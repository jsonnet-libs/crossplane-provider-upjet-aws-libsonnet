{
  ...
  '#':: d.pkg(name='backup', url='', help='"Backup is the Schema for the Backups API. Manages a FSx Backup."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFileSystemId':: d.fn(help='"The ID of the file system to back up. Required if backing up Lustre or Windows file systems."', args=[d.arg(name='fileSystemId', type=d.T.string)]),
      ...
      '#withVolumeId':: d.fn(help='"The ID of the volume to back up. Required if backing up a ONTAP Volume."', args=[d.arg(name='volumeId', type=d.T.string)]),
