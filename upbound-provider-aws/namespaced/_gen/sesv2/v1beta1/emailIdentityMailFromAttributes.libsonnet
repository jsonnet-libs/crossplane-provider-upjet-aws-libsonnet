{
  ...
  '#':: d.pkg(name='emailIdentityMailFromAttributes', url='', help='"EmailIdentityMailFromAttributes is the Schema for the EmailIdentityMailFromAttributess API."'),
  ...
  '#new':: d.fn(help='new returns an instance of EmailIdentityMailFromAttributes', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sesv2.aws.m.upbound.io/v1beta1',
    kind: 'EmailIdentityMailFromAttributes',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EmailIdentityMailFromAttributesSpec defines the desired state of EmailIdentityMailFromAttributes"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withBehaviorOnMxFailure':: d.fn(help="\"The action to take if the required MX record isn't found when you send an email. Valid values: USE_DEFAULT_VALUE, REJECT_MESSAGE.\"", args=[d.arg(name='behaviorOnMxFailure', type=d.T.string)]),
      withBehaviorOnMxFailure(behaviorOnMxFailure): { spec+: { forProvider+: { behaviorOnMxFailure: behaviorOnMxFailure } } },
      '#withMailFromDomain':: d.fn(help='"The custom MAIL FROM domain that you want the verified identity to use. Required if behavior_on_mx_failure is REJECT_MESSAGE."', args=[d.arg(name='mailFromDomain', type=d.T.string)]),
