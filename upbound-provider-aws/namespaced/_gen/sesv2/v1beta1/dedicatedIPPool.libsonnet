{
  ...
  '#':: d.pkg(name='dedicatedIPPool', url='', help='"DedicatedIPPool is the Schema for the DedicatedIPPools API."'),
  ...
  '#new':: d.fn(help='new returns an instance of DedicatedIPPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sesv2.aws.m.upbound.io/v1beta1',
    kind: 'DedicatedIPPool',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DedicatedIPPoolSpec defines the desired state of DedicatedIPPool"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withScalingMode':: d.fn(help='"IP pool scaling mode. Valid values: STANDARD, MANAGED. If omitted, the AWS API will default to a standard pool."', args=[d.arg(name='scalingMode', type=d.T.string)]),
      withScalingMode(scalingMode): { spec+: { forProvider+: { scalingMode: scalingMode } } },
    ...
    initProvider: {
      '#withScalingMode':: d.fn(help='"IP pool scaling mode. Valid values: STANDARD, MANAGED. If omitted, the AWS API will default to a standard pool."', args=[d.arg(name='scalingMode', type=d.T.string)]),
      withScalingMode(scalingMode): { spec+: { initProvider+: { scalingMode: scalingMode } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
