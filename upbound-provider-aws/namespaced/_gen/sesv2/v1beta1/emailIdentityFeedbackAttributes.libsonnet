{
  ...
  '#':: d.pkg(name='emailIdentityFeedbackAttributes', url='', help='"EmailIdentityFeedbackAttributes is the Schema for the EmailIdentityFeedbackAttributess API."'),
  ...
  '#new':: d.fn(help='new returns an instance of EmailIdentityFeedbackAttributes', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sesv2.aws.m.upbound.io/v1beta1',
    kind: 'EmailIdentityFeedbackAttributes',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EmailIdentityFeedbackAttributesSpec defines the desired state of EmailIdentityFeedbackAttributes"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withEmailForwardingEnabled':: d.fn(help='"Sets the feedback forwarding configuration for the identity."', args=[d.arg(name='emailForwardingEnabled', type=d.T.boolean)]),
      withEmailForwardingEnabled(emailForwardingEnabled): { spec+: { forProvider+: { emailForwardingEnabled: emailForwardingEnabled } } },
    ...
    initProvider: {
      '#withEmailForwardingEnabled':: d.fn(help='"Sets the feedback forwarding configuration for the identity."', args=[d.arg(name='emailForwardingEnabled', type=d.T.boolean)]),
      withEmailForwardingEnabled(emailForwardingEnabled): { spec+: { initProvider+: { emailForwardingEnabled: emailForwardingEnabled } } },
    },
