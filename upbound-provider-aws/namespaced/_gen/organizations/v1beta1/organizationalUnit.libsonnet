{
  ...
  '#':: d.pkg(name='organizationalUnit', url='', help='"OrganizationalUnit is the Schema for the OrganizationalUnits API. Provides a resource to create an organizational unit."'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationalUnit', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'organizations.aws.m.upbound.io/v1beta1',
    kind: 'OrganizationalUnit',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"OrganizationalUnitSpec defines the desired state of OrganizationalUnit"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"The name for the organizational unit"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withParentId':: d.fn(help='"ID of the parent organizational unit, which may be the root"', args=[d.arg(name='parentId', type=d.T.string)]),
