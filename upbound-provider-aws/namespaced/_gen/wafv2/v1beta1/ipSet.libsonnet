{
  ...
  '#':: d.pkg(name='ipSet', url='', help='"IPSet is the Schema for the IPSets API. Provides an AWS WAFv2 IP Set resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of IPSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'wafv2.aws.m.upbound.io/v1beta1',
    kind: 'IPSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"IPSetSpec defines the desired state of IPSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAddresses':: d.fn(help='"Contains an array of strings that specifies zero or more IP addresses or blocks of IP addresses. All addresses must be specified using Classless Inter-Domain Routing (CIDR) notation. WAF supports all IPv4 and IPv6 CIDR ranges except for /0."', args=[d.arg(name='addresses', type=d.T.array)]),
      withAddresses(addresses): { spec+: { forProvider+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } },
      '#withAddressesMixin':: d.fn(help='"Contains an array of strings that specifies zero or more IP addresses or blocks of IP addresses. All addresses must be specified using Classless Inter-Domain Routing (CIDR) notation. WAF supports all IPv4 and IPv6 CIDR ranges except for /0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addresses', type=d.T.array)]),
      withAddressesMixin(addresses): { spec+: { forProvider+: { addresses+: if std.isArray(v=addresses) then addresses else [addresses] } } },
      '#withDescription':: d.fn(help='"A friendly description of the IP set."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIpAddressVersion':: d.fn(help='"Specify IPV4 or IPV6. Valid values are IPV4 or IPV6."', args=[d.arg(name='ipAddressVersion', type=d.T.string)]),
      withIpAddressVersion(ipAddressVersion): { spec+: { forProvider+: { ipAddressVersion: ipAddressVersion } } },
      '#withName':: d.fn(help='"A friendly name of the IP set. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withScope':: d.fn(help='"Specifies whether this is for an AWS CloudFront distribution or for a regional application. Valid values are CLOUDFRONT or REGIONAL. To work with CloudFront, you must also specify the Region US East (N. Virginia)."', args=[d.arg(name='scope', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withIpAddressVersion':: d.fn(help='"Specify IPV4 or IPV6. Valid values are IPV4 or IPV6."', args=[d.arg(name='ipAddressVersion', type=d.T.string)]),
      withIpAddressVersion(ipAddressVersion): { spec+: { initProvider+: { ipAddressVersion: ipAddressVersion } } },
      '#withName':: d.fn(help='"A friendly name of the IP set. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
