{
  ...
  '#':: d.pkg(name='inferenceProfile', url='', help='"InferenceProfile is the Schema for the InferenceProfiles API."'),
  ...
  '#new':: d.fn(help='new returns an instance of InferenceProfile', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'bedrock.aws.m.upbound.io/v1beta1',
    kind: 'InferenceProfile',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"InferenceProfileSpec defines the desired state of InferenceProfile"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#modelSource':: d.obj(help='"The source of the model this inference profile will track metrics and cost for. See model_source."'),
      modelSource: {
        '#withCopyFrom':: d.fn(help='"The Amazon Resource Name (ARN) of the model."', args=[d.arg(name='copyFrom', type=d.T.string)]),
        withCopyFrom(copyFrom): { copyFrom: copyFrom },
      },
      '#withDescription':: d.fn(help='"The description of the inference profile."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withModelSource':: d.fn(help='"The source of the model this inference profile will track metrics and cost for. See model_source."', args=[d.arg(name='modelSource', type=d.T.array)]),
      withModelSource(modelSource): { spec+: { forProvider+: { modelSource: if std.isArray(v=modelSource) then modelSource else [modelSource] } } },
      '#withModelSourceMixin':: d.fn(help='"The source of the model this inference profile will track metrics and cost for. See model_source."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='modelSource', type=d.T.array)]),
      withModelSourceMixin(modelSource): { spec+: { forProvider+: { modelSource+: if std.isArray(v=modelSource) then modelSource else [modelSource] } } },
      '#withName':: d.fn(help='"The name of the inference profile."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withModelSource':: d.fn(help='"The source of the model this inference profile will track metrics and cost for. See model_source."', args=[d.arg(name='modelSource', type=d.T.array)]),
      withModelSource(modelSource): { spec+: { initProvider+: { modelSource: if std.isArray(v=modelSource) then modelSource else [modelSource] } } },
      '#withModelSourceMixin':: d.fn(help='"The source of the model this inference profile will track metrics and cost for. See model_source."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='modelSource', type=d.T.array)]),
      withModelSourceMixin(modelSource): { spec+: { initProvider+: { modelSource+: if std.isArray(v=modelSource) then modelSource else [modelSource] } } },
      '#withName':: d.fn(help='"The name of the inference profile."', args=[d.arg(name='name', type=d.T.string)]),
