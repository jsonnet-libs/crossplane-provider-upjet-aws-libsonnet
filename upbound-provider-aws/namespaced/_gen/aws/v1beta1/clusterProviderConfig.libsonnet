{
  ...
  '#':: d.pkg(name='clusterProviderConfig', url='', help='"A ClusterProviderConfig configures the AWS provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterProviderConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
