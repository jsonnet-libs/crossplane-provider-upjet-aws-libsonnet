{
  ...
  '#':: d.pkg(name='providerConfigUsage', url='', help='"A ProviderConfigUsage indicates that a resource is using a ProviderConfig."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProviderConfigUsage', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  providerConfigRef: {
    ...
    withKind(kind): { providerConfigRef+: { kind: kind } },
    '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { providerConfigRef+: { name: name } },
  },
  ...
  resourceRef: {
    ...
    '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { resourceRef+: { name: name } },
    '#withUid':: d.fn(help='"UID of the referenced object."', args=[d.arg(name='uid', type=d.T.string)]),
    withUid(uid): { resourceRef+: { uid: uid } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
