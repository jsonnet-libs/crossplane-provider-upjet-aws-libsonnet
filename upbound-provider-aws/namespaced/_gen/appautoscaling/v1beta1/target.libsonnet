{
  ...
  '#':: d.pkg(name='target', url='', help='"Target is the Schema for the Targets API. Provides an Application AutoScaling ScalableTarget resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#suspendedState':: d.obj(help='"Specifies whether the scaling activities for a scalable target are in a suspended state."'),
      suspendedState: {
        '#withDynamicScalingInSuspended':: d.fn(help='"Whether scale in by a target tracking scaling policy or a step scaling policy is suspended. Default is false."', args=[d.arg(name='dynamicScalingInSuspended', type=d.T.boolean)]),
        withDynamicScalingInSuspended(dynamicScalingInSuspended): { spec+: { forProvider+: { suspendedState+: { dynamicScalingInSuspended: dynamicScalingInSuspended } } } },
        '#withDynamicScalingOutSuspended':: d.fn(help='"Whether scale out by a target tracking scaling policy or a step scaling policy is suspended. Default is false."', args=[d.arg(name='dynamicScalingOutSuspended', type=d.T.boolean)]),
        withDynamicScalingOutSuspended(dynamicScalingOutSuspended): { spec+: { forProvider+: { suspendedState+: { dynamicScalingOutSuspended: dynamicScalingOutSuspended } } } },
        '#withScheduledScalingSuspended':: d.fn(help='"Whether scheduled scaling is suspended. Default is false."', args=[d.arg(name='scheduledScalingSuspended', type=d.T.boolean)]),
        withScheduledScalingSuspended(scheduledScalingSuspended): { spec+: { forProvider+: { suspendedState+: { scheduledScalingSuspended: scheduledScalingSuspended } } } },
      },
      '#withMaxCapacity':: d.fn(help='"Max capacity of the scalable target."', args=[d.arg(name='maxCapacity', type=d.T.number)]),
      withMaxCapacity(maxCapacity): { spec+: { forProvider+: { maxCapacity: maxCapacity } } },
      '#withMinCapacity':: d.fn(help='"Min capacity of the scalable target."', args=[d.arg(name='minCapacity', type=d.T.number)]),
      ...
      '#withRoleArn':: d.fn(help='"ARN of the IAM role that allows Application AutoScaling to modify your scalable target on your behalf. This defaults to an IAM Service-Linked Role for most services and custom IAM Roles are ignored by the API for those namespaces. See the AWS Application Auto Scaling documentation for more information about how this service interacts with IAM."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      suspendedState: {
        '#withDynamicScalingInSuspended':: d.fn(help='"Whether scale in by a target tracking scaling policy or a step scaling policy is suspended. Default is false."', args=[d.arg(name='dynamicScalingInSuspended', type=d.T.boolean)]),
        withDynamicScalingInSuspended(dynamicScalingInSuspended): { spec+: { initProvider+: { suspendedState+: { dynamicScalingInSuspended: dynamicScalingInSuspended } } } },
        '#withDynamicScalingOutSuspended':: d.fn(help='"Whether scale out by a target tracking scaling policy or a step scaling policy is suspended. Default is false."', args=[d.arg(name='dynamicScalingOutSuspended', type=d.T.boolean)]),
        withDynamicScalingOutSuspended(dynamicScalingOutSuspended): { spec+: { initProvider+: { suspendedState+: { dynamicScalingOutSuspended: dynamicScalingOutSuspended } } } },
        '#withScheduledScalingSuspended':: d.fn(help='"Whether scheduled scaling is suspended. Default is false."', args=[d.arg(name='scheduledScalingSuspended', type=d.T.boolean)]),
        withScheduledScalingSuspended(scheduledScalingSuspended): { spec+: { initProvider+: { suspendedState+: { scheduledScalingSuspended: scheduledScalingSuspended } } } },
      },
      '#withMaxCapacity':: d.fn(help='"Max capacity of the scalable target."', args=[d.arg(name='maxCapacity', type=d.T.number)]),
