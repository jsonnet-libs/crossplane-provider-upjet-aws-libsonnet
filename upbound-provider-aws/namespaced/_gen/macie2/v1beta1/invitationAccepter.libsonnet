{
  ...
  '#':: d.pkg(name='invitationAccepter', url='', help='"InvitationAccepter is the Schema for the InvitationAccepters API. Provides a resource to manage an Amazon Macie Invitation Accepter."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAdministratorAccountId':: d.fn(help='"The AWS account ID for the account that sent the invitation."', args=[d.arg(name='administratorAccountId', type=d.T.string)]),
      withAdministratorAccountId(administratorAccountId): { spec+: { forProvider+: { administratorAccountId: administratorAccountId } } },
    ...
    initProvider: {
      '#withAdministratorAccountId':: d.fn(help='"The AWS account ID for the account that sent the invitation."', args=[d.arg(name='administratorAccountId', type=d.T.string)]),
      withAdministratorAccountId(administratorAccountId): { spec+: { initProvider+: { administratorAccountId: administratorAccountId } } },
    },
