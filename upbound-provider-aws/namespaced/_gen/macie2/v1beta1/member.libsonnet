{
  ...
  '#':: d.pkg(name='member', url='', help='"Member is the Schema for the Members API. Provides a resource to manage an Amazon Macie Member."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAccountId':: d.fn(help='"The AWS account ID for the account."', args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withEmail':: d.fn(help='"The email address for the account."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withInvitationDisableEmailNotification':: d.fn(help='"Specifies whether to send an email notification to the root user of each account that the invitation will be sent to. This notification is in addition to an alert that the root user receives in AWS Personal Health Dashboard. To send an email notification to the root user of each account, set this value to true."', args=[d.arg(name='invitationDisableEmailNotification', type=d.T.boolean)]),
      withInvitationDisableEmailNotification(invitationDisableEmailNotification): { spec+: { forProvider+: { invitationDisableEmailNotification: invitationDisableEmailNotification } } },
      '#withInvitationMessage':: d.fn(help='"A custom message to include in the invitation. Amazon Macie adds this message to the standard content that it sends for an invitation."', args=[d.arg(name='invitationMessage', type=d.T.string)]),
      withInvitationMessage(invitationMessage): { spec+: { forProvider+: { invitationMessage: invitationMessage } } },
      '#withInvite':: d.fn(help='"Send an invitation to a member"', args=[d.arg(name='invite', type=d.T.boolean)]),
    ...
    initProvider: {
      ...
      '#withInvitationDisableEmailNotification':: d.fn(help='"Specifies whether to send an email notification to the root user of each account that the invitation will be sent to. This notification is in addition to an alert that the root user receives in AWS Personal Health Dashboard. To send an email notification to the root user of each account, set this value to true."', args=[d.arg(name='invitationDisableEmailNotification', type=d.T.boolean)]),
      withInvitationDisableEmailNotification(invitationDisableEmailNotification): { spec+: { initProvider+: { invitationDisableEmailNotification: invitationDisableEmailNotification } } },
      '#withInvitationMessage':: d.fn(help='"A custom message to include in the invitation. Amazon Macie adds this message to the standard content that it sends for an invitation."', args=[d.arg(name='invitationMessage', type=d.T.string)]),
