{
  ...
  '#':: d.pkg(name='domain', url='', help='"Domain is the Schema for the Domains API. Provides an SWF Domain resource"'),
  ...
  new(name): {
    apiVersion: 'swf.aws.m.upbound.io/v1beta1',
    kind: 'Domain',
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"The domain description."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withWorkflowExecutionRetentionPeriodInDays':: d.fn(help='"Length of time that SWF will continue to retain information about the workflow execution after the workflow execution is complete, must be between 0 and 90 days."', args=[d.arg(name='workflowExecutionRetentionPeriodInDays', type=d.T.string)]),
      withWorkflowExecutionRetentionPeriodInDays(workflowExecutionRetentionPeriodInDays): { spec+: { forProvider+: { workflowExecutionRetentionPeriodInDays: workflowExecutionRetentionPeriodInDays } } },
    },
    ...
    initProvider: {
      ...
      '#withWorkflowExecutionRetentionPeriodInDays':: d.fn(help='"Length of time that SWF will continue to retain information about the workflow execution after the workflow execution is complete, must be between 0 and 90 days."', args=[d.arg(name='workflowExecutionRetentionPeriodInDays', type=d.T.string)]),
      withWorkflowExecutionRetentionPeriodInDays(workflowExecutionRetentionPeriodInDays): { spec+: { initProvider+: { workflowExecutionRetentionPeriodInDays: workflowExecutionRetentionPeriodInDays } } },
    },
