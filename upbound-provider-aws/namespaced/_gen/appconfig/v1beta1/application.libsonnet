{
  ...
  '#':: d.pkg(name='application', url='', help='"Application is the Schema for the Applications API. Provides an AppConfig Application resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the application. Can be at most 1024 characters."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name for the application. Must be between 1 and 64 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
