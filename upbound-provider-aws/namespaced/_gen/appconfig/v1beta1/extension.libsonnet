{
  ...
  '#':: d.pkg(name='extension', url='', help='"Extension is the Schema for the Extensions API. Provides an AppConfig Extension resource."'),
  ...
  '#spec':: d.obj(help='"ExtensionSpec defines the desired state of Extension"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#actionPoint':: d.obj(help='"The action points defined in the extension. Detailed below."'),
      actionPoint: {
        '#action':: d.obj(help='"An action defines the tasks the extension performs during the AppConfig workflow. Detailed below."'),
        action: {
          ...
          '#uriRef':: d.obj(help='"Reference to a Topic in sns to populate uri."'),
          uriRef: {
            '#policy':: d.obj(help='"Policies for referencing."'),
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            ...
            '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { uriRef+: { namespace: namespace } },
          },
          '#uriSelector':: d.obj(help='"Selector for a Topic in sns to populate uri."'),
          uriSelector: {
            '#policy':: d.obj(help='"Policies for selection."'),
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            ...
            '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { uriSelector+: { namespace: namespace } },
          },
          '#withDescription':: d.fn(help='"Information about the action."', args=[d.arg(name='description', type=d.T.string)]),
          withDescription(description): { description: description },
          '#withName':: d.fn(help='"The action name."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
          '#withRoleArn':: d.fn(help='"An Amazon Resource Name (ARN) for an Identity and Access Management assume role."', args=[d.arg(name='roleArn', type=d.T.string)]),
          withRoleArn(roleArn): { roleArn: roleArn },
          '#withUri':: d.fn(help='"The extension URI associated to the action point in the extension definition. The URI can be an Amazon Resource Name (ARN) for one of the following: an Lambda function, an Amazon Simple Queue Service queue, an Amazon Simple Notification Service topic, or the Amazon EventBridge default event bus."', args=[d.arg(name='uri', type=d.T.string)]),
          withUri(uri): { uri: uri },
        },
        '#withAction':: d.fn(help='"An action defines the tasks the extension performs during the AppConfig workflow. Detailed below."', args=[d.arg(name='action', type=d.T.array)]),
        withAction(action): { action: if std.isArray(v=action) then action else [action] },
        '#withActionMixin':: d.fn(help='"An action defines the tasks the extension performs during the AppConfig workflow. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='action', type=d.T.array)]),
        withActionMixin(action): { action+: if std.isArray(v=action) then action else [action] },
        '#withPoint':: d.fn(help='"The point at which to perform the defined actions. Valid points are PRE_CREATE_HOSTED_CONFIGURATION_VERSION, PRE_START_DEPLOYMENT, ON_DEPLOYMENT_START, ON_DEPLOYMENT_STEP, ON_DEPLOYMENT_BAKING, ON_DEPLOYMENT_COMPLETE, ON_DEPLOYMENT_ROLLED_BACK."', args=[d.arg(name='point', type=d.T.string)]),
        withPoint(point): { point: point },
      },
      '#parameter':: d.obj(help='"The parameters accepted by the extension. You specify parameter values when you associate the extension to an AppConfig resource by using the CreateExtensionAssociation API action. For Lambda extension actions, these parameters are included in the Lambda request object. Detailed below."'),
      parameter: {
        '#withDescription':: d.fn(help='"Information about the parameter."', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { description: description },
        '#withName':: d.fn(help='"The parameter name."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRequired':: d.fn(help='"Determines if a parameter value must be specified in the extension association."', args=[d.arg(name='required', type=d.T.boolean)]),
        withRequired(required): { required: required },
      },
      '#withActionPoint':: d.fn(help='"The action points defined in the extension. Detailed below."', args=[d.arg(name='actionPoint', type=d.T.array)]),
      withActionPoint(actionPoint): { spec+: { forProvider+: { actionPoint: if std.isArray(v=actionPoint) then actionPoint else [actionPoint] } } },
      '#withActionPointMixin':: d.fn(help='"The action points defined in the extension. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='actionPoint', type=d.T.array)]),
      withActionPointMixin(actionPoint): { spec+: { forProvider+: { actionPoint+: if std.isArray(v=actionPoint) then actionPoint else [actionPoint] } } },
      '#withDescription':: d.fn(help='"Information about the extension."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"A name for the extension. Each extension name in your account must be unique. Extension versions use the same name."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withParameter':: d.fn(help='"The parameters accepted by the extension. You specify parameter values when you associate the extension to an AppConfig resource by using the CreateExtensionAssociation API action. For Lambda extension actions, these parameters are included in the Lambda request object. Detailed below."', args=[d.arg(name='parameter', type=d.T.array)]),
      withParameter(parameter): { spec+: { forProvider+: { parameter: if std.isArray(v=parameter) then parameter else [parameter] } } },
      '#withParameterMixin':: d.fn(help='"The parameters accepted by the extension. You specify parameter values when you associate the extension to an AppConfig resource by using the CreateExtensionAssociation API action. For Lambda extension actions, these parameters are included in the Lambda request object. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameter', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withActionPoint':: d.fn(help='"The action points defined in the extension. Detailed below."', args=[d.arg(name='actionPoint', type=d.T.array)]),
      withActionPoint(actionPoint): { spec+: { initProvider+: { actionPoint: if std.isArray(v=actionPoint) then actionPoint else [actionPoint] } } },
      '#withActionPointMixin':: d.fn(help='"The action points defined in the extension. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='actionPoint', type=d.T.array)]),
      withActionPointMixin(actionPoint): { spec+: { initProvider+: { actionPoint+: if std.isArray(v=actionPoint) then actionPoint else [actionPoint] } } },
      '#withDescription':: d.fn(help='"Information about the extension."', args=[d.arg(name='description', type=d.T.string)]),
