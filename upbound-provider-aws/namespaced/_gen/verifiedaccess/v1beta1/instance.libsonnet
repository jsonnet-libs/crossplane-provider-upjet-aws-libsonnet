{
  ...
  spec: {
    ...
    forProvider: {
      '#withCidrEndpointsCustomSubdomain':: d.fn(help='"The custom subdomain for the CIDR endpoints."', args=[d.arg(name='cidrEndpointsCustomSubdomain', type=d.T.string)]),
      withCidrEndpointsCustomSubdomain(cidrEndpointsCustomSubdomain): { spec+: { forProvider+: { cidrEndpointsCustomSubdomain: cidrEndpointsCustomSubdomain } } },
      '#withDescription':: d.fn(help='"A description for the AWS Verified Access Instance."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFipsEnabled':: d.fn(help='"Enable or disable support for Federal Information Processing Standards (FIPS) on the AWS Verified Access Instance."', args=[d.arg(name='fipsEnabled', type=d.T.boolean)]),
    ...
    initProvider: {
      '#withCidrEndpointsCustomSubdomain':: d.fn(help='"The custom subdomain for the CIDR endpoints."', args=[d.arg(name='cidrEndpointsCustomSubdomain', type=d.T.string)]),
      withCidrEndpointsCustomSubdomain(cidrEndpointsCustomSubdomain): { spec+: { initProvider+: { cidrEndpointsCustomSubdomain: cidrEndpointsCustomSubdomain } } },
      '#withDescription':: d.fn(help='"A description for the AWS Verified Access Instance."', args=[d.arg(name='description', type=d.T.string)]),
