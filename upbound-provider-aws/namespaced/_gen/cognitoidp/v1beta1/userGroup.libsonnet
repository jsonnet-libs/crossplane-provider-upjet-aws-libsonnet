{
  ...
  '#':: d.pkg(name='userGroup', url='', help='"UserGroup is the Schema for the UserGroups API. Provides a Cognito User Group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the user group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of the user group."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPrecedence':: d.fn(help='"The precedence of the user group."', args=[d.arg(name='precedence', type=d.T.number)]),
      withPrecedence(precedence): { spec+: { forProvider+: { precedence: precedence } } },
      ...
      '#withRoleArn':: d.fn(help='"The ARN of the IAM role to be associated with the user group."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withPrecedence':: d.fn(help='"The precedence of the user group."', args=[d.arg(name='precedence', type=d.T.number)]),
      withPrecedence(precedence): { spec+: { initProvider+: { precedence: precedence } } },
      '#withRoleArn':: d.fn(help='"The ARN of the IAM role to be associated with the user group."', args=[d.arg(name='roleArn', type=d.T.string)]),
