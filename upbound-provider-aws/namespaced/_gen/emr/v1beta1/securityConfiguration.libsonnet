{
  ...
  '#':: d.pkg(name='securityConfiguration', url='', help='"SecurityConfiguration is the Schema for the SecurityConfigurations API. Provides a resource to manage AWS EMR Security Configurations"'),
  ...
  new(name): {
    apiVersion: 'emr.aws.m.upbound.io/v1beta1',
  ...
  spec: {
    ...
    forProvider: {
      '#withConfiguration':: d.fn(help='"A JSON formatted Security Configuration"', args=[d.arg(name='configuration', type=d.T.string)]),
