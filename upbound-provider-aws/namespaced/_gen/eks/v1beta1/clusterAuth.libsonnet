{
  ...
  '#':: d.pkg(name='clusterAuth', url='', help='"ClusterAuth is used to retrieve Kubeconfig of given EKS cluster."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterAuth', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'eks.aws.m.upbound.io/v1beta1',
    kind: 'ClusterAuth',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ClusterAuthSpec defines the desired state of ClusterAuth"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withClusterName':: d.fn(help="\"ClusterName is the name of the cluster you'd like to fetch Kubeconfig of.\\nEither ClusterName, ClusterNameRef or ClusterNameSelector has to be given.\"", args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withRefreshPeriod':: d.fn(help="\"RefreshPeriod is how frequently you'd like the token in the published\\nKubeconfig to be refreshed. The maximum is 10m0s.\\nThe default is 10m0s.\"", args=[d.arg(name='refreshPeriod', type=d.T.string)]),
      withRefreshPeriod(refreshPeriod): { spec+: { forProvider+: { refreshPeriod: refreshPeriod } } },
