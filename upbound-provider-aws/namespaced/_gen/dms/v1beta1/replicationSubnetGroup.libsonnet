{
  ...
  '#':: d.pkg(name='replicationSubnetGroup', url='', help='"ReplicationSubnetGroup is the Schema for the ReplicationSubnetGroups API. Provides a DMS (Data Migration Service) subnet group resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ReplicationSubnetGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'dms.aws.m.upbound.io/v1beta1',
    kind: 'ReplicationSubnetGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ReplicationSubnetGroupSpec defines the desired state of ReplicationSubnetGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withReplicationSubnetGroupDescription':: d.fn(help='"Description for the subnet group."', args=[d.arg(name='replicationSubnetGroupDescription', type=d.T.string)]),
      withReplicationSubnetGroupDescription(replicationSubnetGroupDescription): { spec+: { forProvider+: { replicationSubnetGroupDescription: replicationSubnetGroupDescription } } },
      ...
      '#withSubnetIds':: d.fn(help='"List of at least 2 EC2 subnet IDs for the subnet group. The subnets must cover at least 2 availability zones."', args=[d.arg(name='subnetIds', type=d.T.array)]),
      withSubnetIds(subnetIds): { spec+: { forProvider+: { subnetIds: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] } } },
      '#withSubnetIdsMixin':: d.fn(help='"List of at least 2 EC2 subnet IDs for the subnet group. The subnets must cover at least 2 availability zones."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetIds', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withReplicationSubnetGroupDescription':: d.fn(help='"Description for the subnet group."', args=[d.arg(name='replicationSubnetGroupDescription', type=d.T.string)]),
      withReplicationSubnetGroupDescription(replicationSubnetGroupDescription): { spec+: { initProvider+: { replicationSubnetGroupDescription: replicationSubnetGroupDescription } } },
      '#withSubnetIdRefs':: d.fn(help='"References to Subnet in ec2 to populate subnetIds."', args=[d.arg(name='subnetIdRefs', type=d.T.array)]),
