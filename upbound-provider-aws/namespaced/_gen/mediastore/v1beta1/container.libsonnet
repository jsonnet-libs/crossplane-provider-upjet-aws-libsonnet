{
  ...
  '#':: d.pkg(name='container', url='', help='"Container is the Schema for the Containers API. Provides a MediaStore Container."'),
  ...
  '#new':: d.fn(help='new returns an instance of Container', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
