{
  ...
  '#':: d.pkg(name='tagOption', url='', help='"TagOption is the Schema for the TagOptions API. Manages a Service Catalog Tag Option"'),
  ...
  '#new':: d.fn(help='new returns an instance of TagOption', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'servicecatalog.aws.m.upbound.io/v1beta1',
    kind: 'TagOption',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TagOptionSpec defines the desired state of TagOption"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withActive':: d.fn(help='"Whether tag option is active. Default is true."', args=[d.arg(name='active', type=d.T.boolean)]),
      withActive(active): { spec+: { forProvider+: { active: active } } },
      '#withKey':: d.fn(help='"Tag option key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withValue':: d.fn(help='"Tag option value."', args=[d.arg(name='value', type=d.T.string)]),
