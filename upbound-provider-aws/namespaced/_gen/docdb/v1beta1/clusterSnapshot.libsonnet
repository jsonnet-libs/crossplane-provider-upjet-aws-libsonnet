{
  ...
  '#':: d.pkg(name='clusterSnapshot', url='', help='"ClusterSnapshot is the Schema for the ClusterSnapshots API. Manages a DocumentDB database cluster snapshot."'),
  ...
  spec: {
    ...
    forProvider: {
      '#dbClusterIdentifierRef':: d.obj(help='"Reference to a Cluster in docdb to populate dbClusterIdentifier."'),
      ...
      '#dbClusterIdentifierSelector':: d.obj(help='"Selector for a Cluster in docdb to populate dbClusterIdentifier."'),
      ...
      '#withDbClusterIdentifier':: d.fn(help='"The DocumentDB Cluster Identifier from which to take the snapshot."', args=[d.arg(name='dbClusterIdentifier', type=d.T.string)]),
