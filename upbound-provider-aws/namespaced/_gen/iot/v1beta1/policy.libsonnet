{
  ...
  '#':: d.pkg(name='policy', url='', help='"Policy is the Schema for the Policys API. Provides an IoT policy."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withPolicy':: d.fn(help='"The policy document. This is a JSON formatted string. Use the IoT Developer Guide for more information on IoT Policies."', args=[d.arg(name='policy', type=d.T.string)]),
