{
  ...
  '#':: d.pkg(name='thingGroupMembership', url='', help='"ThingGroupMembership is the Schema for the ThingGroupMemberships API. Adds an IoT Thing to an IoT Thing Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of ThingGroupMembership', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iot.aws.m.upbound.io/v1beta1',
    kind: 'ThingGroupMembership',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ThingGroupMembershipSpec defines the desired state of ThingGroupMembership"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withOverrideDynamicGroup':: d.fn(help='"Override dynamic thing groups with static thing groups when 10-group limit is reached. If a thing belongs to 10 thing groups, and one or more of those groups are dynamic thing groups, adding a thing to a static group removes the thing from the last dynamic group."', args=[d.arg(name='overrideDynamicGroup', type=d.T.boolean)]),
      withOverrideDynamicGroup(overrideDynamicGroup): { spec+: { forProvider+: { overrideDynamicGroup: overrideDynamicGroup } } },
      ...
      '#withThingGroupName':: d.fn(help='"The name of the group to which you are adding a thing."', args=[d.arg(name='thingGroupName', type=d.T.string)]),
      withThingGroupName(thingGroupName): { spec+: { forProvider+: { thingGroupName: thingGroupName } } },
      '#withThingName':: d.fn(help='"The name of the thing to add to a group."', args=[d.arg(name='thingName', type=d.T.string)]),
      withThingName(thingName): { spec+: { forProvider+: { thingName: thingName } } },
    },
    ...
    initProvider: {
      '#withOverrideDynamicGroup':: d.fn(help='"Override dynamic thing groups with static thing groups when 10-group limit is reached. If a thing belongs to 10 thing groups, and one or more of those groups are dynamic thing groups, adding a thing to a static group removes the thing from the last dynamic group."', args=[d.arg(name='overrideDynamicGroup', type=d.T.boolean)]),
      withOverrideDynamicGroup(overrideDynamicGroup): { spec+: { initProvider+: { overrideDynamicGroup: overrideDynamicGroup } } },
      '#withThingGroupName':: d.fn(help='"The name of the group to which you are adding a thing."', args=[d.arg(name='thingGroupName', type=d.T.string)]),
      withThingGroupName(thingGroupName): { spec+: { initProvider+: { thingGroupName: thingGroupName } } },
      '#withThingName':: d.fn(help='"The name of the thing to add to a group."', args=[d.arg(name='thingName', type=d.T.string)]),
      withThingName(thingName): { spec+: { initProvider+: { thingName: thingName } } },
    },
