{
  ...
  '#':: d.pkg(name='roleAlias', url='', help='"RoleAlias is the Schema for the RoleAliass API. Provides an IoT role alias."'),
  ...
  '#new':: d.fn(help='new returns an instance of RoleAlias', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iot.aws.m.upbound.io/v1beta1',
    kind: 'RoleAlias',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RoleAliasSpec defines the desired state of RoleAlias"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAlias':: d.fn(help='"The name of the role alias."', args=[d.arg(name='alias', type=d.T.string)]),
      withAlias(alias): { spec+: { forProvider+: { alias: alias } } },
      '#withCredentialDuration':: d.fn(help='"The duration of the credential, in seconds. If you do not specify a value for this setting, the default maximum of one hour is applied. This setting can have a value from 900 seconds (15 minutes) to 43200 seconds (12 hours)."', args=[d.arg(name='credentialDuration', type=d.T.number)]),
      withCredentialDuration(credentialDuration): { spec+: { forProvider+: { credentialDuration: credentialDuration } } },
      ...
      '#withRoleArn':: d.fn(help='"The identity of the role to which the alias refers."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withCredentialDuration':: d.fn(help='"The duration of the credential, in seconds. If you do not specify a value for this setting, the default maximum of one hour is applied. This setting can have a value from 900 seconds (15 minutes) to 43200 seconds (12 hours)."', args=[d.arg(name='credentialDuration', type=d.T.number)]),
      withCredentialDuration(credentialDuration): { spec+: { initProvider+: { credentialDuration: credentialDuration } } },
      '#withRoleArn':: d.fn(help='"The identity of the role to which the alias refers."', args=[d.arg(name='roleArn', type=d.T.string)]),
