{
  ...
  '#':: d.pkg(name='loggingOptions', url='', help='"LoggingOptions is the Schema for the LoggingOptionss API. Provides a resource to manage default logging options."'),
  ...
  '#new':: d.fn(help='new returns an instance of LoggingOptions', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iot.aws.m.upbound.io/v1beta1',
    kind: 'LoggingOptions',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LoggingOptionsSpec defines the desired state of LoggingOptions"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultLogLevel':: d.fn(help='"The default logging level. Valid Values: \\"DEBUG\\", \\"INFO\\", \\"ERROR\\", \\"WARN\\", \\"DISABLED\\"."', args=[d.arg(name='defaultLogLevel', type=d.T.string)]),
      withDefaultLogLevel(defaultLogLevel): { spec+: { forProvider+: { defaultLogLevel: defaultLogLevel } } },
      '#withDisableAllLogs':: d.fn(help='"If true all logs are disabled. The default is false."', args=[d.arg(name='disableAllLogs', type=d.T.boolean)]),
      withDisableAllLogs(disableAllLogs): { spec+: { forProvider+: { disableAllLogs: disableAllLogs } } },
      ...
      '#withRoleArn':: d.fn(help='"The ARN of the role that allows IoT to write to Cloudwatch logs."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDefaultLogLevel':: d.fn(help='"The default logging level. Valid Values: \\"DEBUG\\", \\"INFO\\", \\"ERROR\\", \\"WARN\\", \\"DISABLED\\"."', args=[d.arg(name='defaultLogLevel', type=d.T.string)]),
      withDefaultLogLevel(defaultLogLevel): { spec+: { initProvider+: { defaultLogLevel: defaultLogLevel } } },
      '#withDisableAllLogs':: d.fn(help='"If true all logs are disabled. The default is false."', args=[d.arg(name='disableAllLogs', type=d.T.boolean)]),
      withDisableAllLogs(disableAllLogs): { spec+: { initProvider+: { disableAllLogs: disableAllLogs } } },
      '#withRoleArn':: d.fn(help='"The ARN of the role that allows IoT to write to Cloudwatch logs."', args=[d.arg(name='roleArn', type=d.T.string)]),
