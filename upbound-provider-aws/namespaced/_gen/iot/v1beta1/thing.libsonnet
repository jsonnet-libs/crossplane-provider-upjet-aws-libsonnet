{
  ...
  '#':: d.pkg(name='thing', url='', help='"Thing is the Schema for the Things API. Creates and manages an AWS IoT Thing."'),
  ...
  '#new':: d.fn(help='new returns an instance of Thing', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withThingTypeName':: d.fn(help='"The thing type name."', args=[d.arg(name='thingTypeName', type=d.T.string)]),
      withThingTypeName(thingTypeName): { spec+: { forProvider+: { thingTypeName: thingTypeName } } },
    },
    ...
    initProvider: {
      ...
      '#withThingTypeName':: d.fn(help='"The thing type name."', args=[d.arg(name='thingTypeName', type=d.T.string)]),
      withThingTypeName(thingTypeName): { spec+: { initProvider+: { thingTypeName: thingTypeName } } },
    },
