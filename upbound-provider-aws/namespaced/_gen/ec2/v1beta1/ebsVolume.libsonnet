{
  ...
  '#':: d.pkg(name='ebsVolume', url='', help='"EBSVolume is the Schema for the EBSVolumes API. Provides an elastic block storage resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of EBSVolume', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'EBSVolume',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EBSVolumeSpec defines the desired state of EBSVolume"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAvailabilityZone':: d.fn(help='"Availability zone where the EBS volume will exist."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      ...
      '#withFinalSnapshot':: d.fn(help='"If true, snapshot will be created before volume deletion. Any tags on the volume will be migrated to the snapshot. By default set to false"', args=[d.arg(name='finalSnapshot', type=d.T.boolean)]),
      withFinalSnapshot(finalSnapshot): { spec+: { forProvider+: { finalSnapshot: finalSnapshot } } },
      '#withIops':: d.fn(help='"Amount of IOPS to provision for the disk. Only valid for type of io1, io2 or gp3."', args=[d.arg(name='iops', type=d.T.number)]),
      withIops(iops): { spec+: { forProvider+: { iops: iops } } },
      '#withKmsKeyId':: d.fn(help='"ARN for the KMS encryption key. When specifying kms_key_id, encrypted needs to be set to true."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { kmsKeyId: kmsKeyId } } },
      '#withMultiAttachEnabled':: d.fn(help='"Specifies whether to enable Amazon EBS Multi-Attach. Multi-Attach is supported on io1 and io2 volumes."', args=[d.arg(name='multiAttachEnabled', type=d.T.boolean)]),
      withMultiAttachEnabled(multiAttachEnabled): { spec+: { forProvider+: { multiAttachEnabled: multiAttachEnabled } } },
      '#withOutpostArn':: d.fn(help='"Amazon Resource Name (ARN) of the Outpost."', args=[d.arg(name='outpostArn', type=d.T.string)]),
      ...
      '#withSize':: d.fn(help='"Size of the drive in GiBs."', args=[d.arg(name='size', type=d.T.number)]),
      withSize(size): { spec+: { forProvider+: { size: size } } },
      '#withSnapshotId':: d.fn(help='"A snapshot to base the EBS volume off of."', args=[d.arg(name='snapshotId', type=d.T.string)]),
      ...
      '#withThroughput':: d.fn(help='"Throughput that the volume supports, in MiB/s. Only valid for type of gp3."', args=[d.arg(name='throughput', type=d.T.number)]),
      withThroughput(throughput): { spec+: { forProvider+: { throughput: throughput } } },
      '#withType':: d.fn(help='"Type of EBS volume. Can be standard, gp2, gp3, io1, io2, sc1 or st1 (Default: gp2)."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { forProvider+: { type: type } } },
      '#withVolumeInitializationRate':: d.fn(help='"EBS provisioned rate for volume initialization, in MiB/s, at which to download the snapshot blocks from Amazon S3 to the volume. This argument can only be set if snapshot_id is specified."', args=[d.arg(name='volumeInitializationRate', type=d.T.number)]),
      withVolumeInitializationRate(volumeInitializationRate): { spec+: { forProvider+: { volumeInitializationRate: volumeInitializationRate } } },
    },
    ...
    initProvider: {
      ...
      '#withFinalSnapshot':: d.fn(help='"If true, snapshot will be created before volume deletion. Any tags on the volume will be migrated to the snapshot. By default set to false"', args=[d.arg(name='finalSnapshot', type=d.T.boolean)]),
      withFinalSnapshot(finalSnapshot): { spec+: { initProvider+: { finalSnapshot: finalSnapshot } } },
      '#withIops':: d.fn(help='"Amount of IOPS to provision for the disk. Only valid for type of io1, io2 or gp3."', args=[d.arg(name='iops', type=d.T.number)]),
      withIops(iops): { spec+: { initProvider+: { iops: iops } } },
      '#withKmsKeyId':: d.fn(help='"ARN for the KMS encryption key. When specifying kms_key_id, encrypted needs to be set to true."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { initProvider+: { kmsKeyId: kmsKeyId } } },
      '#withMultiAttachEnabled':: d.fn(help='"Specifies whether to enable Amazon EBS Multi-Attach. Multi-Attach is supported on io1 and io2 volumes."', args=[d.arg(name='multiAttachEnabled', type=d.T.boolean)]),
      withMultiAttachEnabled(multiAttachEnabled): { spec+: { initProvider+: { multiAttachEnabled: multiAttachEnabled } } },
      '#withOutpostArn':: d.fn(help='"Amazon Resource Name (ARN) of the Outpost."', args=[d.arg(name='outpostArn', type=d.T.string)]),
      ...
      '#withThroughput':: d.fn(help='"Throughput that the volume supports, in MiB/s. Only valid for type of gp3."', args=[d.arg(name='throughput', type=d.T.number)]),
      withThroughput(throughput): { spec+: { initProvider+: { throughput: throughput } } },
      '#withType':: d.fn(help='"Type of EBS volume. Can be standard, gp2, gp3, io1, io2, sc1 or st1 (Default: gp2)."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { initProvider+: { type: type } } },
      '#withVolumeInitializationRate':: d.fn(help='"EBS provisioned rate for volume initialization, in MiB/s, at which to download the snapshot blocks from Amazon S3 to the volume. This argument can only be set if snapshot_id is specified."', args=[d.arg(name='volumeInitializationRate', type=d.T.number)]),
      withVolumeInitializationRate(volumeInitializationRate): { spec+: { initProvider+: { volumeInitializationRate: volumeInitializationRate } } },
    },
