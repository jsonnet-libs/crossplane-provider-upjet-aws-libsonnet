{
  ...
  '#':: d.pkg(name='internetGateway', url='', help='"InternetGateway is the Schema for the InternetGateways API. Provides a resource to create a VPC Internet Gateway."'),
  ...
  '#new':: d.fn(help='new returns an instance of InternetGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'InternetGateway',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"InternetGatewaySpec defines the desired state of InternetGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withVpcId':: d.fn(help='"The VPC ID to create in.  See the aws_internet_gateway_attachment resource for an alternate way to attach an Internet Gateway to a VPC."', args=[d.arg(name='vpcId', type=d.T.string)]),
