{
  ...
  '#':: d.pkg(name='transitGatewayPolicyTable', url='', help='"TransitGatewayPolicyTable is the Schema for the TransitGatewayPolicyTables API. Manages an EC2 Transit Gateway Policy Table"'),
  ...
  '#new':: d.fn(help='new returns an instance of TransitGatewayPolicyTable', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'TransitGatewayPolicyTable',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TransitGatewayPolicyTableSpec defines the desired state of TransitGatewayPolicyTable"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withTransitGatewayId':: d.fn(help='"EC2 Transit Gateway identifier."', args=[d.arg(name='transitGatewayId', type=d.T.string)]),
