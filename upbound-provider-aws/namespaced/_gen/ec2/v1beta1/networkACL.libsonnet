{
  ...
  '#':: d.pkg(name='networkACL', url='', help='"NetworkACL is the Schema for the NetworkACLs API. Provides an network ACL resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkACL', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'NetworkACL',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"NetworkACLSpec defines the desired state of NetworkACL"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withVpcId':: d.fn(help='"The ID of the associated VPC."', args=[d.arg(name='vpcId', type=d.T.string)]),
