{
  ...
  '#':: d.pkg(name='vpnGateway', url='', help='"VPNGateway is the Schema for the VPNGateways API. Provides a resource to create a VPC VPN Gateway."'),
  ...
  '#new':: d.fn(help='new returns an instance of VPNGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'VPNGateway',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VPNGatewaySpec defines the desired state of VPNGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAmazonSideAsn':: d.fn(help="\"The Autonomous System Number (ASN) for the Amazon side of the gateway. If you don't specify an ASN, the virtual private gateway is created with the default ASN.\"", args=[d.arg(name='amazonSideAsn', type=d.T.string)]),
      withAmazonSideAsn(amazonSideAsn): { spec+: { forProvider+: { amazonSideAsn: amazonSideAsn } } },
      '#withAvailabilityZone':: d.fn(help='"The Availability Zone for the virtual private gateway."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      ...
      '#withVpcId':: d.fn(help='"The VPC ID to create in."', args=[d.arg(name='vpcId', type=d.T.string)]),
