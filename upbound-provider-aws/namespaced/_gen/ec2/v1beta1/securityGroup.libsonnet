{
  ...
  '#':: d.pkg(name='securityGroup', url='', help='"SecurityGroup is the Schema for the SecurityGroups API. Provides a security group resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'SecurityGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SecurityGroupSpec defines the desired state of SecurityGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help="\"Security group description. Cannot be \\\"\\\". NOTE: This field maps to the AWS GroupDescription attribute, for which there is no Update API. If you'd like to classify your security groups in a way that can be updated, use tags.\"", args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name of the security group."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRevokeRulesOnDelete':: d.fn(help='"This is normally not needed, however certain AWS services such as Elastic Map Reduce may automatically add required rules to security groups used with the service, and those rules may contain a cyclic dependency that prevent the security groups from being destroyed without removing the dependency first. Default false."', args=[d.arg(name='revokeRulesOnDelete', type=d.T.boolean)]),
      ...
      '#withVpcId':: d.fn(help="\"VPC ID. Defaults to the region's default VPC.\"", args=[d.arg(name='vpcId', type=d.T.string)]),
