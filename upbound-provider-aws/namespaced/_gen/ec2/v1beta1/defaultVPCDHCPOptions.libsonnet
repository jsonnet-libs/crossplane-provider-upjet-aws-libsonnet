{
  ...
  '#':: d.pkg(name='defaultVPCDHCPOptions', url='', help='"DefaultVPCDHCPOptions is the Schema for the DefaultVPCDHCPOptionss API. Manage the default VPC DHCP Options resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of DefaultVPCDHCPOptions', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'DefaultVPCDHCPOptions',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DefaultVPCDHCPOptionsSpec defines the desired state of DefaultVPCDHCPOptions"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withOwnerId':: d.fn(help='"The ID of the AWS account that owns the DHCP options set."', args=[d.arg(name='ownerId', type=d.T.string)]),
      withOwnerId(ownerId): { spec+: { forProvider+: { ownerId: ownerId } } },
    ...
    initProvider: {
      '#withOwnerId':: d.fn(help='"The ID of the AWS account that owns the DHCP options set."', args=[d.arg(name='ownerId', type=d.T.string)]),
      withOwnerId(ownerId): { spec+: { initProvider+: { ownerId: ownerId } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
