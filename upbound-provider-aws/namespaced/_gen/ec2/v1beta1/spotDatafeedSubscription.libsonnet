{
  ...
  '#':: d.pkg(name='spotDatafeedSubscription', url='', help='"SpotDatafeedSubscription is the Schema for the SpotDatafeedSubscriptions API. Provides a Spot Datafeed Subscription resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of SpotDatafeedSubscription', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'SpotDatafeedSubscription',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SpotDatafeedSubscriptionSpec defines the desired state of SpotDatafeedSubscription"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withBucket':: d.fn(help='"The Amazon S3 bucket in which to store the Spot instance data feed."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withPrefix':: d.fn(help='"Path of folder inside bucket to place spot pricing data."', args=[d.arg(name='prefix', type=d.T.string)]),
