{
  ...
  '#':: d.pkg(name='placementGroup', url='', help='"PlacementGroup is the Schema for the PlacementGroups API. Provides an EC2 placement group."'),
  ...
  '#new':: d.fn(help='new returns an instance of PlacementGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'PlacementGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"PlacementGroupSpec defines the desired state of PlacementGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withPartitionCount':: d.fn(help='"The number of partitions to create in the\\nplacement group.  Can only be specified when the strategy is set to\\npartition.  Valid values are 1 - 7 (default is 2)."', args=[d.arg(name='partitionCount', type=d.T.number)]),
      ...
      '#withSpreadLevel':: d.fn(help='"Determines how placement groups spread instances. Can only be used\\nwhen the strategy is set to spread. Can be host or rack. host can only be used for Outpost placement groups. Defaults to rack."', args=[d.arg(name='spreadLevel', type=d.T.string)]),
      withSpreadLevel(spreadLevel): { spec+: { forProvider+: { spreadLevel: spreadLevel } } },
      '#withStrategy':: d.fn(help='"The placement strategy. Can be cluster, partition or spread."', args=[d.arg(name='strategy', type=d.T.string)]),
      withStrategy(strategy): { spec+: { forProvider+: { strategy: strategy } } },
    ...
    initProvider: {
      '#withPartitionCount':: d.fn(help='"The number of partitions to create in the\\nplacement group.  Can only be specified when the strategy is set to\\npartition.  Valid values are 1 - 7 (default is 2)."', args=[d.arg(name='partitionCount', type=d.T.number)]),
      withPartitionCount(partitionCount): { spec+: { initProvider+: { partitionCount: partitionCount } } },
      '#withSpreadLevel':: d.fn(help='"Determines how placement groups spread instances. Can only be used\\nwhen the strategy is set to spread. Can be host or rack. host can only be used for Outpost placement groups. Defaults to rack."', args=[d.arg(name='spreadLevel', type=d.T.string)]),
      withSpreadLevel(spreadLevel): { spec+: { initProvider+: { spreadLevel: spreadLevel } } },
      '#withStrategy':: d.fn(help='"The placement strategy. Can be cluster, partition or spread."', args=[d.arg(name='strategy', type=d.T.string)]),
      withStrategy(strategy): { spec+: { initProvider+: { strategy: strategy } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
