{
  ...
  '#':: d.pkg(name='transitGatewayRouteTable', url='', help='"TransitGatewayRouteTable is the Schema for the TransitGatewayRouteTables API. Manages an EC2 Transit Gateway Route Table"'),
  ...
  '#new':: d.fn(help='new returns an instance of TransitGatewayRouteTable', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
