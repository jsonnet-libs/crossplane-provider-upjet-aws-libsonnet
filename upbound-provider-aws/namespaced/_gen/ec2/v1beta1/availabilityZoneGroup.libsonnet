{
  ...
  '#':: d.pkg(name='availabilityZoneGroup', url='', help='"AvailabilityZoneGroup is the Schema for the AvailabilityZoneGroups API. Manages an EC2 Availability Zone Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of AvailabilityZoneGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'AvailabilityZoneGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AvailabilityZoneGroupSpec defines the desired state of AvailabilityZoneGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withOptInStatus':: d.fn(help='"Indicates whether to enable or disable Availability Zone Group. Valid values: opted-in or not-opted-in."', args=[d.arg(name='optInStatus', type=d.T.string)]),
      withOptInStatus(optInStatus): { spec+: { forProvider+: { optInStatus: optInStatus } } },
    ...
    initProvider: {
      '#withOptInStatus':: d.fn(help='"Indicates whether to enable or disable Availability Zone Group. Valid values: opted-in or not-opted-in."', args=[d.arg(name='optInStatus', type=d.T.string)]),
      withOptInStatus(optInStatus): { spec+: { initProvider+: { optInStatus: optInStatus } } },
    },
