{
  ...
  '#':: d.pkg(name='egressOnlyInternetGateway', url='', help='"EgressOnlyInternetGateway is the Schema for the EgressOnlyInternetGateways API. Provides a resource to create an egress-only Internet gateway."'),
  ...
  '#new':: d.fn(help='new returns an instance of EgressOnlyInternetGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'EgressOnlyInternetGateway',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EgressOnlyInternetGatewaySpec defines the desired state of EgressOnlyInternetGateway"'),
  spec: {
