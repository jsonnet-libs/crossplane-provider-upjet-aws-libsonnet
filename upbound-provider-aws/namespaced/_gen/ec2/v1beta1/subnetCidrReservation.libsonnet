{
  ...
  '#':: d.pkg(name='subnetCidrReservation', url='', help='"SubnetCidrReservation is the Schema for the SubnetCidrReservations API. Provides a subnet CIDR reservation resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetCidrReservation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'SubnetCidrReservation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SubnetCidrReservationSpec defines the desired state of SubnetCidrReservation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCidrBlock':: d.fn(help='"The CIDR block for the reservation."', args=[d.arg(name='cidrBlock', type=d.T.string)]),
      withCidrBlock(cidrBlock): { spec+: { forProvider+: { cidrBlock: cidrBlock } } },
      '#withDescription':: d.fn(help='"A brief description of the reservation."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withReservationType':: d.fn(help='"The type of reservation to create. Valid values: explicit, prefix"', args=[d.arg(name='reservationType', type=d.T.string)]),
      withReservationType(reservationType): { spec+: { forProvider+: { reservationType: reservationType } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet to create the reservation for."', args=[d.arg(name='subnetId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withReservationType':: d.fn(help='"The type of reservation to create. Valid values: explicit, prefix"', args=[d.arg(name='reservationType', type=d.T.string)]),
      withReservationType(reservationType): { spec+: { initProvider+: { reservationType: reservationType } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet to create the reservation for."', args=[d.arg(name='subnetId', type=d.T.string)]),
