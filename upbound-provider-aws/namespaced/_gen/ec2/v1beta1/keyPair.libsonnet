{
  ...
  '#':: d.pkg(name='keyPair', url='', help='"KeyPair is the Schema for the KeyPairs API. Provides a Key Pair resource. Currently this supports importing an existing key pair but not creating a new key pair."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withPublicKey':: d.fn(help='"The public key material."', args=[d.arg(name='publicKey', type=d.T.string)]),
