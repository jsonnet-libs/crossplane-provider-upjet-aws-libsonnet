{
  ...
  '#':: d.pkg(name='carrierGateway', url='', help='"CarrierGateway is the Schema for the CarrierGateways API. Manages an EC2 Carrier Gateway."'),
  ...
  '#new':: d.fn(help='new returns an instance of CarrierGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ec2.aws.m.upbound.io/v1beta1',
    kind: 'CarrierGateway',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CarrierGatewaySpec defines the desired state of CarrierGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withVpcId':: d.fn(help='"The ID of the VPC to associate with the carrier gateway."', args=[d.arg(name='vpcId', type=d.T.string)]),
