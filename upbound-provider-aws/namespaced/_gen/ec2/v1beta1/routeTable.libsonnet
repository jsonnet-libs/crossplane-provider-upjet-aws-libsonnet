{
  ...
  '#':: d.pkg(name='routeTable', url='', help='"RouteTable is the Schema for the RouteTables API. Provides a resource to create a VPC routing table."'),
  ...
  '#spec':: d.obj(help='"RouteTableSpec defines the desired state of RouteTable"'),
  spec: {
