{
  ...
  '#':: d.pkg(name='instanceState', url='', help='"InstanceState is the Schema for the InstanceStates API. Provides an EC2 instance state resource. This allows managing an instance power state."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withForce':: d.fn(help='"Whether to request a forced stop when state is stopped. Otherwise (i.e., state is running), ignored. When an instance is forced to stop, it does not flush file system caches or file system metadata, and you must subsequently perform file system check and repair. Not recommended for Windows instances. Defaults to false."', args=[d.arg(name='force', type=d.T.boolean)]),
      withForce(force): { spec+: { forProvider+: { force: force } } },
      '#withInstanceId':: d.fn(help='"ID of the instance."', args=[d.arg(name='instanceId', type=d.T.string)]),
      ...
      '#withState':: d.fn(help='"- State of the instance. Valid values are stopped, running."', args=[d.arg(name='state', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withForce':: d.fn(help='"Whether to request a forced stop when state is stopped. Otherwise (i.e., state is running), ignored. When an instance is forced to stop, it does not flush file system caches or file system metadata, and you must subsequently perform file system check and repair. Not recommended for Windows instances. Defaults to false."', args=[d.arg(name='force', type=d.T.boolean)]),
      withForce(force): { spec+: { initProvider+: { force: force } } },
      '#withInstanceId':: d.fn(help='"ID of the instance."', args=[d.arg(name='instanceId', type=d.T.string)]),
