{
  ...
  '#':: d.pkg(name='subnetGroup', url='', help='"SubnetGroup is the Schema for the SubnetGroups API. Provides an ElastiCache Subnet Group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description for the cache subnet group."', args=[d.arg(name='description', type=d.T.string)]),
