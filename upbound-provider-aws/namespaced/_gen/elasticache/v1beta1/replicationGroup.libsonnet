{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#globalReplicationGroupIdRef':: d.obj(help='"Reference to a GlobalReplicationGroup in elasticache to populate globalReplicationGroupId."'),
      globalReplicationGroupIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { globalReplicationGroupIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { globalReplicationGroupIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { globalReplicationGroupIdRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { globalReplicationGroupIdRef+: { namespace: namespace } } } },
      },
      '#globalReplicationGroupIdSelector':: d.obj(help='"Selector for a GlobalReplicationGroup in elasticache to populate globalReplicationGroupId."'),
      globalReplicationGroupIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { globalReplicationGroupIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { globalReplicationGroupIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { globalReplicationGroupIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { globalReplicationGroupIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { globalReplicationGroupIdSelector+: { matchLabels+: matchLabels } } } },
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { globalReplicationGroupIdSelector+: { namespace: namespace } } } },
      },
      ...
      '#logDeliveryConfiguration':: d.obj(help='"Specifies the destination and format of Redis OSS/Valkey SLOWLOG or Redis OSS/Valkey Engine Log. See the documentation on Amazon ElastiCache. See Log Delivery Configuration below for more details."'),
      ...
      '#subnetGroupNameRef':: d.obj(help='"Reference to a SubnetGroup in elasticache to populate subnetGroupName."'),
      subnetGroupNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
        ...
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { subnetGroupNameRef+: { namespace: namespace } } } },
      },
      '#subnetGroupNameSelector':: d.obj(help='"Selector for a SubnetGroup in elasticache to populate subnetGroupName."'),
      subnetGroupNameSelector: {
        ...
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { subnetGroupNameSelector+: { namespace: namespace } } } },
      },
      ...
      '#withAtRestEncryptionEnabled':: d.fn(help='"Whether to enable encryption at rest.\\nWhen engine is redis, default is false.\\nWhen engine is valkey, default is true."', args=[d.arg(name='atRestEncryptionEnabled', type=d.T.string)]),
      withAtRestEncryptionEnabled(atRestEncryptionEnabled): { spec+: { forProvider+: { atRestEncryptionEnabled: atRestEncryptionEnabled } } },
      '#withAuthTokenUpdateStrategy':: d.fn(help='"Strategy to use when updating the auth_token. Valid values are SET, ROTATE, and DELETE. Required if auth_token is set."', args=[d.arg(name='authTokenUpdateStrategy', type=d.T.string)]),
      withAuthTokenUpdateStrategy(authTokenUpdateStrategy): { spec+: { forProvider+: { authTokenUpdateStrategy: authTokenUpdateStrategy } } },
      '#withAutoGenerateAuthToken':: d.fn(help='"Password used to access a password protected server. Can be specified only if transit_encryption_enabled = true.\\nIf true, the auth token will be auto-generated and stored in the Secret referenced by the authTokenSecretRef field."', args=[d.arg(name='autoGenerateAuthToken', type=d.T.boolean)]),
      withAutoGenerateAuthToken(autoGenerateAuthToken): { spec+: { forProvider+: { autoGenerateAuthToken: autoGenerateAuthToken } } },
      '#withAutoMinorVersionUpgrade':: d.fn(help='"Specifies whether minor version engine upgrades will be applied automatically to the underlying Cache Cluster instances during the maintenance window.\\nOnly supported for engine types \\"redis\\" and \\"valkey\\" and if the engine version is 6 or higher.\\nDefaults to true."', args=[d.arg(name='autoMinorVersionUpgrade', type=d.T.string)]),
      ...
      '#withClusterMode':: d.fn(help='"Specifies whether cluster mode is enabled or disabled. Valid values are enabled or disabled or compatible"', args=[d.arg(name='clusterMode', type=d.T.string)]),
      withClusterMode(clusterMode): { spec+: { forProvider+: { clusterMode: clusterMode } } },
      ...
      '#withDescription':: d.fn(help='"User-created description for the replication group. Must not be empty."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEngine':: d.fn(help='"Name of the cache engine to be used for the clusters in this replication group.\\nValid values are redis or valkey.\\nDefault is redis."', args=[d.arg(name='engine', type=d.T.string)]),
      withEngine(engine): { spec+: { forProvider+: { engine: engine } } },
      '#withEngineVersion':: d.fn(help='"Version number of the cache engine to be used for the cache clusters in this replication group.\\nIf the version is 7 or higher, the major and minor version should be set, e.g., 7.2.\\nIf the version is 6, the major and minor version can be set, e.g., 6.2,\\nor the minor version can be unspecified which will use the latest version at creation time, e.g., 6.x.\\nOtherwise, specify the full version desired, e.g., 5.0.6.\\nThe actual engine version used is returned in the attribute engine_version_actual, see Attribute Reference below."', args=[d.arg(name='engineVersion', type=d.T.string)]),
      ...
      '#withGlobalReplicationGroupId':: d.fn(help='"The ID of the global replication group to which this replication group should belong. If this parameter is specified, the replication group is added to the specified global replication group as a secondary replication group; otherwise, the replication group is not part of any global replication group. If global_replication_group_id is set, the num_node_groups parameter cannot be set."', args=[d.arg(name='globalReplicationGroupId', type=d.T.string)]),
      withGlobalReplicationGroupId(globalReplicationGroupId): { spec+: { forProvider+: { globalReplicationGroupId: globalReplicationGroupId } } },
      '#withIpDiscovery':: d.fn(help='"The IP version to advertise in the discovery protocol. Valid values are ipv4 or ipv6."', args=[d.arg(name='ipDiscovery', type=d.T.string)]),
      withIpDiscovery(ipDiscovery): { spec+: { forProvider+: { ipDiscovery: ipDiscovery } } },
      ...
      '#withLogDeliveryConfiguration':: d.fn(help='"Specifies the destination and format of Redis OSS/Valkey SLOWLOG or Redis OSS/Valkey Engine Log. See the documentation on Amazon ElastiCache. See Log Delivery Configuration below for more details."', args=[d.arg(name='logDeliveryConfiguration', type=d.T.array)]),
      ...
      '#withLogDeliveryConfigurationMixin':: d.fn(help='"Specifies the destination and format of Redis OSS/Valkey SLOWLOG or Redis OSS/Valkey Engine Log. See the documentation on Amazon ElastiCache. See Log Delivery Configuration below for more details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='logDeliveryConfiguration', type=d.T.array)]),
      ...
      '#withMaintenanceWindow':: d.fn(help='"Specifies the weekly time range for when maintenance on the cache cluster is performed. The format is ddd:hh24:mi-ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: sun:05:00-sun:09:00"', args=[d.arg(name='maintenanceWindow', type=d.T.string)]),
      withMaintenanceWindow(maintenanceWindow): { spec+: { forProvider+: { maintenanceWindow: maintenanceWindow } } },
      '#withMultiAzEnabled':: d.fn(help='"Specifies whether to enable Multi-AZ Support for the replication group.\\nIf true, automatic_failover_enabled must also be enabled.\\nDefaults to false."', args=[d.arg(name='multiAzEnabled', type=d.T.boolean)]),
      withMultiAzEnabled(multiAzEnabled): { spec+: { forProvider+: { multiAzEnabled: multiAzEnabled } } },
      '#withNetworkType':: d.fn(help='"The IP versions for cache cluster connections. Valid values are ipv4, ipv6 or dual_stack."', args=[d.arg(name='networkType', type=d.T.string)]),
      withNetworkType(networkType): { spec+: { forProvider+: { networkType: networkType } } },
      '#withNodeType':: d.fn(help='"Instance class to be used.\\nSee AWS documentation for information on supported node types and guidance on selecting node types.\\nRequired unless global_replication_group_id is set.\\nCannot be set if global_replication_group_id is set."', args=[d.arg(name='nodeType', type=d.T.string)]),
      withNodeType(nodeType): { spec+: { forProvider+: { nodeType: nodeType } } },
      '#withNotificationTopicArn':: d.fn(help='"ARN of an SNS topic to send ElastiCache notifications to. Example: arn:aws:sns:us-east-1:012345678999:my_sns_topic"', args=[d.arg(name='notificationTopicArn', type=d.T.string)]),
      ...
      '#withNumNodeGroups':: d.fn(help='"Number of node groups (shards) for this Redis replication group.\\nChanging this number will trigger a resizing operation before other settings modifications.\\nConflicts with num_cache_clusters."', args=[d.arg(name='numNodeGroups', type=d.T.number)]),
      ...
      '#withReplicasPerNodeGroup':: d.fn(help='"Number of replica nodes in each node group.\\nChanging this number will trigger a resizing operation before other settings modifications.\\nValid values are 0 to 5.\\nConflicts with num_cache_clusters.\\nCan only be set if num_node_groups is set."', args=[d.arg(name='replicasPerNodeGroup', type=d.T.number)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"IDs of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSecurityGroupIdsMixin':: d.fn(help='"IDs of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSecurityGroupNames':: d.fn(help='"Names of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud."', args=[d.arg(name='securityGroupNames', type=d.T.array)]),
      ...
      '#withSecurityGroupNamesMixin':: d.fn(help='"Names of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupNames', type=d.T.array)]),
      ...
      '#withTransitEncryptionEnabled':: d.fn(help='"Whether to enable encryption in transit.\\nChanging this argument with an engine_version < 7.0.5 will force a replacement.\\nEngine versions prior to 7.0.5 only allow this transit encryption to be configured during creation of the replication group."', args=[d.arg(name='transitEncryptionEnabled', type=d.T.boolean)]),
      withTransitEncryptionEnabled(transitEncryptionEnabled): { spec+: { forProvider+: { transitEncryptionEnabled: transitEncryptionEnabled } } },
      '#withTransitEncryptionMode':: d.fn(help='"A setting that enables clients to migrate to in-transit encryption with no downtime.\\nValid values are preferred and required.\\nWhen enabling encryption on an existing replication group, this must first be set to preferred before setting it to required in a subsequent apply.\\nSee the TransitEncryptionMode field in the CreateReplicationGroup API documentation for additional details."', args=[d.arg(name='transitEncryptionMode', type=d.T.string)]),
    ...
    initProvider: {
      ...
      authTokenSecretRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { authTokenSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { authTokenSecretRef+: { name: name } } } },
      },
      '#globalReplicationGroupIdRef':: d.obj(help='"Reference to a GlobalReplicationGroup in elasticache to populate globalReplicationGroupId."'),
      globalReplicationGroupIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { globalReplicationGroupIdRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { globalReplicationGroupIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { globalReplicationGroupIdRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { globalReplicationGroupIdRef+: { namespace: namespace } } } },
      },
      '#globalReplicationGroupIdSelector':: d.obj(help='"Selector for a GlobalReplicationGroup in elasticache to populate globalReplicationGroupId."'),
      globalReplicationGroupIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { globalReplicationGroupIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { globalReplicationGroupIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { globalReplicationGroupIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { globalReplicationGroupIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { globalReplicationGroupIdSelector+: { matchLabels+: matchLabels } } } },
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { globalReplicationGroupIdSelector+: { namespace: namespace } } } },
      },
      '#kmsKeyIdRef':: d.obj(help='"Reference to a Key in kms to populate kmsKeyId."'),
      kmsKeyIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
      ...
      subnetGroupNameRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { subnetGroupNameRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { subnetGroupNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { subnetGroupNameRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { subnetGroupNameRef+: { namespace: namespace } } } },
      },
      '#subnetGroupNameSelector':: d.obj(help='"Selector for a SubnetGroup in elasticache to populate subnetGroupName."'),
      subnetGroupNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { subnetGroupNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { subnetGroupNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { subnetGroupNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { subnetGroupNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { subnetGroupNameSelector+: { matchLabels+: matchLabels } } } },
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { subnetGroupNameSelector+: { namespace: namespace } } } },
      },
      '#withApplyImmediately':: d.fn(help='"Specifies whether any modifications are applied immediately, or during the next maintenance window. Default is false."', args=[d.arg(name='applyImmediately', type=d.T.boolean)]),
      withApplyImmediately(applyImmediately): { spec+: { initProvider+: { applyImmediately: applyImmediately } } },
      '#withAtRestEncryptionEnabled':: d.fn(help='"Whether to enable encryption at rest.\\nWhen engine is redis, default is false.\\nWhen engine is valkey, default is true."', args=[d.arg(name='atRestEncryptionEnabled', type=d.T.string)]),
      withAtRestEncryptionEnabled(atRestEncryptionEnabled): { spec+: { initProvider+: { atRestEncryptionEnabled: atRestEncryptionEnabled } } },
      '#withAuthTokenUpdateStrategy':: d.fn(help='"Strategy to use when updating the auth_token. Valid values are SET, ROTATE, and DELETE. Required if auth_token is set."', args=[d.arg(name='authTokenUpdateStrategy', type=d.T.string)]),
      withAuthTokenUpdateStrategy(authTokenUpdateStrategy): { spec+: { initProvider+: { authTokenUpdateStrategy: authTokenUpdateStrategy } } },
      '#withAutoMinorVersionUpgrade':: d.fn(help='"Specifies whether minor version engine upgrades will be applied automatically to the underlying Cache Cluster instances during the maintenance window.\\nOnly supported for engine types \\"redis\\" and \\"valkey\\" and if the engine version is 6 or higher.\\nDefaults to true."', args=[d.arg(name='autoMinorVersionUpgrade', type=d.T.string)]),
      ...
      '#withClusterMode':: d.fn(help='"Specifies whether cluster mode is enabled or disabled. Valid values are enabled or disabled or compatible"', args=[d.arg(name='clusterMode', type=d.T.string)]),
      withClusterMode(clusterMode): { spec+: { initProvider+: { clusterMode: clusterMode } } },
      '#withDataTieringEnabled':: d.fn(help='"Enables data tiering. Data tiering is only supported for replication groups using the r6gd node type. This parameter must be set to true when using r6gd nodes."', args=[d.arg(name='dataTieringEnabled', type=d.T.boolean)]),
      withDataTieringEnabled(dataTieringEnabled): { spec+: { initProvider+: { dataTieringEnabled: dataTieringEnabled } } },
      '#withDescription':: d.fn(help='"User-created description for the replication group. Must not be empty."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withGlobalReplicationGroupId':: d.fn(help='"The ID of the global replication group to which this replication group should belong. If this parameter is specified, the replication group is added to the specified global replication group as a secondary replication group; otherwise, the replication group is not part of any global replication group. If global_replication_group_id is set, the num_node_groups parameter cannot be set."', args=[d.arg(name='globalReplicationGroupId', type=d.T.string)]),
      withGlobalReplicationGroupId(globalReplicationGroupId): { spec+: { initProvider+: { globalReplicationGroupId: globalReplicationGroupId } } },
      '#withIpDiscovery':: d.fn(help='"The IP version to advertise in the discovery protocol. Valid values are ipv4 or ipv6."', args=[d.arg(name='ipDiscovery', type=d.T.string)]),
      withIpDiscovery(ipDiscovery): { spec+: { initProvider+: { ipDiscovery: ipDiscovery } } },
      '#withKmsKeyId':: d.fn(help='"The ARN of the key that you wish to use if encrypting at rest. If not supplied, uses service managed encryption. Can be specified only if at_rest_encryption_enabled = true."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { initProvider+: { kmsKeyId: kmsKeyId } } },
      '#withLogDeliveryConfiguration':: d.fn(help='"Specifies the destination and format of Redis OSS/Valkey SLOWLOG or Redis OSS/Valkey Engine Log. See the documentation on Amazon ElastiCache. See Log Delivery Configuration below for more details."', args=[d.arg(name='logDeliveryConfiguration', type=d.T.array)]),
      withLogDeliveryConfiguration(logDeliveryConfiguration): { spec+: { initProvider+: { logDeliveryConfiguration: if std.isArray(v=logDeliveryConfiguration) then logDeliveryConfiguration else [logDeliveryConfiguration] } } },
      '#withLogDeliveryConfigurationMixin':: d.fn(help='"Specifies the destination and format of Redis OSS/Valkey SLOWLOG or Redis OSS/Valkey Engine Log. See the documentation on Amazon ElastiCache. See Log Delivery Configuration below for more details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='logDeliveryConfiguration', type=d.T.array)]),
      withLogDeliveryConfigurationMixin(logDeliveryConfiguration): { spec+: { initProvider+: { logDeliveryConfiguration+: if std.isArray(v=logDeliveryConfiguration) then logDeliveryConfiguration else [logDeliveryConfiguration] } } },
      '#withMaintenanceWindow':: d.fn(help='"Specifies the weekly time range for when maintenance on the cache cluster is performed. The format is ddd:hh24:mi-ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: sun:05:00-sun:09:00"', args=[d.arg(name='maintenanceWindow', type=d.T.string)]),
      withMaintenanceWindow(maintenanceWindow): { spec+: { initProvider+: { maintenanceWindow: maintenanceWindow } } },
      '#withMultiAzEnabled':: d.fn(help='"Specifies whether to enable Multi-AZ Support for the replication group.\\nIf true, automatic_failover_enabled must also be enabled.\\nDefaults to false."', args=[d.arg(name='multiAzEnabled', type=d.T.boolean)]),
      withMultiAzEnabled(multiAzEnabled): { spec+: { initProvider+: { multiAzEnabled: multiAzEnabled } } },
      '#withNetworkType':: d.fn(help='"The IP versions for cache cluster connections. Valid values are ipv4, ipv6 or dual_stack."', args=[d.arg(name='networkType', type=d.T.string)]),
      ...
      '#withNotificationTopicArn':: d.fn(help='"ARN of an SNS topic to send ElastiCache notifications to. Example: arn:aws:sns:us-east-1:012345678999:my_sns_topic"', args=[d.arg(name='notificationTopicArn', type=d.T.string)]),
      withNotificationTopicArn(notificationTopicArn): { spec+: { initProvider+: { notificationTopicArn: notificationTopicArn } } },
      '#withNumCacheClusters':: d.fn(help='"00#."', args=[d.arg(name='numCacheClusters', type=d.T.number)]),
      withNumCacheClusters(numCacheClusters): { spec+: { initProvider+: { numCacheClusters: numCacheClusters } } },
      '#withNumNodeGroups':: d.fn(help='"Number of node groups (shards) for this Redis replication group.\\nChanging this number will trigger a resizing operation before other settings modifications.\\nConflicts with num_cache_clusters."', args=[d.arg(name='numNodeGroups', type=d.T.number)]),
      ...
      '#withPreferredCacheClusterAzs':: d.fn(help="\"List of EC2 availability zones in which the replication group's cache clusters will be created. The order of the availability zones in the list is considered. The first item in the list will be the primary node. Ignored when updating.\"", args=[d.arg(name='preferredCacheClusterAzs', type=d.T.array)]),
      withPreferredCacheClusterAzs(preferredCacheClusterAzs): { spec+: { initProvider+: { preferredCacheClusterAzs: if std.isArray(v=preferredCacheClusterAzs) then preferredCacheClusterAzs else [preferredCacheClusterAzs] } } },
      '#withPreferredCacheClusterAzsMixin':: d.fn(help="\"List of EC2 availability zones in which the replication group's cache clusters will be created. The order of the availability zones in the list is considered. The first item in the list will be the primary node. Ignored when updating.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='preferredCacheClusterAzs', type=d.T.array)]),
      withPreferredCacheClusterAzsMixin(preferredCacheClusterAzs): { spec+: { initProvider+: { preferredCacheClusterAzs+: if std.isArray(v=preferredCacheClusterAzs) then preferredCacheClusterAzs else [preferredCacheClusterAzs] } } },
      '#withReplicasPerNodeGroup':: d.fn(help='"Number of replica nodes in each node group.\\nChanging this number will trigger a resizing operation before other settings modifications.\\nValid values are 0 to 5.\\nConflicts with num_cache_clusters.\\nCan only be set if num_node_groups is set."', args=[d.arg(name='replicasPerNodeGroup', type=d.T.number)]),
      withReplicasPerNodeGroup(replicasPerNodeGroup): { spec+: { initProvider+: { replicasPerNodeGroup: replicasPerNodeGroup } } },
      '#withSecurityGroupIdRefs':: d.fn(help='"References to SecurityGroup in ec2 to populate securityGroupIds."', args=[d.arg(name='securityGroupIdRefs', type=d.T.array)]),
      ...
      '#withSnapshotArns':: d.fn(help='"List of ARNs that identify Redis RDB snapshot files stored in Amazon S3. The names object names cannot contain any commas."', args=[d.arg(name='snapshotArns', type=d.T.array)]),
      withSnapshotArns(snapshotArns): { spec+: { initProvider+: { snapshotArns: if std.isArray(v=snapshotArns) then snapshotArns else [snapshotArns] } } },
      '#withSnapshotArnsMixin':: d.fn(help='"List of ARNs that identify Redis RDB snapshot files stored in Amazon S3. The names object names cannot contain any commas."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='snapshotArns', type=d.T.array)]),
      withSnapshotArnsMixin(snapshotArns): { spec+: { initProvider+: { snapshotArns+: if std.isArray(v=snapshotArns) then snapshotArns else [snapshotArns] } } },
      '#withSnapshotName':: d.fn(help='"Name of a snapshot from which to restore data into the new node group. Changing the snapshot_name forces a new resource."', args=[d.arg(name='snapshotName', type=d.T.string)]),
      withSnapshotName(snapshotName): { spec+: { initProvider+: { snapshotName: snapshotName } } },
      '#withSnapshotRetentionLimit':: d.fn(help='"Number of days for which ElastiCache will retain automatic cache cluster snapshots before deleting them. For example, if you set SnapshotRetentionLimit to 5, then a snapshot that was taken today will be retained for 5 days before being deleted. If the value of snapshot_retention_limit is set to zero (0), backups are turned off. Please note that setting a snapshot_retention_limit is not supported on cache.t1.micro cache nodes"', args=[d.arg(name='snapshotRetentionLimit', type=d.T.number)]),
      withSnapshotRetentionLimit(snapshotRetentionLimit): { spec+: { initProvider+: { snapshotRetentionLimit: snapshotRetentionLimit } } },
      '#withSnapshotWindow':: d.fn(help='"Daily time range (in UTC) during which ElastiCache will begin taking a daily snapshot of your cache cluster. The minimum snapshot window is a 60 minute period. Example: 05:00-09:00"', args=[d.arg(name='snapshotWindow', type=d.T.string)]),
      withSnapshotWindow(snapshotWindow): { spec+: { initProvider+: { snapshotWindow: snapshotWindow } } },
      '#withSubnetGroupName':: d.fn(help='"Name of the cache subnet group to be used for the replication group."', args=[d.arg(name='subnetGroupName', type=d.T.string)]),
      withSubnetGroupName(subnetGroupName): { spec+: { initProvider+: { subnetGroupName: subnetGroupName } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Key-value map of resource tags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withTransitEncryptionEnabled':: d.fn(help='"Whether to enable encryption in transit.\\nChanging this argument with an engine_version < 7.0.5 will force a replacement.\\nEngine versions prior to 7.0.5 only allow this transit encryption to be configured during creation of the replication group."', args=[d.arg(name='transitEncryptionEnabled', type=d.T.boolean)]),
      withTransitEncryptionEnabled(transitEncryptionEnabled): { spec+: { initProvider+: { transitEncryptionEnabled: transitEncryptionEnabled } } },
      '#withTransitEncryptionMode':: d.fn(help='"A setting that enables clients to migrate to in-transit encryption with no downtime.\\nValid values are preferred and required.\\nWhen enabling encryption on an existing replication group, this must first be set to preferred before setting it to required in a subsequent apply.\\nSee the TransitEncryptionMode field in the CreateReplicationGroup API documentation for additional details."', args=[d.arg(name='transitEncryptionMode', type=d.T.string)]),
      withTransitEncryptionMode(transitEncryptionMode): { spec+: { initProvider+: { transitEncryptionMode: transitEncryptionMode } } },
      '#withUserGroupIds':: d.fn(help='"User Group ID to associate with the replication group. Only a maximum of one (1) user group ID is valid. NOTE: This argument is a set because the AWS specification allows for multiple IDs. However, in practice, AWS only allows a maximum size of one."', args=[d.arg(name='userGroupIds', type=d.T.array)]),
      withUserGroupIds(userGroupIds): { spec+: { initProvider+: { userGroupIds: if std.isArray(v=userGroupIds) then userGroupIds else [userGroupIds] } } },
      '#withUserGroupIdsMixin':: d.fn(help='"User Group ID to associate with the replication group. Only a maximum of one (1) user group ID is valid. NOTE: This argument is a set because the AWS specification allows for multiple IDs. However, in practice, AWS only allows a maximum size of one."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='userGroupIds', type=d.T.array)]),
      withUserGroupIdsMixin(userGroupIds): { spec+: { initProvider+: { userGroupIds+: if std.isArray(v=userGroupIds) then userGroupIds else [userGroupIds] } } },
    },
