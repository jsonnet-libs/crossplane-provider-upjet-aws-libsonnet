    ...
    forProvider: {
      ...
      clientAuthentication: {
        ...
        sasl: {
          ...
          iam: {
            ...
            withEnabled(enabled): { spec+: { forProvider+: { clientAuthentication+: { sasl+: { iam+: { enabled: enabled } } } } } },
          },
        },
      },
      ...
      vpcConfig: {
        ...
        securityGroupIdSelector: {
          ...
          withNamespace(namespace): { securityGroupIdSelector+: { namespace: namespace } },
        },
    ...
    initProvider: {
      ...
      clientAuthentication: {
        ...
        sasl: {
          ...
          iam: {
            '#withEnabled':: d.fn(help='"Whether SASL/IAM authentication is enabled or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
            withEnabled(enabled): { spec+: { initProvider+: { clientAuthentication+: { sasl+: { iam+: { enabled: enabled } } } } } },
          },
        },
      },
      '#vpcConfig':: d.obj(help='"VPC configuration information. See below."'),
