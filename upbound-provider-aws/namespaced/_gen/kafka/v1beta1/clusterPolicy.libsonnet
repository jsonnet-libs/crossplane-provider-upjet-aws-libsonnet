{
  ...
  '#':: d.pkg(name='clusterPolicy', url='', help='"ClusterPolicy is the Schema for the ClusterPolicys API."'),
  ...
  '#spec':: d.obj(help='"ClusterPolicySpec defines the desired state of ClusterPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withClusterArn':: d.fn(help='"The Amazon Resource Name (ARN) that uniquely identifies the cluster."', args=[d.arg(name='clusterArn', type=d.T.string)]),
      withClusterArn(clusterArn): { spec+: { forProvider+: { clusterArn: clusterArn } } },
      '#withPolicy':: d.fn(help='"Resource policy for cluster."', args=[d.arg(name='policy', type=d.T.string)]),
