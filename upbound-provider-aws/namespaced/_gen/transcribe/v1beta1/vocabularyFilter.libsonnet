{
  ...
  '#':: d.pkg(name='vocabularyFilter', url='', help='"VocabularyFilter is the Schema for the VocabularyFilters API."'),
  ...
  '#new':: d.fn(help='new returns an instance of VocabularyFilter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'transcribe.aws.m.upbound.io/v1beta1',
    kind: 'VocabularyFilter',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VocabularyFilterSpec defines the desired state of VocabularyFilter"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withLanguageCode':: d.fn(help='"The language code you selected for your vocabulary filter. Refer to the supported languages page for accepted codes."', args=[d.arg(name='languageCode', type=d.T.string)]),
      ...
      '#withVocabularyFilterFileUri':: d.fn(help='"The Amazon S3 location (URI) of the text file that contains your custom VocabularyFilter. Conflicts with words argument."', args=[d.arg(name='vocabularyFilterFileUri', type=d.T.string)]),
      withVocabularyFilterFileUri(vocabularyFilterFileUri): { spec+: { forProvider+: { vocabularyFilterFileUri: vocabularyFilterFileUri } } },
      '#withWords':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_filter_file_uri argument."', args=[d.arg(name='words', type=d.T.array)]),
      withWords(words): { spec+: { forProvider+: { words: if std.isArray(v=words) then words else [words] } } },
      '#withWordsMixin':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_filter_file_uri argument."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='words', type=d.T.array)]),
      withWordsMixin(words): { spec+: { forProvider+: { words+: if std.isArray(v=words) then words else [words] } } },
    },
    ...
    initProvider: {
      ...
      '#withVocabularyFilterFileUri':: d.fn(help='"The Amazon S3 location (URI) of the text file that contains your custom VocabularyFilter. Conflicts with words argument."', args=[d.arg(name='vocabularyFilterFileUri', type=d.T.string)]),
      withVocabularyFilterFileUri(vocabularyFilterFileUri): { spec+: { initProvider+: { vocabularyFilterFileUri: vocabularyFilterFileUri } } },
      '#withWords':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_filter_file_uri argument."', args=[d.arg(name='words', type=d.T.array)]),
      withWords(words): { spec+: { initProvider+: { words: if std.isArray(v=words) then words else [words] } } },
      '#withWordsMixin':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_filter_file_uri argument."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='words', type=d.T.array)]),
      withWordsMixin(words): { spec+: { initProvider+: { words+: if std.isArray(v=words) then words else [words] } } },
    },
