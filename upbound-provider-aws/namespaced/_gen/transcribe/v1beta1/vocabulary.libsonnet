{
  ...
  '#':: d.pkg(name='vocabulary', url='', help='"Vocabulary is the Schema for the Vocabularys API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Vocabulary', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'transcribe.aws.m.upbound.io/v1beta1',
    kind: 'Vocabulary',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VocabularySpec defines the desired state of Vocabulary"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withLanguageCode':: d.fn(help='"The language code you selected for your vocabulary."', args=[d.arg(name='languageCode', type=d.T.string)]),
      withLanguageCode(languageCode): { spec+: { forProvider+: { languageCode: languageCode } } },
      '#withPhrases':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_file_uri"', args=[d.arg(name='phrases', type=d.T.array)]),
      withPhrases(phrases): { spec+: { forProvider+: { phrases: if std.isArray(v=phrases) then phrases else [phrases] } } },
      '#withPhrasesMixin':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_file_uri"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='phrases', type=d.T.array)]),
      withPhrasesMixin(phrases): { spec+: { forProvider+: { phrases+: if std.isArray(v=phrases) then phrases else [phrases] } } },
      ...
      '#withVocabularyFileUri':: d.fn(help='"The Amazon S3 location (URI) of the text file that contains your custom vocabulary. Conflicts wth phrases."', args=[d.arg(name='vocabularyFileUri', type=d.T.string)]),
      withVocabularyFileUri(vocabularyFileUri): { spec+: { forProvider+: { vocabularyFileUri: vocabularyFileUri } } },
    },
    ...
    initProvider: {
      ...
      '#withPhrases':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_file_uri"', args=[d.arg(name='phrases', type=d.T.array)]),
      withPhrases(phrases): { spec+: { initProvider+: { phrases: if std.isArray(v=phrases) then phrases else [phrases] } } },
      '#withPhrasesMixin':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_file_uri"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='phrases', type=d.T.array)]),
      withPhrasesMixin(phrases): { spec+: { initProvider+: { phrases+: if std.isArray(v=phrases) then phrases else [phrases] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Key-value map of resource tags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withVocabularyFileUri':: d.fn(help='"The Amazon S3 location (URI) of the text file that contains your custom vocabulary. Conflicts wth phrases."', args=[d.arg(name='vocabularyFileUri', type=d.T.string)]),
      withVocabularyFileUri(vocabularyFileUri): { spec+: { initProvider+: { vocabularyFileUri: vocabularyFileUri } } },
    },
