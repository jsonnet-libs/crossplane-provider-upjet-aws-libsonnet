{
  ...
  '#':: d.pkg(name='parameterGroup', url='', help='"ParameterGroup is the Schema for the ParameterGroups API. Manages a Neptune Parameter Group"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      parameter: {
        '#withApplyMethod':: d.fn(help='"The apply method of the Neptune parameter. Valid values are immediate and pending-reboot. Defaults to pending-reboot."', args=[d.arg(name='applyMethod', type=d.T.string)]),
        withApplyMethod(applyMethod): { applyMethod: applyMethod },
        '#withName':: d.fn(help='"The name of the Neptune parameter group."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"The value of the Neptune parameter."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withDescription':: d.fn(help='"The description of the Neptune parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFamily':: d.fn(help='"The family of the Neptune parameter group."', args=[d.arg(name='family', type=d.T.string)]),
