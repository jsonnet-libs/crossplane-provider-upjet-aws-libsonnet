{
  ...
  '#':: d.pkg(name='subnetGroup', url='', help='"SubnetGroup is the Schema for the SubnetGroups API. Provides an Neptune subnet group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the neptune subnet group."', args=[d.arg(name='description', type=d.T.string)]),
