{
  ...
  '#':: d.pkg(name='clusterSnapshot', url='', help='"ClusterSnapshot is the Schema for the ClusterSnapshots API. Manages a Neptune database cluster snapshot."'),
  ...
  spec: {
    ...
    forProvider: {
      '#dbClusterIdentifierRef':: d.obj(help='"Reference to a Cluster in neptune to populate dbClusterIdentifier."'),
      ...
      '#dbClusterIdentifierSelector':: d.obj(help='"Selector for a Cluster in neptune to populate dbClusterIdentifier."'),
