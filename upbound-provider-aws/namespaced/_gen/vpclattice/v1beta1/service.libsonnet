{
  ...
  spec: {
    ...
    forProvider: {
      '#withAuthType':: d.fn(help='"Type of IAM policy. Either NONE or AWS_IAM."', args=[d.arg(name='authType', type=d.T.string)]),
      withAuthType(authType): { spec+: { forProvider+: { authType: authType } } },
      '#withCertificateArn':: d.fn(help='"Amazon Resource Name (ARN) of the certificate."', args=[d.arg(name='certificateArn', type=d.T.string)]),
      withCertificateArn(certificateArn): { spec+: { forProvider+: { certificateArn: certificateArn } } },
      '#withCustomDomainName':: d.fn(help='"Custom domain name of the service."', args=[d.arg(name='customDomainName', type=d.T.string)]),
      withCustomDomainName(customDomainName): { spec+: { forProvider+: { customDomainName: customDomainName } } },
      '#withName':: d.fn(help="\"Name of the service. The name must be unique within the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.Must be between 3 and 40 characters in length.\"", args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      '#withAuthType':: d.fn(help='"Type of IAM policy. Either NONE or AWS_IAM."', args=[d.arg(name='authType', type=d.T.string)]),
      withAuthType(authType): { spec+: { initProvider+: { authType: authType } } },
      '#withCertificateArn':: d.fn(help='"Amazon Resource Name (ARN) of the certificate."', args=[d.arg(name='certificateArn', type=d.T.string)]),
      withCertificateArn(certificateArn): { spec+: { initProvider+: { certificateArn: certificateArn } } },
      '#withCustomDomainName':: d.fn(help='"Custom domain name of the service."', args=[d.arg(name='customDomainName', type=d.T.string)]),
      withCustomDomainName(customDomainName): { spec+: { initProvider+: { customDomainName: customDomainName } } },
      '#withName':: d.fn(help="\"Name of the service. The name must be unique within the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.Must be between 3 and 40 characters in length.\"", args=[d.arg(name='name', type=d.T.string)]),
