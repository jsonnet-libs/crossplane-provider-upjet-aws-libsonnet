{
  ...
  '#':: d.pkg(name='serviceNetwork', url='', help='"ServiceNetwork is the Schema for the ServiceNetworks API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceNetwork', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'vpclattice.aws.m.upbound.io/v1beta1',
    kind: 'ServiceNetwork',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ServiceNetworkSpec defines the desired state of ServiceNetwork"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Name of the service network"', args=[d.arg(name='name', type=d.T.string)]),
