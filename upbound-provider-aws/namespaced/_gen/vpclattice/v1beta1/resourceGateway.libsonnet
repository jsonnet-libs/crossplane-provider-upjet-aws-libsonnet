{
  ...
  '#':: d.pkg(name='resourceGateway', url='', help='"ResourceGateway is the Schema for the ResourceGateways API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'vpclattice.aws.m.upbound.io/v1beta1',
    kind: 'ResourceGateway',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ResourceGatewaySpec defines the desired state of ResourceGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIpAddressType':: d.fn(help='"IP address type used by the resource gateway. Valid values are IPV4, IPV6, and DUALSTACK. The IP address type of a resource gateway must be compatible with the subnets of the resource gateway and the IP address type of the resource."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
      withIpAddressType(ipAddressType): { spec+: { forProvider+: { ipAddressType: ipAddressType } } },
      '#withName':: d.fn(help='"Name of the resource gateway."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"Security group IDs associated with the resource gateway. The security groups must be in the same VPC."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSecurityGroupIdsMixin':: d.fn(help='"Security group IDs associated with the resource gateway. The security groups must be in the same VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSubnetIds':: d.fn(help='"IDs of the VPC subnets in which to create the resource gateway."', args=[d.arg(name='subnetIds', type=d.T.array)]),
      withSubnetIds(subnetIds): { spec+: { forProvider+: { subnetIds: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] } } },
      '#withSubnetIdsMixin':: d.fn(help='"IDs of the VPC subnets in which to create the resource gateway."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetIds', type=d.T.array)]),
      ...
      '#withVpcId':: d.fn(help='"ID of the VPC for the resource gateway."', args=[d.arg(name='vpcId', type=d.T.string)]),
