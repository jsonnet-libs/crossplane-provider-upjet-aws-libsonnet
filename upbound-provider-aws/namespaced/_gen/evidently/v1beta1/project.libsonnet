{
  ...
  new(name): {
    apiVersion: 'evidently.aws.m.upbound.io/v1beta1',
    kind: 'Project',
  ...
  spec: {
    ...
    forProvider: {
      ...
      dataDelivery: {
        ...
        cloudwatchLogs: {
          ...
          withLogGroup(logGroup): { spec+: { forProvider+: { dataDelivery+: { cloudwatchLogs+: { logGroup: logGroup } } } } },
        },
        ...
        s3Destination: {
          ...
          withBucket(bucket): { spec+: { forProvider+: { dataDelivery+: { s3Destination+: { bucket: bucket } } } } },
          ...
          withPrefix(prefix): { spec+: { forProvider+: { dataDelivery+: { s3Destination+: { prefix: prefix } } } } },
        },
      },
    ...
    initProvider: {
      ...
      dataDelivery: {
        ...
        cloudwatchLogs: {
          '#withLogGroup':: d.fn(help='"The name of the log group where the project stores evaluation events."', args=[d.arg(name='logGroup', type=d.T.string)]),
          withLogGroup(logGroup): { spec+: { initProvider+: { dataDelivery+: { cloudwatchLogs+: { logGroup: logGroup } } } } },
        },
        '#s3Destination':: d.obj(help='"A block that defines the S3 bucket and prefix that stores the evaluation events. See below."'),
        s3Destination: {
          '#withBucket':: d.fn(help='"The name of the bucket in which Evidently stores evaluation events."', args=[d.arg(name='bucket', type=d.T.string)]),
          withBucket(bucket): { spec+: { initProvider+: { dataDelivery+: { s3Destination+: { bucket: bucket } } } } },
          '#withPrefix':: d.fn(help='"The bucket prefix in which Evidently stores evaluation events."', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { initProvider+: { dataDelivery+: { s3Destination+: { prefix: prefix } } } } },
        },
      },
      '#withDescription':: d.fn(help='"Specifies the description of the project."', args=[d.arg(name='description', type=d.T.string)]),
