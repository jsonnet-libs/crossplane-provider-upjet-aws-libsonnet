{
  ...
  '#':: d.pkg(name='segment', url='', help='"Segment is the Schema for the Segments API. Provides a CloudWatch Evidently Segment resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Segment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'evidently.aws.m.upbound.io/v1beta1',
    kind: 'Segment',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SegmentSpec defines the desired state of Segment"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"Specifies the description of the segment."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withPattern':: d.fn(help='"The pattern to use for the segment. For more information about pattern syntax, see Segment rule pattern syntax."', args=[d.arg(name='pattern', type=d.T.string)]),
