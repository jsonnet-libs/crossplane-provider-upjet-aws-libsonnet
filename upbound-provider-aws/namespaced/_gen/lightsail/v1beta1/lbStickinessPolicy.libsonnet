{
  ...
  '#':: d.pkg(name='lbStickinessPolicy', url='', help='"LBStickinessPolicy is the Schema for the LBStickinessPolicys API. Manages session stickiness for a Lightsail Load Balancer."'),
  ...
  '#new':: d.fn(help='new returns an instance of LBStickinessPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'lightsail.aws.m.upbound.io/v1beta1',
    kind: 'LBStickinessPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LBStickinessPolicySpec defines the desired state of LBStickinessPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCookieDuration':: d.fn(help='"Cookie duration in seconds. This determines the length of the session stickiness."', args=[d.arg(name='cookieDuration', type=d.T.number)]),
      withCookieDuration(cookieDuration): { spec+: { forProvider+: { cookieDuration: cookieDuration } } },
      '#withEnabled':: d.fn(help='"Whether to enable session stickiness for the load balancer."', args=[d.arg(name='enabled', type=d.T.boolean)]),
    ...
    initProvider: {
      '#withCookieDuration':: d.fn(help='"Cookie duration in seconds. This determines the length of the session stickiness."', args=[d.arg(name='cookieDuration', type=d.T.number)]),
      withCookieDuration(cookieDuration): { spec+: { initProvider+: { cookieDuration: cookieDuration } } },
      '#withEnabled':: d.fn(help='"Whether to enable session stickiness for the load balancer."', args=[d.arg(name='enabled', type=d.T.boolean)]),
