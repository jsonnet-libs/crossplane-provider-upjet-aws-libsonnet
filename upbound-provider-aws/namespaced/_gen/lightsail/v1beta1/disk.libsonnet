{
  ...
  '#':: d.pkg(name='disk', url='', help='"Disk is the Schema for the Disks API. Manages a Lightsail block storage disk."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAvailabilityZone':: d.fn(help='"Availability Zone in which to create the disk."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      ...
      '#withSizeInGb':: d.fn(help='"Size of the disk in GB."', args=[d.arg(name='sizeInGb', type=d.T.number)]),
      withSizeInGb(sizeInGb): { spec+: { forProvider+: { sizeInGb: sizeInGb } } },
    ...
    initProvider: {
      ...
      '#withSizeInGb':: d.fn(help='"Size of the disk in GB."', args=[d.arg(name='sizeInGb', type=d.T.number)]),
      withSizeInGb(sizeInGb): { spec+: { initProvider+: { sizeInGb: sizeInGb } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
