{
  ...
  '#':: d.pkg(name='domain', url='', help='"Domain is the Schema for the Domains API. Manages a Lightsail domain for DNS management."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDomainName':: d.fn(help='"Name of the Lightsail domain to manage."', args=[d.arg(name='domainName', type=d.T.string)]),
