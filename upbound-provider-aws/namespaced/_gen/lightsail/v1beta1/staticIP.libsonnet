{
  ...
  '#':: d.pkg(name='staticIP', url='', help='"StaticIP is the Schema for the StaticIPs API. Manages a Lightsail Static IP."'),
  ...
  '#new':: d.fn(help='new returns an instance of StaticIP', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'lightsail.aws.m.upbound.io/v1beta1',
    kind: 'StaticIP',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"StaticIPSpec defines the desired state of StaticIP"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"Name for the allocated static IP."', args=[d.arg(name='name', type=d.T.string)]),
