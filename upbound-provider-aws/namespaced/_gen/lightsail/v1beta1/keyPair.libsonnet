{
  ...
  '#':: d.pkg(name='keyPair', url='', help='"KeyPair is the Schema for the KeyPairs API. Manages a Lightsail Key Pair."'),
  ...
  '#new':: d.fn(help='new returns an instance of KeyPair', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'lightsail.aws.m.upbound.io/v1beta1',
    kind: 'KeyPair',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"KeyPairSpec defines the desired state of KeyPair"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"Name of the Lightsail Key Pair. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPgpKey':: d.fn(help='"PGP key to encrypt the resulting private key material. Only used when creating a new key pair."', args=[d.arg(name='pgpKey', type=d.T.string)]),
      withPgpKey(pgpKey): { spec+: { forProvider+: { pgpKey: pgpKey } } },
      '#withPublicKey':: d.fn(help='"Public key material. This public key will be imported into Lightsail."', args=[d.arg(name='publicKey', type=d.T.string)]),
