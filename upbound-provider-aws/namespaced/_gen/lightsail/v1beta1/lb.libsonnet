{
  ...
  '#':: d.pkg(name='lb', url='', help='"LB is the Schema for the LBs API. Manages a Lightsail Load Balancer."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withHealthCheckPath':: d.fn(help='"Health check path of the load balancer. Default value /."', args=[d.arg(name='healthCheckPath', type=d.T.string)]),
      withHealthCheckPath(healthCheckPath): { spec+: { forProvider+: { healthCheckPath: healthCheckPath } } },
      '#withInstancePort':: d.fn(help='"Instance port the load balancer will connect to."', args=[d.arg(name='instancePort', type=d.T.number)]),
      withInstancePort(instancePort): { spec+: { forProvider+: { instancePort: instancePort } } },
      '#withIpAddressType':: d.fn(help='"IP address type of the load balancer. Valid values: dualstack, ipv4. Default value dualstack."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
