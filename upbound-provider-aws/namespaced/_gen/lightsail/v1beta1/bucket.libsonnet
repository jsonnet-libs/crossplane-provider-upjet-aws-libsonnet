{
  ...
  '#':: d.pkg(name='bucket', url='', help='"Bucket is the Schema for the Buckets API. Manages a Lightsail object storage bucket."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBundleId':: d.fn(help='"Bundle ID to use for the bucket. A bucket bundle specifies the monthly cost, storage space, and data transfer quota for a bucket. Use the get-bucket-bundles cli command to get a list of bundle IDs that you can specify."', args=[d.arg(name='bundleId', type=d.T.string)]),
      withBundleId(bundleId): { spec+: { forProvider+: { bundleId: bundleId } } },
      '#withForceDelete':: d.fn(help='"AWS by default will not delete a bucket which is not empty, to prevent losing bucket data and affecting other resources in Lightsail. If force_delete is set to true the bucket will be deleted even when not empty."', args=[d.arg(name='forceDelete', type=d.T.boolean)]),
