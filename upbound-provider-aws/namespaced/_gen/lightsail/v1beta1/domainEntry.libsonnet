{
  ...
  '#':: d.pkg(name='domainEntry', url='', help='"DomainEntry is the Schema for the DomainEntrys API. Manages a Lightsail domain entry (DNS record)."'),
  ...
  '#new':: d.fn(help='new returns an instance of DomainEntry', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'lightsail.aws.m.upbound.io/v1beta1',
    kind: 'DomainEntry',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DomainEntrySpec defines the desired state of DomainEntry"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#domainNameRef':: d.obj(help='"Reference to a Domain in lightsail to populate domainName."'),
      domainNameRef: {
      ...
      '#domainNameSelector':: d.obj(help='"Selector for a Domain in lightsail to populate domainName."'),
      domainNameSelector: {
      ...
      '#withDomainName':: d.fn(help='"Name of the Lightsail domain in which to create the entry."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withIsAlias':: d.fn(help='"Whether the entry should be an alias. Default: false."', args=[d.arg(name='isAlias', type=d.T.boolean)]),
      withIsAlias(isAlias): { spec+: { forProvider+: { isAlias: isAlias } } },
      ...
      '#withTarget':: d.fn(help='"Target of the domain entry."', args=[d.arg(name='target', type=d.T.string)]),
      withTarget(target): { spec+: { forProvider+: { target: target } } },
      '#withType':: d.fn(help='"Type of record. Valid values: A, AAAA, CNAME, MX, NS, SOA, SRV, TXT."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      '#withIsAlias':: d.fn(help='"Whether the entry should be an alias. Default: false."', args=[d.arg(name='isAlias', type=d.T.boolean)]),
      withIsAlias(isAlias): { spec+: { initProvider+: { isAlias: isAlias } } },
      '#withTarget':: d.fn(help='"Target of the domain entry."', args=[d.arg(name='target', type=d.T.string)]),
