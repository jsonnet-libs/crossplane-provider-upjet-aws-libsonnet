{
  ...
  '#':: d.pkg(name='vault', url='', help='"Vault is the Schema for the Vaults API. Provides an AWS Backup vault resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withForceDestroy':: d.fn(help='"A boolean that indicates that all recovery points stored in the vault are deleted so that the vault can be destroyed without error."', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
      withForceDestroy(forceDestroy): { spec+: { forProvider+: { forceDestroy: forceDestroy } } },
      '#withKmsKeyArn':: d.fn(help='"The server-side encryption key that is used to protect your backups."', args=[d.arg(name='kmsKeyArn', type=d.T.string)]),
