{
  ...
  '#':: d.pkg(name='globalSettings', url='', help='"GlobalSettings is the Schema for the GlobalSettingss API. Provides an AWS Backup Global Settings resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalSettings', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'backup.aws.m.upbound.io/v1beta1',
    kind: 'GlobalSettings',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GlobalSettingsSpec defines the desired state of GlobalSettings"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withGlobalSettings':: d.fn(help='"A list of resources along with the opt-in preferences for the account."', args=[d.arg(name='globalSettings', type=d.T.object)]),
      withGlobalSettings(globalSettings): { spec+: { forProvider+: { globalSettings: globalSettings } } },
      '#withGlobalSettingsMixin':: d.fn(help='"A list of resources along with the opt-in preferences for the account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='globalSettings', type=d.T.object)]),
      withGlobalSettingsMixin(globalSettings): { spec+: { forProvider+: { globalSettings+: globalSettings } } },
    },
    ...
    initProvider: {
      '#withGlobalSettings':: d.fn(help='"A list of resources along with the opt-in preferences for the account."', args=[d.arg(name='globalSettings', type=d.T.object)]),
      withGlobalSettings(globalSettings): { spec+: { initProvider+: { globalSettings: globalSettings } } },
      '#withGlobalSettingsMixin':: d.fn(help='"A list of resources along with the opt-in preferences for the account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='globalSettings', type=d.T.object)]),
      withGlobalSettingsMixin(globalSettings): { spec+: { initProvider+: { globalSettings+: globalSettings } } },
    },
