{
  ...
  '#':: d.pkg(name='awsConfigurationRecorderStatus', url='', help='"AWSConfigurationRecorderStatus is the Schema for the AWSConfigurationRecorderStatuss API. Manages status of an AWS Config Configuration Recorder."'),
  ...
  '#new':: d.fn(help='new returns an instance of AWSConfigurationRecorderStatus', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'configservice.aws.m.upbound.io/v1beta1',
    kind: 'AWSConfigurationRecorderStatus',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AWSConfigurationRecorderStatusSpec defines the desired state of AWSConfigurationRecorderStatus"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withIsEnabled':: d.fn(help='"Whether the configuration recorder should be enabled or disabled."', args=[d.arg(name='isEnabled', type=d.T.boolean)]),
