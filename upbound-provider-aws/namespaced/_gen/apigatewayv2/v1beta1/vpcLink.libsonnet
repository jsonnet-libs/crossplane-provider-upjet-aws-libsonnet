{
  ...
  '#':: d.pkg(name='vpcLink', url='', help='"VPCLink is the Schema for the VPCLinks API. Manages an Amazon API Gateway Version 2 VPC Link."'),
  ...
  '#new':: d.fn(help='new returns an instance of VPCLink', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Name of the VPC Link. Must be between 1 and 128 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"Security group IDs for the VPC Link."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
