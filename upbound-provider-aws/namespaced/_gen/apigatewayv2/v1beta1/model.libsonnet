{
  ...
  '#':: d.pkg(name='model', url='', help='"Model is the Schema for the Models API. Manages an Amazon API Gateway Version 2 model."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withContentType':: d.fn(help='"The content-type for the model, for example, application/json. Must be between 1 and 256 characters in length."', args=[d.arg(name='contentType', type=d.T.string)]),
      withContentType(contentType): { spec+: { forProvider+: { contentType: contentType } } },
      '#withDescription':: d.fn(help='"Description of the model. Must be between 1 and 128 characters in length."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name of the model. Must be alphanumeric. Must be between 1 and 128 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSchema':: d.fn(help='"Schema for the model. This should be a JSON schema draft 4 model. Must be less than or equal to 32768 characters in length."', args=[d.arg(name='schema', type=d.T.string)]),
