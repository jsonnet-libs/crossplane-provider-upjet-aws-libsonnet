{
  ...
  '#':: d.pkg(name='deployment', url='', help='"Deployment is the Schema for the Deployments API. Manages an Amazon API Gateway Version 2 deployment."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description for the deployment resource. Must be less than or equal to 1024 characters in length."', args=[d.arg(name='description', type=d.T.string)]),
