{
  ...
  spec: {
    ...
    forProvider: {
      '#withAuthorized':: d.fn(help='"If true, channel is private (enabled for playback authorization)."', args=[d.arg(name='authorized', type=d.T.boolean)]),
      withAuthorized(authorized): { spec+: { forProvider+: { authorized: authorized } } },
      '#withLatencyMode':: d.fn(help='"Channel latency mode. Valid values: NORMAL, LOW."', args=[d.arg(name='latencyMode', type=d.T.string)]),
      withLatencyMode(latencyMode): { spec+: { forProvider+: { latencyMode: latencyMode } } },
      '#withName':: d.fn(help='"Channel name."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRecordingConfigurationArn':: d.fn(help='"Recording configuration ARN."', args=[d.arg(name='recordingConfigurationArn', type=d.T.string)]),
      withRecordingConfigurationArn(recordingConfigurationArn): { spec+: { forProvider+: { recordingConfigurationArn: recordingConfigurationArn } } },
      ...
      '#withType':: d.fn(help='"Channel type, which determines the allowable resolution and bitrate. Valid values: STANDARD, BASIC."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      '#withAuthorized':: d.fn(help='"If true, channel is private (enabled for playback authorization)."', args=[d.arg(name='authorized', type=d.T.boolean)]),
      withAuthorized(authorized): { spec+: { initProvider+: { authorized: authorized } } },
      '#withLatencyMode':: d.fn(help='"Channel latency mode. Valid values: NORMAL, LOW."', args=[d.arg(name='latencyMode', type=d.T.string)]),
      withLatencyMode(latencyMode): { spec+: { initProvider+: { latencyMode: latencyMode } } },
      '#withName':: d.fn(help='"Channel name."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withRecordingConfigurationArn':: d.fn(help='"Recording configuration ARN."', args=[d.arg(name='recordingConfigurationArn', type=d.T.string)]),
      withRecordingConfigurationArn(recordingConfigurationArn): { spec+: { initProvider+: { recordingConfigurationArn: recordingConfigurationArn } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
