{
  ...
  '#':: d.pkg(name='actionTarget', url='', help='"ActionTarget is the Schema for the ActionTargets API. Creates Security Hub custom action."'),
  ...
  '#new':: d.fn(help='new returns an instance of ActionTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'securityhub.aws.m.upbound.io/v1beta1',
    kind: 'ActionTarget',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ActionTargetSpec defines the desired state of ActionTarget"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"The name of the custom action target."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The description for the custom action target."', args=[d.arg(name='name', type=d.T.string)]),
