{
  ...
  '#':: d.pkg(name='standardsSubscription', url='', help='"StandardsSubscription is the Schema for the StandardsSubscriptions API. Subscribes to a Security Hub standard."'),
  ...
  '#new':: d.fn(help='new returns an instance of StandardsSubscription', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'securityhub.aws.m.upbound.io/v1beta1',
    kind: 'StandardsSubscription',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"StandardsSubscriptionSpec defines the desired state of StandardsSubscription"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withStandardsArn':: d.fn(help='"The ARN of a standard - see below."', args=[d.arg(name='standardsArn', type=d.T.string)]),
      withStandardsArn(standardsArn): { spec+: { forProvider+: { standardsArn: standardsArn } } },
    },
    ...
    initProvider: {
      '#withStandardsArn':: d.fn(help='"The ARN of a standard - see below."', args=[d.arg(name='standardsArn', type=d.T.string)]),
      withStandardsArn(standardsArn): { spec+: { initProvider+: { standardsArn: standardsArn } } },
    },
