{
  ...
  '#':: d.pkg(name='member', url='', help='"Member is the Schema for the Members API. Provides a Security Hub member resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAccountId':: d.fn(help='"The ID of the member AWS account."', args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withEmail':: d.fn(help='"The email of the member AWS account."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withInvite':: d.fn(help='"Boolean whether to invite the account to Security Hub as a member. Defaults to false."', args=[d.arg(name='invite', type=d.T.boolean)]),
