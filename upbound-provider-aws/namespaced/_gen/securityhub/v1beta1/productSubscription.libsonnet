{
  ...
  '#':: d.pkg(name='productSubscription', url='', help='"ProductSubscription is the Schema for the ProductSubscriptions API. Subscribes to a Security Hub product."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProductSubscription', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'securityhub.aws.m.upbound.io/v1beta1',
    kind: 'ProductSubscription',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ProductSubscriptionSpec defines the desired state of ProductSubscription"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withProductArn':: d.fn(help='"The ARN of the product that generates findings that you want to import into Security Hub - see below."', args=[d.arg(name='productArn', type=d.T.string)]),
      withProductArn(productArn): { spec+: { forProvider+: { productArn: productArn } } },
    ...
    initProvider: {
      '#withProductArn':: d.fn(help='"The ARN of the product that generates findings that you want to import into Security Hub - see below."', args=[d.arg(name='productArn', type=d.T.string)]),
      withProductArn(productArn): { spec+: { initProvider+: { productArn: productArn } } },
    },
