{
  ...
  '#':: d.pkg(name='serviceLinkedRole', url='', help='"ServiceLinkedRole is the Schema for the ServiceLinkedRoles API. Provides an IAM service-linked role."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceLinkedRole', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.aws.m.upbound.io/v1beta1',
    kind: 'ServiceLinkedRole',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ServiceLinkedRoleSpec defines the desired state of ServiceLinkedRole"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAwsServiceName':: d.fn(help='"The AWS service to which this role is attached. You use a string similar to a URL but without the http:// in front. For example: elasticbeanstalk.amazonaws.com. To find the full list of services that support service-linked roles, check the docs."', args=[d.arg(name='awsServiceName', type=d.T.string)]),
      withAwsServiceName(awsServiceName): { spec+: { forProvider+: { awsServiceName: awsServiceName } } },
      '#withCustomSuffix':: d.fn(help='"Additional string appended to the role name. Not all AWS services support custom suffixes."', args=[d.arg(name='customSuffix', type=d.T.string)]),
      withCustomSuffix(customSuffix): { spec+: { forProvider+: { customSuffix: customSuffix } } },
      '#withDescription':: d.fn(help='"The description of the role."', args=[d.arg(name='description', type=d.T.string)]),
    ...
    initProvider: {
      '#withAwsServiceName':: d.fn(help='"The AWS service to which this role is attached. You use a string similar to a URL but without the http:// in front. For example: elasticbeanstalk.amazonaws.com. To find the full list of services that support service-linked roles, check the docs."', args=[d.arg(name='awsServiceName', type=d.T.string)]),
      withAwsServiceName(awsServiceName): { spec+: { initProvider+: { awsServiceName: awsServiceName } } },
      '#withCustomSuffix':: d.fn(help='"Additional string appended to the role name. Not all AWS services support custom suffixes."', args=[d.arg(name='customSuffix', type=d.T.string)]),
      withCustomSuffix(customSuffix): { spec+: { initProvider+: { customSuffix: customSuffix } } },
      '#withDescription':: d.fn(help='"The description of the role."', args=[d.arg(name='description', type=d.T.string)]),
