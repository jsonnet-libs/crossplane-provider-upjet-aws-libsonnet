{
  ...
  '#':: d.pkg(name='virtualMfaDevice', url='', help='"VirtualMfaDevice is the Schema for the VirtualMfaDevices API. Provides an IAM Virtual MFA Device"'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualMfaDevice', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.aws.m.upbound.io/v1beta1',
    kind: 'VirtualMfaDevice',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VirtualMfaDeviceSpec defines the desired state of VirtualMfaDevice"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withPath':: d.fn(help='"The path for the virtual MFA device."', args=[d.arg(name='path', type=d.T.string)]),
      ...
      '#withVirtualMfaDeviceName':: d.fn(help='"The name of the virtual MFA device. Use with path to uniquely identify a virtual MFA device."', args=[d.arg(name='virtualMfaDeviceName', type=d.T.string)]),
      withVirtualMfaDeviceName(virtualMfaDeviceName): { spec+: { forProvider+: { virtualMfaDeviceName: virtualMfaDeviceName } } },
    },
    ...
    initProvider: {
      ...
      '#withVirtualMfaDeviceName':: d.fn(help='"The name of the virtual MFA device. Use with path to uniquely identify a virtual MFA device."', args=[d.arg(name='virtualMfaDeviceName', type=d.T.string)]),
      withVirtualMfaDeviceName(virtualMfaDeviceName): { spec+: { initProvider+: { virtualMfaDeviceName: virtualMfaDeviceName } } },
    },
