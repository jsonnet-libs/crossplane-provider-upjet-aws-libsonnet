{
  ...
  '#':: d.pkg(name='accessKey', url='', help='"AccessKey is the Schema for the AccessKeys API. Provides an IAM access key. This is a set of credentials that allow API requests to be made as an IAM user."'),
  ...
  '#new':: d.fn(help='new returns an instance of AccessKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.aws.m.upbound.io/v1beta1',
    kind: 'AccessKey',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AccessKeySpec defines the desired state of AccessKey"'),
  spec: {
