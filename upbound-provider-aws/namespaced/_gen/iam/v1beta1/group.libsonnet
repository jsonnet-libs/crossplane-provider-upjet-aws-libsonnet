{
  ...
  '#':: d.pkg(name='group', url='', help='"Group is the Schema for the Groups API. Provides an IAM group."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withPath':: d.fn(help='"Path in which to create the group."', args=[d.arg(name='path', type=d.T.string)]),
