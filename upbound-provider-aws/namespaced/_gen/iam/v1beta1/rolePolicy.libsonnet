{
  ...
  '#':: d.pkg(name='rolePolicy', url='', help='"RolePolicy is the Schema for the RolePolicys API. Provides an IAM role policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of RolePolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.aws.m.upbound.io/v1beta1',
    kind: 'RolePolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RolePolicySpec defines the desired state of RolePolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicy':: d.fn(help='"The inline policy document.\\nThis is a JSON formatted string"', args=[d.arg(name='policy', type=d.T.string)]),
      withPolicy(policy): { spec+: { forProvider+: { policy: policy } } },
      '#withRole':: d.fn(help='"The name of the IAM role to attach to the policy."', args=[d.arg(name='role', type=d.T.string)]),
