{
  ...
  '#':: d.pkg(name='samlProvider', url='', help='"SAMLProvider is the Schema for the SAMLProviders API. Provides an IAM SAML provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of SAMLProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.aws.m.upbound.io/v1beta1',
    kind: 'SAMLProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SAMLProviderSpec defines the desired state of SAMLProvider"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withSamlMetadataDocument':: d.fn(help='"An XML document generated by an identity provider that supports SAML 2.0."', args=[d.arg(name='samlMetadataDocument', type=d.T.string)]),
      withSamlMetadataDocument(samlMetadataDocument): { spec+: { forProvider+: { samlMetadataDocument: samlMetadataDocument } } },
    ...
    initProvider: {
      '#withSamlMetadataDocument':: d.fn(help='"An XML document generated by an identity provider that supports SAML 2.0."', args=[d.arg(name='samlMetadataDocument', type=d.T.string)]),
      withSamlMetadataDocument(samlMetadataDocument): { spec+: { initProvider+: { samlMetadataDocument: samlMetadataDocument } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
