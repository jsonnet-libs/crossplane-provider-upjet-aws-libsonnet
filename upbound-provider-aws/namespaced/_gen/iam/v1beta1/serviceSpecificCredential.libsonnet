{
  ...
  '#':: d.pkg(name='serviceSpecificCredential', url='', help='"ServiceSpecificCredential is the Schema for the ServiceSpecificCredentials API. Provides an IAM Service Specific Credential."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceSpecificCredential', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.aws.m.upbound.io/v1beta1',
    kind: 'ServiceSpecificCredential',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ServiceSpecificCredentialSpec defines the desired state of ServiceSpecificCredential"'),
  spec: {
