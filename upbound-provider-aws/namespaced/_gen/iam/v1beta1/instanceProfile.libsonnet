{
  ...
  '#':: d.pkg(name='instanceProfile', url='', help='"InstanceProfile is the Schema for the InstanceProfiles API. Provides an IAM instance profile."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPath':: d.fn(help='"Path to the instance profile. For more information about paths, see IAM Identifiers in the IAM User Guide. Can be a string of characters consisting of either a forward slash (/) by itself or a string that must begin and end with forward slashes. Can include any ASCII character from the ! (\\\\u0021) through the DEL character (\\\\u007F), including most punctuation characters, digits, and upper and lowercase letters."', args=[d.arg(name='path', type=d.T.string)]),
      withPath(path): { spec+: { forProvider+: { path: path } } },
      '#withRole':: d.fn(help='"Name of the role to add to the profile."', args=[d.arg(name='role', type=d.T.string)]),
