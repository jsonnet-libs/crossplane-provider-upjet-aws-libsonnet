{
  ...
  new(name): {
    apiVersion: 'appintegrations.aws.m.upbound.io/v1beta1',
  ...
  spec: {
    ...
    forProvider: {
      ...
      eventFilter: {
        ...
        withSource(source): { spec+: { forProvider+: { eventFilter+: { source: source } } } },
      },
    ...
    initProvider: {
      ...
      eventFilter: {
        '#withSource':: d.fn(help='"Source of the events."', args=[d.arg(name='source', type=d.T.string)]),
        withSource(source): { spec+: { initProvider+: { eventFilter+: { source: source } } } },
      },
      '#withDescription':: d.fn(help='"Description of the Event Integration."', args=[d.arg(name='description', type=d.T.string)]),
