{
  ...
  '#':: d.pkg(name='lifecycleHook', url='', help='"LifecycleHook is the Schema for the LifecycleHooks API. Provides an AutoScaling Lifecycle Hook resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of LifecycleHook', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'autoscaling.aws.m.upbound.io/v1beta1',
    kind: 'LifecycleHook',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LifecycleHookSpec defines the desired state of LifecycleHook"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoscalingGroupName':: d.fn(help='"Name of the Auto Scaling group to which you want to assign the lifecycle hook"', args=[d.arg(name='autoscalingGroupName', type=d.T.string)]),
      withAutoscalingGroupName(autoscalingGroupName): { spec+: { forProvider+: { autoscalingGroupName: autoscalingGroupName } } },
      '#withDefaultResult':: d.fn(help='"Defines the action the Auto Scaling group should take when the lifecycle hook timeout elapses or if an unexpected failure occurs. The value for this parameter can be either CONTINUE or ABANDON. The default value for this parameter is ABANDON."', args=[d.arg(name='defaultResult', type=d.T.string)]),
      withDefaultResult(defaultResult): { spec+: { forProvider+: { defaultResult: defaultResult } } },
      '#withHeartbeatTimeout':: d.fn(help='"Defines the amount of time, in seconds, that can elapse before the lifecycle hook times out. When the lifecycle hook times out, Auto Scaling performs the action defined in the DefaultResult parameter"', args=[d.arg(name='heartbeatTimeout', type=d.T.number)]),
      withHeartbeatTimeout(heartbeatTimeout): { spec+: { forProvider+: { heartbeatTimeout: heartbeatTimeout } } },
      '#withLifecycleTransition':: d.fn(help='"Instance state to which you want to attach the lifecycle hook. For a list of lifecycle hook types, see describe-lifecycle-hook-types"', args=[d.arg(name='lifecycleTransition', type=d.T.string)]),
      withLifecycleTransition(lifecycleTransition): { spec+: { forProvider+: { lifecycleTransition: lifecycleTransition } } },
      '#withNotificationMetadata':: d.fn(help='"Contains additional information that you want to include any time Auto Scaling sends a message to the notification target."', args=[d.arg(name='notificationMetadata', type=d.T.string)]),
      withNotificationMetadata(notificationMetadata): { spec+: { forProvider+: { notificationMetadata: notificationMetadata } } },
      '#withNotificationTargetArn':: d.fn(help='"ARN of the notification target that Auto Scaling will use to notify you when an instance is in the transition state for the lifecycle hook. This ARN target can be either an SQS queue, an SNS topic, or a Lambda function."', args=[d.arg(name='notificationTargetArn', type=d.T.string)]),
      withNotificationTargetArn(notificationTargetArn): { spec+: { forProvider+: { notificationTargetArn: notificationTargetArn } } },
      ...
      '#withRoleArn':: d.fn(help='"ARN of the IAM role that allows the Auto Scaling group to publish to the specified notification target."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDefaultResult':: d.fn(help='"Defines the action the Auto Scaling group should take when the lifecycle hook timeout elapses or if an unexpected failure occurs. The value for this parameter can be either CONTINUE or ABANDON. The default value for this parameter is ABANDON."', args=[d.arg(name='defaultResult', type=d.T.string)]),
      withDefaultResult(defaultResult): { spec+: { initProvider+: { defaultResult: defaultResult } } },
      '#withHeartbeatTimeout':: d.fn(help='"Defines the amount of time, in seconds, that can elapse before the lifecycle hook times out. When the lifecycle hook times out, Auto Scaling performs the action defined in the DefaultResult parameter"', args=[d.arg(name='heartbeatTimeout', type=d.T.number)]),
      withHeartbeatTimeout(heartbeatTimeout): { spec+: { initProvider+: { heartbeatTimeout: heartbeatTimeout } } },
      '#withLifecycleTransition':: d.fn(help='"Instance state to which you want to attach the lifecycle hook. For a list of lifecycle hook types, see describe-lifecycle-hook-types"', args=[d.arg(name='lifecycleTransition', type=d.T.string)]),
      withLifecycleTransition(lifecycleTransition): { spec+: { initProvider+: { lifecycleTransition: lifecycleTransition } } },
      '#withNotificationMetadata':: d.fn(help='"Contains additional information that you want to include any time Auto Scaling sends a message to the notification target."', args=[d.arg(name='notificationMetadata', type=d.T.string)]),
      withNotificationMetadata(notificationMetadata): { spec+: { initProvider+: { notificationMetadata: notificationMetadata } } },
      '#withNotificationTargetArn':: d.fn(help='"ARN of the notification target that Auto Scaling will use to notify you when an instance is in the transition state for the lifecycle hook. This ARN target can be either an SQS queue, an SNS topic, or a Lambda function."', args=[d.arg(name='notificationTargetArn', type=d.T.string)]),
      withNotificationTargetArn(notificationTargetArn): { spec+: { initProvider+: { notificationTargetArn: notificationTargetArn } } },
      '#withRoleArn':: d.fn(help='"ARN of the IAM role that allows the Auto Scaling group to publish to the specified notification target."', args=[d.arg(name='roleArn', type=d.T.string)]),
