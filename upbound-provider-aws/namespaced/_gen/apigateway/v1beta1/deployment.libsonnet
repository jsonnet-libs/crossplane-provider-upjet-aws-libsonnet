{
  ...
  '#':: d.pkg(name='deployment', url='', help='"Deployment is the Schema for the Deployments API. Manages an API Gateway REST Deployment."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description of the deployment."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withRestApiId':: d.fn(help='"REST API identifier."', args=[d.arg(name='restApiId', type=d.T.string)]),
      withRestApiId(restApiId): { spec+: { forProvider+: { restApiId: restApiId } } },
      '#withTriggers':: d.fn(help='"argument or explicit resource references using the resource . The triggers argument should be preferred over depends_on, since depends_on can only capture dependency ordering and will not cause the resource to recreate (redeploy the REST API) with upstream configuration changes."', args=[d.arg(name='triggers', type=d.T.object)]),
      withTriggers(triggers): { spec+: { forProvider+: { triggers: triggers } } },
      '#withTriggersMixin':: d.fn(help='"argument or explicit resource references using the resource . The triggers argument should be preferred over depends_on, since depends_on can only capture dependency ordering and will not cause the resource to recreate (redeploy the REST API) with upstream configuration changes."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='triggers', type=d.T.object)]),
      withTriggersMixin(triggers): { spec+: { forProvider+: { triggers+: triggers } } },
      '#withVariables':: d.fn(help='"Map to set on the related stage."', args=[d.arg(name='variables', type=d.T.object)]),
      withVariables(variables): { spec+: { forProvider+: { variables: variables } } },
      '#withVariablesMixin':: d.fn(help='"Map to set on the related stage."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.object)]),
