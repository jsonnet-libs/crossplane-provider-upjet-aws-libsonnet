{
  ...
  '#':: d.pkg(name='model', url='', help='"Model is the Schema for the Models API. Provides a Model for a REST API Gateway."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withContentType':: d.fn(help='"Content type of the model"', args=[d.arg(name='contentType', type=d.T.string)]),
      withContentType(contentType): { spec+: { forProvider+: { contentType: contentType } } },
      '#withDescription':: d.fn(help='"Description of the model"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name of the model"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSchema':: d.fn(help='"Schema of the model in a JSON form"', args=[d.arg(name='schema', type=d.T.string)]),
