{
  ...
  '#':: d.pkg(name='clientCertificate', url='', help='"ClientCertificate is the Schema for the ClientCertificates API. Provides an API Gateway Client Certificate."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClientCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'apigateway.aws.m.upbound.io/v1beta1',
    kind: 'ClientCertificate',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ClientCertificateSpec defines the desired state of ClientCertificate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the client certificate."', args=[d.arg(name='description', type=d.T.string)]),
