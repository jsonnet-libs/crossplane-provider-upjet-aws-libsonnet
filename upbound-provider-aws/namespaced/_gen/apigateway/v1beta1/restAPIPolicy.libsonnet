{
  ...
  '#':: d.pkg(name='restAPIPolicy', url='', help='"RestAPIPolicy is the Schema for the RestAPIPolicys API. Provides an API Gateway REST API Policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of RestAPIPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'apigateway.aws.m.upbound.io/v1beta1',
    kind: 'RestAPIPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RestAPIPolicySpec defines the desired state of RestAPIPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicy':: d.fn(help='"JSON formatted policy document that controls access to the API Gateway"', args=[d.arg(name='policy', type=d.T.string)]),
