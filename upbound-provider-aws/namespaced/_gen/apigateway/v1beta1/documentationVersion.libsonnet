{
  ...
  '#':: d.pkg(name='documentationVersion', url='', help='"DocumentationVersion is the Schema for the DocumentationVersions API. Provides a resource to manage an API Gateway Documentation Version."'),
  ...
  '#new':: d.fn(help='new returns an instance of DocumentationVersion', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'apigateway.aws.m.upbound.io/v1beta1',
    kind: 'DocumentationVersion',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DocumentationVersionSpec defines the desired state of DocumentationVersion"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description of the API documentation version."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withVersion':: d.fn(help='"Version identifier of the API documentation snapshot."', args=[d.arg(name='version', type=d.T.string)]),
