{
  ...
  '#':: d.pkg(name='requestValidator', url='', help='"RequestValidator is the Schema for the RequestValidators API. Manages an API Gateway Request Validator."'),
  ...
  '#new':: d.fn(help='new returns an instance of RequestValidator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'apigateway.aws.m.upbound.io/v1beta1',
    kind: 'RequestValidator',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RequestValidatorSpec defines the desired state of RequestValidator"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Name of the request validator"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withValidateRequestBody':: d.fn(help='"Boolean whether to validate request body. Defaults to false."', args=[d.arg(name='validateRequestBody', type=d.T.boolean)]),
      withValidateRequestBody(validateRequestBody): { spec+: { forProvider+: { validateRequestBody: validateRequestBody } } },
      '#withValidateRequestParameters':: d.fn(help='"Boolean whether to validate request parameters. Defaults to false."', args=[d.arg(name='validateRequestParameters', type=d.T.boolean)]),
      withValidateRequestParameters(validateRequestParameters): { spec+: { forProvider+: { validateRequestParameters: validateRequestParameters } } },
    },
    ...
    initProvider: {
      ...
      '#withValidateRequestBody':: d.fn(help='"Boolean whether to validate request body. Defaults to false."', args=[d.arg(name='validateRequestBody', type=d.T.boolean)]),
      withValidateRequestBody(validateRequestBody): { spec+: { initProvider+: { validateRequestBody: validateRequestBody } } },
      '#withValidateRequestParameters':: d.fn(help='"Boolean whether to validate request parameters. Defaults to false."', args=[d.arg(name='validateRequestParameters', type=d.T.boolean)]),
      withValidateRequestParameters(validateRequestParameters): { spec+: { initProvider+: { validateRequestParameters: validateRequestParameters } } },
    },
