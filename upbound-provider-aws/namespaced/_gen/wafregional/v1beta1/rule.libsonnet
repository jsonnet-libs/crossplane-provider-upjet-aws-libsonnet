{
  ...
  '#':: d.pkg(name='rule', url='', help='"Rule is the Schema for the Rules API. Provides an AWS WAF Regional rule resource for use with ALB."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      predicate: {
        ...
        '#withDataId':: d.fn(help='"The unique identifier of a predicate, such as the ID of a ByteMatchSet or IPSet."', args=[d.arg(name='dataId', type=d.T.string)]),
        withDataId(dataId): { dataId: dataId },
        '#withNegated':: d.fn(help='"Whether to use the settings or the negated settings that you specified in the objects."', args=[d.arg(name='negated', type=d.T.boolean)]),
