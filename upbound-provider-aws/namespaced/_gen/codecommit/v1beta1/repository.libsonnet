{
  ...
  '#':: d.pkg(name='repository', url='', help='"Repository is the Schema for the Repositorys API. Provides a CodeCommit Repository Resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultBranch':: d.fn(help='"The default branch of the repository. The branch specified here needs to exist."', args=[d.arg(name='defaultBranch', type=d.T.string)]),
      withDefaultBranch(defaultBranch): { spec+: { forProvider+: { defaultBranch: defaultBranch } } },
      '#withDescription':: d.fn(help='"The description of the repository. This needs to be less than 1000 characters"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withKmsKeyId':: d.fn(help='"The ARN of the encryption key. If no key is specified, the default aws/codecommit Amazon Web Services managed key is used."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDefaultBranch':: d.fn(help='"The default branch of the repository. The branch specified here needs to exist."', args=[d.arg(name='defaultBranch', type=d.T.string)]),
      withDefaultBranch(defaultBranch): { spec+: { initProvider+: { defaultBranch: defaultBranch } } },
      '#withDescription':: d.fn(help='"The description of the repository. This needs to be less than 1000 characters"', args=[d.arg(name='description', type=d.T.string)]),
