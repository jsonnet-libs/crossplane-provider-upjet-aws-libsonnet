{
  ...
  '#':: d.pkg(name='approvalRuleTemplate', url='', help='"ApprovalRuleTemplate is the Schema for the ApprovalRuleTemplates API. Provides a CodeCommit Approval Rule Template Resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApprovalRuleTemplate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'codecommit.aws.m.upbound.io/v1beta1',
    kind: 'ApprovalRuleTemplate',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ApprovalRuleTemplateSpec defines the desired state of ApprovalRuleTemplate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withContent':: d.fn(help='"The content of the approval rule template. Maximum of 3000 characters."', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { spec+: { forProvider+: { content: content } } },
      '#withDescription':: d.fn(help='"The description of the approval rule template. Maximum of 1000 characters."', args=[d.arg(name='description', type=d.T.string)]),
