{
  ...
  '#':: d.pkg(name='bucketIntelligentTieringConfiguration', url='', help='"BucketIntelligentTieringConfiguration is the Schema for the BucketIntelligentTieringConfigurations API. Provides an S3 Intelligent-Tiering configuration resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketIntelligentTieringConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 's3.aws.m.upbound.io/v1beta1',
    kind: 'BucketIntelligentTieringConfiguration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BucketIntelligentTieringConfigurationSpec defines the desired state of BucketIntelligentTieringConfiguration"'),
  spec: {
    ...
    forProvider: {
      ...
      '#filter':: d.obj(help="\"Bucket filter. The configuration only includes objects that meet the filter's criteria (documented below).\""),
      filter: {
        '#withPrefix':: d.fn(help='"Object key name prefix that identifies the subset of objects to which the configuration applies."', args=[d.arg(name='prefix', type=d.T.string)]),
      ...
      '#tiering':: d.obj(help='"S3 Intelligent-Tiering storage class tiers of the configuration (documented below)."'),
      tiering: {
        '#withAccessTier':: d.fn(help='"S3 Intelligent-Tiering access tier. Valid values: ARCHIVE_ACCESS, DEEP_ARCHIVE_ACCESS."', args=[d.arg(name='accessTier', type=d.T.string)]),
        withAccessTier(accessTier): { accessTier: accessTier },
        '#withDays':: d.fn(help='"Number of consecutive days of no access after which an object will be eligible to be transitioned to the corresponding tier."', args=[d.arg(name='days', type=d.T.number)]),
        withDays(days): { days: days },
      },
      '#withBucket':: d.fn(help='"Name of the bucket this intelligent tiering configuration is associated with."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withName':: d.fn(help='"Unique name used to identify the S3 Intelligent-Tiering configuration for the bucket."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      withTieringMixin(tiering): { spec+: { forProvider+: { tiering+: if std.isArray(v=tiering) then tiering else [tiering] } } },
    },
    ...
    initProvider: {
      ...
      '#withTiering':: d.fn(help='"S3 Intelligent-Tiering storage class tiers of the configuration (documented below)."', args=[d.arg(name='tiering', type=d.T.array)]),
      withTiering(tiering): { spec+: { initProvider+: { tiering: if std.isArray(v=tiering) then tiering else [tiering] } } },
      '#withTieringMixin':: d.fn(help='"S3 Intelligent-Tiering storage class tiers of the configuration (documented below)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tiering', type=d.T.array)]),
      withTieringMixin(tiering): { spec+: { initProvider+: { tiering+: if std.isArray(v=tiering) then tiering else [tiering] } } },
    },
