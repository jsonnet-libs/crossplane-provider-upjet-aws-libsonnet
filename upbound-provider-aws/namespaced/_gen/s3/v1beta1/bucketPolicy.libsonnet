{
  ...
  '#':: d.pkg(name='bucketPolicy', url='', help='"BucketPolicy is the Schema for the BucketPolicys API. Attaches a policy to an S3 bucket resource."'),
  ...
  '#spec':: d.obj(help='"BucketPolicySpec defines the desired state of BucketPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBucket':: d.fn(help='"Name of the bucket to which to apply the policy."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withPolicy':: d.fn(help='"Text of the policy. Although this is a bucket policy rather than an IAM policy, the aws_iam_policy_document data source may be used, so long as it specifies a principal. Note: Bucket policies are limited to 20 KB in size."', args=[d.arg(name='policy', type=d.T.string)]),
