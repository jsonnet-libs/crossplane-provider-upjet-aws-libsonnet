{
  ...
  '#':: d.pkg(name='bucketCorsConfiguration', url='', help='"BucketCorsConfiguration is the Schema for the BucketCorsConfigurations API. Provides an S3 bucket CORS configuration resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketCorsConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 's3.aws.m.upbound.io/v1beta1',
    kind: 'BucketCorsConfiguration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BucketCorsConfigurationSpec defines the desired state of BucketCorsConfiguration"'),
  spec: {
    ...
    forProvider: {
      ...
      '#corsRule':: d.obj(help='"Set of origins and methods (cross-origin access that you want to allow). See below. You can configure up to 100 rules."'),
      corsRule: {
        '#withAllowedHeaders':: d.fn(help='"Set of Headers that are specified in the Access-Control-Request-Headers header."', args=[d.arg(name='allowedHeaders', type=d.T.array)]),
        withAllowedHeaders(allowedHeaders): { allowedHeaders: if std.isArray(v=allowedHeaders) then allowedHeaders else [allowedHeaders] },
        '#withAllowedHeadersMixin':: d.fn(help='"Set of Headers that are specified in the Access-Control-Request-Headers header."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedHeaders', type=d.T.array)]),
        ...
        '#withAllowedMethods':: d.fn(help='"Set of HTTP methods that you allow the origin to execute. Valid values are GET, PUT, HEAD, POST, and DELETE."', args=[d.arg(name='allowedMethods', type=d.T.array)]),
        withAllowedMethods(allowedMethods): { allowedMethods: if std.isArray(v=allowedMethods) then allowedMethods else [allowedMethods] },
        '#withAllowedMethodsMixin':: d.fn(help='"Set of HTTP methods that you allow the origin to execute. Valid values are GET, PUT, HEAD, POST, and DELETE."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedMethods', type=d.T.array)]),
        ...
        '#withAllowedOrigins':: d.fn(help='"Set of origins you want customers to be able to access the bucket from."', args=[d.arg(name='allowedOrigins', type=d.T.array)]),
        withAllowedOrigins(allowedOrigins): { allowedOrigins: if std.isArray(v=allowedOrigins) then allowedOrigins else [allowedOrigins] },
        '#withAllowedOriginsMixin':: d.fn(help='"Set of origins you want customers to be able to access the bucket from."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedOrigins', type=d.T.array)]),
        ...
        '#withExposeHeaders':: d.fn(help='"Set of headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript XMLHttpRequest object)."', args=[d.arg(name='exposeHeaders', type=d.T.array)]),
        withExposeHeaders(exposeHeaders): { exposeHeaders: if std.isArray(v=exposeHeaders) then exposeHeaders else [exposeHeaders] },
        '#withExposeHeadersMixin':: d.fn(help='"Set of headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript XMLHttpRequest object)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exposeHeaders', type=d.T.array)]),
        ...
        withId(id): { id: id },
        '#withMaxAgeSeconds':: d.fn(help='"Time in seconds that your browser is to cache the preflight response for the specified resource."', args=[d.arg(name='maxAgeSeconds', type=d.T.number)]),
      ...
      '#withCorsRule':: d.fn(help='"Set of origins and methods (cross-origin access that you want to allow). See below. You can configure up to 100 rules."', args=[d.arg(name='corsRule', type=d.T.array)]),
      withCorsRule(corsRule): { spec+: { forProvider+: { corsRule: if std.isArray(v=corsRule) then corsRule else [corsRule] } } },
      '#withCorsRuleMixin':: d.fn(help='"Set of origins and methods (cross-origin access that you want to allow). See below. You can configure up to 100 rules."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='corsRule', type=d.T.array)]),
