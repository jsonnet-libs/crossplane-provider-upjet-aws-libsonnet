  ...
  spec: {
    ...
    forProvider: {
      ...
      destination: {
        ...
        bucket: {
          ...
          bucketArnRef: {
            ...
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnRef+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnRef+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnRef+: { name: name } } } } } },
            '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnRef+: { namespace: namespace } } } } } },
          },
          ...
          bucketArnSelector: {
            ...
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnSelector+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnSelector+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
            withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnSelector+: { matchControllerRef: matchControllerRef } } } } } },
            '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabels(matchLabels): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnSelector+: { matchLabels: matchLabels } } } } } },
            '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnSelector+: { matchLabels+: matchLabels } } } } } },
            '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { forProvider+: { destination+: { bucket+: { bucketArnSelector+: { namespace: namespace } } } } } },
          },
          ...
          encryption: {
            ...
            sseKms: {
              ...
              withKeyId(keyId): { spec+: { forProvider+: { destination+: { bucket+: { encryption+: { sseKms+: { keyId: keyId } } } } } } },
            },
            '#withSseS3':: d.fn(help='"Specifies to use server-side encryption with Amazon S3-managed keys (SSE-S3) to encrypt the inventory file."', args=[d.arg(name='sseS3', type=d.T.object)]),
            withSseS3(sseS3): { spec+: { forProvider+: { destination+: { bucket+: { encryption+: { sseS3: sseS3 } } } } } },
            '#withSseS3Mixin':: d.fn(help='"Specifies to use server-side encryption with Amazon S3-managed keys (SSE-S3) to encrypt the inventory file."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sseS3', type=d.T.object)]),
            withSseS3Mixin(sseS3): { spec+: { forProvider+: { destination+: { bucket+: { encryption+: { sseS3+: sseS3 } } } } } },
          },
          ...
          withAccountId(accountId): { spec+: { forProvider+: { destination+: { bucket+: { accountId: accountId } } } } },
          '#withBucketArn':: d.fn(help='"Amazon S3 bucket ARN of the destination."', args=[d.arg(name='bucketArn', type=d.T.string)]),
          withBucketArn(bucketArn): { spec+: { forProvider+: { destination+: { bucket+: { bucketArn: bucketArn } } } } },
          ...
          withFormat(format): { spec+: { forProvider+: { destination+: { bucket+: { format: format } } } } },
          ...
          withPrefix(prefix): { spec+: { forProvider+: { destination+: { bucket+: { prefix: prefix } } } } },
        },
      },
      ...
      schedule: {
        ...
        withFrequency(frequency): { spec+: { forProvider+: { schedule+: { frequency: frequency } } } },
      },
    ...
    initProvider: {
      ...
      destination: {
        ...
        bucket: {
          ...
          bucketArnRef: {
            ...
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnRef+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnRef+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnRef+: { name: name } } } } } },
            '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnRef+: { namespace: namespace } } } } } },
          },
          '#bucketArnSelector':: d.obj(help='"Selector for a Bucket in s3 to populate bucketArn."'),
          bucketArnSelector: {
            '#policy':: d.obj(help='"Policies for selection."'),
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnSelector+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnSelector+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
            withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnSelector+: { matchControllerRef: matchControllerRef } } } } } },
            '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabels(matchLabels): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnSelector+: { matchLabels: matchLabels } } } } } },
            '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnSelector+: { matchLabels+: matchLabels } } } } } },
            '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { initProvider+: { destination+: { bucket+: { bucketArnSelector+: { namespace: namespace } } } } } },
          },
          '#encryption':: d.obj(help='"Contains the type of server-side encryption to use to encrypt the inventory (documented below)."'),
          encryption: {
            '#sseKms':: d.obj(help='"Specifies to use server-side encryption with AWS KMS-managed keys to encrypt the inventory file (documented below)."'),
            sseKms: {
              '#withKeyId':: d.fn(help='"ARN of the KMS customer master key (CMK) used to encrypt the inventory file."', args=[d.arg(name='keyId', type=d.T.string)]),
              withKeyId(keyId): { spec+: { initProvider+: { destination+: { bucket+: { encryption+: { sseKms+: { keyId: keyId } } } } } } },
            },
            '#withSseS3':: d.fn(help='"Specifies to use server-side encryption with Amazon S3-managed keys (SSE-S3) to encrypt the inventory file."', args=[d.arg(name='sseS3', type=d.T.object)]),
            withSseS3(sseS3): { spec+: { initProvider+: { destination+: { bucket+: { encryption+: { sseS3: sseS3 } } } } } },
            '#withSseS3Mixin':: d.fn(help='"Specifies to use server-side encryption with Amazon S3-managed keys (SSE-S3) to encrypt the inventory file."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sseS3', type=d.T.object)]),
            withSseS3Mixin(sseS3): { spec+: { initProvider+: { destination+: { bucket+: { encryption+: { sseS3+: sseS3 } } } } } },
          },
          '#withAccountId':: d.fn(help='"ID of the account that owns the destination bucket. Recommended to be set to prevent problems if the destination bucket ownership changes."', args=[d.arg(name='accountId', type=d.T.string)]),
          withAccountId(accountId): { spec+: { initProvider+: { destination+: { bucket+: { accountId: accountId } } } } },
          '#withBucketArn':: d.fn(help='"Amazon S3 bucket ARN of the destination."', args=[d.arg(name='bucketArn', type=d.T.string)]),
          withBucketArn(bucketArn): { spec+: { initProvider+: { destination+: { bucket+: { bucketArn: bucketArn } } } } },
          '#withFormat':: d.fn(help='"Specifies the output format of the inventory results. Can be CSV, ORC or Parquet."', args=[d.arg(name='format', type=d.T.string)]),
          withFormat(format): { spec+: { initProvider+: { destination+: { bucket+: { format: format } } } } },
          '#withPrefix':: d.fn(help='"Prefix that an object must have to be included in the inventory results."', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { initProvider+: { destination+: { bucket+: { prefix: prefix } } } } },
        },
      },
      '#filter':: d.obj(help="\"Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria (documented below).\""),
      filter: {
      ...
      schedule: {
        '#withFrequency':: d.fn(help='"Specifies how frequently inventory results are produced. Valid values: Daily, Weekly."', args=[d.arg(name='frequency', type=d.T.string)]),
        withFrequency(frequency): { spec+: { initProvider+: { schedule+: { frequency: frequency } } } },
      },
      '#withBucket':: d.fn(help='"Name of the source bucket that inventory lists the objects for."', args=[d.arg(name='bucket', type=d.T.string)]),
