{
  ...
  '#':: d.pkg(name='bucketRequestPaymentConfiguration', url='', help='"BucketRequestPaymentConfiguration is the Schema for the BucketRequestPaymentConfigurations API. Provides an S3 bucket request payment configuration resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketRequestPaymentConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 's3.aws.m.upbound.io/v1beta1',
    kind: 'BucketRequestPaymentConfiguration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BucketRequestPaymentConfigurationSpec defines the desired state of BucketRequestPaymentConfiguration"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPayer':: d.fn(help='"Specifies who pays for the download and request fees. Valid values: BucketOwner, Requester."', args=[d.arg(name='payer', type=d.T.string)]),
      withPayer(payer): { spec+: { forProvider+: { payer: payer } } },
    ...
    initProvider: {
      ...
      '#withPayer':: d.fn(help='"Specifies who pays for the download and request fees. Valid values: BucketOwner, Requester."', args=[d.arg(name='payer', type=d.T.string)]),
      withPayer(payer): { spec+: { initProvider+: { payer: payer } } },
    },
