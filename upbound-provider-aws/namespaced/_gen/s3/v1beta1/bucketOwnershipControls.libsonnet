{
  ...
  '#':: d.pkg(name='bucketOwnershipControls', url='', help='"BucketOwnershipControls is the Schema for the BucketOwnershipControlss API. Manages S3 Bucket Ownership Controls."'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketOwnershipControls', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 's3.aws.m.upbound.io/v1beta1',
    kind: 'BucketOwnershipControls',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BucketOwnershipControlsSpec defines the desired state of BucketOwnershipControls"'),
  spec: {
    ...
    forProvider: {
      ...
      '#rule':: d.obj(help='"Configuration block(s) with Ownership Controls rules. Detailed below."'),
      rule: {
        '#withObjectOwnership':: d.fn(help='"Object ownership. Valid values: BucketOwnerPreferred, ObjectWriter or BucketOwnerEnforced"', args=[d.arg(name='objectOwnership', type=d.T.string)]),
        withObjectOwnership(objectOwnership): { spec+: { forProvider+: { rule+: { objectOwnership: objectOwnership } } } },
      },
      '#withBucket':: d.fn(help='"Name of the bucket that you want to associate this access point with."', args=[d.arg(name='bucket', type=d.T.string)]),
    ...
    initProvider: {
      ...
      rule: {
        '#withObjectOwnership':: d.fn(help='"Object ownership. Valid values: BucketOwnerPreferred, ObjectWriter or BucketOwnerEnforced"', args=[d.arg(name='objectOwnership', type=d.T.string)]),
        withObjectOwnership(objectOwnership): { spec+: { initProvider+: { rule+: { objectOwnership: objectOwnership } } } },
      },
      '#withBucket':: d.fn(help='"Name of the bucket that you want to associate this access point with."', args=[d.arg(name='bucket', type=d.T.string)]),
