{
  ...
  '#':: d.pkg(name='bucketAccelerateConfiguration', url='', help='"BucketAccelerateConfiguration is the Schema for the BucketAccelerateConfigurations API. Provides an S3 bucket accelerate configuration resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketAccelerateConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 's3.aws.m.upbound.io/v1beta1',
    kind: 'BucketAccelerateConfiguration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BucketAccelerateConfigurationSpec defines the desired state of BucketAccelerateConfiguration"'),
  spec: {
