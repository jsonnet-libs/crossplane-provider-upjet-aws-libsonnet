{
  ...
  new(name): {
    apiVersion: 'sfn.aws.m.upbound.io/v1beta1',
    kind: 'StateMachine',
  ...
  spec: {
    ...
    forProvider: {
      '#encryptionConfiguration':: d.obj(help='"Defines what encryption configuration is used to encrypt data in the State Machine. For more information see [TBD] in the AWS Step Functions User Guide."'),
      encryptionConfiguration: {
        ...
        kmsKeyIdRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { policy+: { resolution: resolution } } } } } },
            ...
            withResolve(resolve): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { namespace: namespace } } } } },
        },
        ...
        kmsKeyIdSelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { policy+: { resolve: resolve } } } } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { matchLabels+: matchLabels } } } } },
          '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { namespace: namespace } } } } },
        },
        '#withKmsDataKeyReusePeriodSeconds':: d.fn(help='"Maximum duration for which Step Functions will reuse data keys. When the period expires, Step Functions will call GenerateDataKey. This setting only applies to customer managed KMS key and does not apply when type is AWS_OWNED_KEY."', args=[d.arg(name='kmsDataKeyReusePeriodSeconds', type=d.T.number)]),
        withKmsDataKeyReusePeriodSeconds(kmsDataKeyReusePeriodSeconds): { spec+: { forProvider+: { encryptionConfiguration+: { kmsDataKeyReusePeriodSeconds: kmsDataKeyReusePeriodSeconds } } } },
        '#withKmsKeyId':: d.fn(help='"The alias, alias ARN, key ID, or key ARN of the symmetric encryption KMS key that encrypts the data key. To specify a KMS key in a different AWS account, the customer must use the key ARN or alias ARN. For more information regarding kms_key_id, see KeyId in the KMS documentation."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
        withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { encryptionConfiguration+: { kmsKeyId: kmsKeyId } } } },
        '#withType':: d.fn(help='"The encryption option specified for the state machine. Valid values: AWS_OWNED_KEY, CUSTOMER_MANAGED_KMS_KEY"', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { forProvider+: { encryptionConfiguration+: { type: type } } } },
      },
      '#loggingConfiguration':: d.obj(help='"Defines what execution history events are logged and where they are logged. The logging_configuration parameter is valid when type is set to STANDARD or EXPRESS. Defaults to OFF. For more information see Logging Express Workflows, Log Levels and Logging Configuration in the AWS Step Functions User Guide."'),
      loggingConfiguration: {
        ...
        withIncludeExecutionData(includeExecutionData): { spec+: { forProvider+: { loggingConfiguration+: { includeExecutionData: includeExecutionData } } } },
        ...
        withLevel(level): { spec+: { forProvider+: { loggingConfiguration+: { level: level } } } },
        ...
        withLogDestination(logDestination): { spec+: { forProvider+: { loggingConfiguration+: { logDestination: logDestination } } } },
      },
      ...
      tracingConfiguration: {
        ...
        withEnabled(enabled): { spec+: { forProvider+: { tracingConfiguration+: { enabled: enabled } } } },
      },
    ...
    initProvider: {
      ...
      encryptionConfiguration: {
        ...
        kmsKeyIdRef: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdRef+: { namespace: namespace } } } } },
        },
        '#kmsKeyIdSelector':: d.obj(help='"Selector for a Key in kms to populate kmsKeyId."'),
        kmsKeyIdSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { policy+: { resolve: resolve } } } } } },
          },
          '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
          withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { matchLabels+: matchLabels } } } } },
          '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyIdSelector+: { namespace: namespace } } } } },
        },
        '#withKmsDataKeyReusePeriodSeconds':: d.fn(help='"Maximum duration for which Step Functions will reuse data keys. When the period expires, Step Functions will call GenerateDataKey. This setting only applies to customer managed KMS key and does not apply when type is AWS_OWNED_KEY."', args=[d.arg(name='kmsDataKeyReusePeriodSeconds', type=d.T.number)]),
        withKmsDataKeyReusePeriodSeconds(kmsDataKeyReusePeriodSeconds): { spec+: { initProvider+: { encryptionConfiguration+: { kmsDataKeyReusePeriodSeconds: kmsDataKeyReusePeriodSeconds } } } },
        '#withKmsKeyId':: d.fn(help='"The alias, alias ARN, key ID, or key ARN of the symmetric encryption KMS key that encrypts the data key. To specify a KMS key in a different AWS account, the customer must use the key ARN or alias ARN. For more information regarding kms_key_id, see KeyId in the KMS documentation."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
        withKmsKeyId(kmsKeyId): { spec+: { initProvider+: { encryptionConfiguration+: { kmsKeyId: kmsKeyId } } } },
        '#withType':: d.fn(help='"The encryption option specified for the state machine. Valid values: AWS_OWNED_KEY, CUSTOMER_MANAGED_KMS_KEY"', args=[d.arg(name='type', type=d.T.string)]),
      ...
      loggingConfiguration: {
        '#withIncludeExecutionData':: d.fn(help='"Determines whether execution data is included in your log. When set to false, data is excluded."', args=[d.arg(name='includeExecutionData', type=d.T.boolean)]),
        withIncludeExecutionData(includeExecutionData): { spec+: { initProvider+: { loggingConfiguration+: { includeExecutionData: includeExecutionData } } } },
        '#withLevel':: d.fn(help='"Defines which category of execution history events are logged. Valid values: ALL, ERROR, FATAL, OFF"', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { initProvider+: { loggingConfiguration+: { level: level } } } },
        '#withLogDestination':: d.fn(help='"Amazon Resource Name (ARN) of a CloudWatch log group. Make sure the State Machine has the correct IAM policies for logging. The ARN must end with :*"', args=[d.arg(name='logDestination', type=d.T.string)]),
        withLogDestination(logDestination): { spec+: { initProvider+: { loggingConfiguration+: { logDestination: logDestination } } } },
      },
      '#roleArnRef':: d.obj(help='"Reference to a Role in iam to populate roleArn."'),
      roleArnRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
      ...
      tracingConfiguration: {
        '#withEnabled':: d.fn(help='"When set to true, AWS X-Ray tracing is enabled. Make sure the State Machine has the correct IAM policies for logging. See the AWS Step Functions Developer Guide for details."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { initProvider+: { tracingConfiguration+: { enabled: enabled } } } },
      },
      '#withDefinition':: d.fn(help='"The Amazon States Language definition of the state machine."', args=[d.arg(name='definition', type=d.T.string)]),
