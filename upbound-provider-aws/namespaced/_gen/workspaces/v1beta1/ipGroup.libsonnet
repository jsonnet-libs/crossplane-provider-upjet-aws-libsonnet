{
  ...
  '#':: d.pkg(name='ipGroup', url='', help='"IPGroup is the Schema for the IPGroups API. Provides an IP access control group in AWS WorkSpaces Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of IPGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'workspaces.aws.m.upbound.io/v1beta1',
    kind: 'IPGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"IPGroupSpec defines the desired state of IPGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#rules':: d.obj(help='"One or more pairs specifying the IP group rule (in CIDR format) from which web requests originate."'),
      rules: {
        '#withDescription':: d.fn(help='"The description of the IP group."', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { description: description },
        '#withSource':: d.fn(help='"The IP address range, in CIDR notation, e.g., 10.0.0.0/16"', args=[d.arg(name='source', type=d.T.string)]),
        withSource(source): { source: source },
      },
      '#withDescription':: d.fn(help='"The description of the IP group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of the IP group."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRules':: d.fn(help='"One or more pairs specifying the IP group rule (in CIDR format) from which web requests originate."', args=[d.arg(name='rules', type=d.T.array)]),
      withRules(rules): { spec+: { forProvider+: { rules: if std.isArray(v=rules) then rules else [rules] } } },
      '#withRulesMixin':: d.fn(help='"One or more pairs specifying the IP group rule (in CIDR format) from which web requests originate."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rules', type=d.T.array)]),
