{
  ...
  '#':: d.pkg(name='resolverConfig', url='', help='"ResolverConfig is the Schema for the ResolverConfigs API. Provides a Route 53 Resolver config resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResolverConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'route53.aws.m.upbound.io/v1beta1',
    kind: 'ResolverConfig',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ResolverConfigSpec defines the desired state of ResolverConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#resourceIdRef':: d.obj(help='"Reference to a VPC in ec2 to populate resourceId."'),
      resourceIdRef: {
      ...
      '#resourceIdSelector':: d.obj(help='"Selector for a VPC in ec2 to populate resourceId."'),
      resourceIdSelector: {
      ...
      '#withAutodefinedReverseFlag':: d.fn(help='"Indicates whether or not the Resolver will create autodefined rules for reverse DNS lookups. Valid values: ENABLE, DISABLE."', args=[d.arg(name='autodefinedReverseFlag', type=d.T.string)]),
      withAutodefinedReverseFlag(autodefinedReverseFlag): { spec+: { forProvider+: { autodefinedReverseFlag: autodefinedReverseFlag } } },
      ...
      '#withResourceId':: d.fn(help='"The ID of the VPC that the configuration is for."', args=[d.arg(name='resourceId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAutodefinedReverseFlag':: d.fn(help='"Indicates whether or not the Resolver will create autodefined rules for reverse DNS lookups. Valid values: ENABLE, DISABLE."', args=[d.arg(name='autodefinedReverseFlag', type=d.T.string)]),
      withAutodefinedReverseFlag(autodefinedReverseFlag): { spec+: { initProvider+: { autodefinedReverseFlag: autodefinedReverseFlag } } },
      '#withResourceId':: d.fn(help='"The ID of the VPC that the configuration is for."', args=[d.arg(name='resourceId', type=d.T.string)]),
