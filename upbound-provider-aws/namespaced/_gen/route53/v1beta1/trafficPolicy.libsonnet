{
  ...
  '#':: d.pkg(name='trafficPolicy', url='', help='"TrafficPolicy is the Schema for the TrafficPolicys API. Manages a Route53 Traffic Policy"'),
  ...
  '#new':: d.fn(help='new returns an instance of TrafficPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'route53.aws.m.upbound.io/v1beta1',
    kind: 'TrafficPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TrafficPolicySpec defines the desired state of TrafficPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withComment':: d.fn(help='"Comment for the traffic policy."', args=[d.arg(name='comment', type=d.T.string)]),
      withComment(comment): { spec+: { forProvider+: { comment: comment } } },
      '#withDocument':: d.fn(help='"Policy document. This is a JSON formatted string. For more information about building Route53 traffic policy documents, see the AWS Route53 Traffic Policy document format"', args=[d.arg(name='document', type=d.T.string)]),
      withDocument(document): { spec+: { forProvider+: { document: document } } },
      '#withName':: d.fn(help='"Name of the traffic policy."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDocument':: d.fn(help='"Policy document. This is a JSON formatted string. For more information about building Route53 traffic policy documents, see the AWS Route53 Traffic Policy document format"', args=[d.arg(name='document', type=d.T.string)]),
      withDocument(document): { spec+: { initProvider+: { document: document } } },
      '#withName':: d.fn(help='"Name of the traffic policy."', args=[d.arg(name='name', type=d.T.string)]),
