{
  ...
  '#':: d.pkg(name='permissionSetInlinePolicy', url='', help='"PermissionSetInlinePolicy is the Schema for the PermissionSetInlinePolicys API. Manages an IAM inline policy for a Single Sign-On (SSO) Permission Set"'),
  ...
  '#new':: d.fn(help='new returns an instance of PermissionSetInlinePolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ssoadmin.aws.m.upbound.io/v1beta1',
    kind: 'PermissionSetInlinePolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"PermissionSetInlinePolicySpec defines the desired state of PermissionSetInlinePolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withInlinePolicy':: d.fn(help='"The IAM inline policy to attach to a Permission Set."', args=[d.arg(name='inlinePolicy', type=d.T.string)]),
      withInlinePolicy(inlinePolicy): { spec+: { forProvider+: { inlinePolicy: inlinePolicy } } },
    ...
    initProvider: {
      '#withInlinePolicy':: d.fn(help='"The IAM inline policy to attach to a Permission Set."', args=[d.arg(name='inlinePolicy', type=d.T.string)]),
      withInlinePolicy(inlinePolicy): { spec+: { initProvider+: { inlinePolicy: inlinePolicy } } },
    },
