{
  ...
  '#':: d.pkg(name='instanceAccessControlAttributes', url='', help='"InstanceAccessControlAttributes is the Schema for the InstanceAccessControlAttributess API. Provides a Single Sign-On (SSO) ABAC Resource: https://docs.aws.amazon.com/singlesignon/latest/userguide/abac.html"'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceAccessControlAttributes', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ssoadmin.aws.m.upbound.io/v1beta1',
    kind: 'InstanceAccessControlAttributes',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"InstanceAccessControlAttributesSpec defines the desired state of InstanceAccessControlAttributes"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#attribute':: d.obj(help='"See AccessControlAttribute for more details."'),
      attribute: {
        '#value':: d.obj(help='"The value used for mapping a specified attribute to an identity source. See AccessControlAttributeValue"'),
        value: {
          '#withSource':: d.fn(help='"The identity source to use when mapping a specified attribute to AWS SSO."', args=[d.arg(name='source', type=d.T.array)]),
          withSource(source): { source: if std.isArray(v=source) then source else [source] },
          '#withSourceMixin':: d.fn(help='"The identity source to use when mapping a specified attribute to AWS SSO."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='source', type=d.T.array)]),
          withSourceMixin(source): { source+: if std.isArray(v=source) then source else [source] },
        },
        '#withKey':: d.fn(help='"The name of the attribute associated with your identities in your identity source. This is used to map a specified attribute in your identity source with an attribute in AWS SSO."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { key: key },
        '#withValue':: d.fn(help='"The value used for mapping a specified attribute to an identity source. See AccessControlAttributeValue"', args=[d.arg(name='value', type=d.T.array)]),
        withValue(value): { value: if std.isArray(v=value) then value else [value] },
        '#withValueMixin':: d.fn(help='"The value used for mapping a specified attribute to an identity source. See AccessControlAttributeValue"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='value', type=d.T.array)]),
        withValueMixin(value): { value+: if std.isArray(v=value) then value else [value] },
      },
      '#withAttribute':: d.fn(help='"See AccessControlAttribute for more details."', args=[d.arg(name='attribute', type=d.T.array)]),
      withAttribute(attribute): { spec+: { forProvider+: { attribute: if std.isArray(v=attribute) then attribute else [attribute] } } },
      '#withAttributeMixin':: d.fn(help='"See AccessControlAttribute for more details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='attribute', type=d.T.array)]),
