{
  ...
  '#':: d.pkg(name='subnetGroup', url='', help='"SubnetGroup is the Schema for the SubnetGroups API. Provides an DAX Subnet Group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description of the subnet group."', args=[d.arg(name='description', type=d.T.string)]),
