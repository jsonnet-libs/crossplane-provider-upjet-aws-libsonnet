{
  ...
  '#':: d.pkg(name='cluster', url='', help='"Cluster is the Schema for the Clusters API. Provides an DAX Cluster resource."'),
  ...
  new(name): {
    apiVersion: 'dax.aws.m.upbound.io/v1beta1',
    kind: 'Cluster',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#serverSideEncryption':: d.obj(help='"Encrypt at rest options"'),
      serverSideEncryption: {
        '#withEnabled':: d.fn(help='"Whether to enable encryption at rest. Defaults to false."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { forProvider+: { serverSideEncryption+: { enabled: enabled } } } },
      },
      '#withAvailabilityZones':: d.fn(help='"List of Availability Zones in which the\\nnodes will be created"', args=[d.arg(name='availabilityZones', type=d.T.array)]),
      ...
      '#withClusterEndpointEncryptionType':: d.fn(help="\"The type of encryption the\\ncluster's endpoint should support. Valid values are: NONE and TLS.\\nDefault value is NONE.\"", args=[d.arg(name='clusterEndpointEncryptionType', type=d.T.string)]),
      ...
      '#withIamRoleArn':: d.fn(help="\"A valid Amazon Resource Name (ARN) that identifies\\nan IAM role. At runtime, DAX will assume this role and use the role's\\npermissions to access DynamoDB on your behalf\"", args=[d.arg(name='iamRoleArn', type=d.T.string)]),
      withIamRoleArn(iamRoleArn): { spec+: { forProvider+: { iamRoleArn: iamRoleArn } } },
      '#withMaintenanceWindow':: d.fn(help='"Specifies the weekly time range for when\\nmaintenance on the cluster is performed. The format is ddd:hh24:mi-ddd:hh24:mi\\n(24H Clock UTC). The minimum maintenance window is a 60 minute period. Example:\\nsun:05:00-sun:09:00"', args=[d.arg(name='maintenanceWindow', type=d.T.string)]),
      withMaintenanceWindow(maintenanceWindow): { spec+: { forProvider+: { maintenanceWindow: maintenanceWindow } } },
      '#withNodeType':: d.fn(help='"The compute and memory capacity of the nodes. See\\nNodes for supported node types"', args=[d.arg(name='nodeType', type=d.T.string)]),
      withNodeType(nodeType): { spec+: { forProvider+: { nodeType: nodeType } } },
      '#withNotificationTopicArn':: d.fn(help='"An Amazon Resource Name (ARN) of an\\nSNS topic to send DAX notifications to. Example:\\narn:aws:sns:us-east-1:012345678999:my_sns_topic"', args=[d.arg(name='notificationTopicArn', type=d.T.string)]),
      withNotificationTopicArn(notificationTopicArn): { spec+: { forProvider+: { notificationTopicArn: notificationTopicArn } } },
      '#withParameterGroupName':: d.fn(help='"Name of the parameter group to associate\\nwith this DAX cluster"', args=[d.arg(name='parameterGroupName', type=d.T.string)]),
      ...
      '#withReplicationFactor':: d.fn(help='"The number of nodes in the DAX cluster. A\\nreplication factor of 1 will create a single-node cluster, without any read\\nreplicas"', args=[d.arg(name='replicationFactor', type=d.T.number)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"One or more VPC security groups associated\\nwith the cluster"', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSubnetGroupName':: d.fn(help='"Name of the subnet group to be used for the\\ncluster"', args=[d.arg(name='subnetGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withClusterEndpointEncryptionType':: d.fn(help="\"The type of encryption the\\ncluster's endpoint should support. Valid values are: NONE and TLS.\\nDefault value is NONE.\"", args=[d.arg(name='clusterEndpointEncryptionType', type=d.T.string)]),
      withClusterEndpointEncryptionType(clusterEndpointEncryptionType): { spec+: { initProvider+: { clusterEndpointEncryptionType: clusterEndpointEncryptionType } } },
      '#withDescription':: d.fn(help='"Description for the cluster"', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withReplicationFactor':: d.fn(help='"The number of nodes in the DAX cluster. A\\nreplication factor of 1 will create a single-node cluster, without any read\\nreplicas"', args=[d.arg(name='replicationFactor', type=d.T.number)]),
      withReplicationFactor(replicationFactor): { spec+: { initProvider+: { replicationFactor: replicationFactor } } },
      '#withSecurityGroupIdRefs':: d.fn(help='"References to SecurityGroup in ec2 to populate securityGroupIds."', args=[d.arg(name='securityGroupIdRefs', type=d.T.array)]),
