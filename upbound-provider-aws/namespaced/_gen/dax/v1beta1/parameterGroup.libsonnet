{
  ...
  '#':: d.pkg(name='parameterGroup', url='', help='"ParameterGroup is the Schema for the ParameterGroups API. Provides an DAX Parameter Group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#parameters':: d.obj(help='"The parameters of the parameter group."'),
      parameters: {
        '#withName':: d.fn(help='"The name of the parameter."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"The value for the parameter."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withDescription':: d.fn(help='"A description of the parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withParameters':: d.fn(help='"The parameters of the parameter group."', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"The parameters of the parameter group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
