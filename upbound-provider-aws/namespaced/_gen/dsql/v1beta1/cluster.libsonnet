{
  ...
  spec: {
    ...
    forProvider: {
      '#multiRegionProperties':: d.obj(help='"Multi-region properties of the DSQL Cluster."'),
      multiRegionProperties: {
        '#withClusters':: d.fn(help='"List of DSQL Cluster ARNs peered to this cluster."', args=[d.arg(name='clusters', type=d.T.array)]),
        withClusters(clusters): { clusters: if std.isArray(v=clusters) then clusters else [clusters] },
        '#withClustersMixin':: d.fn(help='"List of DSQL Cluster ARNs peered to this cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='clusters', type=d.T.array)]),
        withClustersMixin(clusters): { clusters+: if std.isArray(v=clusters) then clusters else [clusters] },
        '#withWitnessRegion':: d.fn(help='"Witness region for the multi-region clusters. Setting this makes this cluster a multi-region cluster. Changing it recreates the resource."', args=[d.arg(name='witnessRegion', type=d.T.string)]),
        withWitnessRegion(witnessRegion): { witnessRegion: witnessRegion },
      },
      '#withDeletionProtectionEnabled':: d.fn(help='"Whether deletion protection is enabled in this cluster."', args=[d.arg(name='deletionProtectionEnabled', type=d.T.boolean)]),
      ...
      '#withKmsEncryptionKey':: d.fn(help='"The ARN of the AWS KMS key that encrypts data in the DSQL Cluster, or \\"AWS_OWNED_KMS_KEY\\"."', args=[d.arg(name='kmsEncryptionKey', type=d.T.string)]),
      withKmsEncryptionKey(kmsEncryptionKey): { spec+: { forProvider+: { kmsEncryptionKey: kmsEncryptionKey } } },
      '#withMultiRegionProperties':: d.fn(help='"Multi-region properties of the DSQL Cluster."', args=[d.arg(name='multiRegionProperties', type=d.T.array)]),
      withMultiRegionProperties(multiRegionProperties): { spec+: { forProvider+: { multiRegionProperties: if std.isArray(v=multiRegionProperties) then multiRegionProperties else [multiRegionProperties] } } },
      '#withMultiRegionPropertiesMixin':: d.fn(help='"Multi-region properties of the DSQL Cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='multiRegionProperties', type=d.T.array)]),
      withMultiRegionPropertiesMixin(multiRegionProperties): { spec+: { forProvider+: { multiRegionProperties+: if std.isArray(v=multiRegionProperties) then multiRegionProperties else [multiRegionProperties] } } },
    ...
    initProvider: {
      ...
      '#withKmsEncryptionKey':: d.fn(help='"The ARN of the AWS KMS key that encrypts data in the DSQL Cluster, or \\"AWS_OWNED_KMS_KEY\\"."', args=[d.arg(name='kmsEncryptionKey', type=d.T.string)]),
      withKmsEncryptionKey(kmsEncryptionKey): { spec+: { initProvider+: { kmsEncryptionKey: kmsEncryptionKey } } },
      '#withMultiRegionProperties':: d.fn(help='"Multi-region properties of the DSQL Cluster."', args=[d.arg(name='multiRegionProperties', type=d.T.array)]),
      withMultiRegionProperties(multiRegionProperties): { spec+: { initProvider+: { multiRegionProperties: if std.isArray(v=multiRegionProperties) then multiRegionProperties else [multiRegionProperties] } } },
      '#withMultiRegionPropertiesMixin':: d.fn(help='"Multi-region properties of the DSQL Cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='multiRegionProperties', type=d.T.array)]),
      withMultiRegionPropertiesMixin(multiRegionProperties): { spec+: { initProvider+: { multiRegionProperties+: if std.isArray(v=multiRegionProperties) then multiRegionProperties else [multiRegionProperties] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
