{
  ...
  '#':: d.pkg(name='ruleGroupNamespace', url='', help='"RuleGroupNamespace is the Schema for the RuleGroupNamespaces API. Manages an Amazon Managed Service for Prometheus (AMP) Rule Group Namespace"'),
  ...
  '#new':: d.fn(help='new returns an instance of RuleGroupNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'amp.aws.m.upbound.io/v1beta1',
    kind: 'RuleGroupNamespace',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RuleGroupNamespaceSpec defines the desired state of RuleGroupNamespace"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withData':: d.fn(help='"the rule group namespace data that you want to be applied. See more in AWS Docs."', args=[d.arg(name='data', type=d.T.string)]),
      ...
      '#withWorkspaceId':: d.fn(help='"ID of the prometheus workspace the rule group namespace should be linked to."', args=[d.arg(name='workspaceId', type=d.T.string)]),
