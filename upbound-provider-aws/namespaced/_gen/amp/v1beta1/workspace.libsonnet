{
  ...
  '#':: d.pkg(name='workspace', url='', help='"Workspace is the Schema for the Workspaces API. Manages an Amazon Managed Service for Prometheus (AMP) Workspace"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#loggingConfiguration':: d.obj(help='"Logging configuration for the workspace. See Logging Configuration below for details."'),
      loggingConfiguration: {
        '#withLogGroupArn':: d.fn(help='"The ARN of the CloudWatch log group to which the vended log data will be published. This log group must exist."', args=[d.arg(name='logGroupArn', type=d.T.string)]),
        withLogGroupArn(logGroupArn): { spec+: { forProvider+: { loggingConfiguration+: { logGroupArn: logGroupArn } } } },
      },
      '#withAlias':: d.fn(help='"The alias of the prometheus workspace. See more in AWS Docs."', args=[d.arg(name='alias', type=d.T.string)]),
      withAlias(alias): { spec+: { forProvider+: { alias: alias } } },
      '#withKmsKeyArn':: d.fn(help='"The ARN for the KMS encryption key. If this argument is not provided, then the AWS owned encryption key will be used to encrypt the data in the workspace. See more in AWS Docs"', args=[d.arg(name='kmsKeyArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      loggingConfiguration: {
        '#withLogGroupArn':: d.fn(help='"The ARN of the CloudWatch log group to which the vended log data will be published. This log group must exist."', args=[d.arg(name='logGroupArn', type=d.T.string)]),
        withLogGroupArn(logGroupArn): { spec+: { initProvider+: { loggingConfiguration+: { logGroupArn: logGroupArn } } } },
      },
      '#withAlias':: d.fn(help='"The alias of the prometheus workspace. See more in AWS Docs."', args=[d.arg(name='alias', type=d.T.string)]),
