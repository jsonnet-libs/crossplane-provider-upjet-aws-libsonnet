{
  ...
  '#':: d.pkg(name='region', url='', help='"Region is the Schema for the Regions API. Enable (Opt-In) or Disable (Opt-Out) a particular Region for an AWS account"'),
  ...
  '#new':: d.fn(help='new returns an instance of Region', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'account.aws.m.upbound.io/v1beta1',
    kind: 'Region',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RegionSpec defines the desired state of Region"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAccountId':: d.fn(help="\"The ID of the target account when managing member accounts. Will manage current user's account by default if omitted. To use this parameter, the caller must be an identity in the organization's management account or a delegated administrator account. The specified account ID must also be a member account in the same organization. The organization must have all features enabled, and the organization must have trusted access enabled for the Account Management service, and optionally a delegated admin account assigned.\"", args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withEnabled':: d.fn(help='"Whether the region is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withRegionName':: d.fn(help='"The region name to manage."', args=[d.arg(name='regionName', type=d.T.string)]),
      withRegionName(regionName): { spec+: { forProvider+: { regionName: regionName } } },
    },
