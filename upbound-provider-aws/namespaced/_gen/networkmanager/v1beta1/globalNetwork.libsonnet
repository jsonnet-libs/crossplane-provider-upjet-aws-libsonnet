{
  ...
  '#':: d.pkg(name='globalNetwork', url='', help='"GlobalNetwork is the Schema for the GlobalNetworks API. Manages a Network Manager Global Network."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalNetwork', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networkmanager.aws.m.upbound.io/v1beta1',
    kind: 'GlobalNetwork',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GlobalNetworkSpec defines the desired state of GlobalNetwork"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the Global Network."', args=[d.arg(name='description', type=d.T.string)]),
