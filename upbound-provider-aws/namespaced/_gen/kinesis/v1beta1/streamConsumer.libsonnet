{
  ...
  '#':: d.pkg(name='streamConsumer', url='', help='"StreamConsumer is the Schema for the StreamConsumers API. Manages a Kinesis Stream Consumer."'),
  ...
  '#new':: d.fn(help='new returns an instance of StreamConsumer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'kinesis.aws.m.upbound.io/v1beta1',
    kind: 'StreamConsumer',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"StreamConsumerSpec defines the desired state of StreamConsumer"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Name of the stream consumer."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withStreamArn':: d.fn(help='"Amazon Resource Name (ARN) of the data stream the consumer is registered with."', args=[d.arg(name='streamArn', type=d.T.string)]),
