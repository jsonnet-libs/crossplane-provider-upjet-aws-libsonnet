{
  ...
  '#':: d.pkg(name='readinessCheck', url='', help='"ReadinessCheck is the Schema for the ReadinessChecks API. Provides an AWS Route 53 Recovery Readiness Readiness Check"'),
  ...
  '#new':: d.fn(help='new returns an instance of ReadinessCheck', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'route53recoveryreadiness.aws.m.upbound.io/v1beta1',
    kind: 'ReadinessCheck',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ReadinessCheckSpec defines the desired state of ReadinessCheck"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withResourceSetName':: d.fn(help='"Name describing the resource set that will be monitored for readiness."', args=[d.arg(name='resourceSetName', type=d.T.string)]),
      withResourceSetName(resourceSetName): { spec+: { forProvider+: { resourceSetName: resourceSetName } } },
    ...
    initProvider: {
      '#withResourceSetName':: d.fn(help='"Name describing the resource set that will be monitored for readiness."', args=[d.arg(name='resourceSetName', type=d.T.string)]),
      withResourceSetName(resourceSetName): { spec+: { initProvider+: { resourceSetName: resourceSetName } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
