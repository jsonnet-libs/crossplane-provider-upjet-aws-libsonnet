{
  ...
  '#':: d.pkg(name='recoveryGroup', url='', help='"RecoveryGroup is the Schema for the RecoveryGroups API. Provides an AWS Route 53 Recovery Readiness Recovery Group"'),
  ...
  '#new':: d.fn(help='new returns an instance of RecoveryGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'route53recoveryreadiness.aws.m.upbound.io/v1beta1',
    kind: 'RecoveryGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RecoveryGroupSpec defines the desired state of RecoveryGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCells':: d.fn(help='"List of cell arns to add as nested fault domains within this recovery group"', args=[d.arg(name='cells', type=d.T.array)]),
      withCells(cells): { spec+: { forProvider+: { cells: if std.isArray(v=cells) then cells else [cells] } } },
      '#withCellsMixin':: d.fn(help='"List of cell arns to add as nested fault domains within this recovery group"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cells', type=d.T.array)]),
      withCellsMixin(cells): { spec+: { forProvider+: { cells+: if std.isArray(v=cells) then cells else [cells] } } },
    ...
    initProvider: {
      '#withCells':: d.fn(help='"List of cell arns to add as nested fault domains within this recovery group"', args=[d.arg(name='cells', type=d.T.array)]),
      withCells(cells): { spec+: { initProvider+: { cells: if std.isArray(v=cells) then cells else [cells] } } },
      '#withCellsMixin':: d.fn(help='"List of cell arns to add as nested fault domains within this recovery group"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cells', type=d.T.array)]),
      withCellsMixin(cells): { spec+: { initProvider+: { cells+: if std.isArray(v=cells) then cells else [cells] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
