{
  ...
  '#':: d.pkg(name='cell', url='', help='"Cell is the Schema for the Cells API. Provides an AWS Route 53 Recovery Readiness Cell"'),
  ...
  '#new':: d.fn(help='new returns an instance of Cell', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'route53recoveryreadiness.aws.m.upbound.io/v1beta1',
    kind: 'Cell',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CellSpec defines the desired state of Cell"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCells':: d.fn(help='"List of cell arns to add as nested fault domains within this cell."', args=[d.arg(name='cells', type=d.T.array)]),
      withCells(cells): { spec+: { forProvider+: { cells: if std.isArray(v=cells) then cells else [cells] } } },
      '#withCellsMixin':: d.fn(help='"List of cell arns to add as nested fault domains within this cell."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cells', type=d.T.array)]),
