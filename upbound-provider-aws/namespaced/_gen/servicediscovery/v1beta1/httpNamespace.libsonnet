{
  ...
  '#':: d.pkg(name='httpNamespace', url='', help='"HTTPNamespace is the Schema for the HTTPNamespaces API. Provides a Service Discovery HTTP Namespace resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of HTTPNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'servicediscovery.aws.m.upbound.io/v1beta1',
    kind: 'HTTPNamespace',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"HTTPNamespaceSpec defines the desired state of HTTPNamespace"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"The name of the http namespace."', args=[d.arg(name='name', type=d.T.string)]),
