{
  ...
  '#':: d.pkg(name='secret', url='', help='"Secret is the Schema for the Secrets API. Provides a resource to manage AWS Secrets Manager secret metadata"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#replica':: d.obj(help='"Configuration block to support secret replication. See details below."'),
      replica: {
        '#withKmsKeyId':: d.fn(help="\"ARN, Key ID, or Alias of the AWS KMS key within the region secret is replicated to. If one is not specified, then Secrets Manager defaults to using the AWS account's default KMS key (aws/secretsmanager) in the region or creates one for use if non-existent.\"", args=[d.arg(name='kmsKeyId', type=d.T.string)]),
        withKmsKeyId(kmsKeyId): { kmsKeyId: kmsKeyId },
        '#withRegion':: d.fn(help='"Region for replicating the secret."', args=[d.arg(name='region', type=d.T.string)]),
        withRegion(region): { region: region },
      },
      '#withDescription':: d.fn(help='"Description of the secret."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withForceOverwriteReplicaSecret':: d.fn(help='"Accepts boolean value to specify whether to overwrite a secret with the same name in the destination Region."', args=[d.arg(name='forceOverwriteReplicaSecret', type=d.T.boolean)]),
      ...
      '#withKmsKeyId':: d.fn(help="\"ARN or Id of the AWS KMS key to be used to encrypt the secret values in the versions stored in this secret. If you need to reference a CMK in a different account, you can use only the key ARN. If you don't specify this value, then Secrets Manager defaults to using the AWS account's default KMS key (the one named aws/secretsmanager). If the default KMS key with that name doesn't yet exist, then AWS Secrets Manager creates it for you automatically the first time.\"", args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { kmsKeyId: kmsKeyId } } },
      '#withName':: d.fn(help='"Friendly name of the new secret. The secret name can consist of uppercase letters, lowercase letters, digits, and any of the following characters: /_+=.@- Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRecoveryWindowInDays':: d.fn(help='"Number of days that AWS Secrets Manager waits before it can delete the secret. This value can be 0 to force deletion without recovery or range from 7 to 30 days. The default value is 30."', args=[d.arg(name='recoveryWindowInDays', type=d.T.number)]),
      ...
      '#withReplica':: d.fn(help='"Configuration block to support secret replication. See details below."', args=[d.arg(name='replica', type=d.T.array)]),
      withReplica(replica): { spec+: { forProvider+: { replica: if std.isArray(v=replica) then replica else [replica] } } },
      '#withReplicaMixin':: d.fn(help='"Configuration block to support secret replication. See details below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='replica', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withForceOverwriteReplicaSecret':: d.fn(help='"Accepts boolean value to specify whether to overwrite a secret with the same name in the destination Region."', args=[d.arg(name='forceOverwriteReplicaSecret', type=d.T.boolean)]),
      withForceOverwriteReplicaSecret(forceOverwriteReplicaSecret): { spec+: { initProvider+: { forceOverwriteReplicaSecret: forceOverwriteReplicaSecret } } },
      '#withKmsKeyId':: d.fn(help="\"ARN or Id of the AWS KMS key to be used to encrypt the secret values in the versions stored in this secret. If you need to reference a CMK in a different account, you can use only the key ARN. If you don't specify this value, then Secrets Manager defaults to using the AWS account's default KMS key (the one named aws/secretsmanager). If the default KMS key with that name doesn't yet exist, then AWS Secrets Manager creates it for you automatically the first time.\"", args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { initProvider+: { kmsKeyId: kmsKeyId } } },
      '#withName':: d.fn(help='"Friendly name of the new secret. The secret name can consist of uppercase letters, lowercase letters, digits, and any of the following characters: /_+=.@- Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withRecoveryWindowInDays':: d.fn(help='"Number of days that AWS Secrets Manager waits before it can delete the secret. This value can be 0 to force deletion without recovery or range from 7 to 30 days. The default value is 30."', args=[d.arg(name='recoveryWindowInDays', type=d.T.number)]),
      withRecoveryWindowInDays(recoveryWindowInDays): { spec+: { initProvider+: { recoveryWindowInDays: recoveryWindowInDays } } },
      '#withReplica':: d.fn(help='"Configuration block to support secret replication. See details below."', args=[d.arg(name='replica', type=d.T.array)]),
