{
  ...
  '#':: d.pkg(name='registry', url='', help='"Registry is the Schema for the Registrys API. Provides a Glue Registry resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"A description of the registry."', args=[d.arg(name='description', type=d.T.string)]),
