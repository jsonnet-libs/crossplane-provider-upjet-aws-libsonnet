{
  ...
  '#':: d.pkg(name='activeReceiptRuleSet', url='', help='"ActiveReceiptRuleSet is the Schema for the ActiveReceiptRuleSets API. Provides a resource to designate the active SES receipt rule set"'),
  ...
  '#new':: d.fn(help='new returns an instance of ActiveReceiptRuleSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ses.aws.m.upbound.io/v1beta1',
    kind: 'ActiveReceiptRuleSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ActiveReceiptRuleSetSpec defines the desired state of ActiveReceiptRuleSet"'),
  spec: {
