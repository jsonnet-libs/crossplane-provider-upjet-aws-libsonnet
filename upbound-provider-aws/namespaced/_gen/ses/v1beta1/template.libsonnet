{
  ...
  '#':: d.pkg(name='template', url='', help='"Template is the Schema for the Templates API. Provides a resource to create a SES template"'),
  ...
  '#new':: d.fn(help='new returns an instance of Template', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ses.aws.m.upbound.io/v1beta1',
    kind: 'Template',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TemplateSpec defines the desired state of Template"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withHtml':: d.fn(help='"The HTML body of the email. Must be less than 500KB in size, including both the text and HTML parts."', args=[d.arg(name='html', type=d.T.string)]),
      withHtml(html): { spec+: { forProvider+: { html: html } } },
      ...
      '#withSubject':: d.fn(help='"The subject line of the email."', args=[d.arg(name='subject', type=d.T.string)]),
      withSubject(subject): { spec+: { forProvider+: { subject: subject } } },
      '#withText':: d.fn(help='"The email body that will be visible to recipients whose email clients do not display HTML. Must be less than 500KB in size, including both the text and HTML parts."', args=[d.arg(name='text', type=d.T.string)]),
      withText(text): { spec+: { forProvider+: { text: text } } },
    },
    ...
    initProvider: {
      '#withHtml':: d.fn(help='"The HTML body of the email. Must be less than 500KB in size, including both the text and HTML parts."', args=[d.arg(name='html', type=d.T.string)]),
      withHtml(html): { spec+: { initProvider+: { html: html } } },
      '#withSubject':: d.fn(help='"The subject line of the email."', args=[d.arg(name='subject', type=d.T.string)]),
      withSubject(subject): { spec+: { initProvider+: { subject: subject } } },
      '#withText':: d.fn(help='"The email body that will be visible to recipients whose email clients do not display HTML. Must be less than 500KB in size, including both the text and HTML parts."', args=[d.arg(name='text', type=d.T.string)]),
      withText(text): { spec+: { initProvider+: { text: text } } },
    },
