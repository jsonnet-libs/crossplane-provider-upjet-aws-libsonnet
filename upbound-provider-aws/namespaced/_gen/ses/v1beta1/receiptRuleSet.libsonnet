{
  ...
  '#':: d.pkg(name='receiptRuleSet', url='', help='"ReceiptRuleSet is the Schema for the ReceiptRuleSets API. Provides an SES receipt rule set resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of ReceiptRuleSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ses.aws.m.upbound.io/v1beta1',
    kind: 'ReceiptRuleSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ReceiptRuleSetSpec defines the desired state of ReceiptRuleSet"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRuleSetName':: d.fn(help='"Name of the rule set."', args=[d.arg(name='ruleSetName', type=d.T.string)]),
