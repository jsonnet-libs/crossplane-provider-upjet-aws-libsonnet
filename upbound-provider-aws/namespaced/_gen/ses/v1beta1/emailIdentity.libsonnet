{
  ...
  '#':: d.pkg(name='emailIdentity', url='', help='"EmailIdentity is the Schema for the EmailIdentitys API. Provides an SES email identity resource"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withEmail':: d.fn(help='"The email address to assign to SES."', args=[d.arg(name='email', type=d.T.string)]),
