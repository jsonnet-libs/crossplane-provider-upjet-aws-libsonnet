{
  ...
  '#':: d.pkg(name='receiptFilter', url='', help='"ReceiptFilter is the Schema for the ReceiptFilters API. Provides an SES receipt filter"'),
  ...
  '#new':: d.fn(help='new returns an instance of ReceiptFilter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ses.aws.m.upbound.io/v1beta1',
    kind: 'ReceiptFilter',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ReceiptFilterSpec defines the desired state of ReceiptFilter"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCidr':: d.fn(help='"The IP address or address range to filter, in CIDR notation"', args=[d.arg(name='cidr', type=d.T.string)]),
      withCidr(cidr): { spec+: { forProvider+: { cidr: cidr } } },
      '#withPolicy':: d.fn(help='"Block or Allow"', args=[d.arg(name='policy', type=d.T.string)]),
