{
  ...
  '#':: d.pkg(name='cluster', url='', help='"Cluster is the Schema for the Clusters API. Provides an AWS Route 53 Recovery Control Config Cluster"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"Unique name describing the cluster."', args=[d.arg(name='name', type=d.T.string)]),
