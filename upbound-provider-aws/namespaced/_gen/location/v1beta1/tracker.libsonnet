{
  ...
  '#':: d.pkg(name='tracker', url='', help='"Tracker is the Schema for the Trackers API. Provides a Location Service Tracker."'),
  ...
  '#new':: d.fn(help='new returns an instance of Tracker', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'location.aws.m.upbound.io/v1beta1',
    kind: 'Tracker',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TrackerSpec defines the desired state of Tracker"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The optional description for the tracker resource."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withKmsKeyId':: d.fn(help='"A key identifier for an AWS KMS customer managed key assigned to the Amazon Location resource."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { kmsKeyId: kmsKeyId } } },
      '#withPositionFiltering':: d.fn(help='"The position filtering method of the tracker resource. Valid values: TimeBased, DistanceBased, AccuracyBased. Default: TimeBased."', args=[d.arg(name='positionFiltering', type=d.T.string)]),
      withPositionFiltering(positionFiltering): { spec+: { forProvider+: { positionFiltering: positionFiltering } } },
    ...
    initProvider: {
      ...
      '#withPositionFiltering':: d.fn(help='"The position filtering method of the tracker resource. Valid values: TimeBased, DistanceBased, AccuracyBased. Default: TimeBased."', args=[d.arg(name='positionFiltering', type=d.T.string)]),
      withPositionFiltering(positionFiltering): { spec+: { initProvider+: { positionFiltering: positionFiltering } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
