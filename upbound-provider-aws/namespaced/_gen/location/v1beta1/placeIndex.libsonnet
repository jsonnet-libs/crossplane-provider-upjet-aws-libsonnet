  ...
  spec: {
    ...
    forProvider: {
      ...
      dataSourceConfiguration: {
        ...
        withIntendedUse(intendedUse): { spec+: { forProvider+: { dataSourceConfiguration+: { intendedUse: intendedUse } } } },
      },
    ...
    initProvider: {
      ...
      dataSourceConfiguration: {
        '#withIntendedUse':: d.fn(help='"Specifies how the results of an operation will be stored by the caller. Valid values: SingleUse, Storage. Default: SingleUse."', args=[d.arg(name='intendedUse', type=d.T.string)]),
        withIntendedUse(intendedUse): { spec+: { initProvider+: { dataSourceConfiguration+: { intendedUse: intendedUse } } } },
      },
      '#withDataSource':: d.fn(help='"Specifies the geospatial data provider for the new place index."', args=[d.arg(name='dataSource', type=d.T.string)]),
