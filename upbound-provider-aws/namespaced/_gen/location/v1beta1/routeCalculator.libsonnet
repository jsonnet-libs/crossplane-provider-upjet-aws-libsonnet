{
  ...
  '#':: d.pkg(name='routeCalculator', url='', help='"RouteCalculator is the Schema for the RouteCalculators API. Provides a Location Service Route Calculator."'),
  ...
  '#new':: d.fn(help='new returns an instance of RouteCalculator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'location.aws.m.upbound.io/v1beta1',
    kind: 'RouteCalculator',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RouteCalculatorSpec defines the desired state of RouteCalculator"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDataSource':: d.fn(help='"Specifies the data provider of traffic and road network data."', args=[d.arg(name='dataSource', type=d.T.string)]),
      withDataSource(dataSource): { spec+: { forProvider+: { dataSource: dataSource } } },
      '#withDescription':: d.fn(help='"The optional description for the route calculator resource."', args=[d.arg(name='description', type=d.T.string)]),
