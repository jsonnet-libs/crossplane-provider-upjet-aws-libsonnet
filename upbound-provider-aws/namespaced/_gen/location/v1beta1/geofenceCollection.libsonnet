{
  ...
  '#':: d.pkg(name='geofenceCollection', url='', help='"GeofenceCollection is the Schema for the GeofenceCollections API."'),
  ...
  '#new':: d.fn(help='new returns an instance of GeofenceCollection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'location.aws.m.upbound.io/v1beta1',
    kind: 'GeofenceCollection',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GeofenceCollectionSpec defines the desired state of GeofenceCollection"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The optional description for the geofence collection."', args=[d.arg(name='description', type=d.T.string)]),
