{
  ...
  '#':: d.pkg(name='revision', url='', help='"Revision is the Schema for the Revisions API. Provides a DataExchange Revision"'),
  ...
  '#new':: d.fn(help='new returns an instance of Revision', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'dataexchange.aws.m.upbound.io/v1beta1',
    kind: 'Revision',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RevisionSpec defines the desired state of Revision"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#dataSetIdRef':: d.obj(help='"Reference to a DataSet in dataexchange to populate dataSetId."'),
      dataSetIdRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { dataSetIdRef+: { namespace: namespace } } } },
      },
      '#dataSetIdSelector':: d.obj(help='"Selector for a DataSet in dataexchange to populate dataSetId."'),
      dataSetIdSelector: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { dataSetIdSelector+: { namespace: namespace } } } },
      },
      '#withComment':: d.fn(help='"An optional comment about the revision."', args=[d.arg(name='comment', type=d.T.string)]),
      withComment(comment): { spec+: { forProvider+: { comment: comment } } },
      '#withDataSetId':: d.fn(help='"The dataset id."', args=[d.arg(name='dataSetId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      dataSetIdRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { dataSetIdRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { dataSetIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { dataSetIdRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { dataSetIdRef+: { namespace: namespace } } } },
      },
      '#dataSetIdSelector':: d.obj(help='"Selector for a DataSet in dataexchange to populate dataSetId."'),
      dataSetIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { dataSetIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { dataSetIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { dataSetIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { dataSetIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { dataSetIdSelector+: { matchLabels+: matchLabels } } } },
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { dataSetIdSelector+: { namespace: namespace } } } },
      },
      '#withComment':: d.fn(help='"An optional comment about the revision."', args=[d.arg(name='comment', type=d.T.string)]),
      withComment(comment): { spec+: { initProvider+: { comment: comment } } },
      '#withDataSetId':: d.fn(help='"The dataset id."', args=[d.arg(name='dataSetId', type=d.T.string)]),
      withDataSetId(dataSetId): { spec+: { initProvider+: { dataSetId: dataSetId } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
