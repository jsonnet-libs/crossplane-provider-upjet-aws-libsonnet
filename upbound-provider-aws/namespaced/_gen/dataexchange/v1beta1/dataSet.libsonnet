{
  ...
  '#':: d.pkg(name='dataSet', url='', help='"DataSet is the Schema for the DataSets API. Provides a DataExchange DataSet"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAssetType':: d.fn(help='"The type of asset that is added to a data set. Valid values include API_GATEWAY_API, LAKE_FORMATION_DATA_PERMISSION, REDSHIFT_DATA_SHARE, S3_DATA_ACCESS, S3_SNAPSHOT."', args=[d.arg(name='assetType', type=d.T.string)]),
      withAssetType(assetType): { spec+: { forProvider+: { assetType: assetType } } },
      '#withDescription':: d.fn(help='"A description for the data set."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of the data set."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      '#withAssetType':: d.fn(help='"The type of asset that is added to a data set. Valid values include API_GATEWAY_API, LAKE_FORMATION_DATA_PERMISSION, REDSHIFT_DATA_SHARE, S3_DATA_ACCESS, S3_SNAPSHOT."', args=[d.arg(name='assetType', type=d.T.string)]),
      withAssetType(assetType): { spec+: { initProvider+: { assetType: assetType } } },
      '#withDescription':: d.fn(help='"A description for the data set."', args=[d.arg(name='description', type=d.T.string)]),
