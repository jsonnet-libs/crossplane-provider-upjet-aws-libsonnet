{
  ...
  new(name): {
    apiVersion: 'waf.aws.m.upbound.io/v1beta1',
    kind: 'WebACL',
  ...
  spec: {
    ...
    forProvider: {
      ...
      defaultAction: {
        '#withType':: d.fn(help="\"Specifies how you want AWS WAF to respond to requests that don't match the criteria in any of the rules.\\ne.g., ALLOW or BLOCK\"", args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { forProvider+: { defaultAction+: { type: type } } } },
      },
      ...
      loggingConfiguration: {
        ...
        logDestinationRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationRef+: { policy+: { resolution: resolution } } } } } },
            ...
            withResolve(resolve): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationRef+: { namespace: namespace } } } } },
        },
        ...
        logDestinationSelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationSelector+: { policy+: { resolve: resolve } } } } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationSelector+: { matchLabels+: matchLabels } } } } },
          '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { forProvider+: { loggingConfiguration+: { logDestinationSelector+: { namespace: namespace } } } } },
        },
        ...
        redactedFields: {
          ...
          withFieldToMatch(fieldToMatch): { spec+: { forProvider+: { loggingConfiguration+: { redactedFields+: { fieldToMatch: if std.isArray(v=fieldToMatch) then fieldToMatch else [fieldToMatch] } } } } },
          ...
          withFieldToMatchMixin(fieldToMatch): { spec+: { forProvider+: { loggingConfiguration+: { redactedFields+: { fieldToMatch+: if std.isArray(v=fieldToMatch) then fieldToMatch else [fieldToMatch] } } } } },
        },
      ...
      rules: {
        ...
        overrideAction: {
          '#withType':: d.fn(help='"valid values are: BLOCK, ALLOW, or COUNT"', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { overrideAction+: { type: type } },
        },
        ...
        ruleIdRef: {
          ...
          '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { ruleIdRef+: { namespace: namespace } },
        },
        ...
        ruleIdSelector: {
          ...
          '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { ruleIdSelector+: { namespace: namespace } },
        },
        '#withPriority':: d.fn(help='"Specifies the order in which the rules in a WebACL are evaluated.\\nRules with a lower value are evaluated before rules with a higher value."', args=[d.arg(name='priority', type=d.T.number)]),
    ...
    initProvider: {
      ...
      defaultAction: {
        '#withType':: d.fn(help="\"Specifies how you want AWS WAF to respond to requests that don't match the criteria in any of the rules.\\ne.g., ALLOW or BLOCK\"", args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { initProvider+: { defaultAction+: { type: type } } } },
      },
      '#loggingConfiguration':: d.obj(help='"Configuration block to enable WAF logging. Detailed below."'),
      loggingConfiguration: {
        '#logDestinationRef':: d.obj(help='"Reference to a DeliveryStream in firehose to populate logDestination."'),
        logDestinationRef: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationRef+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationRef+: { namespace: namespace } } } } },
        },
        '#logDestinationSelector':: d.obj(help='"Selector for a DeliveryStream in firehose to populate logDestination."'),
        logDestinationSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationSelector+: { policy+: { resolve: resolve } } } } } },
          },
          '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
          withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationSelector+: { matchLabels+: matchLabels } } } } },
          '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { initProvider+: { loggingConfiguration+: { logDestinationSelector+: { namespace: namespace } } } } },
        },
        '#redactedFields':: d.obj(help='"Configuration block containing parts of the request that you want redacted from the logs. Detailed below."'),
        redactedFields: {
          '#fieldToMatch':: d.obj(help='"Set of configuration blocks for fields to redact. Detailed below."'),
          ...
          '#withFieldToMatch':: d.fn(help='"Set of configuration blocks for fields to redact. Detailed below."', args=[d.arg(name='fieldToMatch', type=d.T.array)]),
          withFieldToMatch(fieldToMatch): { spec+: { initProvider+: { loggingConfiguration+: { redactedFields+: { fieldToMatch: if std.isArray(v=fieldToMatch) then fieldToMatch else [fieldToMatch] } } } } },
          '#withFieldToMatchMixin':: d.fn(help='"Set of configuration blocks for fields to redact. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fieldToMatch', type=d.T.array)]),
          withFieldToMatchMixin(fieldToMatch): { spec+: { initProvider+: { loggingConfiguration+: { redactedFields+: { fieldToMatch+: if std.isArray(v=fieldToMatch) then fieldToMatch else [fieldToMatch] } } } } },
        },
        '#withLogDestination':: d.fn(help='"Amazon Resource Name (ARN) of Kinesis Firehose Delivery Stream"', args=[d.arg(name='logDestination', type=d.T.string)]),
      ...
      '#withRules':: d.fn(help='"Configuration blocks containing rules to associate with the web ACL and the settings for each rule. Detailed below."', args=[d.arg(name='rules', type=d.T.array)]),
      withRules(rules): { spec+: { initProvider+: { rules: if std.isArray(v=rules) then rules else [rules] } } },
      '#withRulesMixin':: d.fn(help='"Configuration blocks containing rules to associate with the web ACL and the settings for each rule. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rules', type=d.T.array)]),
      withRulesMixin(rules): { spec+: { initProvider+: { rules+: if std.isArray(v=rules) then rules else [rules] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
