  ...
  spec: {
    ...
    forProvider: {
      ...
      configuration: {
        ...
        contentSourceConfiguration: {
          ...
          withDataSourceIds(dataSourceIds): { spec+: { forProvider+: { configuration+: { contentSourceConfiguration+: { dataSourceIds: if std.isArray(v=dataSourceIds) then dataSourceIds else [dataSourceIds] } } } } },
          ...
          withDataSourceIdsMixin(dataSourceIds): { spec+: { forProvider+: { configuration+: { contentSourceConfiguration+: { dataSourceIds+: if std.isArray(v=dataSourceIds) then dataSourceIds else [dataSourceIds] } } } } },
          ...
          withDirectPutContent(directPutContent): { spec+: { forProvider+: { configuration+: { contentSourceConfiguration+: { directPutContent: directPutContent } } } } },
          ...
          withFaqIds(faqIds): { spec+: { forProvider+: { configuration+: { contentSourceConfiguration+: { faqIds: if std.isArray(v=faqIds) then faqIds else [faqIds] } } } } },
          ...
          withFaqIdsMixin(faqIds): { spec+: { forProvider+: { configuration+: { contentSourceConfiguration+: { faqIds+: if std.isArray(v=faqIds) then faqIds else [faqIds] } } } } },
        },
        ...
        userIdentityConfiguration: {
          ...
          withIdentityAttributeName(identityAttributeName): { spec+: { forProvider+: { configuration+: { userIdentityConfiguration+: { identityAttributeName: identityAttributeName } } } } },
        },
      },
    ...
    initProvider: {
      ...
      configuration: {
        ...
        contentSourceConfiguration: {
          '#withDataSourceIds':: d.fn(help='"The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items."', args=[d.arg(name='dataSourceIds', type=d.T.array)]),
          withDataSourceIds(dataSourceIds): { spec+: { initProvider+: { configuration+: { contentSourceConfiguration+: { dataSourceIds: if std.isArray(v=dataSourceIds) then dataSourceIds else [dataSourceIds] } } } } },
          '#withDataSourceIdsMixin':: d.fn(help='"The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dataSourceIds', type=d.T.array)]),
          withDataSourceIdsMixin(dataSourceIds): { spec+: { initProvider+: { configuration+: { contentSourceConfiguration+: { dataSourceIds+: if std.isArray(v=dataSourceIds) then dataSourceIds else [dataSourceIds] } } } } },
          '#withDirectPutContent':: d.fn(help='"Whether to use documents you indexed directly using the BatchPutDocument API. Defaults to false."', args=[d.arg(name='directPutContent', type=d.T.boolean)]),
          withDirectPutContent(directPutContent): { spec+: { initProvider+: { configuration+: { contentSourceConfiguration+: { directPutContent: directPutContent } } } } },
          '#withFaqIds':: d.fn(help='"The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items."', args=[d.arg(name='faqIds', type=d.T.array)]),
          withFaqIds(faqIds): { spec+: { initProvider+: { configuration+: { contentSourceConfiguration+: { faqIds: if std.isArray(v=faqIds) then faqIds else [faqIds] } } } } },
          '#withFaqIdsMixin':: d.fn(help='"The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='faqIds', type=d.T.array)]),
          withFaqIdsMixin(faqIds): { spec+: { initProvider+: { configuration+: { contentSourceConfiguration+: { faqIds+: if std.isArray(v=faqIds) then faqIds else [faqIds] } } } } },
        },
        '#userIdentityConfiguration':: d.obj(help='"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."'),
        userIdentityConfiguration: {
          '#withIdentityAttributeName':: d.fn(help='"The AWS SSO field name that contains the identifiers of your users, such as their emails."', args=[d.arg(name='identityAttributeName', type=d.T.string)]),
          withIdentityAttributeName(identityAttributeName): { spec+: { initProvider+: { configuration+: { userIdentityConfiguration+: { identityAttributeName: identityAttributeName } } } } },
        },
      },
      '#indexIdRef':: d.obj(help='"Reference to a Index in kendra to populate indexId."'),
      indexIdRef: {
