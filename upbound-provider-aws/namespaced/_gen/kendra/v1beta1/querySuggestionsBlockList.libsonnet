{
  ...
  '#':: d.pkg(name='querySuggestionsBlockList', url='', help='"QuerySuggestionsBlockList is the Schema for the QuerySuggestionsBlockLists API. provider resource for managing an aws kendra block list used for query suggestions for an index"'),
  ...
  '#new':: d.fn(help='new returns an instance of QuerySuggestionsBlockList', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'kendra.aws.m.upbound.io/v1beta1',
    kind: 'QuerySuggestionsBlockList',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"QuerySuggestionsBlockListSpec defines the desired state of QuerySuggestionsBlockList"'),
  spec: {
    ...
    forProvider: {
      ...
      '#sourceS3Path':: d.obj(help='"S3 path where your block list text file is located. See details below."'),
      sourceS3Path: {
        ...
        '#withBucket':: d.fn(help='"Name of the S3 bucket that contains the file."', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { spec+: { forProvider+: { sourceS3Path+: { bucket: bucket } } } },
        '#withKey':: d.fn(help='"Name of the file."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { sourceS3Path+: { key: key } } } },
      },
      '#withDescription':: d.fn(help='"Description for a block list."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIndexId':: d.fn(help='"Identifier of the index for a block list."', args=[d.arg(name='indexId', type=d.T.string)]),
      withIndexId(indexId): { spec+: { forProvider+: { indexId: indexId } } },
      '#withName':: d.fn(help='"Name for the block list."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"IAM (Identity and Access Management) role used to access the block list text file in S3."', args=[d.arg(name='roleArn', type=d.T.string)]),
      withRoleArn(roleArn): { spec+: { forProvider+: { roleArn: roleArn } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags. If configured with a provider default_tags configuration block, tags with matching keys will overwrite those defined at the provider-level."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Key-value map of resource tags. If configured with a provider default_tags configuration block, tags with matching keys will overwrite those defined at the provider-level."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
