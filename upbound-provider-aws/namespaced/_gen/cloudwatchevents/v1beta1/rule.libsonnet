{
  ...
  '#':: d.pkg(name='rule', url='', help='"Rule is the Schema for the Rules API. Provides an EventBridge Rule resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventBusName':: d.fn(help='"The name or ARN of the event bus to associate with this rule. If you omit this, the default event bus is used."', args=[d.arg(name='eventBusName', type=d.T.string)]),
      withEventBusName(eventBusName): { spec+: { forProvider+: { eventBusName: eventBusName } } },
      '#withEventPattern':: d.fn(help='"The event pattern described a JSON object. At least one of schedule_expression or event_pattern is required. See full documentation of Events and Event Patterns in EventBridge for details. Note: The event pattern size is 2048 by default but it is adjustable up to 4096 characters by submitting a service quota increase request. See Amazon EventBridge quotas for details."', args=[d.arg(name='eventPattern', type=d.T.string)]),
      ...
      '#withIsEnabled':: d.fn(help='"Whether the rule should be enabled. Defaults to true. Conflicts with state."', args=[d.arg(name='isEnabled', type=d.T.boolean)]),
      ...
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) associated with the role that is used for target invocation."', args=[d.arg(name='roleArn', type=d.T.string)]),
      withRoleArn(roleArn): { spec+: { forProvider+: { roleArn: roleArn } } },
      '#withScheduleExpression':: d.fn(help='"The scheduling expression. For example, cron(0 20 * * ? *) or rate(5 minutes). At least one of schedule_expression or event_pattern is required. Can only be used on the default event bus. For more information, refer to the AWS documentation Schedule Expressions for Rules."', args=[d.arg(name='scheduleExpression', type=d.T.string)]),
      withScheduleExpression(scheduleExpression): { spec+: { forProvider+: { scheduleExpression: scheduleExpression } } },
      '#withState':: d.fn(help='"State of the rule. Valid values are DISABLED, ENABLED, and ENABLED_WITH_ALL_CLOUDTRAIL_MANAGEMENT_EVENTS. When state is ENABLED, the rule is enabled for all events except those delivered by CloudTrail. To also enable the rule for events delivered by CloudTrail, set state to ENABLED_WITH_ALL_CLOUDTRAIL_MANAGEMENT_EVENTS. Defaults to ENABLED. Conflicts with is_enabled."', args=[d.arg(name='state', type=d.T.string)]),
