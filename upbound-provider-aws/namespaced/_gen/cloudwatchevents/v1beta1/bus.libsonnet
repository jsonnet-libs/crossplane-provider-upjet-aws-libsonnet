{
  ...
  '#':: d.pkg(name='bus', url='', help='"Bus is the Schema for the Buss API. Provides an EventBridge event bus resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Bus', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudwatchevents.aws.m.upbound.io/v1beta1',
    kind: 'Bus',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BusSpec defines the desired state of Bus"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#deadLetterConfig':: d.obj(help='"Configuration details of the Amazon SQS queue for EventBridge to use as a dead-letter queue (DLQ). This block supports the following arguments:"'),
      deadLetterConfig: {
        '#withArn':: d.fn(help='"The ARN of the SQS queue specified as the target for the dead-letter queue."', args=[d.arg(name='arn', type=d.T.string)]),
        withArn(arn): { spec+: { forProvider+: { deadLetterConfig+: { arn: arn } } } },
      },
      '#logConfig':: d.obj(help='"configured"'),
      logConfig: {
        '#withIncludeDetail':: d.fn(help='"Whether EventBridge include detailed event information in the records it generates. Valid values are NONE and FULL."', args=[d.arg(name='includeDetail', type=d.T.string)]),
        withIncludeDetail(includeDetail): { spec+: { forProvider+: { logConfig+: { includeDetail: includeDetail } } } },
        '#withLevel':: d.fn(help='"Level of logging detail to include. Valid values are OFF, ERROR, INFO, and TRACE."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { forProvider+: { logConfig+: { level: level } } } },
      },
      '#withDescription':: d.fn(help='"Event bus description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEventSourceName':: d.fn(help='"Partner event source that the new event bus will be matched with. Must match name."', args=[d.arg(name='eventSourceName', type=d.T.string)]),
      withEventSourceName(eventSourceName): { spec+: { forProvider+: { eventSourceName: eventSourceName } } },
      '#withKmsKeyIdentifier':: d.fn(help='"Identifier of the AWS KMS customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt events on this event bus. The identifier can be the key Amazon Resource Name (ARN), KeyId, key alias, or key alias ARN."', args=[d.arg(name='kmsKeyIdentifier', type=d.T.string)]),
    ...
    initProvider: {
      ...
      logConfig: {
        '#withIncludeDetail':: d.fn(help='"Whether EventBridge include detailed event information in the records it generates. Valid values are NONE and FULL."', args=[d.arg(name='includeDetail', type=d.T.string)]),
        withIncludeDetail(includeDetail): { spec+: { initProvider+: { logConfig+: { includeDetail: includeDetail } } } },
        '#withLevel':: d.fn(help='"Level of logging detail to include. Valid values are OFF, ERROR, INFO, and TRACE."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { initProvider+: { logConfig+: { level: level } } } },
      },
      '#withDescription':: d.fn(help='"Event bus description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withEventSourceName':: d.fn(help='"Partner event source that the new event bus will be matched with. Must match name."', args=[d.arg(name='eventSourceName', type=d.T.string)]),
      withEventSourceName(eventSourceName): { spec+: { initProvider+: { eventSourceName: eventSourceName } } },
      '#withKmsKeyIdentifier':: d.fn(help='"Identifier of the AWS KMS customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt events on this event bus. The identifier can be the key Amazon Resource Name (ARN), KeyId, key alias, or key alias ARN."', args=[d.arg(name='kmsKeyIdentifier', type=d.T.string)]),
