{
  ...
  '#':: d.pkg(name='configuration', url='', help='"Configuration is the Schema for the Configurations API. \\"Manages an Amazon MQ configuration\\'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAuthenticationStrategy':: d.fn(help='"Authentication strategy associated with the configuration. Valid values are simple and ldap. ldap is not supported for RabbitMQ engine type."', args=[d.arg(name='authenticationStrategy', type=d.T.string)]),
      withAuthenticationStrategy(authenticationStrategy): { spec+: { forProvider+: { authenticationStrategy: authenticationStrategy } } },
      '#withData':: d.fn(help='"Broker configuration in XML format for ActiveMQ or Cuttlefish format for RabbitMQ. See AWS documentation for supported parameters and format of the XML."', args=[d.arg(name='data', type=d.T.string)]),
