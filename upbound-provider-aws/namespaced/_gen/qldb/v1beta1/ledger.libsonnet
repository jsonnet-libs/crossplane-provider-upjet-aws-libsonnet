{
  ...
  '#':: d.pkg(name='ledger', url='', help='"Ledger is the Schema for the Ledgers API. Provides an QLDB Resource resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Ledger', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'qldb.aws.m.upbound.io/v1beta1',
    kind: 'Ledger',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LedgerSpec defines the desired state of Ledger"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDeletionProtection':: d.fn(help='"The deletion protection for the QLDB Ledger instance. By default it is true."', args=[d.arg(name='deletionProtection', type=d.T.boolean)]),
      withDeletionProtection(deletionProtection): { spec+: { forProvider+: { deletionProtection: deletionProtection } } },
      '#withKmsKey':: d.fn(help='"The key in AWS Key Management Service (AWS KMS) to use for encryption of data at rest in the ledger. For more information, see the AWS documentation. Valid values are \\"AWS_OWNED_KMS_KEY\\" to use an AWS KMS key that is owned and managed by AWS on your behalf, or the ARN of a valid symmetric customer managed KMS key."', args=[d.arg(name='kmsKey', type=d.T.string)]),
      withKmsKey(kmsKey): { spec+: { forProvider+: { kmsKey: kmsKey } } },
      '#withPermissionsMode':: d.fn(help='"The permissions mode for the QLDB ledger instance. Specify either ALLOW_ALL or STANDARD."', args=[d.arg(name='permissionsMode', type=d.T.string)]),
      withPermissionsMode(permissionsMode): { spec+: { forProvider+: { permissionsMode: permissionsMode } } },
    ...
    initProvider: {
      ...
      '#withPermissionsMode':: d.fn(help='"The permissions mode for the QLDB ledger instance. Specify either ALLOW_ALL or STANDARD."', args=[d.arg(name='permissionsMode', type=d.T.string)]),
      withPermissionsMode(permissionsMode): { spec+: { initProvider+: { permissionsMode: permissionsMode } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
