{
  ...
  '#':: d.pkg(name='instanceRoleAssociation', url='', help='"InstanceRoleAssociation is the Schema for the InstanceRoleAssociations API. Manages an RDS DB Instance association with an IAM Role."'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceRoleAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'rds.aws.m.upbound.io/v1beta1',
    kind: 'InstanceRoleAssociation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"InstanceRoleAssociationSpec defines the desired state of InstanceRoleAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDbInstanceIdentifier':: d.fn(help='"DB Instance Identifier to associate with the IAM Role."', args=[d.arg(name='dbInstanceIdentifier', type=d.T.string)]),
      withDbInstanceIdentifier(dbInstanceIdentifier): { spec+: { forProvider+: { dbInstanceIdentifier: dbInstanceIdentifier } } },
      '#withFeatureName':: d.fn(help='"Name of the feature for association. This can be found in the AWS documentation relevant to the integration or a full list is available in the SupportedFeatureNames list returned by AWS CLI rds describe-db-engine-versions."', args=[d.arg(name='featureName', type=d.T.string)]),
      withFeatureName(featureName): { spec+: { forProvider+: { featureName: featureName } } },
      ...
      '#withRoleArn':: d.fn(help='"Amazon Resource Name (ARN) of the IAM Role to associate with the DB Instance."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withFeatureName':: d.fn(help='"Name of the feature for association. This can be found in the AWS documentation relevant to the integration or a full list is available in the SupportedFeatureNames list returned by AWS CLI rds describe-db-engine-versions."', args=[d.arg(name='featureName', type=d.T.string)]),
      withFeatureName(featureName): { spec+: { initProvider+: { featureName: featureName } } },
      '#withRoleArn':: d.fn(help='"Amazon Resource Name (ARN) of the IAM Role to associate with the DB Instance."', args=[d.arg(name='roleArn', type=d.T.string)]),
