{
  ...
  '#':: d.pkg(name='clusterRoleAssociation', url='', help='"ClusterRoleAssociation is the Schema for the ClusterRoleAssociations API. Manages a RDS DB Cluster association with an IAM Role."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterRoleAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'rds.aws.m.upbound.io/v1beta1',
    kind: 'ClusterRoleAssociation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ClusterRoleAssociationSpec defines the desired state of ClusterRoleAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDbClusterIdentifier':: d.fn(help='"DB Cluster Identifier to associate with the IAM Role."', args=[d.arg(name='dbClusterIdentifier', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"Amazon Resource Name (ARN) of the IAM Role to associate with the DB Cluster."', args=[d.arg(name='roleArn', type=d.T.string)]),
