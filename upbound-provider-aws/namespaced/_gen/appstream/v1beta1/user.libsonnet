{
  ...
  '#':: d.pkg(name='user', url='', help='"User is the Schema for the Users API. Provides an AppStream user"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAuthenticationType':: d.fn(help='"Authentication type for the user. You must specify USERPOOL. Valid values: API, SAML, USERPOOL"', args=[d.arg(name='authenticationType', type=d.T.string)]),
      withAuthenticationType(authenticationType): { spec+: { forProvider+: { authenticationType: authenticationType } } },
      '#withEnabled':: d.fn(help='"Whether the user in the user pool is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withFirstName':: d.fn(help='"First name, or given name, of the user."', args=[d.arg(name='firstName', type=d.T.string)]),
      withFirstName(firstName): { spec+: { forProvider+: { firstName: firstName } } },
      '#withLastName':: d.fn(help='"Last name, or surname, of the user."', args=[d.arg(name='lastName', type=d.T.string)]),
      withLastName(lastName): { spec+: { forProvider+: { lastName: lastName } } },
      ...
      '#withSendEmailNotification':: d.fn(help='"Send an email notification."', args=[d.arg(name='sendEmailNotification', type=d.T.boolean)]),
    ...
    initProvider: {
      ...
      '#withFirstName':: d.fn(help='"First name, or given name, of the user."', args=[d.arg(name='firstName', type=d.T.string)]),
      withFirstName(firstName): { spec+: { initProvider+: { firstName: firstName } } },
      '#withLastName':: d.fn(help='"Last name, or surname, of the user."', args=[d.arg(name='lastName', type=d.T.string)]),
      withLastName(lastName): { spec+: { initProvider+: { lastName: lastName } } },
      '#withSendEmailNotification':: d.fn(help='"Send an email notification."', args=[d.arg(name='sendEmailNotification', type=d.T.boolean)]),
