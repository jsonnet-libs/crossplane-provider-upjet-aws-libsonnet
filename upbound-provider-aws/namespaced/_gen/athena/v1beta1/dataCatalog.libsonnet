{
  ...
  '#':: d.pkg(name='dataCatalog', url='', help='"DataCatalog is the Schema for the DataCatalogs API. Provides an Athena data catalog."'),
  ...
  '#new':: d.fn(help='new returns an instance of DataCatalog', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'athena.aws.m.upbound.io/v1beta1',
    kind: 'DataCatalog',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DataCatalogSpec defines the desired state of DataCatalog"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the data catalog."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withParameters':: d.fn(help='"Key value pairs that specifies the Lambda function or functions to use for the data catalog. The mapping used depends on the catalog type."', args=[d.arg(name='parameters', type=d.T.object)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: parameters } } },
      '#withParametersMixin':: d.fn(help='"Key value pairs that specifies the Lambda function or functions to use for the data catalog. The mapping used depends on the catalog type."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.object)]),
      ...
      '#withType':: d.fn(help='"Type of data catalog: LAMBDA for a federated catalog, GLUE for AWS Glue Catalog, or HIVE for an external hive metastore."', args=[d.arg(name='type', type=d.T.string)]),
