{
  ...
  '#':: d.pkg(name='dashboard', url='', help='"Dashboard is the Schema for the Dashboards API. Provides a CloudWatch Dashboard resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Dashboard', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudwatch.aws.m.upbound.io/v1beta1',
    kind: 'Dashboard',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DashboardSpec defines the desired state of Dashboard"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDashboardBody':: d.fn(help='"The detailed information about the dashboard, including what widgets are included and their location on the dashboard. You can read more about the body structure in the documentation."', args=[d.arg(name='dashboardBody', type=d.T.string)]),
      withDashboardBody(dashboardBody): { spec+: { forProvider+: { dashboardBody: dashboardBody } } },
    ...
    initProvider: {
      '#withDashboardBody':: d.fn(help='"The detailed information about the dashboard, including what widgets are included and their location on the dashboard. You can read more about the body structure in the documentation."', args=[d.arg(name='dashboardBody', type=d.T.string)]),
      withDashboardBody(dashboardBody): { spec+: { initProvider+: { dashboardBody: dashboardBody } } },
    },
