  ...
  spec: {
    ...
    forProvider: {
      ...
      insightsConfiguration: {
        ...
        withInsightsEnabled(insightsEnabled): { spec+: { forProvider+: { insightsConfiguration+: { insightsEnabled: insightsEnabled } } } },
        ...
        withNotificationsEnabled(notificationsEnabled): { spec+: { forProvider+: { insightsConfiguration+: { notificationsEnabled: notificationsEnabled } } } },
      },
    ...
    initProvider: {
      ...
      insightsConfiguration: {
        '#withInsightsEnabled':: d.fn(help='"Specifies whether insights are enabled."', args=[d.arg(name='insightsEnabled', type=d.T.boolean)]),
        withInsightsEnabled(insightsEnabled): { spec+: { initProvider+: { insightsConfiguration+: { insightsEnabled: insightsEnabled } } } },
        '#withNotificationsEnabled':: d.fn(help='"Specifies whether insight notifications are enabled."', args=[d.arg(name='notificationsEnabled', type=d.T.boolean)]),
        withNotificationsEnabled(notificationsEnabled): { spec+: { initProvider+: { insightsConfiguration+: { notificationsEnabled: notificationsEnabled } } } },
      },
      '#withFilterExpression':: d.fn(help='"The filter expression defining criteria by which to group traces. more info can be found in official docs."', args=[d.arg(name='filterExpression', type=d.T.string)]),
