{
  ...
  '#':: d.pkg(name='resourceGroup', url='', help='"ResourceGroup is the Schema for the ResourceGroups API. Provides an Amazon Inspector Classic Resource Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'inspector.aws.m.upbound.io/v1beta1',
    kind: 'ResourceGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ResourceGroupSpec defines the desired state of ResourceGroup"'),
  spec: {
