{
  ...
  '#':: d.pkg(name='securityProfile', url='', help='"SecurityProfile is the Schema for the SecurityProfiles API. Provides details about a specific Amazon Connect Security Profile."'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityProfile', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'connect.aws.m.upbound.io/v1beta1',
    kind: 'SecurityProfile',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SecurityProfileSpec defines the desired state of SecurityProfile"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Specifies the description of the Security Profile."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"Specifies the name of the Security Profile."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPermissions':: d.fn(help='"Specifies a list of permissions assigned to the security profile."', args=[d.arg(name='permissions', type=d.T.array)]),
      withPermissions(permissions): { spec+: { forProvider+: { permissions: if std.isArray(v=permissions) then permissions else [permissions] } } },
      '#withPermissionsMixin':: d.fn(help='"Specifies a list of permissions assigned to the security profile."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='permissions', type=d.T.array)]),
