{
  ...
  '#':: d.pkg(name='vocabulary', url='', help='"Vocabulary is the Schema for the Vocabularys API. Provides details about a specific Amazon Connect Vocabulary"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withContent':: d.fn(help='"The content of the custom vocabulary in plain-text format with a table of values. Each row in the table represents a word or a phrase, described with Phrase, IPA, SoundsLike, and DisplayAs fields. Separate the fields with TAB characters. For more information, see Create a custom vocabulary using a table. Minimum length of 1. Maximum length of 60000."', args=[d.arg(name='content', type=d.T.string)]),
      ...
      '#withLanguageCode':: d.fn(help='"The language code of the vocabulary entries. For a list of languages and their corresponding language codes, see What is Amazon Transcribe?. Valid Values are ar-AE, de-CH, de-DE, en-AB, en-AU, en-GB, en-IE, en-IN, en-US, en-WL, es-ES, es-US, fr-CA, fr-FR, hi-IN, it-IT, ja-JP, ko-KR, pt-BR, pt-PT, zh-CN."', args=[d.arg(name='languageCode', type=d.T.string)]),
      withLanguageCode(languageCode): { spec+: { forProvider+: { languageCode: languageCode } } },
      '#withName':: d.fn(help='"A unique name of the custom vocabulary. Must not be more than 140 characters."', args=[d.arg(name='name', type=d.T.string)]),
