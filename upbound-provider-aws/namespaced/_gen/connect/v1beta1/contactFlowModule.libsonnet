{
  ...
  '#':: d.pkg(name='contactFlowModule', url='', help='"ContactFlowModule is the Schema for the ContactFlowModules API. Provides details about a specific Amazon Connect Contact Flow Module."'),
  ...
  '#new':: d.fn(help='new returns an instance of ContactFlowModule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'connect.aws.m.upbound.io/v1beta1',
    kind: 'ContactFlowModule',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ContactFlowModuleSpec defines the desired state of ContactFlowModule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withContent':: d.fn(help='"Specifies the content of the Contact Flow Module, provided as a JSON string, written in Amazon Connect Contact Flow Language. If defined, the filename argument cannot be used."', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { spec+: { forProvider+: { content: content } } },
      '#withContentHash':: d.fn(help='"Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow Module source specified with filename. The usual way to set this is filebase64sha256(\\"contact_flow_module.11.12 and later) or base64sha256(file(\\"contact_flow_module.11.11 and earlier), where \\"contact_flow_module.json\\" is the local filename of the Contact Flow Module source."', args=[d.arg(name='contentHash', type=d.T.string)]),
      withContentHash(contentHash): { spec+: { forProvider+: { contentHash: contentHash } } },
      '#withDescription':: d.fn(help='"Specifies the description of the Contact Flow Module."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFilename':: d.fn(help='"The path to the Contact Flow Module source within the local filesystem. Conflicts with content."', args=[d.arg(name='filename', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"Specifies the name of the Contact Flow Module."', args=[d.arg(name='name', type=d.T.string)]),
