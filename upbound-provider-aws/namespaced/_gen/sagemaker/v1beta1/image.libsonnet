{
  ...
  '#':: d.pkg(name='image', url='', help='"Image is the Schema for the Images API. Provides a SageMaker AI Image resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the image."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name of the image. When the image is added to a domain (must be unique to the domain)."', args=[d.arg(name='displayName', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) of an IAM role that enables Amazon SageMaker AI to perform tasks on your behalf."', args=[d.arg(name='roleArn', type=d.T.string)]),
