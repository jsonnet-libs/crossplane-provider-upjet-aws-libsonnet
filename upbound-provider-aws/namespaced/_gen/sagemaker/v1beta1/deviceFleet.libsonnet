  ...
  spec: {
    ...
    forProvider: {
      ...
      outputConfig: {
        ...
        withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { outputConfig+: { kmsKeyId: kmsKeyId } } } },
        '#withS3OutputLocation':: d.fn(help='"The Amazon Simple Storage (S3) bucker URI."', args=[d.arg(name='s3OutputLocation', type=d.T.string)]),
        withS3OutputLocation(s3OutputLocation): { spec+: { forProvider+: { outputConfig+: { s3OutputLocation: s3OutputLocation } } } },
      },
    ...
    initProvider: {
      ...
      outputConfig: {
        '#withKmsKeyId':: d.fn(help="\"The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt data on the storage volume after compilation job. If you don't provide a KMS key ID, Amazon SageMaker AI uses the default KMS key for Amazon S3 for your role's account.\"", args=[d.arg(name='kmsKeyId', type=d.T.string)]),
        withKmsKeyId(kmsKeyId): { spec+: { initProvider+: { outputConfig+: { kmsKeyId: kmsKeyId } } } },
        '#withS3OutputLocation':: d.fn(help='"The Amazon Simple Storage (S3) bucker URI."', args=[d.arg(name='s3OutputLocation', type=d.T.string)]),
        withS3OutputLocation(s3OutputLocation): { spec+: { initProvider+: { outputConfig+: { s3OutputLocation: s3OutputLocation } } } },
      },
      '#roleArnRef':: d.obj(help='"Reference to a Role in iam to populate roleArn."'),
      roleArnRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
