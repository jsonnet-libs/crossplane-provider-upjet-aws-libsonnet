{
  ...
  '#':: d.pkg(name='notebookInstanceLifecycleConfiguration', url='', help='"NotebookInstanceLifecycleConfiguration is the Schema for the NotebookInstanceLifecycleConfigurations API. Provides a lifecycle configuration for SageMaker AI Notebook Instances."'),
  ...
  '#new':: d.fn(help='new returns an instance of NotebookInstanceLifecycleConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sagemaker.aws.m.upbound.io/v1beta1',
    kind: 'NotebookInstanceLifecycleConfiguration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"NotebookInstanceLifecycleConfigurationSpec defines the desired state of NotebookInstanceLifecycleConfiguration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withOnCreate':: d.fn(help='"A shell script (base64-encoded) that runs only once when the SageMaker AI Notebook Instance is created."', args=[d.arg(name='onCreate', type=d.T.string)]),
      withOnCreate(onCreate): { spec+: { forProvider+: { onCreate: onCreate } } },
      '#withOnStart':: d.fn(help="\"A shell script (base64-encoded) that runs every time the SageMaker AI Notebook Instance is started including the time it's created.\"", args=[d.arg(name='onStart', type=d.T.string)]),
      withOnStart(onStart): { spec+: { forProvider+: { onStart: onStart } } },
    ...
    initProvider: {
      '#withOnCreate':: d.fn(help='"A shell script (base64-encoded) that runs only once when the SageMaker AI Notebook Instance is created."', args=[d.arg(name='onCreate', type=d.T.string)]),
      withOnCreate(onCreate): { spec+: { initProvider+: { onCreate: onCreate } } },
      '#withOnStart':: d.fn(help="\"A shell script (base64-encoded) that runs every time the SageMaker AI Notebook Instance is started including the time it's created.\"", args=[d.arg(name='onStart', type=d.T.string)]),
      withOnStart(onStart): { spec+: { initProvider+: { onStart: onStart } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
