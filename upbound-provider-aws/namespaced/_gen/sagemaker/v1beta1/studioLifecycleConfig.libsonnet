{
  ...
  '#':: d.pkg(name='studioLifecycleConfig', url='', help='"StudioLifecycleConfig is the Schema for the StudioLifecycleConfigs API. Provides a SageMaker AI Studio Lifecycle Config resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of StudioLifecycleConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sagemaker.aws.m.upbound.io/v1beta1',
    kind: 'StudioLifecycleConfig',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"StudioLifecycleConfigSpec defines the desired state of StudioLifecycleConfig"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withStudioLifecycleConfigAppType':: d.fn(help='"The App type that the Lifecycle Configuration is attached to. Valid values are JupyterServer, JupyterLab, CodeEditor and KernelGateway."', args=[d.arg(name='studioLifecycleConfigAppType', type=d.T.string)]),
      withStudioLifecycleConfigAppType(studioLifecycleConfigAppType): { spec+: { forProvider+: { studioLifecycleConfigAppType: studioLifecycleConfigAppType } } },
      '#withStudioLifecycleConfigContent':: d.fn(help='"The content of your Studio Lifecycle Configuration script. This content must be base64 encoded."', args=[d.arg(name='studioLifecycleConfigContent', type=d.T.string)]),
      withStudioLifecycleConfigContent(studioLifecycleConfigContent): { spec+: { forProvider+: { studioLifecycleConfigContent: studioLifecycleConfigContent } } },
    ...
    initProvider: {
      '#withStudioLifecycleConfigAppType':: d.fn(help='"The App type that the Lifecycle Configuration is attached to. Valid values are JupyterServer, JupyterLab, CodeEditor and KernelGateway."', args=[d.arg(name='studioLifecycleConfigAppType', type=d.T.string)]),
      withStudioLifecycleConfigAppType(studioLifecycleConfigAppType): { spec+: { initProvider+: { studioLifecycleConfigAppType: studioLifecycleConfigAppType } } },
      '#withStudioLifecycleConfigContent':: d.fn(help='"The content of your Studio Lifecycle Configuration script. This content must be base64 encoded."', args=[d.arg(name='studioLifecycleConfigContent', type=d.T.string)]),
      withStudioLifecycleConfigContent(studioLifecycleConfigContent): { spec+: { initProvider+: { studioLifecycleConfigContent: studioLifecycleConfigContent } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
