{
  ...
  '#':: d.pkg(name='modelPackageGroup', url='', help='"ModelPackageGroup is the Schema for the ModelPackageGroups API. Provides a SageMaker AI Model Package Group resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ModelPackageGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sagemaker.aws.m.upbound.io/v1beta1',
    kind: 'ModelPackageGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ModelPackageGroupSpec defines the desired state of ModelPackageGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withModelPackageGroupDescription':: d.fn(help='"A description for the model group."', args=[d.arg(name='modelPackageGroupDescription', type=d.T.string)]),
      withModelPackageGroupDescription(modelPackageGroupDescription): { spec+: { forProvider+: { modelPackageGroupDescription: modelPackageGroupDescription } } },
    ...
    initProvider: {
      '#withModelPackageGroupDescription':: d.fn(help='"A description for the model group."', args=[d.arg(name='modelPackageGroupDescription', type=d.T.string)]),
      withModelPackageGroupDescription(modelPackageGroupDescription): { spec+: { initProvider+: { modelPackageGroupDescription: modelPackageGroupDescription } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
