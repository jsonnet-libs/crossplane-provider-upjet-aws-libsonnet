{
  ...
  '#':: d.pkg(name='mlflowTrackingServer', url='', help='"MlflowTrackingServer is the Schema for the MlflowTrackingServers API. Provides a SageMaker AI MLFlow Tracking Server resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of MlflowTrackingServer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sagemaker.aws.m.upbound.io/v1beta1',
    kind: 'MlflowTrackingServer',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"MlflowTrackingServerSpec defines the desired state of MlflowTrackingServer"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withArtifactStoreUri':: d.fn(help='"The S3 URI for a general purpose bucket to use as the MLflow Tracking Server artifact store."', args=[d.arg(name='artifactStoreUri', type=d.T.string)]),
      withArtifactStoreUri(artifactStoreUri): { spec+: { forProvider+: { artifactStoreUri: artifactStoreUri } } },
      '#withAutomaticModelRegistration':: d.fn(help='"A list of Member Definitions that contains objects that identify the workers that make up the work team."', args=[d.arg(name='automaticModelRegistration', type=d.T.boolean)]),
      withAutomaticModelRegistration(automaticModelRegistration): { spec+: { forProvider+: { automaticModelRegistration: automaticModelRegistration } } },
      '#withMlflowVersion':: d.fn(help='"The version of MLflow that the tracking server uses. To see which MLflow versions are available to use, see How it works."', args=[d.arg(name='mlflowVersion', type=d.T.string)]),
      withMlflowVersion(mlflowVersion): { spec+: { forProvider+: { mlflowVersion: mlflowVersion } } },
      ...
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) for an IAM role in your account that the MLflow Tracking Server uses to access the artifact store in Amazon S3. The role should have AmazonS3FullAccess permissions. For more information on IAM permissions for tracking server creation, see Set up IAM permissions for MLflow."', args=[d.arg(name='roleArn', type=d.T.string)]),
      ...
      '#withTrackingServerSize':: d.fn(help='"The size of the tracking server you want to create. You can choose between \\"Small\\", \\"Medium\\", and \\"Large\\". The default MLflow Tracking Server configuration size is \\"Small\\". You can choose a size depending on the projected use of the tracking server such as the volume of data logged, number of users, and frequency of use."', args=[d.arg(name='trackingServerSize', type=d.T.string)]),
      withTrackingServerSize(trackingServerSize): { spec+: { forProvider+: { trackingServerSize: trackingServerSize } } },
      '#withWeeklyMaintenanceWindowStart':: d.fn(help='"The day and time of the week in Coordinated Universal Time (UTC) 24-hour standard time that weekly maintenance updates are scheduled. For example: TUE:03:30."', args=[d.arg(name='weeklyMaintenanceWindowStart', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withArtifactStoreUri':: d.fn(help='"The S3 URI for a general purpose bucket to use as the MLflow Tracking Server artifact store."', args=[d.arg(name='artifactStoreUri', type=d.T.string)]),
      withArtifactStoreUri(artifactStoreUri): { spec+: { initProvider+: { artifactStoreUri: artifactStoreUri } } },
      '#withAutomaticModelRegistration':: d.fn(help='"A list of Member Definitions that contains objects that identify the workers that make up the work team."', args=[d.arg(name='automaticModelRegistration', type=d.T.boolean)]),
      withAutomaticModelRegistration(automaticModelRegistration): { spec+: { initProvider+: { automaticModelRegistration: automaticModelRegistration } } },
      '#withMlflowVersion':: d.fn(help='"The version of MLflow that the tracking server uses. To see which MLflow versions are available to use, see How it works."', args=[d.arg(name='mlflowVersion', type=d.T.string)]),
      withMlflowVersion(mlflowVersion): { spec+: { initProvider+: { mlflowVersion: mlflowVersion } } },
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) for an IAM role in your account that the MLflow Tracking Server uses to access the artifact store in Amazon S3. The role should have AmazonS3FullAccess permissions. For more information on IAM permissions for tracking server creation, see Set up IAM permissions for MLflow."', args=[d.arg(name='roleArn', type=d.T.string)]),
      ...
      '#withTrackingServerSize':: d.fn(help='"The size of the tracking server you want to create. You can choose between \\"Small\\", \\"Medium\\", and \\"Large\\". The default MLflow Tracking Server configuration size is \\"Small\\". You can choose a size depending on the projected use of the tracking server such as the volume of data logged, number of users, and frequency of use."', args=[d.arg(name='trackingServerSize', type=d.T.string)]),
      withTrackingServerSize(trackingServerSize): { spec+: { initProvider+: { trackingServerSize: trackingServerSize } } },
      '#withWeeklyMaintenanceWindowStart':: d.fn(help='"The day and time of the week in Coordinated Universal Time (UTC) 24-hour standard time that weekly maintenance updates are scheduled. For example: TUE:03:30."', args=[d.arg(name='weeklyMaintenanceWindowStart', type=d.T.string)]),
