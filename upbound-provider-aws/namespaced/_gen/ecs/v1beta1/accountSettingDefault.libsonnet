{
  ...
  '#':: d.pkg(name='accountSettingDefault', url='', help='"AccountSettingDefault is the Schema for the AccountSettingDefaults API. Provides an ECS Default account setting."'),
  ...
  '#new':: d.fn(help='new returns an instance of AccountSettingDefault', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ecs.aws.m.upbound.io/v1beta1',
    kind: 'AccountSettingDefault',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AccountSettingDefaultSpec defines the desired state of AccountSettingDefault"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"Name of the account setting to set."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withValue':: d.fn(help='"State of the setting."', args=[d.arg(name='value', type=d.T.string)]),
