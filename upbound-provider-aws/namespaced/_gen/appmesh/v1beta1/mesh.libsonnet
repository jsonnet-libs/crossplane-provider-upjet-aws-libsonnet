  ...
  spec: {
    ...
    forProvider: {
      ...
      spec: {
        ...
        egressFilter: {
          ...
          withType(type): { spec+: { forProvider+: { spec+: { egressFilter+: { type: type } } } } },
        },
        ...
        serviceDiscovery: {
          ...
          withIpPreference(ipPreference): { spec+: { forProvider+: { spec+: { serviceDiscovery+: { ipPreference: ipPreference } } } } },
        },
      },
    ...
    initProvider: {
      ...
      spec: {
        ...
        egressFilter: {
          '#withType':: d.fn(help='"Egress filter type. By default, the type is DROP_ALL. Valid values are ALLOW_ALL and DROP_ALL."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { initProvider+: { spec+: { egressFilter+: { type: type } } } } },
        },
        '#serviceDiscovery':: d.obj(help='"The service discovery information for the service mesh."'),
        serviceDiscovery: {
          '#withIpPreference':: d.fn(help='"The IP version to use to control traffic within the mesh. Valid values are IPv6_PREFERRED, IPv4_PREFERRED, IPv4_ONLY, and IPv6_ONLY."', args=[d.arg(name='ipPreference', type=d.T.string)]),
          withIpPreference(ipPreference): { spec+: { initProvider+: { spec+: { serviceDiscovery+: { ipPreference: ipPreference } } } } },
        },
      },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
