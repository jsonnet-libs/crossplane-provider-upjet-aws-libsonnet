{
  ...
  '#':: d.pkg(name='anomalyMonitor', url='', help='"AnomalyMonitor is the Schema for the AnomalyMonitors API. Provides a CE Cost Anomaly Monitor"'),
  ...
  '#new':: d.fn(help='new returns an instance of AnomalyMonitor', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ce.aws.m.upbound.io/v1beta1',
    kind: 'AnomalyMonitor',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AnomalyMonitorSpec defines the desired state of AnomalyMonitor"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withMonitorDimension':: d.fn(help='"The dimensions to evaluate. Valid values: SERVICE."', args=[d.arg(name='monitorDimension', type=d.T.string)]),
      withMonitorDimension(monitorDimension): { spec+: { forProvider+: { monitorDimension: monitorDimension } } },
      '#withMonitorSpecification':: d.fn(help='"A valid JSON representation for the Expression object."', args=[d.arg(name='monitorSpecification', type=d.T.string)]),
      withMonitorSpecification(monitorSpecification): { spec+: { forProvider+: { monitorSpecification: monitorSpecification } } },
      '#withMonitorType':: d.fn(help='"The possible type values. Valid values: DIMENSIONAL | CUSTOM."', args=[d.arg(name='monitorType', type=d.T.string)]),
      withMonitorType(monitorType): { spec+: { forProvider+: { monitorType: monitorType } } },
      '#withName':: d.fn(help='"The name of the monitor."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      '#withMonitorDimension':: d.fn(help='"The dimensions to evaluate. Valid values: SERVICE."', args=[d.arg(name='monitorDimension', type=d.T.string)]),
      withMonitorDimension(monitorDimension): { spec+: { initProvider+: { monitorDimension: monitorDimension } } },
      '#withMonitorSpecification':: d.fn(help='"A valid JSON representation for the Expression object."', args=[d.arg(name='monitorSpecification', type=d.T.string)]),
      withMonitorSpecification(monitorSpecification): { spec+: { initProvider+: { monitorSpecification: monitorSpecification } } },
      '#withMonitorType':: d.fn(help='"The possible type values. Valid values: DIMENSIONAL | CUSTOM."', args=[d.arg(name='monitorType', type=d.T.string)]),
      withMonitorType(monitorType): { spec+: { initProvider+: { monitorType: monitorType } } },
      '#withName':: d.fn(help='"The name of the monitor."', args=[d.arg(name='name', type=d.T.string)]),
