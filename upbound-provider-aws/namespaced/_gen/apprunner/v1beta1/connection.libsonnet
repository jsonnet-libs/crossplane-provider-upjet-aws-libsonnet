{
  ...
  '#':: d.pkg(name='connection', url='', help='"Connection is the Schema for the Connections API. Manages an App Runner Connection."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withProviderType':: d.fn(help='"Source repository provider. Valid values: GITHUB."', args=[d.arg(name='providerType', type=d.T.string)]),
