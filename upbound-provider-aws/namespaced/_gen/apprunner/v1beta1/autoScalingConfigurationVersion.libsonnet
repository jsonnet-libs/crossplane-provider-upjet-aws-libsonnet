{
  ...
  '#':: d.pkg(name='autoScalingConfigurationVersion', url='', help='"AutoScalingConfigurationVersion is the Schema for the AutoScalingConfigurationVersions API. Manages an App Runner AutoScaling Configuration Version."'),
  ...
  '#new':: d.fn(help='new returns an instance of AutoScalingConfigurationVersion', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'apprunner.aws.m.upbound.io/v1beta1',
    kind: 'AutoScalingConfigurationVersion',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AutoScalingConfigurationVersionSpec defines the desired state of AutoScalingConfigurationVersion"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAutoScalingConfigurationName':: d.fn(help='"Name of the auto scaling configuration."', args=[d.arg(name='autoScalingConfigurationName', type=d.T.string)]),
      withAutoScalingConfigurationName(autoScalingConfigurationName): { spec+: { forProvider+: { autoScalingConfigurationName: autoScalingConfigurationName } } },
      '#withMaxConcurrency':: d.fn(help='"Maximal number of concurrent requests that you want an instance to process. When the number of concurrent requests goes over this limit, App Runner scales up your service."', args=[d.arg(name='maxConcurrency', type=d.T.number)]),
      withMaxConcurrency(maxConcurrency): { spec+: { forProvider+: { maxConcurrency: maxConcurrency } } },
      '#withMaxSize':: d.fn(help='"Maximal number of instances that App Runner provisions for your service."', args=[d.arg(name='maxSize', type=d.T.number)]),
      withMaxSize(maxSize): { spec+: { forProvider+: { maxSize: maxSize } } },
      '#withMinSize':: d.fn(help='"Minimal number of instances that App Runner provisions for your service."', args=[d.arg(name='minSize', type=d.T.number)]),
    ...
    initProvider: {
      '#withAutoScalingConfigurationName':: d.fn(help='"Name of the auto scaling configuration."', args=[d.arg(name='autoScalingConfigurationName', type=d.T.string)]),
      withAutoScalingConfigurationName(autoScalingConfigurationName): { spec+: { initProvider+: { autoScalingConfigurationName: autoScalingConfigurationName } } },
      '#withMaxConcurrency':: d.fn(help='"Maximal number of concurrent requests that you want an instance to process. When the number of concurrent requests goes over this limit, App Runner scales up your service."', args=[d.arg(name='maxConcurrency', type=d.T.number)]),
