{
  ...
  '#':: d.pkg(name='vpcConnector', url='', help='"VPCConnector is the Schema for the VPCConnectors API. Manages an App Runner VPC Connector."'),
  ...
  '#new':: d.fn(help='new returns an instance of VPCConnector', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'apprunner.aws.m.upbound.io/v1beta1',
    kind: 'VPCConnector',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VPCConnectorSpec defines the desired state of VPCConnector"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSecurityGroups':: d.fn(help='"List of IDs of security groups that App Runner should use for access to AWS resources under the specified subnets. If not specified, App Runner uses the default security group of the Amazon VPC. The default security group allows all outbound traffic."', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSecurityGroupsMixin':: d.fn(help='"List of IDs of security groups that App Runner should use for access to AWS resources under the specified subnets. If not specified, App Runner uses the default security group of the Amazon VPC. The default security group allows all outbound traffic."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSubnets':: d.fn(help='"List of IDs of subnets that App Runner should use when it associates your service with a custom Amazon VPC. Specify IDs of subnets of a single Amazon VPC. App Runner determines the Amazon VPC from the subnets you specify."', args=[d.arg(name='subnets', type=d.T.array)]),
      withSubnets(subnets): { spec+: { forProvider+: { subnets: if std.isArray(v=subnets) then subnets else [subnets] } } },
      '#withSubnetsMixin':: d.fn(help='"List of IDs of subnets that App Runner should use when it associates your service with a custom Amazon VPC. Specify IDs of subnets of a single Amazon VPC. App Runner determines the Amazon VPC from the subnets you specify."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnets', type=d.T.array)]),
      ...
      '#withVpcConnectorName':: d.fn(help='"Name for the VPC connector."', args=[d.arg(name='vpcConnectorName', type=d.T.string)]),
      withVpcConnectorName(vpcConnectorName): { spec+: { forProvider+: { vpcConnectorName: vpcConnectorName } } },
    },
    ...
    initProvider: {
      ...
      '#withVpcConnectorName':: d.fn(help='"Name for the VPC connector."', args=[d.arg(name='vpcConnectorName', type=d.T.string)]),
      withVpcConnectorName(vpcConnectorName): { spec+: { initProvider+: { vpcConnectorName: vpcConnectorName } } },
    },
