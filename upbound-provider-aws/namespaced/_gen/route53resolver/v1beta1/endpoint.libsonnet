{
  ...
  '#':: d.pkg(name='endpoint', url='', help='"Endpoint is the Schema for the Endpoints API. Provides a Route 53 Resolver endpoint resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#ipAddress':: d.obj(help='"Subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."'),
      ipAddress: {
        ...
        '#withIp':: d.fn(help='"IPv4 address in the subnet that you want to use for DNS queries."', args=[d.arg(name='ip', type=d.T.string)]),
        withIp(ip): { ip: ip },
        '#withIpv6':: d.fn(help='"IPv6 address in the subnet that you want to use for DNS queries."', args=[d.arg(name='ipv6', type=d.T.string)]),
        withIpv6(ipv6): { ipv6: ipv6 },
        '#withSubnetId':: d.fn(help='"ID of the subnet that contains the IP address."', args=[d.arg(name='subnetId', type=d.T.string)]),
      ...
      '#withDirection':: d.fn(help='"Direction of DNS queries to or from the Route 53 Resolver endpoint.\\nValid values are INBOUND (resolver forwards DNS queries to the DNS service for a VPC from your network or another VPC), OUTBOUND (resolver forwards DNS queries from the DNS service for a VPC to your network or another VPC) or INBOUND_DELEGATION (resolver delegates queries to Route 53 private hosted zones from your network)."', args=[d.arg(name='direction', type=d.T.string)]),
      withDirection(direction): { spec+: { forProvider+: { direction: direction } } },
      '#withIpAddress':: d.fn(help='"Subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddress(ipAddress): { spec+: { forProvider+: { ipAddress: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withIpAddressMixin':: d.fn(help='"Subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddressMixin(ipAddress): { spec+: { forProvider+: { ipAddress+: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withName':: d.fn(help='"Friendly name of the Route 53 Resolver endpoint."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withProtocols':: d.fn(help='"Protocols you want to use for the Route 53 Resolver endpoint.\\nValid values are DoH, Do53, or DoH-FIPS."', args=[d.arg(name='protocols', type=d.T.array)]),
      withProtocols(protocols): { spec+: { forProvider+: { protocols: if std.isArray(v=protocols) then protocols else [protocols] } } },
      '#withProtocolsMixin':: d.fn(help='"Protocols you want to use for the Route 53 Resolver endpoint.\\nValid values are DoH, Do53, or DoH-FIPS."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='protocols', type=d.T.array)]),
      ...
      '#withResolverEndpointType':: d.fn(help='"Endpoint IP type. This endpoint type is applied to all IP addresses.\\nValid values are IPV6,IPV4 or DUALSTACK (both IPv4 and IPv6)."', args=[d.arg(name='resolverEndpointType', type=d.T.string)]),
      withResolverEndpointType(resolverEndpointType): { spec+: { forProvider+: { resolverEndpointType: resolverEndpointType } } },
      ...
      '#withSecurityGroupIds':: d.fn(help='"ID of one or more security groups that you want to use to control access to this VPC."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSecurityGroupIdsMixin':: d.fn(help='"ID of one or more security groups that you want to use to control access to this VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withIpAddress':: d.fn(help='"Subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddress(ipAddress): { spec+: { initProvider+: { ipAddress: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withIpAddressMixin':: d.fn(help='"Subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddressMixin(ipAddress): { spec+: { initProvider+: { ipAddress+: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withName':: d.fn(help='"Friendly name of the Route 53 Resolver endpoint."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withResolverEndpointType':: d.fn(help='"Endpoint IP type. This endpoint type is applied to all IP addresses.\\nValid values are IPV6,IPV4 or DUALSTACK (both IPv4 and IPv6)."', args=[d.arg(name='resolverEndpointType', type=d.T.string)]),
      withResolverEndpointType(resolverEndpointType): { spec+: { initProvider+: { resolverEndpointType: resolverEndpointType } } },
      '#withSecurityGroupIdRefs':: d.fn(help='"References to SecurityGroup in ec2 to populate securityGroupIds."', args=[d.arg(name='securityGroupIdRefs', type=d.T.array)]),
