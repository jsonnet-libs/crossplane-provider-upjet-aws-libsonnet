{
  ...
  '#':: d.pkg(name='voiceConnector', url='', help='"VoiceConnector is the Schema for the VoiceConnectors API. Enables you to connect your phone system to the telephone network at a substantial cost savings by using SIP trunking."'),
  ...
  '#new':: d.fn(help='new returns an instance of VoiceConnector', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'chime.aws.m.upbound.io/v1beta1',
    kind: 'VoiceConnector',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VoiceConnectorSpec defines the desired state of VoiceConnector"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAwsRegion':: d.fn(help='"The AWS Region in which the Amazon Chime Voice Connector is created. Default value: us-east-1"', args=[d.arg(name='awsRegion', type=d.T.string)]),
      ...
      '#withRequireEncryption':: d.fn(help='"When enabled, requires encryption for the Amazon Chime Voice Connector."', args=[d.arg(name='requireEncryption', type=d.T.boolean)]),
      withRequireEncryption(requireEncryption): { spec+: { forProvider+: { requireEncryption: requireEncryption } } },
    ...
    initProvider: {
      ...
      '#withRequireEncryption':: d.fn(help='"When enabled, requires encryption for the Amazon Chime Voice Connector."', args=[d.arg(name='requireEncryption', type=d.T.boolean)]),
      withRequireEncryption(requireEncryption): { spec+: { initProvider+: { requireEncryption: requireEncryption } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
