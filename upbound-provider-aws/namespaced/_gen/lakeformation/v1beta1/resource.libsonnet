{
  ...
  '#':: d.pkg(name='resource', url='', help='"Resource is the Schema for the Resources API. Registers a Lake Formation resource as managed by the Data Catalog."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withArn':: d.fn(help='"Amazon Resource Name (ARN) of the resource."', args=[d.arg(name='arn', type=d.T.string)]),
      withArn(arn): { spec+: { forProvider+: { arn: arn } } },
      '#withHybridAccessEnabled':: d.fn(help='"Flag to enable AWS LakeFormation hybrid access permission mode."', args=[d.arg(name='hybridAccessEnabled', type=d.T.boolean)]),
      withHybridAccessEnabled(hybridAccessEnabled): { spec+: { forProvider+: { hybridAccessEnabled: hybridAccessEnabled } } },
      ...
      '#withRoleArn':: d.fn(help='"Role that has read/write access to the resource."', args=[d.arg(name='roleArn', type=d.T.string)]),
      withRoleArn(roleArn): { spec+: { forProvider+: { roleArn: roleArn } } },
      '#withUseServiceLinkedRole':: d.fn(help='"Designates an AWS Identity and Access Management (IAM) service-linked role by registering this role with the Data Catalog."', args=[d.arg(name='useServiceLinkedRole', type=d.T.boolean)]),
      withUseServiceLinkedRole(useServiceLinkedRole): { spec+: { forProvider+: { useServiceLinkedRole: useServiceLinkedRole } } },
      '#withWithFederation':: d.fn(help='"Whether or not the resource is a federated resource. Set to true when registering AWS Glue connections for federated catalog functionality."', args=[d.arg(name='withFederation', type=d.T.boolean)]),
      withWithFederation(withFederation): { spec+: { forProvider+: { withFederation: withFederation } } },
      '#withWithPrivilegedAccess':: d.fn(help='"Boolean to grant the calling principal the permissions to perform all supported Lake Formation operations on the registered data location."', args=[d.arg(name='withPrivilegedAccess', type=d.T.boolean)]),
      withWithPrivilegedAccess(withPrivilegedAccess): { spec+: { forProvider+: { withPrivilegedAccess: withPrivilegedAccess } } },
    },
    ...
    initProvider: {
      ...
      '#withHybridAccessEnabled':: d.fn(help='"Flag to enable AWS LakeFormation hybrid access permission mode."', args=[d.arg(name='hybridAccessEnabled', type=d.T.boolean)]),
      withHybridAccessEnabled(hybridAccessEnabled): { spec+: { initProvider+: { hybridAccessEnabled: hybridAccessEnabled } } },
      '#withRoleArn':: d.fn(help='"Role that has read/write access to the resource."', args=[d.arg(name='roleArn', type=d.T.string)]),
      withRoleArn(roleArn): { spec+: { initProvider+: { roleArn: roleArn } } },
      '#withUseServiceLinkedRole':: d.fn(help='"Designates an AWS Identity and Access Management (IAM) service-linked role by registering this role with the Data Catalog."', args=[d.arg(name='useServiceLinkedRole', type=d.T.boolean)]),
      withUseServiceLinkedRole(useServiceLinkedRole): { spec+: { initProvider+: { useServiceLinkedRole: useServiceLinkedRole } } },
      '#withWithFederation':: d.fn(help='"Whether or not the resource is a federated resource. Set to true when registering AWS Glue connections for federated catalog functionality."', args=[d.arg(name='withFederation', type=d.T.boolean)]),
      withWithFederation(withFederation): { spec+: { initProvider+: { withFederation: withFederation } } },
      '#withWithPrivilegedAccess':: d.fn(help='"Boolean to grant the calling principal the permissions to perform all supported Lake Formation operations on the registered data location."', args=[d.arg(name='withPrivilegedAccess', type=d.T.boolean)]),
      withWithPrivilegedAccess(withPrivilegedAccess): { spec+: { initProvider+: { withPrivilegedAccess: withPrivilegedAccess } } },
    },
