{
  ...
  '#':: d.pkg(name='project', url='', help='"Project is the Schema for the Projects API. Provides a Devicefarm project"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDefaultJobTimeoutMinutes':: d.fn(help='"Sets the execution timeout value (in minutes) for a project. All test runs in this project use the specified execution timeout value unless overridden when scheduling a run."', args=[d.arg(name='defaultJobTimeoutMinutes', type=d.T.number)]),
      withDefaultJobTimeoutMinutes(defaultJobTimeoutMinutes): { spec+: { forProvider+: { defaultJobTimeoutMinutes: defaultJobTimeoutMinutes } } },
      '#withName':: d.fn(help='"The name of the project"', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      '#withDefaultJobTimeoutMinutes':: d.fn(help='"Sets the execution timeout value (in minutes) for a project. All test runs in this project use the specified execution timeout value unless overridden when scheduling a run."', args=[d.arg(name='defaultJobTimeoutMinutes', type=d.T.number)]),
      withDefaultJobTimeoutMinutes(defaultJobTimeoutMinutes): { spec+: { initProvider+: { defaultJobTimeoutMinutes: defaultJobTimeoutMinutes } } },
      '#withName':: d.fn(help='"The name of the project"', args=[d.arg(name='name', type=d.T.string)]),
