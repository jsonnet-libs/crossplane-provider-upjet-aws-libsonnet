{
  ...
  '#':: d.pkg(name='backendEnvironment', url='', help='"BackendEnvironment is the Schema for the BackendEnvironments API. Provides an Amplify Backend Environment resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of BackendEnvironment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'amplify.aws.m.upbound.io/v1beta1',
    kind: 'BackendEnvironment',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BackendEnvironmentSpec defines the desired state of BackendEnvironment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDeploymentArtifacts':: d.fn(help='"Name of deployment artifacts."', args=[d.arg(name='deploymentArtifacts', type=d.T.string)]),
      withDeploymentArtifacts(deploymentArtifacts): { spec+: { forProvider+: { deploymentArtifacts: deploymentArtifacts } } },
      ...
      '#withStackName':: d.fn(help='"AWS CloudFormation stack name of a backend environment."', args=[d.arg(name='stackName', type=d.T.string)]),
    ...
    initProvider: {
      '#withDeploymentArtifacts':: d.fn(help='"Name of deployment artifacts."', args=[d.arg(name='deploymentArtifacts', type=d.T.string)]),
      withDeploymentArtifacts(deploymentArtifacts): { spec+: { initProvider+: { deploymentArtifacts: deploymentArtifacts } } },
      '#withStackName':: d.fn(help='"AWS CloudFormation stack name of a backend environment."', args=[d.arg(name='stackName', type=d.T.string)]),
      withStackName(stackName): { spec+: { initProvider+: { stackName: stackName } } },
    },
