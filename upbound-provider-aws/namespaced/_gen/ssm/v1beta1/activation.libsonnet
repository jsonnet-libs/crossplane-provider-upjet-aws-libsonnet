{
  ...
  '#':: d.pkg(name='activation', url='', help='"Activation is the Schema for the Activations API. Registers an on-premises server or virtual machine with Amazon EC2 so that it can be managed using Run Command."'),
  ...
  '#new':: d.fn(help='new returns an instance of Activation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ssm.aws.m.upbound.io/v1beta1',
    kind: 'Activation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ActivationSpec defines the desired state of Activation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the resource that you want to register."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withExpirationDate':: d.fn(help='"UTC timestamp in RFC3339 format by which this activation request should expire. The default value is 24 hours from resource creation time."', args=[d.arg(name='expirationDate', type=d.T.string)]),
      withExpirationDate(expirationDate): { spec+: { forProvider+: { expirationDate: expirationDate } } },
      '#withIamRole':: d.fn(help='"The IAM Role to attach to the managed instance."', args=[d.arg(name='iamRole', type=d.T.string)]),
      withIamRole(iamRole): { spec+: { forProvider+: { iamRole: iamRole } } },
      '#withName':: d.fn(help='"The default name of the registered managed instance."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRegistrationLimit':: d.fn(help='"The maximum number of managed instances you want to register. The default value is 1 instance."', args=[d.arg(name='registrationLimit', type=d.T.number)]),
      withRegistrationLimit(registrationLimit): { spec+: { forProvider+: { registrationLimit: registrationLimit } } },
    ...
    initProvider: {
      ...
      '#withRegistrationLimit':: d.fn(help='"The maximum number of managed instances you want to register. The default value is 1 instance."', args=[d.arg(name='registrationLimit', type=d.T.number)]),
      withRegistrationLimit(registrationLimit): { spec+: { initProvider+: { registrationLimit: registrationLimit } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
