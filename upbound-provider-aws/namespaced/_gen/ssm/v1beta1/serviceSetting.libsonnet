{
  ...
  '#':: d.pkg(name='serviceSetting', url='', help='"ServiceSetting is the Schema for the ServiceSettings API. Defines how a user interacts with or uses a service or a feature of a service."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceSetting', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'ssm.aws.m.upbound.io/v1beta1',
    kind: 'ServiceSetting',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ServiceSettingSpec defines the desired state of ServiceSetting"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSettingId':: d.fn(help='"ID of the service setting. Valid values are shown in the AWS documentation."', args=[d.arg(name='settingId', type=d.T.string)]),
      withSettingId(settingId): { spec+: { forProvider+: { settingId: settingId } } },
      '#withSettingValue':: d.fn(help='"Value of the service setting."', args=[d.arg(name='settingValue', type=d.T.string)]),
      withSettingValue(settingValue): { spec+: { forProvider+: { settingValue: settingValue } } },
    },
    ...
    initProvider: {
      '#withSettingId':: d.fn(help='"ID of the service setting. Valid values are shown in the AWS documentation."', args=[d.arg(name='settingId', type=d.T.string)]),
      withSettingId(settingId): { spec+: { initProvider+: { settingId: settingId } } },
      '#withSettingValue':: d.fn(help='"Value of the service setting."', args=[d.arg(name='settingValue', type=d.T.string)]),
      withSettingValue(settingValue): { spec+: { initProvider+: { settingValue: settingValue } } },
    },
