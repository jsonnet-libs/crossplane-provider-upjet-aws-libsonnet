{
  ...
  '#':: d.pkg(name='snapshotSchedule', url='', help='"SnapshotSchedule is the Schema for the SnapshotSchedules API. Provides an Redshift Snapshot Schedule resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of SnapshotSchedule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'redshift.aws.m.upbound.io/v1beta1',
    kind: 'SnapshotSchedule',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SnapshotScheduleSpec defines the desired state of SnapshotSchedule"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDefinitions':: d.fn(help='"The definition of the snapshot schedule. The definition is made up of schedule expressions, for example cron(30 12 *) or rate(12 hours)."', args=[d.arg(name='definitions', type=d.T.array)]),
      withDefinitions(definitions): { spec+: { forProvider+: { definitions: if std.isArray(v=definitions) then definitions else [definitions] } } },
      '#withDefinitionsMixin':: d.fn(help='"The definition of the snapshot schedule. The definition is made up of schedule expressions, for example cron(30 12 *) or rate(12 hours)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='definitions', type=d.T.array)]),
      withDefinitionsMixin(definitions): { spec+: { forProvider+: { definitions+: if std.isArray(v=definitions) then definitions else [definitions] } } },
      '#withDescription':: d.fn(help='"The description of the snapshot schedule."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withForceDestroy':: d.fn(help='"Whether to destroy all associated clusters with this snapshot schedule on deletion. Must be enabled and applied before attempting deletion."', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
    ...
    initProvider: {
      '#withDefinitions':: d.fn(help='"The definition of the snapshot schedule. The definition is made up of schedule expressions, for example cron(30 12 *) or rate(12 hours)."', args=[d.arg(name='definitions', type=d.T.array)]),
      withDefinitions(definitions): { spec+: { initProvider+: { definitions: if std.isArray(v=definitions) then definitions else [definitions] } } },
      '#withDefinitionsMixin':: d.fn(help='"The definition of the snapshot schedule. The definition is made up of schedule expressions, for example cron(30 12 *) or rate(12 hours)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='definitions', type=d.T.array)]),
      withDefinitionsMixin(definitions): { spec+: { initProvider+: { definitions+: if std.isArray(v=definitions) then definitions else [definitions] } } },
      '#withDescription':: d.fn(help='"The description of the snapshot schedule."', args=[d.arg(name='description', type=d.T.string)]),
