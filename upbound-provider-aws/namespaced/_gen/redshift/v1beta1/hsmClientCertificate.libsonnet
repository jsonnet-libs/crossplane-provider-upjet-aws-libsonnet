{
  ...
  '#':: d.pkg(name='hsmClientCertificate', url='', help="\"HSMClientCertificate is the Schema for the HSMClientCertificates API. Creates an HSM client certificate that an Amazon Redshift cluster will use to connect to the client's HSM in order to store and retrieve the keys used to encrypt the cluster databases.\""),
  ...
  '#new':: d.fn(help='new returns an instance of HSMClientCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'redshift.aws.m.upbound.io/v1beta1',
    kind: 'HSMClientCertificate',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"HSMClientCertificateSpec defines the desired state of HSMClientCertificate"'),
  spec: {
