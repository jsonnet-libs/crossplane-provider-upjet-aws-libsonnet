{
  ...
  '#':: d.pkg(name='snapshotCopyGrant', url='', help='"SnapshotCopyGrant is the Schema for the SnapshotCopyGrants API. Creates a snapshot copy grant that allows AWS Redshift to encrypt copied snapshots with a customer master key from AWS KMS in a destination region."'),
  ...
  '#new':: d.fn(help='new returns an instance of SnapshotCopyGrant', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'redshift.aws.m.upbound.io/v1beta1',
    kind: 'SnapshotCopyGrant',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SnapshotCopyGrantSpec defines the desired state of SnapshotCopyGrant"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withKmsKeyId':: d.fn(help='"The unique identifier for the customer master key (CMK) that the grant applies to. Specify the key ID or the Amazon Resource Name (ARN) of the CMK. To specify a CMK in a different AWS account, you must use the key ARN. If not specified, the default key is used."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      ...
      '#withSnapshotCopyGrantName':: d.fn(help='"A friendly name for identifying the grant."', args=[d.arg(name='snapshotCopyGrantName', type=d.T.string)]),
      withSnapshotCopyGrantName(snapshotCopyGrantName): { spec+: { forProvider+: { snapshotCopyGrantName: snapshotCopyGrantName } } },
    ...
    initProvider: {
      ...
      '#withSnapshotCopyGrantName':: d.fn(help='"A friendly name for identifying the grant."', args=[d.arg(name='snapshotCopyGrantName', type=d.T.string)]),
      withSnapshotCopyGrantName(snapshotCopyGrantName): { spec+: { initProvider+: { snapshotCopyGrantName: snapshotCopyGrantName } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
