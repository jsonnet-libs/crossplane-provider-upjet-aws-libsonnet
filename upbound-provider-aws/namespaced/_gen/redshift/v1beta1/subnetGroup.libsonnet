{
  ...
  '#':: d.pkg(name='subnetGroup', url='', help='"SubnetGroup is the Schema for the SubnetGroups API. Provides a Redshift Subnet Group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the Redshift Subnet group."', args=[d.arg(name='description', type=d.T.string)]),
