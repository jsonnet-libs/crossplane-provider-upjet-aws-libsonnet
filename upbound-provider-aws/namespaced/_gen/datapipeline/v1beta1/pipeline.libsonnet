{
  ...
  '#':: d.pkg(name='pipeline', url='', help='"Pipeline is the Schema for the Pipelines API. Provides a AWS DataPipeline Pipeline."'),
  ...
  new(name): {
    apiVersion: 'datapipeline.aws.m.upbound.io/v1beta1',
    kind: 'Pipeline',
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"The description of Pipeline."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of Pipeline."', args=[d.arg(name='name', type=d.T.string)]),
