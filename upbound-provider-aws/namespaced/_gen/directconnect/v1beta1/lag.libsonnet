{
  ...
  '#':: d.pkg(name='lag', url='', help='"Lag is the Schema for the Lags API. Provides a Direct Connect LAG."'),
  ...
  '#new':: d.fn(help='new returns an instance of Lag', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'directconnect.aws.m.upbound.io/v1beta1',
    kind: 'Lag',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LagSpec defines the desired state of Lag"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withConnectionId':: d.fn(help='"The ID of an existing dedicated connection to migrate to the LAG."', args=[d.arg(name='connectionId', type=d.T.string)]),
      withConnectionId(connectionId): { spec+: { forProvider+: { connectionId: connectionId } } },
      '#withConnectionsBandwidth':: d.fn(help='"The bandwidth of the individual dedicated connections bundled by the LAG. Valid values: 1Gbps, 10Gbps, 100Gbps, and 400Gbps. Case sensitive. Refer to the AWS Direct Connection supported bandwidths for Dedicated Connections."', args=[d.arg(name='connectionsBandwidth', type=d.T.string)]),
      withConnectionsBandwidth(connectionsBandwidth): { spec+: { forProvider+: { connectionsBandwidth: connectionsBandwidth } } },
      '#withForceDestroy':: d.fn(help='"A boolean that indicates all connections associated with the LAG should be deleted so that the LAG can be destroyed without error. These objects are not recoverable."', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
      withForceDestroy(forceDestroy): { spec+: { forProvider+: { forceDestroy: forceDestroy } } },
      '#withLocation':: d.fn(help='"The AWS Direct Connect location in which the LAG should be allocated. See DescribeLocations for the list of AWS Direct Connect locations. Use locationCode."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"The name of the LAG."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withProviderName':: d.fn(help='"The name of the service provider associated with the LAG."', args=[d.arg(name='providerName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withConnectionsBandwidth':: d.fn(help='"The bandwidth of the individual dedicated connections bundled by the LAG. Valid values: 1Gbps, 10Gbps, 100Gbps, and 400Gbps. Case sensitive. Refer to the AWS Direct Connection supported bandwidths for Dedicated Connections."', args=[d.arg(name='connectionsBandwidth', type=d.T.string)]),
      withConnectionsBandwidth(connectionsBandwidth): { spec+: { initProvider+: { connectionsBandwidth: connectionsBandwidth } } },
      '#withForceDestroy':: d.fn(help='"A boolean that indicates all connections associated with the LAG should be deleted so that the LAG can be destroyed without error. These objects are not recoverable."', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
