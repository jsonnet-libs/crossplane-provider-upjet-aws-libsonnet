{
  ...
  '#':: d.pkg(name='parameterGroup', url='', help='"ParameterGroup is the Schema for the ParameterGroups API. Provides a MemoryDB Parameter Group."'),
  ...
  spec: {
    ...
    forProvider: {
      '#parameter':: d.obj(help='"Set of MemoryDB parameters to apply. Any parameters not specified will fall back to their family defaults. Detailed below."'),
      parameter: {
      ...
      '#withDescription':: d.fn(help='"Description for the parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFamily':: d.fn(help='"The engine version that the parameter group can be used with."', args=[d.arg(name='family', type=d.T.string)]),
      withFamily(family): { spec+: { forProvider+: { family: family } } },
      '#withParameter':: d.fn(help='"Set of MemoryDB parameters to apply. Any parameters not specified will fall back to their family defaults. Detailed below."', args=[d.arg(name='parameter', type=d.T.array)]),
      withParameter(parameter): { spec+: { forProvider+: { parameter: if std.isArray(v=parameter) then parameter else [parameter] } } },
      '#withParameterMixin':: d.fn(help='"Set of MemoryDB parameters to apply. Any parameters not specified will fall back to their family defaults. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameter', type=d.T.array)]),
