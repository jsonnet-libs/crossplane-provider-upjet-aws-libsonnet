{
  ...
  '#':: d.pkg(name='acl', url='', help='"ACL is the Schema for the ACLs API. Provides a MemoryDB ACL."'),
  ...
  '#new':: d.fn(help='new returns an instance of ACL', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'memorydb.aws.m.upbound.io/v1beta1',
    kind: 'ACL',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ACLSpec defines the desired state of ACL"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withUserNames':: d.fn(help='"Set of MemoryDB user names to be included in this ACL."', args=[d.arg(name='userNames', type=d.T.array)]),
      withUserNames(userNames): { spec+: { forProvider+: { userNames: if std.isArray(v=userNames) then userNames else [userNames] } } },
      '#withUserNamesMixin':: d.fn(help='"Set of MemoryDB user names to be included in this ACL."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='userNames', type=d.T.array)]),
      withUserNamesMixin(userNames): { spec+: { forProvider+: { userNames+: if std.isArray(v=userNames) then userNames else [userNames] } } },
    },
    ...
    initProvider: {
      ...
      '#withUserNames':: d.fn(help='"Set of MemoryDB user names to be included in this ACL."', args=[d.arg(name='userNames', type=d.T.array)]),
      withUserNames(userNames): { spec+: { initProvider+: { userNames: if std.isArray(v=userNames) then userNames else [userNames] } } },
      '#withUserNamesMixin':: d.fn(help='"Set of MemoryDB user names to be included in this ACL."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='userNames', type=d.T.array)]),
      withUserNamesMixin(userNames): { spec+: { initProvider+: { userNames+: if std.isArray(v=userNames) then userNames else [userNames] } } },
    },
