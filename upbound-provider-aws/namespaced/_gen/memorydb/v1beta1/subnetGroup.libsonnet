{
  ...
  '#':: d.pkg(name='subnetGroup', url='', help='"SubnetGroup is the Schema for the SubnetGroups API. Provides a MemoryDB Subnet Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'memorydb.aws.m.upbound.io/v1beta1',
    kind: 'SubnetGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SubnetGroupSpec defines the desired state of SubnetGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description for the subnet group."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withSubnetIds':: d.fn(help='"Set of VPC Subnet ID-s for the subnet group. At least one subnet must be provided."', args=[d.arg(name='subnetIds', type=d.T.array)]),
      withSubnetIds(subnetIds): { spec+: { forProvider+: { subnetIds: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] } } },
      '#withSubnetIdsMixin':: d.fn(help='"Set of VPC Subnet ID-s for the subnet group. At least one subnet must be provided."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetIds', type=d.T.array)]),
