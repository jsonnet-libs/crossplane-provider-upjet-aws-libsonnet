{
  ...
  '#':: d.pkg(name='apiCache', url='', help='"APICache is the Schema for the APICaches API. Provides an AppSync API Cache."'),
  ...
  '#new':: d.fn(help='new returns an instance of APICache', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'appsync.aws.m.upbound.io/v1beta1',
    kind: 'APICache',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"APICacheSpec defines the desired state of APICache"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiCachingBehavior':: d.fn(help='"Caching behavior. Valid values are FULL_REQUEST_CACHING and PER_RESOLVER_CACHING."', args=[d.arg(name='apiCachingBehavior', type=d.T.string)]),
      withApiCachingBehavior(apiCachingBehavior): { spec+: { forProvider+: { apiCachingBehavior: apiCachingBehavior } } },
      '#withApiId':: d.fn(help='"GraphQL API ID."', args=[d.arg(name='apiId', type=d.T.string)]),
      withApiId(apiId): { spec+: { forProvider+: { apiId: apiId } } },
      '#withAtRestEncryptionEnabled':: d.fn(help='"At-rest encryption flag for cache. You cannot update this setting after creation."', args=[d.arg(name='atRestEncryptionEnabled', type=d.T.boolean)]),
      ...
      '#withTransitEncryptionEnabled':: d.fn(help='"Transit encryption flag when connecting to cache. You cannot update this setting after creation."', args=[d.arg(name='transitEncryptionEnabled', type=d.T.boolean)]),
      withTransitEncryptionEnabled(transitEncryptionEnabled): { spec+: { forProvider+: { transitEncryptionEnabled: transitEncryptionEnabled } } },
      '#withTtl':: d.fn(help='"TTL in seconds for cache entries."', args=[d.arg(name='ttl', type=d.T.number)]),
      withTtl(ttl): { spec+: { forProvider+: { ttl: ttl } } },
      '#withType':: d.fn(help='"Cache instance type. Valid values are SMALL, MEDIUM, LARGE, XLARGE, LARGE_2X, LARGE_4X, LARGE_8X, LARGE_12X, T2_SMALL, T2_MEDIUM, R4_LARGE, R4_XLARGE, R4_2XLARGE, R4_4XLARGE, R4_8XLARGE."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withApiCachingBehavior':: d.fn(help='"Caching behavior. Valid values are FULL_REQUEST_CACHING and PER_RESOLVER_CACHING."', args=[d.arg(name='apiCachingBehavior', type=d.T.string)]),
      withApiCachingBehavior(apiCachingBehavior): { spec+: { initProvider+: { apiCachingBehavior: apiCachingBehavior } } },
      '#withApiId':: d.fn(help='"GraphQL API ID."', args=[d.arg(name='apiId', type=d.T.string)]),
