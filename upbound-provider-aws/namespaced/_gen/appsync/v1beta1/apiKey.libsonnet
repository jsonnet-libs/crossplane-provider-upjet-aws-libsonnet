{
  ...
  '#':: d.pkg(name='apiKey', url='', help='"APIKey is the Schema for the APIKeys API. Provides an AppSync API Key."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExpires':: d.fn(help='"RFC3339 string representation of the expiry date. Rounded down to nearest hour. By default, it is 7 days from the date of creation."', args=[d.arg(name='expires', type=d.T.string)]),
