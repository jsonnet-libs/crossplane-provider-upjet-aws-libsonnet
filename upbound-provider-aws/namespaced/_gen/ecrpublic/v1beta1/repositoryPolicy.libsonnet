{
  ...
  '#':: d.pkg(name='repositoryPolicy', url='', help='"RepositoryPolicy is the Schema for the RepositoryPolicys API. Provides an Elastic Container Registry Public Repository Policy."'),
  ...
  '#spec':: d.obj(help='"RepositoryPolicySpec defines the desired state of RepositoryPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#repositoryNameRef':: d.obj(help='"Reference to a Repository in ecrpublic to populate repositoryName."'),
      repositoryNameRef: {
      ...
      '#repositoryNameSelector':: d.obj(help='"Selector for a Repository in ecrpublic to populate repositoryName."'),
      ...
      '#withPolicy':: d.fn(help='"The policy document. This is a JSON formatted string"', args=[d.arg(name='policy', type=d.T.string)]),
      ...
      '#withRepositoryName':: d.fn(help='"Name of the repository to apply the policy."', args=[d.arg(name='repositoryName', type=d.T.string)]),
