{
  ...
  '#':: d.pkg(name='lbTrustStore', url='', help='"LBTrustStore is the Schema for the LBTrustStores API. Provides a Trust Store resource for use with Load Balancers."'),
  ...
  '#new':: d.fn(help='new returns an instance of LBTrustStore', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'elbv2.aws.m.upbound.io/v1beta1',
    kind: 'LBTrustStore',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LBTrustStoreSpec defines the desired state of LBTrustStore"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCaCertificatesBundleS3Bucket':: d.fn(help='"S3 Bucket name holding the client certificate CA bundle."', args=[d.arg(name='caCertificatesBundleS3Bucket', type=d.T.string)]),
      withCaCertificatesBundleS3Bucket(caCertificatesBundleS3Bucket): { spec+: { forProvider+: { caCertificatesBundleS3Bucket: caCertificatesBundleS3Bucket } } },
      '#withCaCertificatesBundleS3Key':: d.fn(help='"S3 object key holding the client certificate CA bundle."', args=[d.arg(name='caCertificatesBundleS3Key', type=d.T.string)]),
      withCaCertificatesBundleS3Key(caCertificatesBundleS3Key): { spec+: { forProvider+: { caCertificatesBundleS3Key: caCertificatesBundleS3Key } } },
      '#withCaCertificatesBundleS3ObjectVersion':: d.fn(help='"Version Id of CA bundle S3 bucket object, if versioned, defaults to latest if omitted."', args=[d.arg(name='caCertificatesBundleS3ObjectVersion', type=d.T.string)]),
      withCaCertificatesBundleS3ObjectVersion(caCertificatesBundleS3ObjectVersion): { spec+: { forProvider+: { caCertificatesBundleS3ObjectVersion: caCertificatesBundleS3ObjectVersion } } },
      '#withName':: d.fn(help='"Name of the Trust Store. This name must be unique per region per account, can have a maximum of 32 characters, must contain only alphanumeric characters or hyphens, and must not begin or end with a hyphen."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      '#withCaCertificatesBundleS3Bucket':: d.fn(help='"S3 Bucket name holding the client certificate CA bundle."', args=[d.arg(name='caCertificatesBundleS3Bucket', type=d.T.string)]),
      withCaCertificatesBundleS3Bucket(caCertificatesBundleS3Bucket): { spec+: { initProvider+: { caCertificatesBundleS3Bucket: caCertificatesBundleS3Bucket } } },
      '#withCaCertificatesBundleS3Key':: d.fn(help='"S3 object key holding the client certificate CA bundle."', args=[d.arg(name='caCertificatesBundleS3Key', type=d.T.string)]),
      withCaCertificatesBundleS3Key(caCertificatesBundleS3Key): { spec+: { initProvider+: { caCertificatesBundleS3Key: caCertificatesBundleS3Key } } },
      '#withCaCertificatesBundleS3ObjectVersion':: d.fn(help='"Version Id of CA bundle S3 bucket object, if versioned, defaults to latest if omitted."', args=[d.arg(name='caCertificatesBundleS3ObjectVersion', type=d.T.string)]),
      withCaCertificatesBundleS3ObjectVersion(caCertificatesBundleS3ObjectVersion): { spec+: { initProvider+: { caCertificatesBundleS3ObjectVersion: caCertificatesBundleS3ObjectVersion } } },
      '#withName':: d.fn(help='"Name of the Trust Store. This name must be unique per region per account, can have a maximum of 32 characters, must contain only alphanumeric characters or hyphens, and must not begin or end with a hyphen."', args=[d.arg(name='name', type=d.T.string)]),
