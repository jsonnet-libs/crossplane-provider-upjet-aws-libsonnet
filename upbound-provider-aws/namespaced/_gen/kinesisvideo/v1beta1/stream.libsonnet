{
  ...
  '#':: d.pkg(name='stream', url='', help='"Stream is the Schema for the Streams API. Provides a AWS Kinesis Video Stream"'),
  ...
  new(name): {
    apiVersion: 'kinesisvideo.aws.m.upbound.io/v1beta1',
    kind: 'Stream',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDataRetentionInHours':: d.fn(help='"The number of hours that you want to retain the data in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream. The default value is 0, indicating that the stream does not persist data."', args=[d.arg(name='dataRetentionInHours', type=d.T.number)]),
      withDataRetentionInHours(dataRetentionInHours): { spec+: { forProvider+: { dataRetentionInHours: dataRetentionInHours } } },
      '#withDeviceName':: d.fn(help='"The name of the device that is writing to the stream. In the current implementation, Kinesis Video Streams does not use this name."', args=[d.arg(name='deviceName', type=d.T.string)]),
      withDeviceName(deviceName): { spec+: { forProvider+: { deviceName: deviceName } } },
      '#withKmsKeyId':: d.fn(help='"The ID of the AWS Key Management Service (AWS KMS) key that you want Kinesis Video Streams to use to encrypt stream data. If no key ID is specified, the default, Kinesis Video-managed key (aws/kinesisvideo) is used."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { kmsKeyId: kmsKeyId } } },
      '#withMediaType':: d.fn(help='"The media type of the stream. Consumers of the stream can use this information when processing the stream. For more information about media types, see Media Types. If you choose to specify the MediaType, see Naming Requirements for guidelines."', args=[d.arg(name='mediaType', type=d.T.string)]),
      withMediaType(mediaType): { spec+: { forProvider+: { mediaType: mediaType } } },
      '#withName':: d.fn(help='"A name to identify the stream. This is unique to the\\nAWS account and region the Stream is created in."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDataRetentionInHours':: d.fn(help='"The number of hours that you want to retain the data in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream. The default value is 0, indicating that the stream does not persist data."', args=[d.arg(name='dataRetentionInHours', type=d.T.number)]),
      withDataRetentionInHours(dataRetentionInHours): { spec+: { initProvider+: { dataRetentionInHours: dataRetentionInHours } } },
      '#withDeviceName':: d.fn(help='"The name of the device that is writing to the stream. In the current implementation, Kinesis Video Streams does not use this name."', args=[d.arg(name='deviceName', type=d.T.string)]),
      ...
      '#withMediaType':: d.fn(help='"The media type of the stream. Consumers of the stream can use this information when processing the stream. For more information about media types, see Media Types. If you choose to specify the MediaType, see Naming Requirements for guidelines."', args=[d.arg(name='mediaType', type=d.T.string)]),
      withMediaType(mediaType): { spec+: { initProvider+: { mediaType: mediaType } } },
      '#withName':: d.fn(help='"A name to identify the stream. This is unique to the\\nAWS account and region the Stream is created in."', args=[d.arg(name='name', type=d.T.string)]),
