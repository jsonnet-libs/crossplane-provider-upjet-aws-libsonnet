{
  ...
  '#':: d.pkg(name='appCookieStickinessPolicy', url='', help='"AppCookieStickinessPolicy is the Schema for the AppCookieStickinessPolicys API. Provides an application cookie stickiness policy, which allows an ELB to wed its stickiness cookie to a cookie generated by your application."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppCookieStickinessPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'elb.aws.m.upbound.io/v1beta1',
    kind: 'AppCookieStickinessPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AppCookieStickinessPolicySpec defines the desired state of AppCookieStickinessPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCookieName':: d.fn(help="\"Application cookie whose lifetime the ELB's cookie should follow.\"", args=[d.arg(name='cookieName', type=d.T.string)]),
      withCookieName(cookieName): { spec+: { forProvider+: { cookieName: cookieName } } },
      '#withLbPort':: d.fn(help='"Load balancer port to which the policy\\nshould be applied. This must be an active listener on the load\\nbalancer."', args=[d.arg(name='lbPort', type=d.T.number)]),
      withLbPort(lbPort): { spec+: { forProvider+: { lbPort: lbPort } } },
      '#withLoadBalancer':: d.fn(help='"Name of load balancer to which the policy\\nshould be attached."', args=[d.arg(name='loadBalancer', type=d.T.string)]),
    ...
    initProvider: {
      '#withCookieName':: d.fn(help="\"Application cookie whose lifetime the ELB's cookie should follow.\"", args=[d.arg(name='cookieName', type=d.T.string)]),
      withCookieName(cookieName): { spec+: { initProvider+: { cookieName: cookieName } } },
    },
