{
  ...
  '#':: d.pkg(name='serviceQuota', url='', help='"ServiceQuota is the Schema for the ServiceQuotas API. Manages an individual Service Quota"'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceQuota', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'servicequotas.aws.m.upbound.io/v1beta1',
    kind: 'ServiceQuota',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ServiceQuotaSpec defines the desired state of ServiceQuota"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withQuotaCode':: d.fn(help='"Code of the service quota to track. For example: L-F678F1CE. Available values can be found with the AWS CLI service-quotas list-service-quotas command."', args=[d.arg(name='quotaCode', type=d.T.string)]),
      withQuotaCode(quotaCode): { spec+: { forProvider+: { quotaCode: quotaCode } } },
      ...
      '#withServiceCode':: d.fn(help='"Code of the service to track. For example: vpc. Available values can be found with the AWS CLI service-quotas list-services command."', args=[d.arg(name='serviceCode', type=d.T.string)]),
      withServiceCode(serviceCode): { spec+: { forProvider+: { serviceCode: serviceCode } } },
      '#withValue':: d.fn(help='"Float specifying the desired value for the service quota. If the desired value is higher than the current value, a quota increase request is submitted. When a known request is submitted and pending, the value reflects the desired value of the pending request."', args=[d.arg(name='value', type=d.T.number)]),
    ...
    initProvider: {
      '#withQuotaCode':: d.fn(help='"Code of the service quota to track. For example: L-F678F1CE. Available values can be found with the AWS CLI service-quotas list-service-quotas command."', args=[d.arg(name='quotaCode', type=d.T.string)]),
      withQuotaCode(quotaCode): { spec+: { initProvider+: { quotaCode: quotaCode } } },
      '#withServiceCode':: d.fn(help='"Code of the service to track. For example: vpc. Available values can be found with the AWS CLI service-quotas list-services command."', args=[d.arg(name='serviceCode', type=d.T.string)]),
      withServiceCode(serviceCode): { spec+: { initProvider+: { serviceCode: serviceCode } } },
      '#withValue':: d.fn(help='"Float specifying the desired value for the service quota. If the desired value is higher than the current value, a quota increase request is submitted. When a known request is submitted and pending, the value reflects the desired value of the pending request."', args=[d.arg(name='value', type=d.T.number)]),
