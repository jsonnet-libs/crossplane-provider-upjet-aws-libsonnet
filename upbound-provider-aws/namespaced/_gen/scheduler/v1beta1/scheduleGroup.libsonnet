{
  ...
  '#':: d.pkg(name='scheduleGroup', url='', help='"ScheduleGroup is the Schema for the ScheduleGroups API. Provides an EventBridge Scheduler Schedule Group resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ScheduleGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'scheduler.aws.m.upbound.io/v1beta1',
    kind: 'ScheduleGroup',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ScheduleGroupSpec defines the desired state of ScheduleGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"Name of the schedule group. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
