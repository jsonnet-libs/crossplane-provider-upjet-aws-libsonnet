{
  ...
  '#':: d.pkg(name='environmentEC2', url='', help='"EnvironmentEC2 is the Schema for the EnvironmentEC2s API. Provides a Cloud9 EC2 Development Environment."'),
  ...
  '#new':: d.fn(help='new returns an instance of EnvironmentEC2', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloud9.aws.m.upbound.io/v1beta1',
    kind: 'EnvironmentEC2',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EnvironmentEC2Spec defines the desired state of EnvironmentEC2"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAutomaticStopTimeMinutes':: d.fn(help='"The number of minutes until the running instance is shut down after the environment has last been used."', args=[d.arg(name='automaticStopTimeMinutes', type=d.T.number)]),
      withAutomaticStopTimeMinutes(automaticStopTimeMinutes): { spec+: { forProvider+: { automaticStopTimeMinutes: automaticStopTimeMinutes } } },
      '#withConnectionType':: d.fn(help='"The connection type used for connecting to an Amazon EC2 environment. Valid values are CONNECT_SSH and CONNECT_SSM. For more information please refer AWS documentation for Cloud9."', args=[d.arg(name='connectionType', type=d.T.string)]),
      withConnectionType(connectionType): { spec+: { forProvider+: { connectionType: connectionType } } },
      '#withDescription':: d.fn(help='"The description of the environment."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withImageId':: d.fn(help="\"The identifier for the Amazon Machine Image (AMI) that's used to create the EC2 instance. Valid values are\"", args=[d.arg(name='imageId', type=d.T.string)]),
      withImageId(imageId): { spec+: { forProvider+: { imageId: imageId } } },
      '#withInstanceType':: d.fn(help='"The type of instance to connect to the environment, e.g., t2.micro."', args=[d.arg(name='instanceType', type=d.T.string)]),
      withInstanceType(instanceType): { spec+: { forProvider+: { instanceType: instanceType } } },
      '#withName':: d.fn(help='"The name of the environment."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withOwnerArn':: d.fn(help="\"The ARN of the environment owner. This can be ARN of any AWS IAM principal. Defaults to the environment's creator.\"", args=[d.arg(name='ownerArn', type=d.T.string)]),
      withOwnerArn(ownerArn): { spec+: { forProvider+: { ownerArn: ownerArn } } },
      ...
      '#withSubnetId':: d.fn(help='"The ID of the subnet in Amazon VPC that AWS Cloud9 will use to communicate with the Amazon EC2 instance."', args=[d.arg(name='subnetId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAutomaticStopTimeMinutes':: d.fn(help='"The number of minutes until the running instance is shut down after the environment has last been used."', args=[d.arg(name='automaticStopTimeMinutes', type=d.T.number)]),
      withAutomaticStopTimeMinutes(automaticStopTimeMinutes): { spec+: { initProvider+: { automaticStopTimeMinutes: automaticStopTimeMinutes } } },
      '#withConnectionType':: d.fn(help='"The connection type used for connecting to an Amazon EC2 environment. Valid values are CONNECT_SSH and CONNECT_SSM. For more information please refer AWS documentation for Cloud9."', args=[d.arg(name='connectionType', type=d.T.string)]),
      ...
      '#withOwnerArn':: d.fn(help="\"The ARN of the environment owner. This can be ARN of any AWS IAM principal. Defaults to the environment's creator.\"", args=[d.arg(name='ownerArn', type=d.T.string)]),
      withOwnerArn(ownerArn): { spec+: { initProvider+: { ownerArn: ownerArn } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet in Amazon VPC that AWS Cloud9 will use to communicate with the Amazon EC2 instance."', args=[d.arg(name='subnetId', type=d.T.string)]),
