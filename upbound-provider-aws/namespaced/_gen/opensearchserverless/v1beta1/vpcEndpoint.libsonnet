{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Name of the interface endpoint.\\nName of the interface endpoint."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"One or more security groups that define the ports, protocols, and sources for inbound traffic that you are authorizing into your endpoint. Up to 5 security groups can be provided.\\nOne or more security groups that define the ports, protocols, and sources for inbound traffic that you are authorizing into your endpoint. Up to 5 security groups can be provided."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSubnetIds':: d.fn(help="\"One or more subnet IDs from which you'll access OpenSearch Serverless. Up to 6 subnets can be provided.\\nOne or more subnet IDs from which you'll access OpenSearch Serverless. Up to 6 subnets can be provided.\"", args=[d.arg(name='subnetIds', type=d.T.array)]),
      withSubnetIds(subnetIds): { spec+: { forProvider+: { subnetIds: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] } } },
      '#withSubnetIdsMixin':: d.fn(help="\"One or more subnet IDs from which you'll access OpenSearch Serverless. Up to 6 subnets can be provided.\\nOne or more subnet IDs from which you'll access OpenSearch Serverless. Up to 6 subnets can be provided.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='subnetIds', type=d.T.array)]),
      withSubnetIdsMixin(subnetIds): { spec+: { forProvider+: { subnetIds+: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] } } },
      '#withVpcId':: d.fn(help="\"ID of the VPC from which you'll access OpenSearch Serverless.\\nID of the VPC from which you'll access OpenSearch Serverless.\"", args=[d.arg(name='vpcId', type=d.T.string)]),
