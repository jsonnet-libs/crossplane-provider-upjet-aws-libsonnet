{
  ...
  '#':: d.pkg(name='securityPolicy', url='', help='"SecurityPolicy is the Schema for the SecurityPolicys API."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the policy. Typically used to store information about the permissions defined in the policy.\\nDescription of the policy. Typically used to store information about the permissions defined in the policy."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withPolicy':: d.fn(help='"JSON policy document to use as the content for the new policy\\nJSON policy document to use as the content for the new policy."', args=[d.arg(name='policy', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of security policy. One of encryption or network.\\nType of security policy. One of `encryption` or `network`."', args=[d.arg(name='type', type=d.T.string)]),
