{
  ...
  '#':: d.pkg(name='lifecyclePolicy', url='', help='"LifecyclePolicy is the Schema for the LifecyclePolicys API."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the policy.\\nDescription of the policy."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of lifecycle policy. Must be retention.\\nType of lifecycle policy. Must be `retention`."', args=[d.arg(name='type', type=d.T.string)]),
