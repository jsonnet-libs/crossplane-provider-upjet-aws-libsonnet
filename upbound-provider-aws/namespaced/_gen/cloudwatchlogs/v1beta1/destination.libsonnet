{
  ...
  '#':: d.pkg(name='destination', url='', help='"Destination is the Schema for the Destinations API. Provides a CloudWatch Logs destination."'),
  ...
  '#new':: d.fn(help='new returns an instance of Destination', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudwatchlogs.aws.m.upbound.io/v1beta1',
    kind: 'Destination',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"DestinationSpec defines the desired state of Destination"'),
  spec: {
    ...
    forProvider: {
      ...
      '#targetArnRef':: d.obj(help='"Reference to a Stream in kinesis to populate targetArn."'),
      targetArnRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#targetArnSelector':: d.obj(help='"Selector for a Stream in kinesis to populate targetArn."'),
      targetArnSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"The ARN of an IAM role that grants Amazon CloudWatch Logs permissions to put data into the target."', args=[d.arg(name='roleArn', type=d.T.string)]),
      ...
      '#withTargetArn':: d.fn(help='"The ARN of the target Amazon Kinesis stream resource for the destination."', args=[d.arg(name='targetArn', type=d.T.string)]),
