{
  ...
  '#':: d.pkg(name='group', url='', help='"Group is the Schema for the Groups API. Provides a CloudWatch Log Group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withKmsKeyId':: d.fn(help='"The ARN of the KMS Key to use when encrypting log data. Please note, after the AWS KMS CMK is disassociated from the log group,\\nAWS CloudWatch Logs stops encrypting newly ingested data for the log group. All previously ingested data remains encrypted, and AWS CloudWatch Logs requires\\npermissions for the CMK whenever the encrypted data is requested."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      withKmsKeyId(kmsKeyId): { spec+: { forProvider+: { kmsKeyId: kmsKeyId } } },
      '#withLogGroupClass':: d.fn(help='"Specified the log class of the log group. Possible values are: STANDARD, INFREQUENT_ACCESS, or DELIVERY."', args=[d.arg(name='logGroupClass', type=d.T.string)]),
      withLogGroupClass(logGroupClass): { spec+: { forProvider+: { logGroupClass: logGroupClass } } },
      ...
      '#withRetentionInDays':: d.fn(help='"Specifies the number of days\\nyou want to retain log events in the specified log group.  Possible values are: 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, 2192, 2557, 2922, 3288, 3653, and 0.\\nIf you select 0, the events in the log group are always retained and never expire. If log_group_class is set to DELIVERY, this argument is ignored and retention_in_days is forcibly set to 2."', args=[d.arg(name='retentionInDays', type=d.T.number)]),
      withRetentionInDays(retentionInDays): { spec+: { forProvider+: { retentionInDays: retentionInDays } } },
    ...
    initProvider: {
      ...
      '#withLogGroupClass':: d.fn(help='"Specified the log class of the log group. Possible values are: STANDARD, INFREQUENT_ACCESS, or DELIVERY."', args=[d.arg(name='logGroupClass', type=d.T.string)]),
      withLogGroupClass(logGroupClass): { spec+: { initProvider+: { logGroupClass: logGroupClass } } },
      '#withRetentionInDays':: d.fn(help='"Specifies the number of days\\nyou want to retain log events in the specified log group.  Possible values are: 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, 2192, 2557, 2922, 3288, 3653, and 0.\\nIf you select 0, the events in the log group are always retained and never expire. If log_group_class is set to DELIVERY, this argument is ignored and retention_in_days is forcibly set to 2."', args=[d.arg(name='retentionInDays', type=d.T.number)]),
      withRetentionInDays(retentionInDays): { spec+: { initProvider+: { retentionInDays: retentionInDays } } },
      '#withSkipDestroy':: d.fn(help='', args=[d.arg(name='skipDestroy', type=d.T.boolean)]),
