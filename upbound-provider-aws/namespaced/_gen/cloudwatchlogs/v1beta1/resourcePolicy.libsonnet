{
  ...
  '#':: d.pkg(name='resourcePolicy', url='', help='"ResourcePolicy is the Schema for the ResourcePolicys API. Provides a resource to manage a CloudWatch log resource policy"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withPolicyDocument':: d.fn(help='"Details of the resource policy, including the identity of the principal that is enabled to put logs to this account. This is formatted as a JSON string. Maximum length of 5120 characters."', args=[d.arg(name='policyDocument', type=d.T.string)]),
