{
  ...
  '#':: d.pkg(name='subscriptionFilter', url='', help='"SubscriptionFilter is the Schema for the SubscriptionFilters API. Provides a CloudWatch Logs subscription filter."'),
  ...
  '#new':: d.fn(help='new returns an instance of SubscriptionFilter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudwatchlogs.aws.m.upbound.io/v1beta1',
    kind: 'SubscriptionFilter',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SubscriptionFilterSpec defines the desired state of SubscriptionFilter"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#destinationArnRef':: d.obj(help='"Reference to a Stream in kinesis to populate destinationArn."'),
      destinationArnRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { destinationArnRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { destinationArnRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { destinationArnRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { destinationArnRef+: { namespace: namespace } } } },
      },
      '#destinationArnSelector':: d.obj(help='"Selector for a Stream in kinesis to populate destinationArn."'),
      destinationArnSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { destinationArnSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { destinationArnSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { destinationArnSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { destinationArnSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { destinationArnSelector+: { matchLabels+: matchLabels } } } },
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { destinationArnSelector+: { namespace: namespace } } } },
      },
      ...
      '#withDestinationArn':: d.fn(help='"The ARN of the destination to deliver matching log events to. Kinesis stream or Lambda function ARN."', args=[d.arg(name='destinationArn', type=d.T.string)]),
      withDestinationArn(destinationArn): { spec+: { forProvider+: { destinationArn: destinationArn } } },
      '#withDistribution':: d.fn(help='"The method used to distribute log data to the destination. By default log data is grouped by log stream, but the grouping can be set to random for a more even distribution. This property is only applicable when the destination is an Amazon Kinesis stream. Valid values are \\"Random\\" and \\"ByLogStream\\"."', args=[d.arg(name='distribution', type=d.T.string)]),
      withDistribution(distribution): { spec+: { forProvider+: { distribution: distribution } } },
      '#withFilterPattern':: d.fn(help='"A valid CloudWatch Logs filter pattern for subscribing to a filtered stream of log events. Use empty string \\"\\" to match everything. For more information, see the Amazon CloudWatch Logs User Guide."', args=[d.arg(name='filterPattern', type=d.T.string)]),
      withFilterPattern(filterPattern): { spec+: { forProvider+: { filterPattern: filterPattern } } },
      '#withLogGroupName':: d.fn(help='"The name of the log group to associate the subscription filter with"', args=[d.arg(name='logGroupName', type=d.T.string)]),
      withLogGroupName(logGroupName): { spec+: { forProvider+: { logGroupName: logGroupName } } },
      '#withName':: d.fn(help='"A name for the subscription filter"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"The ARN of an IAM role that grants Amazon CloudWatch Logs permissions to deliver ingested log events to the destination. If you use Lambda as a destination, you should skip this argument and use aws_lambda_permission resource for granting access from CloudWatch logs to the destination Lambda function."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      destinationArnRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { destinationArnRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { destinationArnRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { destinationArnRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referenced object"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { destinationArnRef+: { namespace: namespace } } } },
      },
      '#destinationArnSelector':: d.obj(help='"Selector for a Stream in kinesis to populate destinationArn."'),
      destinationArnSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { destinationArnSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { destinationArnSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { destinationArnSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { destinationArnSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { destinationArnSelector+: { matchLabels+: matchLabels } } } },
        '#withNamespace':: d.fn(help='"Namespace for the selector"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { destinationArnSelector+: { namespace: namespace } } } },
      },
      '#roleArnRef':: d.obj(help='"Reference to a Role in iam to populate roleArn."'),
      roleArnRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
      ...
      '#withDestinationArn':: d.fn(help='"The ARN of the destination to deliver matching log events to. Kinesis stream or Lambda function ARN."', args=[d.arg(name='destinationArn', type=d.T.string)]),
      withDestinationArn(destinationArn): { spec+: { initProvider+: { destinationArn: destinationArn } } },
      '#withDistribution':: d.fn(help='"The method used to distribute log data to the destination. By default log data is grouped by log stream, but the grouping can be set to random for a more even distribution. This property is only applicable when the destination is an Amazon Kinesis stream. Valid values are \\"Random\\" and \\"ByLogStream\\"."', args=[d.arg(name='distribution', type=d.T.string)]),
      withDistribution(distribution): { spec+: { initProvider+: { distribution: distribution } } },
      '#withFilterPattern':: d.fn(help='"A valid CloudWatch Logs filter pattern for subscribing to a filtered stream of log events. Use empty string \\"\\" to match everything. For more information, see the Amazon CloudWatch Logs User Guide."', args=[d.arg(name='filterPattern', type=d.T.string)]),
      withFilterPattern(filterPattern): { spec+: { initProvider+: { filterPattern: filterPattern } } },
      '#withLogGroupName':: d.fn(help='"The name of the log group to associate the subscription filter with"', args=[d.arg(name='logGroupName', type=d.T.string)]),
