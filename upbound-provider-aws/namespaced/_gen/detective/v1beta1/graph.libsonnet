{
  ...
  '#':: d.pkg(name='graph', url='', help='"Graph is the Schema for the Graphs API. Provides a resource to manage an Amazon Detective graph."'),
  ...
  '#new':: d.fn(help='new returns an instance of Graph', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'detective.aws.m.upbound.io/v1beta1',
    kind: 'Graph',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GraphSpec defines the desired state of Graph"'),
  spec: {
