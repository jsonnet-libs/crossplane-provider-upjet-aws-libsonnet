{
  ...
  '#':: d.pkg(name='app', url='', help='"App is the Schema for the Apps API. Provides a CodeDeploy application."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withComputePlatform':: d.fn(help='"The compute platform can either be ECS, Lambda, or Server. Default is Server."', args=[d.arg(name='computePlatform', type=d.T.string)]),
