{
  ...
  '#':: d.pkg(name='group', url='', help='"Group is the Schema for the Groups API. Manages a Resource QuickSight Group."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description for the group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withGroupName':: d.fn(help='"A name for the group."', args=[d.arg(name='groupName', type=d.T.string)]),
      withGroupName(groupName): { spec+: { forProvider+: { groupName: groupName } } },
      '#withNamespace':: d.fn(help='"The namespace. Currently, you should set this to default."', args=[d.arg(name='namespace', type=d.T.string)]),
