{
  ...
  '#':: d.pkg(name='resource', url='', help='"Resource is the Schema for the Resources API. Manages a Cloud Control API Resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#schemaSecretRef':: d.obj(help='"JSON string of the CloudFormation resource type schema which is used for plan time validation where possible. Automatically fetched if not provided. In large scale environments with multiple resources using the same type_name, it is recommended to fetch the schema once via the aws_cloudformation_type data source and use this argument to reduce DescribeType API operation throttling. This value is marked sensitive only to prevent large plan differences from showing."'),
      schemaSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { schemaSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { schemaSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { schemaSecretRef+: { namespace: namespace } } } },
      },
      '#withDesiredState':: d.fn(help='"JSON string matching the CloudFormation resource type schema with desired configuration."', args=[d.arg(name='desiredState', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"Amazon Resource Name (ARN) of the IAM Role to assume for operations."', args=[d.arg(name='roleArn', type=d.T.string)]),
      withRoleArn(roleArn): { spec+: { forProvider+: { roleArn: roleArn } } },
      '#withTypeName':: d.fn(help='"CloudFormation resource type name. For example, AWS::EC2::VPC."', args=[d.arg(name='typeName', type=d.T.string)]),
      withTypeName(typeName): { spec+: { forProvider+: { typeName: typeName } } },
      '#withTypeVersionId':: d.fn(help='"Identifier of the CloudFormation resource type version."', args=[d.arg(name='typeVersionId', type=d.T.string)]),
      withTypeVersionId(typeVersionId): { spec+: { forProvider+: { typeVersionId: typeVersionId } } },
    },
    ...
    initProvider: {
      ...
      schemaSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { schemaSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { schemaSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { schemaSecretRef+: { namespace: namespace } } } },
      },
      '#withDesiredState':: d.fn(help='"JSON string matching the CloudFormation resource type schema with desired configuration."', args=[d.arg(name='desiredState', type=d.T.string)]),
      ...
      '#withTypeName':: d.fn(help='"CloudFormation resource type name. For example, AWS::EC2::VPC."', args=[d.arg(name='typeName', type=d.T.string)]),
      withTypeName(typeName): { spec+: { initProvider+: { typeName: typeName } } },
      '#withTypeVersionId':: d.fn(help='"Identifier of the CloudFormation resource type version."', args=[d.arg(name='typeVersionId', type=d.T.string)]),
      withTypeVersionId(typeVersionId): { spec+: { initProvider+: { typeVersionId: typeVersionId } } },
    },
