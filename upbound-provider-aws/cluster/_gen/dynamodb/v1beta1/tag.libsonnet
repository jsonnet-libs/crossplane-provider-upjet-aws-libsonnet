{
  ...
  '#':: d.pkg(name='tag', url='', help='"Tag is the Schema for the Tags API. Manages an individual DynamoDB resource tag"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceArn':: d.fn(help='"Amazon Resource Name (ARN) of the DynamoDB resource to tag."', args=[d.arg(name='resourceArn', type=d.T.string)]),
