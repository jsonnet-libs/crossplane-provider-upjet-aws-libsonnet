{
  ...
  '#':: d.pkg(name='globalTable', url='', help='"GlobalTable is the Schema for the GlobalTables API. Manages DynamoDB Global Tables V1 (version 2017.11.29)"'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalTable', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#replica':: d.obj(help='"Underlying DynamoDB Table. At least 1 replica must be defined. See below."'),
      replica: {
        '#withRegionName':: d.fn(help='"AWS region name of replica DynamoDB TableE.g., us-east-1"', args=[d.arg(name='regionName', type=d.T.string)]),
      ...
      '#withReplica':: d.fn(help='"Underlying DynamoDB Table. At least 1 replica must be defined. See below."', args=[d.arg(name='replica', type=d.T.array)]),
      withReplica(replica): { spec+: { forProvider+: { replica: if std.isArray(v=replica) then replica else [replica] } } },
      '#withReplicaMixin':: d.fn(help='"Underlying DynamoDB Table. At least 1 replica must be defined. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='replica', type=d.T.array)]),
