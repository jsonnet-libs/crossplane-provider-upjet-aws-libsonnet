{
  ...
  '#':: d.pkg(name='group', url='', help='"Group is the Schema for the Groups API. Provides a Resource Group."'),
  ...
  spec: {
    ...
    forProvider: {
      '#configuration':: d.obj(help='"A configuration associates the resource group with an AWS service and specifies how the service can interact with the resources in the group. See below for details."'),
      configuration: {
        '#parameters':: d.obj(help='"A collection of parameters for this group configuration item. See below for details."'),
        parameters: {
          '#withName':: d.fn(help='"The name of the group configuration parameter."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
          '#withValues':: d.fn(help='"The value or values to be used for the specified parameter."', args=[d.arg(name='values', type=d.T.array)]),
          withValues(values): { values: if std.isArray(v=values) then values else [values] },
          '#withValuesMixin':: d.fn(help='"The value or values to be used for the specified parameter."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
          withValuesMixin(values): { values+: if std.isArray(v=values) then values else [values] },
        },
        '#withParameters':: d.fn(help='"A collection of parameters for this group configuration item. See below for details."', args=[d.arg(name='parameters', type=d.T.array)]),
        withParameters(parameters): { parameters: if std.isArray(v=parameters) then parameters else [parameters] },
        '#withParametersMixin':: d.fn(help='"A collection of parameters for this group configuration item. See below for details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
        withParametersMixin(parameters): { parameters+: if std.isArray(v=parameters) then parameters else [parameters] },
        '#withType':: d.fn(help='"Specifies the type of group configuration item."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#resourceQuery':: d.obj(help='"A resource_query block. Resource queries are documented below."'),
      resourceQuery: {
        '#withQuery':: d.fn(help='"The resource query as a JSON string."', args=[d.arg(name='query', type=d.T.string)]),
        withQuery(query): { query: query },
        '#withType':: d.fn(help='"The type of the resource query. Defaults to TAG_FILTERS_1_0."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withConfiguration':: d.fn(help='"A configuration associates the resource group with an AWS service and specifies how the service can interact with the resources in the group. See below for details."', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withConfigurationMixin':: d.fn(help='"A configuration associates the resource group with an AWS service and specifies how the service can interact with the resources in the group. See below for details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withDescription':: d.fn(help='"A description of the resource group."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withResourceQuery':: d.fn(help='"A resource_query block. Resource queries are documented below."', args=[d.arg(name='resourceQuery', type=d.T.array)]),
      withResourceQuery(resourceQuery): { spec+: { forProvider+: { resourceQuery: if std.isArray(v=resourceQuery) then resourceQuery else [resourceQuery] } } },
      '#withResourceQueryMixin':: d.fn(help='"A resource_query block. Resource queries are documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceQuery', type=d.T.array)]),
      withResourceQueryMixin(resourceQuery): { spec+: { forProvider+: { resourceQuery+: if std.isArray(v=resourceQuery) then resourceQuery else [resourceQuery] } } },
    ...
    initProvider: {
      ...
      '#withResourceQuery':: d.fn(help='"A resource_query block. Resource queries are documented below."', args=[d.arg(name='resourceQuery', type=d.T.array)]),
      withResourceQuery(resourceQuery): { spec+: { initProvider+: { resourceQuery: if std.isArray(v=resourceQuery) then resourceQuery else [resourceQuery] } } },
      '#withResourceQueryMixin':: d.fn(help='"A resource_query block. Resource queries are documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceQuery', type=d.T.array)]),
      withResourceQueryMixin(resourceQuery): { spec+: { initProvider+: { resourceQuery+: if std.isArray(v=resourceQuery) then resourceQuery else [resourceQuery] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
