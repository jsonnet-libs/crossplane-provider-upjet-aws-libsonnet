{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLoggingConfiguration':: d.fn(help='"Logging configuration for the workspace. See Logging Configuration below for details."', args=[d.arg(name='loggingConfiguration', type=d.T.array)]),
      ...
      '#withLoggingConfigurationMixin':: d.fn(help='"Logging configuration for the workspace. See Logging Configuration below for details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='loggingConfiguration', type=d.T.array)]),
