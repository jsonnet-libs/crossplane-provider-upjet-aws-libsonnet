{
  ...
  '#':: d.pkg(name='networkPerformanceMetricSubscription', url='', help='"NetworkPerformanceMetricSubscription is the Schema for the NetworkPerformanceMetricSubscriptions API. Provides a resource to manage an Infrastructure Performance subscription."'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkPerformanceMetricSubscription', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NetworkPerformanceMetricSubscriptionSpec defines the desired state of NetworkPerformanceMetricSubscription"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDestination':: d.fn(help='"The target Region or Availability Zone that the metric subscription is enabled for. For example, eu-west-1."', args=[d.arg(name='destination', type=d.T.string)]),
      withDestination(destination): { spec+: { forProvider+: { destination: destination } } },
      '#withMetric':: d.fn(help='"The metric used for the enabled subscription. Valid values: aggregate-latency. Default: aggregate-latency."', args=[d.arg(name='metric', type=d.T.string)]),
      withMetric(metric): { spec+: { forProvider+: { metric: metric } } },
      ...
      '#withSource':: d.fn(help='"The source Region or Availability Zone that the metric subscription is enabled for. For example, us-east-1."', args=[d.arg(name='source', type=d.T.string)]),
      withSource(source): { spec+: { forProvider+: { source: source } } },
      '#withStatistic':: d.fn(help='"The statistic used for the enabled subscription. Valid values: p50. Default: p50."', args=[d.arg(name='statistic', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withMetric':: d.fn(help='"The metric used for the enabled subscription. Valid values: aggregate-latency. Default: aggregate-latency."', args=[d.arg(name='metric', type=d.T.string)]),
      withMetric(metric): { spec+: { initProvider+: { metric: metric } } },
      '#withSource':: d.fn(help='"The source Region or Availability Zone that the metric subscription is enabled for. For example, us-east-1."', args=[d.arg(name='source', type=d.T.string)]),
