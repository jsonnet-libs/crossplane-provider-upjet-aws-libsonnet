{
  ...
  '#':: d.pkg(name='inputSecurityGroup', url='', help='"InputSecurityGroup is the Schema for the InputSecurityGroups API."'),
  ...
  '#new':: d.fn(help='new returns an instance of InputSecurityGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"InputSecurityGroupSpec defines the desired state of InputSecurityGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#whitelistRules':: d.obj(help='"Whitelist rules. See Whitelist Rules for more details."'),
      whitelistRules: {
        '#withCidr':: d.fn(help="\"The IPv4 CIDR that's whitelisted.\"", args=[d.arg(name='cidr', type=d.T.string)]),
      ...
      '#withWhitelistRules':: d.fn(help='"Whitelist rules. See Whitelist Rules for more details."', args=[d.arg(name='whitelistRules', type=d.T.array)]),
      withWhitelistRules(whitelistRules): { spec+: { forProvider+: { whitelistRules: if std.isArray(v=whitelistRules) then whitelistRules else [whitelistRules] } } },
      '#withWhitelistRulesMixin':: d.fn(help='"Whitelist rules. See Whitelist Rules for more details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='whitelistRules', type=d.T.array)]),
      withWhitelistRulesMixin(whitelistRules): { spec+: { forProvider+: { whitelistRules+: if std.isArray(v=whitelistRules) then whitelistRules else [whitelistRules] } } },
    },
    ...
    initProvider: {
      ...
      '#withWhitelistRules':: d.fn(help='"Whitelist rules. See Whitelist Rules for more details."', args=[d.arg(name='whitelistRules', type=d.T.array)]),
      withWhitelistRules(whitelistRules): { spec+: { initProvider+: { whitelistRules: if std.isArray(v=whitelistRules) then whitelistRules else [whitelistRules] } } },
      '#withWhitelistRulesMixin':: d.fn(help='"Whitelist rules. See Whitelist Rules for more details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='whitelistRules', type=d.T.array)]),
      withWhitelistRulesMixin(whitelistRules): { spec+: { initProvider+: { whitelistRules+: if std.isArray(v=whitelistRules) then whitelistRules else [whitelistRules] } } },
    },
