  ...
  spec: {
    ...
    forProvider: {
      ...
      multiplexSettings: {
        ...
        withMaximumVideoBufferDelayMilliseconds(maximumVideoBufferDelayMilliseconds): { spec+: { forProvider+: { multiplexSettings+: { maximumVideoBufferDelayMilliseconds: maximumVideoBufferDelayMilliseconds } } } },
        '#withTransportStreamBitrate':: d.fn(help='"Transport stream bit rate."', args=[d.arg(name='transportStreamBitrate', type=d.T.number)]),
        withTransportStreamBitrate(transportStreamBitrate): { spec+: { forProvider+: { multiplexSettings+: { transportStreamBitrate: transportStreamBitrate } } } },
        '#withTransportStreamId':: d.fn(help='"Unique ID for each multiplex."', args=[d.arg(name='transportStreamId', type=d.T.number)]),
        withTransportStreamId(transportStreamId): { spec+: { forProvider+: { multiplexSettings+: { transportStreamId: transportStreamId } } } },
        ...
        withTransportStreamReservedBitrate(transportStreamReservedBitrate): { spec+: { forProvider+: { multiplexSettings+: { transportStreamReservedBitrate: transportStreamReservedBitrate } } } },
      },
    ...
    initProvider: {
      ...
      multiplexSettings: {
        '#withMaximumVideoBufferDelayMilliseconds':: d.fn(help='"Maximum video buffer delay."', args=[d.arg(name='maximumVideoBufferDelayMilliseconds', type=d.T.number)]),
        withMaximumVideoBufferDelayMilliseconds(maximumVideoBufferDelayMilliseconds): { spec+: { initProvider+: { multiplexSettings+: { maximumVideoBufferDelayMilliseconds: maximumVideoBufferDelayMilliseconds } } } },
        '#withTransportStreamBitrate':: d.fn(help='"Transport stream bit rate."', args=[d.arg(name='transportStreamBitrate', type=d.T.number)]),
        withTransportStreamBitrate(transportStreamBitrate): { spec+: { initProvider+: { multiplexSettings+: { transportStreamBitrate: transportStreamBitrate } } } },
        '#withTransportStreamId':: d.fn(help='"Unique ID for each multiplex."', args=[d.arg(name='transportStreamId', type=d.T.number)]),
        withTransportStreamId(transportStreamId): { spec+: { initProvider+: { multiplexSettings+: { transportStreamId: transportStreamId } } } },
        '#withTransportStreamReservedBitrate':: d.fn(help='"Transport stream reserved bit rate."', args=[d.arg(name='transportStreamReservedBitrate', type=d.T.number)]),
        withTransportStreamReservedBitrate(transportStreamReservedBitrate): { spec+: { initProvider+: { multiplexSettings+: { transportStreamReservedBitrate: transportStreamReservedBitrate } } } },
      },
      '#withAvailabilityZones':: d.fn(help='"A list of availability zones. You must specify exactly two."', args=[d.arg(name='availabilityZones', type=d.T.array)]),
