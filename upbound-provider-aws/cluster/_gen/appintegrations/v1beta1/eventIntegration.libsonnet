{
  ...
  '#':: d.pkg(name='eventIntegration', url='', help='"EventIntegration is the Schema for the EventIntegrations API. Provides details about a specific Amazon AppIntegrations Event Integration"'),
  ...
  '#new':: d.fn(help='new returns an instance of EventIntegration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EventIntegrationSpec defines the desired state of EventIntegration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#eventFilter':: d.obj(help='"Block that defines the configuration information for the event filter. The Event Filter block is documented below."'),
      eventFilter: {
        '#withSource':: d.fn(help='"Source of the events."', args=[d.arg(name='source', type=d.T.string)]),
        withSource(source): { source: source },
      },
      '#withDescription':: d.fn(help='"Description of the Event Integration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEventFilter':: d.fn(help='"Block that defines the configuration information for the event filter. The Event Filter block is documented below."', args=[d.arg(name='eventFilter', type=d.T.array)]),
      withEventFilter(eventFilter): { spec+: { forProvider+: { eventFilter: if std.isArray(v=eventFilter) then eventFilter else [eventFilter] } } },
      '#withEventFilterMixin':: d.fn(help='"Block that defines the configuration information for the event filter. The Event Filter block is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventFilter', type=d.T.array)]),
      withEventFilterMixin(eventFilter): { spec+: { forProvider+: { eventFilter+: if std.isArray(v=eventFilter) then eventFilter else [eventFilter] } } },
      '#withEventbridgeBus':: d.fn(help='"EventBridge bus."', args=[d.arg(name='eventbridgeBus', type=d.T.string)]),
      withEventbridgeBus(eventbridgeBus): { spec+: { forProvider+: { eventbridgeBus: eventbridgeBus } } },
    ...
    initProvider: {
      ...
      '#withEventFilter':: d.fn(help='"Block that defines the configuration information for the event filter. The Event Filter block is documented below."', args=[d.arg(name='eventFilter', type=d.T.array)]),
      withEventFilter(eventFilter): { spec+: { initProvider+: { eventFilter: if std.isArray(v=eventFilter) then eventFilter else [eventFilter] } } },
      '#withEventFilterMixin':: d.fn(help='"Block that defines the configuration information for the event filter. The Event Filter block is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventFilter', type=d.T.array)]),
      withEventFilterMixin(eventFilter): { spec+: { initProvider+: { eventFilter+: if std.isArray(v=eventFilter) then eventFilter else [eventFilter] } } },
      '#withEventbridgeBus':: d.fn(help='"EventBridge bus."', args=[d.arg(name='eventbridgeBus', type=d.T.string)]),
      withEventbridgeBus(eventbridgeBus): { spec+: { initProvider+: { eventbridgeBus: eventbridgeBus } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
