{
  ...
  '#':: d.pkg(name='resourceShare', url='', help='"ResourceShare is the Schema for the ResourceShares API. Manages a Resource Access Manager (RAM) Resource Share."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceShare', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ResourceShareSpec defines the desired state of ResourceShare"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAllowExternalPrincipals':: d.fn(help='"Indicates whether principals outside your organization can be associated with a resource share."', args=[d.arg(name='allowExternalPrincipals', type=d.T.boolean)]),
      withAllowExternalPrincipals(allowExternalPrincipals): { spec+: { forProvider+: { allowExternalPrincipals: allowExternalPrincipals } } },
      '#withName':: d.fn(help='"The name of the resource share."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPermissionArns':: d.fn(help='"Specifies the Amazon Resource Names (ARNs) of the RAM permission to associate with the resource share. If you do not specify an ARN for the permission, RAM automatically attaches the default version of the permission for each resource type. You can associate only one permission with each resource type included in the resource share."', args=[d.arg(name='permissionArns', type=d.T.array)]),
      withPermissionArns(permissionArns): { spec+: { forProvider+: { permissionArns: if std.isArray(v=permissionArns) then permissionArns else [permissionArns] } } },
      '#withPermissionArnsMixin':: d.fn(help='"Specifies the Amazon Resource Names (ARNs) of the RAM permission to associate with the resource share. If you do not specify an ARN for the permission, RAM automatically attaches the default version of the permission for each resource type. You can associate only one permission with each resource type included in the resource share."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='permissionArns', type=d.T.array)]),
      withPermissionArnsMixin(permissionArns): { spec+: { forProvider+: { permissionArns+: if std.isArray(v=permissionArns) then permissionArns else [permissionArns] } } },
    ...
    initProvider: {
      '#withAllowExternalPrincipals':: d.fn(help='"Indicates whether principals outside your organization can be associated with a resource share."', args=[d.arg(name='allowExternalPrincipals', type=d.T.boolean)]),
      withAllowExternalPrincipals(allowExternalPrincipals): { spec+: { initProvider+: { allowExternalPrincipals: allowExternalPrincipals } } },
      '#withName':: d.fn(help='"The name of the resource share."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withPermissionArns':: d.fn(help='"Specifies the Amazon Resource Names (ARNs) of the RAM permission to associate with the resource share. If you do not specify an ARN for the permission, RAM automatically attaches the default version of the permission for each resource type. You can associate only one permission with each resource type included in the resource share."', args=[d.arg(name='permissionArns', type=d.T.array)]),
      withPermissionArns(permissionArns): { spec+: { initProvider+: { permissionArns: if std.isArray(v=permissionArns) then permissionArns else [permissionArns] } } },
      '#withPermissionArnsMixin':: d.fn(help='"Specifies the Amazon Resource Names (ARNs) of the RAM permission to associate with the resource share. If you do not specify an ARN for the permission, RAM automatically attaches the default version of the permission for each resource type. You can associate only one permission with each resource type included in the resource share."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='permissionArns', type=d.T.array)]),
      withPermissionArnsMixin(permissionArns): { spec+: { initProvider+: { permissionArns+: if std.isArray(v=permissionArns) then permissionArns else [permissionArns] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
