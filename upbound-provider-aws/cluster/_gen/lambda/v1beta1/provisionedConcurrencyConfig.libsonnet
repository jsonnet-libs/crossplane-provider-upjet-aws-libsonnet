{
  ...
  '#':: d.pkg(name='provisionedConcurrencyConfig', url='', help='"ProvisionedConcurrencyConfig is the Schema for the ProvisionedConcurrencyConfigs API. Manages an AWS Lambda Provisioned Concurrency Configuration."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProvisionedConcurrencyConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProvisionedConcurrencyConfigSpec defines the desired state of ProvisionedConcurrencyConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withFunctionName':: d.fn(help='"Name or Amazon Resource Name (ARN) of the Lambda Function."', args=[d.arg(name='functionName', type=d.T.string)]),
      withFunctionName(functionName): { spec+: { forProvider+: { functionName: functionName } } },
      '#withProvisionedConcurrentExecutions':: d.fn(help='"Amount of capacity to allocate. Must be greater than or equal to 1."', args=[d.arg(name='provisionedConcurrentExecutions', type=d.T.number)]),
      withProvisionedConcurrentExecutions(provisionedConcurrentExecutions): { spec+: { forProvider+: { provisionedConcurrentExecutions: provisionedConcurrentExecutions } } },
      '#withQualifier':: d.fn(help='"Lambda Function version or Lambda Alias name."', args=[d.arg(name='qualifier', type=d.T.string)]),
      ...
      '#withSkipDestroy':: d.fn(help='"Whether to retain the provisioned concurrency configuration upon destruction. Defaults to false. If set to true, the resource is simply removed from state instead."', args=[d.arg(name='skipDestroy', type=d.T.boolean)]),
    ...
    initProvider: {
      ...
      '#withProvisionedConcurrentExecutions':: d.fn(help='"Amount of capacity to allocate. Must be greater than or equal to 1."', args=[d.arg(name='provisionedConcurrentExecutions', type=d.T.number)]),
      withProvisionedConcurrentExecutions(provisionedConcurrentExecutions): { spec+: { initProvider+: { provisionedConcurrentExecutions: provisionedConcurrentExecutions } } },
      '#withQualifier':: d.fn(help='"Lambda Function version or Lambda Alias name."', args=[d.arg(name='qualifier', type=d.T.string)]),
