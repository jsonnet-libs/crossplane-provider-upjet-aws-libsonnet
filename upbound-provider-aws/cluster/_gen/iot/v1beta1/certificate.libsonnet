{
  ...
  '#':: d.pkg(name='certificate', url='', help='"Certificate is the Schema for the Certificates API. Creates and manages an AWS IoT certificate."'),
  ...
  spec: {
    ...
    forProvider: {
      '#caPemSecretRef':: d.obj(help='"The CA certificate for the certificate to be registered. If this is set, the CA needs to be registered with AWS IoT beforehand."'),
      caPemSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { caPemSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { caPemSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { caPemSecretRef+: { namespace: namespace } } } },
      },
      '#certificatePemSecretRef':: d.obj(help='"The certificate to be registered. If ca_pem is unspecified, review\\nRegisterCertificateWithoutCA.\\nIf ca_pem is specified, review\\nRegisterCertificate\\nfor more information on registering a certificate."'),
      certificatePemSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { certificatePemSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { certificatePemSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { certificatePemSecretRef+: { namespace: namespace } } } },
      },
      '#withActive':: d.fn(help='"Boolean flag to indicate if the certificate should be active"', args=[d.arg(name='active', type=d.T.boolean)]),
      withActive(active): { spec+: { forProvider+: { active: active } } },
      '#withCsr':: d.fn(help='"The certificate signing request. Review\\nCreateCertificateFromCsr\\nfor more information on generating a certificate from a certificate signing request (CSR).\\nIf none is specified both the certificate and keys will be generated, review CreateKeysAndCertificate\\nfor more information on generating keys and a certificate."', args=[d.arg(name='csr', type=d.T.string)]),
      withCsr(csr): { spec+: { forProvider+: { csr: csr } } },
    ...
    initProvider: {
      ...
      caPemSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { caPemSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { caPemSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { caPemSecretRef+: { namespace: namespace } } } },
      },
      '#certificatePemSecretRef':: d.obj(help='"The certificate to be registered. If ca_pem is unspecified, review\\nRegisterCertificateWithoutCA.\\nIf ca_pem is specified, review\\nRegisterCertificate\\nfor more information on registering a certificate."'),
      certificatePemSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { certificatePemSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { certificatePemSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { certificatePemSecretRef+: { namespace: namespace } } } },
      },
      '#withActive':: d.fn(help='"Boolean flag to indicate if the certificate should be active"', args=[d.arg(name='active', type=d.T.boolean)]),
      withActive(active): { spec+: { initProvider+: { active: active } } },
      '#withCsr':: d.fn(help='"The certificate signing request. Review\\nCreateCertificateFromCsr\\nfor more information on generating a certificate from a certificate signing request (CSR).\\nIf none is specified both the certificate and keys will be generated, review CreateKeysAndCertificate\\nfor more information on generating keys and a certificate."', args=[d.arg(name='csr', type=d.T.string)]),
      withCsr(csr): { spec+: { initProvider+: { csr: csr } } },
    },
