{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVpcConfiguration':: d.fn(help='"Configuration of the virtual private cloud (VPC) connection. For more info, see the AWS documentation."', args=[d.arg(name='vpcConfiguration', type=d.T.array)]),
      ...
      '#withVpcConfigurationMixin':: d.fn(help='"Configuration of the virtual private cloud (VPC) connection. For more info, see the AWS documentation."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vpcConfiguration', type=d.T.array)]),
