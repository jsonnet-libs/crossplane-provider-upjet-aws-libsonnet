  ...
  spec: {
    ...
    forProvider: {
      ...
      properties: {
        ...
        withSearchableAttributes(searchableAttributes): { searchableAttributes: if std.isArray(v=searchableAttributes) then searchableAttributes else [searchableAttributes] },
        ...
        withSearchableAttributesMixin(searchableAttributes): { searchableAttributes+: if std.isArray(v=searchableAttributes) then searchableAttributes else [searchableAttributes] },
      },
      ...
      '#withProperties':: d.fn(help='", Configuration block that can contain the following properties of the thing type:"', args=[d.arg(name='properties', type=d.T.array)]),
      withProperties(properties): { spec+: { forProvider+: { properties: if std.isArray(v=properties) then properties else [properties] } } },
      '#withPropertiesMixin':: d.fn(help='", Configuration block that can contain the following properties of the thing type:"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='properties', type=d.T.array)]),
