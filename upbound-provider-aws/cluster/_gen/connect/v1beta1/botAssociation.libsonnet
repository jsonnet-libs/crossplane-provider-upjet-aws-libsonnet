  ...
  spec: {
    ...
    forProvider: {
      ...
      lexBot: {
        ...
        withLexRegion(lexRegion): { lexRegion: lexRegion },
      ...
      '#withLexBot':: d.fn(help='"Configuration information of an Amazon Lex (V1) bot. Detailed below."', args=[d.arg(name='lexBot', type=d.T.array)]),
      withLexBot(lexBot): { spec+: { forProvider+: { lexBot: if std.isArray(v=lexBot) then lexBot else [lexBot] } } },
      '#withLexBotMixin':: d.fn(help='"Configuration information of an Amazon Lex (V1) bot. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='lexBot', type=d.T.array)]),
      withLexBotMixin(lexBot): { spec+: { forProvider+: { lexBot+: if std.isArray(v=lexBot) then lexBot else [lexBot] } } },
    ...
    initProvider: {
      ...
      '#withLexBot':: d.fn(help='"Configuration information of an Amazon Lex (V1) bot. Detailed below."', args=[d.arg(name='lexBot', type=d.T.array)]),
      withLexBot(lexBot): { spec+: { initProvider+: { lexBot: if std.isArray(v=lexBot) then lexBot else [lexBot] } } },
      '#withLexBotMixin':: d.fn(help='"Configuration information of an Amazon Lex (V1) bot. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='lexBot', type=d.T.array)]),
      withLexBotMixin(lexBot): { spec+: { initProvider+: { lexBot+: if std.isArray(v=lexBot) then lexBot else [lexBot] } } },
    },
