{
  ...
  '#':: d.pkg(name='policy', url='', help='"Policy is the Schema for the Policys API. Provides an IAM policy."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the IAM policy."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withPath':: d.fn(help='"Path in which to create the policy. See IAM Identifiers for more information."', args=[d.arg(name='path', type=d.T.string)]),
      withPath(path): { spec+: { forProvider+: { path: path } } },
      '#withPolicy':: d.fn(help='"Policy document. This is a JSON formatted string"', args=[d.arg(name='policy', type=d.T.string)]),
