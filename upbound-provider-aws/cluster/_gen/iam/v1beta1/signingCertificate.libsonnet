{
  ...
  '#':: d.pkg(name='signingCertificate', url='', help='"SigningCertificate is the Schema for the SigningCertificates API. Provides an IAM Signing Certificate"'),
  ...
  '#new':: d.fn(help='new returns an instance of SigningCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SigningCertificateSpec defines the desired state of SigningCertificate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCertificateBody':: d.fn(help='"The contents of the signing certificate in PEM-encoded format."', args=[d.arg(name='certificateBody', type=d.T.string)]),
