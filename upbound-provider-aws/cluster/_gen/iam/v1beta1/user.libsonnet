{
  ...
  '#':: d.pkg(name='user', url='', help='"User is the Schema for the Users API. Provides an IAM user."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withForceDestroy':: d.fn(help='"when destroying this user, destroy even if it\\nhas non-provider-managed iam access keys, login profile or mfa devices. without force_destroy\\na user with non-provider-managed access keys and login profile will fail to be destroyed.\\ndelete user even if it has non-provider-managed iam access keys, login profile or mfa devices"', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
      withForceDestroy(forceDestroy): { spec+: { forProvider+: { forceDestroy: forceDestroy } } },
      '#withPath':: d.fn(help='"Path in which to create the user."', args=[d.arg(name='path', type=d.T.string)]),
      withPath(path): { spec+: { forProvider+: { path: path } } },
      '#withPermissionsBoundary':: d.fn(help='"The ARN of the policy that is used to set the permissions boundary for the user."', args=[d.arg(name='permissionsBoundary', type=d.T.string)]),
