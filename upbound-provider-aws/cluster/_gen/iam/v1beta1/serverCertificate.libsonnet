{
  ...
  '#':: d.pkg(name='serverCertificate', url='', help='"ServerCertificate is the Schema for the ServerCertificates API. Provides an IAM Server Certificate"'),
  ...
  '#new':: d.fn(help='new returns an instance of ServerCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServerCertificateSpec defines the desired state of ServerCertificate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#privateKeySecretRef':: d.obj(help='"The contents of the private key in PEM-encoded format."'),
      privateKeySecretRef: {
      ...
      '#withCertificateBody':: d.fn(help='"The contents of the public key certificate in\\nPEM-encoded format."', args=[d.arg(name='certificateBody', type=d.T.string)]),
      withCertificateBody(certificateBody): { spec+: { forProvider+: { certificateBody: certificateBody } } },
      '#withCertificateChain':: d.fn(help='"The contents of the certificate chain.\\nThis is typically a concatenation of the PEM-encoded public key certificates\\nof the chain."', args=[d.arg(name='certificateChain', type=d.T.string)]),
      withCertificateChain(certificateChain): { spec+: { forProvider+: { certificateChain: certificateChain } } },
      '#withPath':: d.fn(help='"The IAM path for the server certificate.  If it is not\\nincluded, it defaults to a slash (/). If this certificate is for use with\\nAWS CloudFront, the path must be in format /cloudfront/your_path_here.\\nSee IAM Identifiers for more details on IAM Paths."', args=[d.arg(name='path', type=d.T.string)]),
