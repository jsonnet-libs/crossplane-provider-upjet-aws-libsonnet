{
  ...
  spec: {
    ...
    forProvider: {
      ...
      appversionLifecycle: {
        ...
        serviceRoleRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { serviceRoleRef+: { policy+: { resolution: resolution } } },
            ...
            withResolve(resolve): { serviceRoleRef+: { policy+: { resolve: resolve } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { serviceRoleRef+: { name: name } },
        },
        ...
        serviceRoleSelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { serviceRoleSelector+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { serviceRoleSelector+: { policy+: { resolve: resolve } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { serviceRoleSelector+: { matchControllerRef: matchControllerRef } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { serviceRoleSelector+: { matchLabels: matchLabels } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { serviceRoleSelector+: { matchLabels+: matchLabels } },
        },
        ...
        withDeleteSourceFromS3(deleteSourceFromS3): { deleteSourceFromS3: deleteSourceFromS3 },
        ...
        withMaxAgeInDays(maxAgeInDays): { maxAgeInDays: maxAgeInDays },
      ...
      '#withAppversionLifecycle':: d.fn(help='', args=[d.arg(name='appversionLifecycle', type=d.T.array)]),
      withAppversionLifecycle(appversionLifecycle): { spec+: { forProvider+: { appversionLifecycle: if std.isArray(v=appversionLifecycle) then appversionLifecycle else [appversionLifecycle] } } },
      '#withAppversionLifecycleMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='appversionLifecycle', type=d.T.array)]),
      withAppversionLifecycleMixin(appversionLifecycle): { spec+: { forProvider+: { appversionLifecycle+: if std.isArray(v=appversionLifecycle) then appversionLifecycle else [appversionLifecycle] } } },
    ...
    initProvider: {
      ...
      '#withAppversionLifecycle':: d.fn(help='', args=[d.arg(name='appversionLifecycle', type=d.T.array)]),
      withAppversionLifecycle(appversionLifecycle): { spec+: { initProvider+: { appversionLifecycle: if std.isArray(v=appversionLifecycle) then appversionLifecycle else [appversionLifecycle] } } },
      '#withAppversionLifecycleMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='appversionLifecycle', type=d.T.array)]),
      withAppversionLifecycleMixin(appversionLifecycle): { spec+: { initProvider+: { appversionLifecycle+: if std.isArray(v=appversionLifecycle) then appversionLifecycle else [appversionLifecycle] } } },
      '#withDescription':: d.fn(help='"Short description of the application"', args=[d.arg(name='description', type=d.T.string)]),
