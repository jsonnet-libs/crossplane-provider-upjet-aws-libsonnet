{
  ...
  '#':: d.pkg(name='channel', url='', help='"Channel is the Schema for the Channels API. Provides an AWS Elemental MediaPackage Channel."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withChannelId':: d.fn(help='"A unique identifier describing the channel"', args=[d.arg(name='channelId', type=d.T.string)]),
      withChannelId(channelId): { spec+: { forProvider+: { channelId: channelId } } },
      '#withDescription':: d.fn(help='"A description of the channel"', args=[d.arg(name='description', type=d.T.string)]),
    ...
    initProvider: {
      '#withChannelId':: d.fn(help='"A unique identifier describing the channel"', args=[d.arg(name='channelId', type=d.T.string)]),
      withChannelId(channelId): { spec+: { initProvider+: { channelId: channelId } } },
      '#withDescription':: d.fn(help='"A description of the channel"', args=[d.arg(name='description', type=d.T.string)]),
