{
  ...
  '#':: d.pkg(name='multiRegionAccessPointPolicy', url='', help='"MultiRegionAccessPointPolicy is the Schema for the MultiRegionAccessPointPolicys API. Provides a resource to manage an S3 Multi-Region Access Point access control policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of MultiRegionAccessPointPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MultiRegionAccessPointPolicySpec defines the desired state of MultiRegionAccessPointPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#details':: d.obj(help='"A configuration block containing details about the policy for the Multi-Region Access Point. See Details Configuration Block below for more details"'),
      details: {
        '#withName':: d.fn(help='"The name of the Multi-Region Access Point."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withPolicy':: d.fn(help='"A valid JSON document that specifies the policy that you want to associate with this Multi-Region Access Point. Once applied, the policy can be edited, but not deleted. For more information, see the documentation on Multi-Region Access Point Permissions."', args=[d.arg(name='policy', type=d.T.string)]),
        withPolicy(policy): { policy: policy },
      },
      '#withAccountId':: d.fn(help='"The AWS account ID for the owner of the Multi-Region Access Point."', args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withDetails':: d.fn(help='"A configuration block containing details about the policy for the Multi-Region Access Point. See Details Configuration Block below for more details"', args=[d.arg(name='details', type=d.T.array)]),
      withDetails(details): { spec+: { forProvider+: { details: if std.isArray(v=details) then details else [details] } } },
      '#withDetailsMixin':: d.fn(help='"A configuration block containing details about the policy for the Multi-Region Access Point. See Details Configuration Block below for more details"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='details', type=d.T.array)]),
