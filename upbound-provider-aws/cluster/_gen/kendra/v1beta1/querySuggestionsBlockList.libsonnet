{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSourceS3Path':: d.fn(help='"S3 path where your block list text file is located. See details below."', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
