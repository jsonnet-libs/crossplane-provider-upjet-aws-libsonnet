{
  ...
  '#':: d.pkg(name='experience', url='', help='"Experience is the Schema for the Experiences API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Experience', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ExperienceSpec defines the desired state of Experience"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#configuration':: d.obj(help='"Configuration information for your Amazon Kendra experience. Detailed below."'),
      configuration: {
        '#contentSourceConfiguration':: d.obj(help='"The identifiers of your data sources and FAQs. Or, you can specify that you want to use documents indexed via the BatchPutDocument API. Detailed below."'),
        contentSourceConfiguration: {
          '#withDataSourceIds':: d.fn(help='"The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items."', args=[d.arg(name='dataSourceIds', type=d.T.array)]),
          withDataSourceIds(dataSourceIds): { dataSourceIds: if std.isArray(v=dataSourceIds) then dataSourceIds else [dataSourceIds] },
          '#withDataSourceIdsMixin':: d.fn(help='"The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dataSourceIds', type=d.T.array)]),
          withDataSourceIdsMixin(dataSourceIds): { dataSourceIds+: if std.isArray(v=dataSourceIds) then dataSourceIds else [dataSourceIds] },
          '#withDirectPutContent':: d.fn(help='"Whether to use documents you indexed directly using the BatchPutDocument API. Defaults to false."', args=[d.arg(name='directPutContent', type=d.T.boolean)]),
          withDirectPutContent(directPutContent): { directPutContent: directPutContent },
          '#withFaqIds':: d.fn(help='"The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items."', args=[d.arg(name='faqIds', type=d.T.array)]),
          withFaqIds(faqIds): { faqIds: if std.isArray(v=faqIds) then faqIds else [faqIds] },
          '#withFaqIdsMixin':: d.fn(help='"The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='faqIds', type=d.T.array)]),
          withFaqIdsMixin(faqIds): { faqIds+: if std.isArray(v=faqIds) then faqIds else [faqIds] },
        },
        '#userIdentityConfiguration':: d.obj(help='"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."'),
        userIdentityConfiguration: {
          '#withIdentityAttributeName':: d.fn(help='"The AWS SSO field name that contains the identifiers of your users, such as their emails."', args=[d.arg(name='identityAttributeName', type=d.T.string)]),
          withIdentityAttributeName(identityAttributeName): { identityAttributeName: identityAttributeName },
        },
        '#withContentSourceConfiguration':: d.fn(help='"The identifiers of your data sources and FAQs. Or, you can specify that you want to use documents indexed via the BatchPutDocument API. Detailed below."', args=[d.arg(name='contentSourceConfiguration', type=d.T.array)]),
        withContentSourceConfiguration(contentSourceConfiguration): { contentSourceConfiguration: if std.isArray(v=contentSourceConfiguration) then contentSourceConfiguration else [contentSourceConfiguration] },
        '#withContentSourceConfigurationMixin':: d.fn(help='"The identifiers of your data sources and FAQs. Or, you can specify that you want to use documents indexed via the BatchPutDocument API. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='contentSourceConfiguration', type=d.T.array)]),
        withContentSourceConfigurationMixin(contentSourceConfiguration): { contentSourceConfiguration+: if std.isArray(v=contentSourceConfiguration) then contentSourceConfiguration else [contentSourceConfiguration] },
        '#withUserIdentityConfiguration':: d.fn(help='"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."', args=[d.arg(name='userIdentityConfiguration', type=d.T.array)]),
        withUserIdentityConfiguration(userIdentityConfiguration): { userIdentityConfiguration: if std.isArray(v=userIdentityConfiguration) then userIdentityConfiguration else [userIdentityConfiguration] },
        '#withUserIdentityConfigurationMixin':: d.fn(help='"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='userIdentityConfiguration', type=d.T.array)]),
        withUserIdentityConfigurationMixin(userIdentityConfiguration): { userIdentityConfiguration+: if std.isArray(v=userIdentityConfiguration) then userIdentityConfiguration else [userIdentityConfiguration] },
      },
      ...
      '#withConfiguration':: d.fn(help='"Configuration information for your Amazon Kendra experience. Detailed below."', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withConfigurationMixin':: d.fn(help='"Configuration information for your Amazon Kendra experience. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withDescription':: d.fn(help='"A description for your Amazon Kendra experience."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIndexId':: d.fn(help='"The identifier of the index for your Amazon Kendra experience."', args=[d.arg(name='indexId', type=d.T.string)]),
      withIndexId(indexId): { spec+: { forProvider+: { indexId: indexId } } },
      '#withName':: d.fn(help='"A name for your Amazon Kendra experience."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) of a role with permission to access Query API, QuerySuggestions API, SubmitFeedback API, and AWS SSO that stores your user and group information. For more information, see IAM roles for Amazon Kendra."', args=[d.arg(name='roleArn', type=d.T.string)]),
