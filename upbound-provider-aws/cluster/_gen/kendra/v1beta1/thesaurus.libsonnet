{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSourceS3Path':: d.fn(help='"The S3 path where your thesaurus file sits in S3. Detailed below."', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
      withSourceS3Path(sourceS3Path): { spec+: { forProvider+: { sourceS3Path: if std.isArray(v=sourceS3Path) then sourceS3Path else [sourceS3Path] } } },
      '#withSourceS3PathMixin':: d.fn(help='"The S3 path where your thesaurus file sits in S3. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
      withSourceS3PathMixin(sourceS3Path): { spec+: { forProvider+: { sourceS3Path+: if std.isArray(v=sourceS3Path) then sourceS3Path else [sourceS3Path] } } },
    ...
    initProvider: {
      ...
      '#withSourceS3Path':: d.fn(help='"The S3 path where your thesaurus file sits in S3. Detailed below."', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
      withSourceS3Path(sourceS3Path): { spec+: { initProvider+: { sourceS3Path: if std.isArray(v=sourceS3Path) then sourceS3Path else [sourceS3Path] } } },
      '#withSourceS3PathMixin':: d.fn(help='"The S3 path where your thesaurus file sits in S3. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
      withSourceS3PathMixin(sourceS3Path): { spec+: { initProvider+: { sourceS3Path+: if std.isArray(v=sourceS3Path) then sourceS3Path else [sourceS3Path] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags. If configured with a provider default_tags configuration block present, tags with matching keys will overwrite those defined at the provider-level."', args=[d.arg(name='tags', type=d.T.object)]),
