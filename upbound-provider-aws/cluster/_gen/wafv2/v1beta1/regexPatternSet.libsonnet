{
  ...
  '#':: d.pkg(name='regexPatternSet', url='', help='"RegexPatternSet is the Schema for the RegexPatternSets API. Provides an AWS WAFv2 Regex Pattern Set resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegexPatternSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegexPatternSetSpec defines the desired state of RegexPatternSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#regularExpression':: d.obj(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details."'),
      regularExpression: {
        '#withRegexString':: d.fn(help='"The string representing the regular expression, see the AWS WAF documentation for more information."', args=[d.arg(name='regexString', type=d.T.string)]),
        withRegexString(regexString): { regexString: regexString },
      },
      '#withDescription':: d.fn(help='"A friendly description of the regular expression pattern set."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"A friendly name of the regular expression pattern set. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRegularExpression':: d.fn(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details."', args=[d.arg(name='regularExpression', type=d.T.array)]),
      withRegularExpression(regularExpression): { spec+: { forProvider+: { regularExpression: if std.isArray(v=regularExpression) then regularExpression else [regularExpression] } } },
      '#withRegularExpressionMixin':: d.fn(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='regularExpression', type=d.T.array)]),
      withRegularExpressionMixin(regularExpression): { spec+: { forProvider+: { regularExpression+: if std.isArray(v=regularExpression) then regularExpression else [regularExpression] } } },
    ...
    initProvider: {
      ...
      '#withRegularExpression':: d.fn(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details."', args=[d.arg(name='regularExpression', type=d.T.array)]),
      withRegularExpression(regularExpression): { spec+: { initProvider+: { regularExpression: if std.isArray(v=regularExpression) then regularExpression else [regularExpression] } } },
      '#withRegularExpressionMixin':: d.fn(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='regularExpression', type=d.T.array)]),
      withRegularExpressionMixin(regularExpression): { spec+: { initProvider+: { regularExpression+: if std.isArray(v=regularExpression) then regularExpression else [regularExpression] } } },
      '#withScope':: d.fn(help='"Specifies whether this is for an AWS CloudFront distribution or for a regional application. Valid values are CLOUDFRONT or REGIONAL. To work with CloudFront, you must also specify the region us-east-1 (N. Virginia) on the AWS provider."', args=[d.arg(name='scope', type=d.T.string)]),
