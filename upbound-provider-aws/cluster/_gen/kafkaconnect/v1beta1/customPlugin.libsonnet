  ...
  spec: {
    ...
    forProvider: {
      ...
      location: {
        ...
        '#withS3':: d.fn(help='"Information of the plugin file stored in Amazon S3. See s3 Block for details.."', args=[d.arg(name='s3', type=d.T.array)]),
        withS3(s3): { s3: if std.isArray(v=s3) then s3 else [s3] },
        '#withS3Mixin':: d.fn(help='"Information of the plugin file stored in Amazon S3. See s3 Block for details.."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='s3', type=d.T.array)]),
      ...
      '#withLocation':: d.fn(help='"Information about the location of a custom plugin. See location Block for details."', args=[d.arg(name='location', type=d.T.array)]),
      withLocation(location): { spec+: { forProvider+: { location: if std.isArray(v=location) then location else [location] } } },
      '#withLocationMixin':: d.fn(help='"Information about the location of a custom plugin. See location Block for details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='location', type=d.T.array)]),
