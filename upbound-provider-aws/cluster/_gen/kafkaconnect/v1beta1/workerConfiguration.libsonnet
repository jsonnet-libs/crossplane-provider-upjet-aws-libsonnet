{
  ...
  '#':: d.pkg(name='workerConfiguration', url='', help='"WorkerConfiguration is the Schema for the WorkerConfigurations API. Provides an Amazon MSK Connect worker configuration resource. This resource is create-only, and requires a unique \\"name\\" parameter. AWS does not currently provide update or delete APIs."'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkerConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkerConfigurationSpec defines the desired state of WorkerConfiguration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"A summary description of the worker configuration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of the worker configuration."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPropertiesFileContent':: d.fn(help='"Contents of connect-distributed.properties file. The value can be either base64 encoded or in raw format."', args=[d.arg(name='propertiesFileContent', type=d.T.string)]),
      withPropertiesFileContent(propertiesFileContent): { spec+: { forProvider+: { propertiesFileContent: propertiesFileContent } } },
    ...
    initProvider: {
      ...
      '#withPropertiesFileContent':: d.fn(help='"Contents of connect-distributed.properties file. The value can be either base64 encoded or in raw format."', args=[d.arg(name='propertiesFileContent', type=d.T.string)]),
      withPropertiesFileContent(propertiesFileContent): { spec+: { initProvider+: { propertiesFileContent: propertiesFileContent } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
