{
  ...
  spec: {
    ...
    forProvider: {
      ...
      policyDetails: {
        ...
        action: {
          ...
          crossRegionCopy: {
            ...
            retainRule: {
              ...
              withIntervalUnit(intervalUnit): { intervalUnit: intervalUnit },
            },
            '#withEncryptionConfiguration':: d.fn(help='"The encryption settings for the copied snapshot. See the encryption_configuration block. Max of 1 per action."', args=[d.arg(name='encryptionConfiguration', type=d.T.array)]),
            ...
            '#withEncryptionConfigurationMixin':: d.fn(help='"The encryption settings for the copied snapshot. See the encryption_configuration block. Max of 1 per action."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionConfiguration', type=d.T.array)]),
            ...
            '#withRetainRule':: d.fn(help='"Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action."', args=[d.arg(name='retainRule', type=d.T.array)]),
            withRetainRule(retainRule): { retainRule: if std.isArray(v=retainRule) then retainRule else [retainRule] },
            '#withRetainRuleMixin':: d.fn(help='"Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='retainRule', type=d.T.array)]),
            withRetainRuleMixin(retainRule): { retainRule+: if std.isArray(v=retainRule) then retainRule else [retainRule] },
          ...
          withCrossRegionCopy(crossRegionCopy): { crossRegionCopy: if std.isArray(v=crossRegionCopy) then crossRegionCopy else [crossRegionCopy] },
          ...
          withCrossRegionCopyMixin(crossRegionCopy): { crossRegionCopy+: if std.isArray(v=crossRegionCopy) then crossRegionCopy else [crossRegionCopy] },
        ...
        eventSource: {
          ...
          parameters: {
            ...
            withDescriptionRegex(descriptionRegex): { descriptionRegex: descriptionRegex },
            ...
            withSnapshotOwner(snapshotOwner): { snapshotOwner: if std.isArray(v=snapshotOwner) then snapshotOwner else [snapshotOwner] },
            ...
            withSnapshotOwnerMixin(snapshotOwner): { snapshotOwner+: if std.isArray(v=snapshotOwner) then snapshotOwner else [snapshotOwner] },
          },
          '#withParameters':: d.fn(help='"A set of optional parameters for snapshot and AMI lifecycle policies. See the parameters configuration block."', args=[d.arg(name='parameters', type=d.T.array)]),
          withParameters(parameters): { parameters: if std.isArray(v=parameters) then parameters else [parameters] },
          '#withParametersMixin':: d.fn(help='"A set of optional parameters for snapshot and AMI lifecycle policies. See the parameters configuration block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
        ...
        exclusions: {
          ...
          withExcludeBootVolumes(excludeBootVolumes): { excludeBootVolumes: excludeBootVolumes },
          ...
          withExcludeTags(excludeTags): { excludeTags: excludeTags },
          ...
          withExcludeTagsMixin(excludeTags): { excludeTags+: excludeTags },
          ...
          withExcludeVolumeTypes(excludeVolumeTypes): { excludeVolumeTypes: if std.isArray(v=excludeVolumeTypes) then excludeVolumeTypes else [excludeVolumeTypes] },
          ...
          withExcludeVolumeTypesMixin(excludeVolumeTypes): { excludeVolumeTypes+: if std.isArray(v=excludeVolumeTypes) then excludeVolumeTypes else [excludeVolumeTypes] },
        },
        '#parameters':: d.obj(help='"A set of optional parameters for snapshot and AMI lifecycle policies. See the parameters configuration block."'),
        parameters: {
          ...
          withExcludeBootVolume(excludeBootVolume): { excludeBootVolume: excludeBootVolume },
          ...
          withNoReboot(noReboot): { noReboot: noReboot },
        },
        ...
        schedule: {
          ...
          archiveRule: {
            ...
            archiveRetainRule: {
              ...
              '#withRetentionArchiveTier':: d.fn(help='"Information about retention period in the Amazon EBS Snapshots Archive. See the retention_archive_tier block."', args=[d.arg(name='retentionArchiveTier', type=d.T.array)]),
              withRetentionArchiveTier(retentionArchiveTier): { retentionArchiveTier: if std.isArray(v=retentionArchiveTier) then retentionArchiveTier else [retentionArchiveTier] },
              '#withRetentionArchiveTierMixin':: d.fn(help='"Information about retention period in the Amazon EBS Snapshots Archive. See the retention_archive_tier block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='retentionArchiveTier', type=d.T.array)]),
              withRetentionArchiveTierMixin(retentionArchiveTier): { retentionArchiveTier+: if std.isArray(v=retentionArchiveTier) then retentionArchiveTier else [retentionArchiveTier] },
            },
            '#withArchiveRetainRule':: d.fn(help='"Information about the retention period for the snapshot archiving rule. See the archive_retain_rule block."', args=[d.arg(name='archiveRetainRule', type=d.T.array)]),
            withArchiveRetainRule(archiveRetainRule): { archiveRetainRule: if std.isArray(v=archiveRetainRule) then archiveRetainRule else [archiveRetainRule] },
            '#withArchiveRetainRuleMixin':: d.fn(help='"Information about the retention period for the snapshot archiving rule. See the archive_retain_rule block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='archiveRetainRule', type=d.T.array)]),
            withArchiveRetainRuleMixin(archiveRetainRule): { archiveRetainRule+: if std.isArray(v=archiveRetainRule) then archiveRetainRule else [archiveRetainRule] },
          },
          ...
          createRule: {
            ...
            scripts: {
              ...
              withExecuteOperationOnScriptFailure(executeOperationOnScriptFailure): { executeOperationOnScriptFailure: executeOperationOnScriptFailure },
              ...
              withExecutionHandler(executionHandler): { executionHandler: executionHandler },
              ...
              withExecutionHandlerService(executionHandlerService): { executionHandlerService: executionHandlerService },
              ...
              withMaximumRetryCount(maximumRetryCount): { maximumRetryCount: maximumRetryCount },
            ...
            withCronExpression(cronExpression): { cronExpression: cronExpression },
            '#withInterval':: d.fn(help='"How often this lifecycle policy should be evaluated. 1, 2,3,4,6,8,12 or 24 are valid values. Conflicts with cron_expression. If set, interval_unit and times must also be set."', args=[d.arg(name='interval', type=d.T.number)]),
            withInterval(interval): { interval: interval },
            '#withIntervalUnit':: d.fn(help='"The unit for how often the lifecycle policy should be evaluated. HOURS is currently the only allowed value and also the default value. Conflicts with cron_expression. Must be set if interval is set."', args=[d.arg(name='intervalUnit', type=d.T.string)]),
            withIntervalUnit(intervalUnit): { intervalUnit: intervalUnit },
            ...
            '#withScripts':: d.fn(help='"Specifies pre and/or post scripts for a snapshot lifecycle policy that targets instances. Valid only when resource_type is INSTANCE. See the scripts configuration block."', args=[d.arg(name='scripts', type=d.T.array)]),
            withScripts(scripts): { scripts: if std.isArray(v=scripts) then scripts else [scripts] },
            '#withScriptsMixin':: d.fn(help='"Specifies pre and/or post scripts for a snapshot lifecycle policy that targets instances. Valid only when resource_type is INSTANCE. See the scripts configuration block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scripts', type=d.T.array)]),
            withScriptsMixin(scripts): { scripts+: if std.isArray(v=scripts) then scripts else [scripts] },
          ...
          crossRegionCopyRule: {
            ...
            '#withDeprecateRule':: d.fn(help='"See the deprecate_rule block. Max of 1 per schedule."', args=[d.arg(name='deprecateRule', type=d.T.array)]),
            withDeprecateRule(deprecateRule): { deprecateRule: if std.isArray(v=deprecateRule) then deprecateRule else [deprecateRule] },
            '#withDeprecateRuleMixin':: d.fn(help='"See the deprecate_rule block. Max of 1 per schedule."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='deprecateRule', type=d.T.array)]),
            withDeprecateRuleMixin(deprecateRule): { deprecateRule+: if std.isArray(v=deprecateRule) then deprecateRule else [deprecateRule] },
            '#withEncrypted':: d.fn(help='"To encrypt a copy of an unencrypted snapshot when encryption by default is not enabled, enable encryption using this parameter. Copies of encrypted snapshots are encrypted, even if this parameter is false or when encryption by default is not enabled."', args=[d.arg(name='encrypted', type=d.T.boolean)]),
            withEncrypted(encrypted): { encrypted: encrypted },
            '#withRetainRule':: d.fn(help='"Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action."', args=[d.arg(name='retainRule', type=d.T.array)]),
            withRetainRule(retainRule): { retainRule: if std.isArray(v=retainRule) then retainRule else [retainRule] },
          ...
          fastRestoreRule: {
            ...
            withAvailabilityZones(availabilityZones): { availabilityZones: if std.isArray(v=availabilityZones) then availabilityZones else [availabilityZones] },
            ...
            withAvailabilityZonesMixin(availabilityZones): { availabilityZones+: if std.isArray(v=availabilityZones) then availabilityZones else [availabilityZones] },
            '#withCount':: d.fn(help='"Specifies the number of oldest AMIs to deprecate. Must be an integer between 1 and 1000. Conflicts with interval and interval_unit."', args=[d.arg(name='count', type=d.T.number)]),
            withCount(count): { count: count },
            '#withInterval':: d.fn(help='"How often this lifecycle policy should be evaluated. 1, 2,3,4,6,8,12 or 24 are valid values. Conflicts with cron_expression. If set, interval_unit and times must also be set."', args=[d.arg(name='interval', type=d.T.number)]),
            withInterval(interval): { interval: interval },
          ...
          shareRule: {
            ...
            withTargetAccounts(targetAccounts): { targetAccounts: if std.isArray(v=targetAccounts) then targetAccounts else [targetAccounts] },
            ...
            withTargetAccountsMixin(targetAccounts): { targetAccounts+: if std.isArray(v=targetAccounts) then targetAccounts else [targetAccounts] },
            ...
            withUnshareInterval(unshareInterval): { unshareInterval: unshareInterval },
            ...
            withUnshareIntervalUnit(unshareIntervalUnit): { unshareIntervalUnit: unshareIntervalUnit },
          },
          '#withArchiveRule':: d.fn(help='"Specifies a snapshot archiving rule for a schedule. See archive_rule block."', args=[d.arg(name='archiveRule', type=d.T.array)]),
          withArchiveRule(archiveRule): { archiveRule: if std.isArray(v=archiveRule) then archiveRule else [archiveRule] },
          '#withArchiveRuleMixin':: d.fn(help='"Specifies a snapshot archiving rule for a schedule. See archive_rule block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='archiveRule', type=d.T.array)]),
          withArchiveRuleMixin(archiveRule): { archiveRule+: if std.isArray(v=archiveRule) then archiveRule else [archiveRule] },
          '#withCopyTags':: d.fn(help='"Indicates whether the policy should copy tags from the source resource to the snapshot or AMI. Default value is false."', args=[d.arg(name='copyTags', type=d.T.boolean)]),
          withCopyTags(copyTags): { copyTags: copyTags },
          '#withCreateRule':: d.fn(help='"See the create_rule block. Max of 1 per schedule."', args=[d.arg(name='createRule', type=d.T.array)]),
          withCreateRule(createRule): { createRule: if std.isArray(v=createRule) then createRule else [createRule] },
          '#withCreateRuleMixin':: d.fn(help='"See the create_rule block. Max of 1 per schedule."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='createRule', type=d.T.array)]),
          withCreateRuleMixin(createRule): { createRule+: if std.isArray(v=createRule) then createRule else [createRule] },
          ...
          '#withDeprecateRuleMixin':: d.fn(help='"See the deprecate_rule block. Max of 1 per schedule."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='deprecateRule', type=d.T.array)]),
          withDeprecateRuleMixin(deprecateRule): { deprecateRule+: if std.isArray(v=deprecateRule) then deprecateRule else [deprecateRule] },
          '#withFastRestoreRule':: d.fn(help='"See the fast_restore_rule block. Max of 1 per schedule."', args=[d.arg(name='fastRestoreRule', type=d.T.array)]),
          withFastRestoreRule(fastRestoreRule): { fastRestoreRule: if std.isArray(v=fastRestoreRule) then fastRestoreRule else [fastRestoreRule] },
          '#withFastRestoreRuleMixin':: d.fn(help='"See the fast_restore_rule block. Max of 1 per schedule."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fastRestoreRule', type=d.T.array)]),
          withFastRestoreRuleMixin(fastRestoreRule): { fastRestoreRule+: if std.isArray(v=fastRestoreRule) then fastRestoreRule else [fastRestoreRule] },
          '#withName':: d.fn(help='"A descriptive name for the action."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
          '#withRetainRule':: d.fn(help='"Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action."', args=[d.arg(name='retainRule', type=d.T.array)]),
          withRetainRule(retainRule): { retainRule: if std.isArray(v=retainRule) then retainRule else [retainRule] },
          '#withRetainRuleMixin':: d.fn(help='"Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='retainRule', type=d.T.array)]),
          withRetainRuleMixin(retainRule): { retainRule+: if std.isArray(v=retainRule) then retainRule else [retainRule] },
          '#withShareRule':: d.fn(help='"See the share_rule block. Max of 1 per schedule."', args=[d.arg(name='shareRule', type=d.T.array)]),
          withShareRule(shareRule): { shareRule: if std.isArray(v=shareRule) then shareRule else [shareRule] },
          '#withShareRuleMixin':: d.fn(help='"See the share_rule block. Max of 1 per schedule."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='shareRule', type=d.T.array)]),
          withShareRuleMixin(shareRule): { shareRule+: if std.isArray(v=shareRule) then shareRule else [shareRule] },
        ...
        '#withAction':: d.fn(help='"The actions to be performed when the event-based policy is triggered. You can specify only one action per policy. This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter. See the action configuration block."', args=[d.arg(name='action', type=d.T.array)]),
        withAction(action): { action: if std.isArray(v=action) then action else [action] },
        '#withActionMixin':: d.fn(help='"The actions to be performed when the event-based policy is triggered. You can specify only one action per policy. This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter. See the action configuration block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='action', type=d.T.array)]),
        ...
        withCreateInterval(createInterval): { createInterval: createInterval },
        '#withEventSource':: d.fn(help='"The event that triggers the event-based policy. This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter. See the event_source configuration block."', args=[d.arg(name='eventSource', type=d.T.array)]),
        withEventSource(eventSource): { eventSource: if std.isArray(v=eventSource) then eventSource else [eventSource] },
        '#withEventSourceMixin':: d.fn(help='"The event that triggers the event-based policy. This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter. See the event_source configuration block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventSource', type=d.T.array)]),
        withEventSourceMixin(eventSource): { eventSource+: if std.isArray(v=eventSource) then eventSource else [eventSource] },
        '#withExclusions':: d.fn(help='"Specifies exclusion parameters for volumes or instances for which you do not want to create snapshots or AMIs.  See the exclusions configuration block."', args=[d.arg(name='exclusions', type=d.T.array)]),
        withExclusions(exclusions): { exclusions: if std.isArray(v=exclusions) then exclusions else [exclusions] },
        '#withExclusionsMixin':: d.fn(help='"Specifies exclusion parameters for volumes or instances for which you do not want to create snapshots or AMIs.  See the exclusions configuration block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exclusions', type=d.T.array)]),
        ...
        withExtendDeletion(extendDeletion): { extendDeletion: extendDeletion },
        '#withParameters':: d.fn(help='"A set of optional parameters for snapshot and AMI lifecycle policies. See the parameters configuration block."', args=[d.arg(name='parameters', type=d.T.array)]),
        withParameters(parameters): { parameters: if std.isArray(v=parameters) then parameters else [parameters] },
        '#withParametersMixin':: d.fn(help='"A set of optional parameters for snapshot and AMI lifecycle policies. See the parameters configuration block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
        withParametersMixin(parameters): { parameters+: if std.isArray(v=parameters) then parameters else [parameters] },
        ...
        withPolicyLanguage(policyLanguage): { policyLanguage: policyLanguage },
        ...
        withResourceLocations(resourceLocations): { resourceLocations: if std.isArray(v=resourceLocations) then resourceLocations else [resourceLocations] },
        ...
        withResourceLocationsMixin(resourceLocations): { resourceLocations+: if std.isArray(v=resourceLocations) then resourceLocations else [resourceLocations] },
        ...
        withResourceTypes(resourceTypes): { resourceTypes: if std.isArray(v=resourceTypes) then resourceTypes else [resourceTypes] },
        ...
        withResourceTypesMixin(resourceTypes): { resourceTypes+: if std.isArray(v=resourceTypes) then resourceTypes else [resourceTypes] },
        ...
        withRetainInterval(retainInterval): { retainInterval: retainInterval },
        ...
        withTargetTags(targetTags): { targetTags: targetTags },
        ...
        withTargetTagsMixin(targetTags): { targetTags+: targetTags },
      },
      ...
      '#withPolicyDetails':: d.fn(help='"See the policy_details configuration block. Max of 1."', args=[d.arg(name='policyDetails', type=d.T.array)]),
      withPolicyDetails(policyDetails): { spec+: { forProvider+: { policyDetails: if std.isArray(v=policyDetails) then policyDetails else [policyDetails] } } },
      '#withPolicyDetailsMixin':: d.fn(help='"See the policy_details configuration block. Max of 1."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='policyDetails', type=d.T.array)]),
      withPolicyDetailsMixin(policyDetails): { spec+: { forProvider+: { policyDetails+: if std.isArray(v=policyDetails) then policyDetails else [policyDetails] } } },
    ...
    initProvider: {
      ...
      '#withPolicyDetails':: d.fn(help='"See the policy_details configuration block. Max of 1."', args=[d.arg(name='policyDetails', type=d.T.array)]),
      withPolicyDetails(policyDetails): { spec+: { initProvider+: { policyDetails: if std.isArray(v=policyDetails) then policyDetails else [policyDetails] } } },
      '#withPolicyDetailsMixin':: d.fn(help='"See the policy_details configuration block. Max of 1."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='policyDetails', type=d.T.array)]),
      withPolicyDetailsMixin(policyDetails): { spec+: { initProvider+: { policyDetails+: if std.isArray(v=policyDetails) then policyDetails else [policyDetails] } } },
      '#withState':: d.fn(help='"Whether the lifecycle policy should be enabled or disabled. ENABLED or DISABLED are valid values. Defaults to ENABLED."', args=[d.arg(name='state', type=d.T.string)]),
