{
  ...
  '#':: d.pkg(name='definition', url='', help='"Definition is the Schema for the Definitions API. Provides a CloudWatch Logs query definition resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Definition', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DefinitionSpec defines the desired state of Definition"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withLogGroupNames':: d.fn(help='"Specific log groups to use with the query."', args=[d.arg(name='logGroupNames', type=d.T.array)]),
      withLogGroupNames(logGroupNames): { spec+: { forProvider+: { logGroupNames: if std.isArray(v=logGroupNames) then logGroupNames else [logGroupNames] } } },
      '#withLogGroupNamesMixin':: d.fn(help='"Specific log groups to use with the query."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='logGroupNames', type=d.T.array)]),
      withLogGroupNamesMixin(logGroupNames): { spec+: { forProvider+: { logGroupNames+: if std.isArray(v=logGroupNames) then logGroupNames else [logGroupNames] } } },
      '#withName':: d.fn(help='"The name of the query."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withQueryString':: d.fn(help='"The query to save. You can read more about CloudWatch Logs Query Syntax in the documentation."', args=[d.arg(name='queryString', type=d.T.string)]),
      withQueryString(queryString): { spec+: { forProvider+: { queryString: queryString } } },
    ...
    initProvider: {
      '#withLogGroupNames':: d.fn(help='"Specific log groups to use with the query."', args=[d.arg(name='logGroupNames', type=d.T.array)]),
      withLogGroupNames(logGroupNames): { spec+: { initProvider+: { logGroupNames: if std.isArray(v=logGroupNames) then logGroupNames else [logGroupNames] } } },
      '#withLogGroupNamesMixin':: d.fn(help='"Specific log groups to use with the query."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='logGroupNames', type=d.T.array)]),
      withLogGroupNamesMixin(logGroupNames): { spec+: { initProvider+: { logGroupNames+: if std.isArray(v=logGroupNames) then logGroupNames else [logGroupNames] } } },
      '#withName':: d.fn(help='"The name of the query."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withQueryString':: d.fn(help='"The query to save. You can read more about CloudWatch Logs Query Syntax in the documentation."', args=[d.arg(name='queryString', type=d.T.string)]),
      withQueryString(queryString): { spec+: { initProvider+: { queryString: queryString } } },
    },
