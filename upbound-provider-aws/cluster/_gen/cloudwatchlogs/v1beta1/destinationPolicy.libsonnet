{
  ...
  '#':: d.pkg(name='destinationPolicy', url='', help='"DestinationPolicy is the Schema for the DestinationPolicys API. Provides a CloudWatch Logs destination policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of DestinationPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DestinationPolicySpec defines the desired state of DestinationPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAccessPolicy':: d.fn(help='"The policy document. This is a JSON formatted string."', args=[d.arg(name='accessPolicy', type=d.T.string)]),
      withAccessPolicy(accessPolicy): { spec+: { forProvider+: { accessPolicy: accessPolicy } } },
      '#withForceUpdate':: d.fn(help='"Specify true if you are updating an existing destination policy to grant permission to an organization ID instead of granting permission to individual AWS accounts."', args=[d.arg(name='forceUpdate', type=d.T.boolean)]),
      withForceUpdate(forceUpdate): { spec+: { forProvider+: { forceUpdate: forceUpdate } } },
    ...
    initProvider: {
      ...
      '#withForceUpdate':: d.fn(help='"Specify true if you are updating an existing destination policy to grant permission to an organization ID instead of granting permission to individual AWS accounts."', args=[d.arg(name='forceUpdate', type=d.T.boolean)]),
      withForceUpdate(forceUpdate): { spec+: { initProvider+: { forceUpdate: forceUpdate } } },
    },
