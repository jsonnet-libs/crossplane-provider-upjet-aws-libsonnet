{
  ...
  '#':: d.pkg(name='tag', url='', help='"Tag is the Schema for the Tags API. Manages an individual EC2 resource tag"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withKey':: d.fn(help='"The tag name."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withResourceId':: d.fn(help='"The ID of the EC2 resource to manage the tag for."', args=[d.arg(name='resourceId', type=d.T.string)]),
