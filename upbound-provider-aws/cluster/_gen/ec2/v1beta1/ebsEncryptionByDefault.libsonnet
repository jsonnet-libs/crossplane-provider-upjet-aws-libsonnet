{
  ...
  '#':: d.pkg(name='ebsEncryptionByDefault', url='', help='"EBSEncryptionByDefault is the Schema for the EBSEncryptionByDefaults API. Manages whether default EBS encryption is enabled for your AWS account in the current AWS region."'),
  ...
  '#new':: d.fn(help='new returns an instance of EBSEncryptionByDefault', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EBSEncryptionByDefaultSpec defines the desired state of EBSEncryptionByDefault"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withEnabled':: d.fn(help='"Whether or not default EBS encryption is enabled. Valid values are true or false. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
