{
  ...
  '#':: d.pkg(name='trafficMirrorFilter', url='', help='"TrafficMirrorFilter is the Schema for the TrafficMirrorFilters API. Provides an Traffic mirror filter"'),
  ...
  '#new':: d.fn(help='new returns an instance of TrafficMirrorFilter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TrafficMirrorFilterSpec defines the desired state of TrafficMirrorFilter"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"A description of the filter."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withNetworkServices':: d.fn(help='"List of amazon network services that should be mirrored. Valid values: amazon-dns."', args=[d.arg(name='networkServices', type=d.T.array)]),
      withNetworkServices(networkServices): { spec+: { forProvider+: { networkServices: if std.isArray(v=networkServices) then networkServices else [networkServices] } } },
      '#withNetworkServicesMixin':: d.fn(help='"List of amazon network services that should be mirrored. Valid values: amazon-dns."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networkServices', type=d.T.array)]),
      withNetworkServicesMixin(networkServices): { spec+: { forProvider+: { networkServices+: if std.isArray(v=networkServices) then networkServices else [networkServices] } } },
    ...
    initProvider: {
      ...
      '#withNetworkServices':: d.fn(help='"List of amazon network services that should be mirrored. Valid values: amazon-dns."', args=[d.arg(name='networkServices', type=d.T.array)]),
      withNetworkServices(networkServices): { spec+: { initProvider+: { networkServices: if std.isArray(v=networkServices) then networkServices else [networkServices] } } },
      '#withNetworkServicesMixin':: d.fn(help='"List of amazon network services that should be mirrored. Valid values: amazon-dns."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networkServices', type=d.T.array)]),
      withNetworkServicesMixin(networkServices): { spec+: { initProvider+: { networkServices+: if std.isArray(v=networkServices) then networkServices else [networkServices] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
