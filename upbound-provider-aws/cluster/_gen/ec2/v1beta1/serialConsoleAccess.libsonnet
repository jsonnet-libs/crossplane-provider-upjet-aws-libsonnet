{
  ...
  '#':: d.pkg(name='serialConsoleAccess', url='', help='"SerialConsoleAccess is the Schema for the SerialConsoleAccesss API. Manages whether serial console access is enabled for your AWS account in the current AWS region."'),
  ...
  '#new':: d.fn(help='new returns an instance of SerialConsoleAccess', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SerialConsoleAccessSpec defines the desired state of SerialConsoleAccess"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withEnabled':: d.fn(help='"Whether or not serial console access is enabled. Valid values are true or false. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
