{
  ...
  spec: {
    ...
    forProvider: {
      ...
      executionControls: {
        ...
        ssmControls: {
          ...
          withConcurrentExecutionRatePercentage(concurrentExecutionRatePercentage): { concurrentExecutionRatePercentage: concurrentExecutionRatePercentage },
          ...
          withErrorPercentage(errorPercentage): { errorPercentage: errorPercentage },
        },
        '#withSsmControls':: d.fn(help='"Configuration block for SSM controls. See below."', args=[d.arg(name='ssmControls', type=d.T.array)]),
        withSsmControls(ssmControls): { ssmControls: if std.isArray(v=ssmControls) then ssmControls else [ssmControls] },
        '#withSsmControlsMixin':: d.fn(help='"Configuration block for SSM controls. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ssmControls', type=d.T.array)]),
        withSsmControlsMixin(ssmControls): { ssmControls+: if std.isArray(v=ssmControls) then ssmControls else [ssmControls] },
      },
      ...
      '#withExecutionControls':: d.fn(help='"Configuration block for execution controls. See below."', args=[d.arg(name='executionControls', type=d.T.array)]),
      withExecutionControls(executionControls): { spec+: { forProvider+: { executionControls: if std.isArray(v=executionControls) then executionControls else [executionControls] } } },
      '#withExecutionControlsMixin':: d.fn(help='"Configuration block for execution controls. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='executionControls', type=d.T.array)]),
      withExecutionControlsMixin(executionControls): { spec+: { forProvider+: { executionControls+: if std.isArray(v=executionControls) then executionControls else [executionControls] } } },
    ...
    initProvider: {
      ...
      '#withExecutionControls':: d.fn(help='"Configuration block for execution controls. See below."', args=[d.arg(name='executionControls', type=d.T.array)]),
      withExecutionControls(executionControls): { spec+: { initProvider+: { executionControls: if std.isArray(v=executionControls) then executionControls else [executionControls] } } },
      '#withExecutionControlsMixin':: d.fn(help='"Configuration block for execution controls. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='executionControls', type=d.T.array)]),
      withExecutionControlsMixin(executionControls): { spec+: { initProvider+: { executionControls+: if std.isArray(v=executionControls) then executionControls else [executionControls] } } },
      '#withMaximumAutomaticAttempts':: d.fn(help='"Maximum number of failed attempts for auto-remediation. If you do not select a number, the default is 5."', args=[d.arg(name='maximumAutomaticAttempts', type=d.T.number)]),
