{
  ...
  '#':: d.pkg(name='parameterGroup', url='', help='"ParameterGroup is the Schema for the ParameterGroups API. Provides an RDS DB parameter group resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ParameterGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ParameterGroupSpec defines the desired state of ParameterGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#parameter':: d.obj(help='"The DB parameters to apply. See parameter Block below for more details. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via aws rds describe-db-parameters after initial creation of the group."'),
      parameter: {
        '#withApplyMethod':: d.fn(help="\"\\\"immediate\\\" (default), or \\\"pending-reboot\\\". Some\\nengines can't apply some parameters without a reboot, and you will need to\\nspecify \\\"pending-reboot\\\" here.\"", args=[d.arg(name='applyMethod', type=d.T.string)]),
        withApplyMethod(applyMethod): { applyMethod: applyMethod },
        '#withName':: d.fn(help='"The name of the DB parameter."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"The value of the DB parameter."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withDescription':: d.fn(help='"The description of the DB parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFamily':: d.fn(help='"The family of the DB parameter group."', args=[d.arg(name='family', type=d.T.string)]),
      withFamily(family): { spec+: { forProvider+: { family: family } } },
      '#withParameter':: d.fn(help='"The DB parameters to apply. See parameter Block below for more details. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via aws rds describe-db-parameters after initial creation of the group."', args=[d.arg(name='parameter', type=d.T.array)]),
      withParameter(parameter): { spec+: { forProvider+: { parameter: if std.isArray(v=parameter) then parameter else [parameter] } } },
      '#withParameterMixin':: d.fn(help='"The DB parameters to apply. See parameter Block below for more details. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via aws rds describe-db-parameters after initial creation of the group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameter', type=d.T.array)]),
