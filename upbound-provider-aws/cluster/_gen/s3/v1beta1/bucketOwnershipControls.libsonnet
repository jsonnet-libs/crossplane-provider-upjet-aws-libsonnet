{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRule':: d.fn(help='"Configuration block(s) with Ownership Controls rules. Detailed below."', args=[d.arg(name='rule', type=d.T.array)]),
      withRule(rule): { spec+: { forProvider+: { rule: if std.isArray(v=rule) then rule else [rule] } } },
      '#withRuleMixin':: d.fn(help='"Configuration block(s) with Ownership Controls rules. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rule', type=d.T.array)]),
