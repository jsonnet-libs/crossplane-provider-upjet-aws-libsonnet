{
  ...
  '#':: d.pkg(name='bucketVersioning', url='', help='"BucketVersioning is the Schema for the BucketVersionings API. Provides an S3 bucket versioning resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketVersioning', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BucketVersioningSpec defines the desired state of BucketVersioning"'),
  spec: {
    ...
    forProvider: {
      ...
      '#versioningConfiguration':: d.obj(help='"Configuration block for the versioning parameters. See below."'),
      ...
      '#withMfa':: d.fn(help="\"Concatenation of the authentication device's serial number, a space, and the value that is displayed on your authentication device.\"", args=[d.arg(name='mfa', type=d.T.string)]),
      withMfa(mfa): { spec+: { forProvider+: { mfa: mfa } } },
      ...
      '#withVersioningConfiguration':: d.fn(help='"Configuration block for the versioning parameters. See below."', args=[d.arg(name='versioningConfiguration', type=d.T.array)]),
      withVersioningConfiguration(versioningConfiguration): { spec+: { forProvider+: { versioningConfiguration: if std.isArray(v=versioningConfiguration) then versioningConfiguration else [versioningConfiguration] } } },
      '#withVersioningConfigurationMixin':: d.fn(help='"Configuration block for the versioning parameters. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='versioningConfiguration', type=d.T.array)]),
      withVersioningConfigurationMixin(versioningConfiguration): { spec+: { forProvider+: { versioningConfiguration+: if std.isArray(v=versioningConfiguration) then versioningConfiguration else [versioningConfiguration] } } },
    },
    ...
    initProvider: {
      ...
      '#withMfa':: d.fn(help="\"Concatenation of the authentication device's serial number, a space, and the value that is displayed on your authentication device.\"", args=[d.arg(name='mfa', type=d.T.string)]),
      withMfa(mfa): { spec+: { initProvider+: { mfa: mfa } } },
      '#withVersioningConfiguration':: d.fn(help='"Configuration block for the versioning parameters. See below."', args=[d.arg(name='versioningConfiguration', type=d.T.array)]),
      withVersioningConfiguration(versioningConfiguration): { spec+: { initProvider+: { versioningConfiguration: if std.isArray(v=versioningConfiguration) then versioningConfiguration else [versioningConfiguration] } } },
      '#withVersioningConfigurationMixin':: d.fn(help='"Configuration block for the versioning parameters. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='versioningConfiguration', type=d.T.array)]),
      withVersioningConfigurationMixin(versioningConfiguration): { spec+: { initProvider+: { versioningConfiguration+: if std.isArray(v=versioningConfiguration) then versioningConfiguration else [versioningConfiguration] } } },
    },
