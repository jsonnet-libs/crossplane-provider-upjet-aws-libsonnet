{
  ...
  '#':: d.pkg(name='workflow', url='', help='"Workflow is the Schema for the Workflows API. Provides a Glue Workflow resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDefaultRunProperties':: d.fn(help='"A map of default run properties for this workflow. These properties are passed to all jobs associated to the workflow."', args=[d.arg(name='defaultRunProperties', type=d.T.object)]),
      withDefaultRunProperties(defaultRunProperties): { spec+: { forProvider+: { defaultRunProperties: defaultRunProperties } } },
      '#withDefaultRunPropertiesMixin':: d.fn(help='"A map of default run properties for this workflow. These properties are passed to all jobs associated to the workflow."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultRunProperties', type=d.T.object)]),
      withDefaultRunPropertiesMixin(defaultRunProperties): { spec+: { forProvider+: { defaultRunProperties+: defaultRunProperties } } },
      '#withDescription':: d.fn(help='"Description of the workflow."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withMaxConcurrentRuns':: d.fn(help='"Prevents exceeding the maximum number of concurrent runs of any of the component jobs. If you leave this parameter blank, there is no limit to the number of concurrent workflow runs."', args=[d.arg(name='maxConcurrentRuns', type=d.T.number)]),
      withMaxConcurrentRuns(maxConcurrentRuns): { spec+: { forProvider+: { maxConcurrentRuns: maxConcurrentRuns } } },
    ...
    initProvider: {
      '#withDefaultRunProperties':: d.fn(help='"A map of default run properties for this workflow. These properties are passed to all jobs associated to the workflow."', args=[d.arg(name='defaultRunProperties', type=d.T.object)]),
      withDefaultRunProperties(defaultRunProperties): { spec+: { initProvider+: { defaultRunProperties: defaultRunProperties } } },
      '#withDefaultRunPropertiesMixin':: d.fn(help='"A map of default run properties for this workflow. These properties are passed to all jobs associated to the workflow."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultRunProperties', type=d.T.object)]),
      withDefaultRunPropertiesMixin(defaultRunProperties): { spec+: { initProvider+: { defaultRunProperties+: defaultRunProperties } } },
      '#withDescription':: d.fn(help='"Description of the workflow."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withMaxConcurrentRuns':: d.fn(help='"Prevents exceeding the maximum number of concurrent runs of any of the component jobs. If you leave this parameter blank, there is no limit to the number of concurrent workflow runs."', args=[d.arg(name='maxConcurrentRuns', type=d.T.number)]),
      withMaxConcurrentRuns(maxConcurrentRuns): { spec+: { initProvider+: { maxConcurrentRuns: maxConcurrentRuns } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
