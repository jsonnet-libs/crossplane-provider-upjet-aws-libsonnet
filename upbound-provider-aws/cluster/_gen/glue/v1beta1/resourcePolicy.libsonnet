{
  ...
  '#':: d.pkg(name='resourcePolicy', url='', help='"ResourcePolicy is the Schema for the ResourcePolicys API. Provides a resource to configure the aws glue resource policy."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withEnableHybrid':: d.fn(help='"Indicates that you are using both methods to grant cross-account. Valid values are TRUE and FALSE."', args=[d.arg(name='enableHybrid', type=d.T.string)]),
      withEnableHybrid(enableHybrid): { spec+: { forProvider+: { enableHybrid: enableHybrid } } },
      '#withPolicy':: d.fn(help='"The policy to be applied to the aws glue data catalog."', args=[d.arg(name='policy', type=d.T.string)]),
    ...
    initProvider: {
      '#withEnableHybrid':: d.fn(help='"Indicates that you are using both methods to grant cross-account. Valid values are TRUE and FALSE."', args=[d.arg(name='enableHybrid', type=d.T.string)]),
      withEnableHybrid(enableHybrid): { spec+: { initProvider+: { enableHybrid: enableHybrid } } },
      '#withPolicy':: d.fn(help='"The policy to be applied to the aws glue data catalog."', args=[d.arg(name='policy', type=d.T.string)]),
