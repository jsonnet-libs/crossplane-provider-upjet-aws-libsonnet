{
  ...
  '#':: d.pkg(name='hsmConfiguration', url='', help='"HSMConfiguration is the Schema for the HSMConfigurations API. Creates an HSM configuration that contains the information required by an Amazon Redshift cluster to store and use database encryption keys in a Hardware Security Module (HSM)."'),
  ...
  '#new':: d.fn(help='new returns an instance of HSMConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HSMConfigurationSpec defines the desired state of HSMConfiguration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#hsmPartitionPasswordSecretRef':: d.obj(help='"The password required to access the HSM partition."'),
      hsmPartitionPasswordSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { hsmPartitionPasswordSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { hsmPartitionPasswordSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { hsmPartitionPasswordSecretRef+: { namespace: namespace } } } },
      },
      '#withDescription':: d.fn(help='"A text description of the HSM configuration to be created."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withHsmIpAddress':: d.fn(help='"The IP address that the Amazon Redshift cluster must use to access the HSM."', args=[d.arg(name='hsmIpAddress', type=d.T.string)]),
      withHsmIpAddress(hsmIpAddress): { spec+: { forProvider+: { hsmIpAddress: hsmIpAddress } } },
      '#withHsmPartitionName':: d.fn(help='"The name of the partition in the HSM where the Amazon Redshift clusters will store their database encryption keys."', args=[d.arg(name='hsmPartitionName', type=d.T.string)]),
      withHsmPartitionName(hsmPartitionName): { spec+: { forProvider+: { hsmPartitionName: hsmPartitionName } } },
      '#withHsmServerPublicCertificate':: d.fn(help='"The HSMs public certificate file. When using Cloud HSM, the file name is server.pem."', args=[d.arg(name='hsmServerPublicCertificate', type=d.T.string)]),
      withHsmServerPublicCertificate(hsmServerPublicCertificate): { spec+: { forProvider+: { hsmServerPublicCertificate: hsmServerPublicCertificate } } },
    ...
    initProvider: {
      ...
      hsmPartitionPasswordSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { hsmPartitionPasswordSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { hsmPartitionPasswordSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { hsmPartitionPasswordSecretRef+: { namespace: namespace } } } },
      },
      '#withDescription':: d.fn(help='"A text description of the HSM configuration to be created."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withHsmIpAddress':: d.fn(help='"The IP address that the Amazon Redshift cluster must use to access the HSM."', args=[d.arg(name='hsmIpAddress', type=d.T.string)]),
      withHsmIpAddress(hsmIpAddress): { spec+: { initProvider+: { hsmIpAddress: hsmIpAddress } } },
      '#withHsmPartitionName':: d.fn(help='"The name of the partition in the HSM where the Amazon Redshift clusters will store their database encryption keys."', args=[d.arg(name='hsmPartitionName', type=d.T.string)]),
      withHsmPartitionName(hsmPartitionName): { spec+: { initProvider+: { hsmPartitionName: hsmPartitionName } } },
      '#withHsmServerPublicCertificate':: d.fn(help='"The HSMs public certificate file. When using Cloud HSM, the file name is server.pem."', args=[d.arg(name='hsmServerPublicCertificate', type=d.T.string)]),
      withHsmServerPublicCertificate(hsmServerPublicCertificate): { spec+: { initProvider+: { hsmServerPublicCertificate: hsmServerPublicCertificate } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
