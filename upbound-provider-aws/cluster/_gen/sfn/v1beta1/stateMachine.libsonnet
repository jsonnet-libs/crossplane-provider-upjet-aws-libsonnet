  ...
  spec: {
    ...
    forProvider: {
      ...
      encryptionConfiguration: {
        ...
        withKmsDataKeyReusePeriodSeconds(kmsDataKeyReusePeriodSeconds): { kmsDataKeyReusePeriodSeconds: kmsDataKeyReusePeriodSeconds },
      ...
      '#withEncryptionConfiguration':: d.fn(help='"Defines what encryption configuration is used to encrypt data in the State Machine. For more information see [TBD] in the AWS Step Functions User Guide."', args=[d.arg(name='encryptionConfiguration', type=d.T.array)]),
      ...
      '#withEncryptionConfigurationMixin':: d.fn(help='"Defines what encryption configuration is used to encrypt data in the State Machine. For more information see [TBD] in the AWS Step Functions User Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionConfiguration', type=d.T.array)]),
      ...
      '#withLoggingConfiguration':: d.fn(help='"Defines what execution history events are logged and where they are logged. The logging_configuration parameter is valid when type is set to STANDARD or EXPRESS. Defaults to OFF. For more information see Logging Express Workflows, Log Levels and Logging Configuration in the AWS Step Functions User Guide."', args=[d.arg(name='loggingConfiguration', type=d.T.array)]),
      ...
      '#withLoggingConfigurationMixin':: d.fn(help='"Defines what execution history events are logged and where they are logged. The logging_configuration parameter is valid when type is set to STANDARD or EXPRESS. Defaults to OFF. For more information see Logging Express Workflows, Log Levels and Logging Configuration in the AWS Step Functions User Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='loggingConfiguration', type=d.T.array)]),
