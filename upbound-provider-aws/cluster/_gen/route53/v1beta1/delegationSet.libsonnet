{
  ...
  '#':: d.pkg(name='delegationSet', url='', help='"DelegationSet is the Schema for the DelegationSets API. Provides a Route53 Delegation Set resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of DelegationSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DelegationSetSpec defines the desired state of DelegationSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withReferenceName':: d.fn(help='"This is a reference name used in Caller Reference\\n(helpful for identifying single delegation set amongst others)"', args=[d.arg(name='referenceName', type=d.T.string)]),
