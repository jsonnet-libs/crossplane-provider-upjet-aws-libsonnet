{
  ...
  '#':: d.pkg(name='xssMatchSet', url='', help='"XSSMatchSet is the Schema for the XSSMatchSets API. Provides an AWS WAF Regional XSS Match Set resource for use with ALB."'),
  ...
  '#new':: d.fn(help='new returns an instance of XSSMatchSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"XSSMatchSetSpec defines the desired state of XSSMatchSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"The name of the set"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withXssMatchTuple':: d.fn(help='"The parts of web requests that you want to inspect for cross-site scripting attacks."', args=[d.arg(name='xssMatchTuple', type=d.T.array)]),
      withXssMatchTuple(xssMatchTuple): { spec+: { forProvider+: { xssMatchTuple: if std.isArray(v=xssMatchTuple) then xssMatchTuple else [xssMatchTuple] } } },
      '#withXssMatchTupleMixin':: d.fn(help='"The parts of web requests that you want to inspect for cross-site scripting attacks."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='xssMatchTuple', type=d.T.array)]),
      withXssMatchTupleMixin(xssMatchTuple): { spec+: { forProvider+: { xssMatchTuple+: if std.isArray(v=xssMatchTuple) then xssMatchTuple else [xssMatchTuple] } } },
      '#xssMatchTuple':: d.obj(help='"The parts of web requests that you want to inspect for cross-site scripting attacks."'),
      xssMatchTuple: {
        '#fieldToMatch':: d.obj(help='"Specifies where in a web request to look for cross-site scripting attacks."'),
        fieldToMatch: {
          ...
          '#withType':: d.fn(help='"The part of the web request that you want AWS WAF to search for a specified stringE.g., HEADER or METHOD"', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        '#withFieldToMatch':: d.fn(help='"Specifies where in a web request to look for cross-site scripting attacks."', args=[d.arg(name='fieldToMatch', type=d.T.array)]),
        withFieldToMatch(fieldToMatch): { fieldToMatch: if std.isArray(v=fieldToMatch) then fieldToMatch else [fieldToMatch] },
        '#withFieldToMatchMixin':: d.fn(help='"Specifies where in a web request to look for cross-site scripting attacks."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fieldToMatch', type=d.T.array)]),
        withFieldToMatchMixin(fieldToMatch): { fieldToMatch+: if std.isArray(v=fieldToMatch) then fieldToMatch else [fieldToMatch] },
        '#withTextTransformation':: d.fn(help='"Which text transformation, if any, to perform on the web request before inspecting the request for cross-site scripting attacks."', args=[d.arg(name='textTransformation', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withXssMatchTuple':: d.fn(help='"The parts of web requests that you want to inspect for cross-site scripting attacks."', args=[d.arg(name='xssMatchTuple', type=d.T.array)]),
      withXssMatchTuple(xssMatchTuple): { spec+: { initProvider+: { xssMatchTuple: if std.isArray(v=xssMatchTuple) then xssMatchTuple else [xssMatchTuple] } } },
      '#withXssMatchTupleMixin':: d.fn(help='"The parts of web requests that you want to inspect for cross-site scripting attacks."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='xssMatchTuple', type=d.T.array)]),
      withXssMatchTupleMixin(xssMatchTuple): { spec+: { initProvider+: { xssMatchTuple+: if std.isArray(v=xssMatchTuple) then xssMatchTuple else [xssMatchTuple] } } },
      '#xssMatchTuple':: d.obj(help='"The parts of web requests that you want to inspect for cross-site scripting attacks."'),
      xssMatchTuple: {
        '#fieldToMatch':: d.obj(help='"Specifies where in a web request to look for cross-site scripting attacks."'),
        fieldToMatch: {
