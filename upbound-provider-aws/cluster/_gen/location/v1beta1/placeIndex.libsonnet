{
  ...
  '#':: d.pkg(name='placeIndex', url='', help='"PlaceIndex is the Schema for the PlaceIndexs API. Provides a Location Service Place Index."'),
  ...
  '#new':: d.fn(help='new returns an instance of PlaceIndex', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PlaceIndexSpec defines the desired state of PlaceIndex"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#dataSourceConfiguration':: d.obj(help='"Configuration block with the data storage option chosen for requesting Places. Detailed below."'),
      dataSourceConfiguration: {
        '#withIntendedUse':: d.fn(help='"Specifies how the results of an operation will be stored by the caller. Valid values: SingleUse, Storage. Default: SingleUse."', args=[d.arg(name='intendedUse', type=d.T.string)]),
        withIntendedUse(intendedUse): { intendedUse: intendedUse },
      },
      '#withDataSource':: d.fn(help='"Specifies the geospatial data provider for the new place index."', args=[d.arg(name='dataSource', type=d.T.string)]),
      withDataSource(dataSource): { spec+: { forProvider+: { dataSource: dataSource } } },
      '#withDataSourceConfiguration':: d.fn(help='"Configuration block with the data storage option chosen for requesting Places. Detailed below."', args=[d.arg(name='dataSourceConfiguration', type=d.T.array)]),
      withDataSourceConfiguration(dataSourceConfiguration): { spec+: { forProvider+: { dataSourceConfiguration: if std.isArray(v=dataSourceConfiguration) then dataSourceConfiguration else [dataSourceConfiguration] } } },
      '#withDataSourceConfigurationMixin':: d.fn(help='"Configuration block with the data storage option chosen for requesting Places. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dataSourceConfiguration', type=d.T.array)]),
      withDataSourceConfigurationMixin(dataSourceConfiguration): { spec+: { forProvider+: { dataSourceConfiguration+: if std.isArray(v=dataSourceConfiguration) then dataSourceConfiguration else [dataSourceConfiguration] } } },
      '#withDescription':: d.fn(help='"The optional description for the place index resource."', args=[d.arg(name='description', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDataSourceConfiguration':: d.fn(help='"Configuration block with the data storage option chosen for requesting Places. Detailed below."', args=[d.arg(name='dataSourceConfiguration', type=d.T.array)]),
      withDataSourceConfiguration(dataSourceConfiguration): { spec+: { initProvider+: { dataSourceConfiguration: if std.isArray(v=dataSourceConfiguration) then dataSourceConfiguration else [dataSourceConfiguration] } } },
      '#withDataSourceConfigurationMixin':: d.fn(help='"Configuration block with the data storage option chosen for requesting Places. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dataSourceConfiguration', type=d.T.array)]),
      withDataSourceConfigurationMixin(dataSourceConfiguration): { spec+: { initProvider+: { dataSourceConfiguration+: if std.isArray(v=dataSourceConfiguration) then dataSourceConfiguration else [dataSourceConfiguration] } } },
      '#withDescription':: d.fn(help='"The optional description for the place index resource."', args=[d.arg(name='description', type=d.T.string)]),
