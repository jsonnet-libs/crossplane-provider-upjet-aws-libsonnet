{
  ...
  '#':: d.pkg(name='group', url='', help='"Group is the Schema for the Groups API. Creates and manages an AWS XRay Group."'),
  ...
  spec: {
    ...
    forProvider: {
      '#insightsConfiguration':: d.obj(help='"Configuration options for enabling insights."'),
      insightsConfiguration: {
        '#withInsightsEnabled':: d.fn(help='"Specifies whether insights are enabled."', args=[d.arg(name='insightsEnabled', type=d.T.boolean)]),
        withInsightsEnabled(insightsEnabled): { insightsEnabled: insightsEnabled },
        '#withNotificationsEnabled':: d.fn(help='"Specifies whether insight notifications are enabled."', args=[d.arg(name='notificationsEnabled', type=d.T.boolean)]),
        withNotificationsEnabled(notificationsEnabled): { notificationsEnabled: notificationsEnabled },
      },
      '#withFilterExpression':: d.fn(help='"The filter expression defining criteria by which to group traces. more info can be found in official docs."', args=[d.arg(name='filterExpression', type=d.T.string)]),
      withFilterExpression(filterExpression): { spec+: { forProvider+: { filterExpression: filterExpression } } },
      '#withGroupName':: d.fn(help='"The name of the group."', args=[d.arg(name='groupName', type=d.T.string)]),
      withGroupName(groupName): { spec+: { forProvider+: { groupName: groupName } } },
      '#withInsightsConfiguration':: d.fn(help='"Configuration options for enabling insights."', args=[d.arg(name='insightsConfiguration', type=d.T.array)]),
      withInsightsConfiguration(insightsConfiguration): { spec+: { forProvider+: { insightsConfiguration: if std.isArray(v=insightsConfiguration) then insightsConfiguration else [insightsConfiguration] } } },
      '#withInsightsConfigurationMixin':: d.fn(help='"Configuration options for enabling insights."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='insightsConfiguration', type=d.T.array)]),
      withInsightsConfigurationMixin(insightsConfiguration): { spec+: { forProvider+: { insightsConfiguration+: if std.isArray(v=insightsConfiguration) then insightsConfiguration else [insightsConfiguration] } } },
    ...
    initProvider: {
      ...
      '#withFilterExpression':: d.fn(help='"The filter expression defining criteria by which to group traces. more info can be found in official docs."', args=[d.arg(name='filterExpression', type=d.T.string)]),
      withFilterExpression(filterExpression): { spec+: { initProvider+: { filterExpression: filterExpression } } },
      '#withGroupName':: d.fn(help='"The name of the group."', args=[d.arg(name='groupName', type=d.T.string)]),
      withGroupName(groupName): { spec+: { initProvider+: { groupName: groupName } } },
      '#withInsightsConfiguration':: d.fn(help='"Configuration options for enabling insights."', args=[d.arg(name='insightsConfiguration', type=d.T.array)]),
      withInsightsConfiguration(insightsConfiguration): { spec+: { initProvider+: { insightsConfiguration: if std.isArray(v=insightsConfiguration) then insightsConfiguration else [insightsConfiguration] } } },
      '#withInsightsConfigurationMixin':: d.fn(help='"Configuration options for enabling insights."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='insightsConfiguration', type=d.T.array)]),
      withInsightsConfigurationMixin(insightsConfiguration): { spec+: { initProvider+: { insightsConfiguration+: if std.isArray(v=insightsConfiguration) then insightsConfiguration else [insightsConfiguration] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
