{
  ...
  '#':: d.pkg(name='queue', url='', help='"Queue is the Schema for the Queues API. Provides an AWS Elemental MediaConvert Queue."'),
  ...
  spec: {
    ...
    forProvider: {
      '#reservationPlanSettings':: d.obj(help='"A detail pricing plan of the  reserved queue. See below."'),
      reservationPlanSettings: {
        '#withCommitment':: d.fn(help='"The length of the term of your reserved queue pricing plan commitment. Valid value is ONE_YEAR."', args=[d.arg(name='commitment', type=d.T.string)]),
        withCommitment(commitment): { commitment: commitment },
        '#withRenewalType':: d.fn(help='"Specifies whether the term of your reserved queue pricing plan. Valid values are AUTO_RENEW or EXPIRE."', args=[d.arg(name='renewalType', type=d.T.string)]),
        withRenewalType(renewalType): { renewalType: renewalType },
        '#withReservedSlots':: d.fn(help='"Specifies the number of reserved transcode slots (RTS) for queue."', args=[d.arg(name='reservedSlots', type=d.T.number)]),
        withReservedSlots(reservedSlots): { reservedSlots: reservedSlots },
      },
      '#withConcurrentJobs':: d.fn(help='"The maximum number of jobs your queue can process concurrently. For on-demand queues, the value you enter is constrained by your service quotas for Maximum concurrent jobs, per on-demand queue and Maximum concurrent jobs, per account. For reserved queues, specify the number of jobs you can process concurrently in your reservation plan instead."', args=[d.arg(name='concurrentJobs', type=d.T.number)]),
      withConcurrentJobs(concurrentJobs): { spec+: { forProvider+: { concurrentJobs: concurrentJobs } } },
      '#withDescription':: d.fn(help='"A description of the queue"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withPricingPlan':: d.fn(help='"Specifies whether the pricing plan for the queue is on-demand or reserved. Valid values are ON_DEMAND or RESERVED. Default to ON_DEMAND."', args=[d.arg(name='pricingPlan', type=d.T.string)]),
      withPricingPlan(pricingPlan): { spec+: { forProvider+: { pricingPlan: pricingPlan } } },
      ...
      '#withReservationPlanSettings':: d.fn(help='"A detail pricing plan of the  reserved queue. See below."', args=[d.arg(name='reservationPlanSettings', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withConcurrentJobs':: d.fn(help='"The maximum number of jobs your queue can process concurrently. For on-demand queues, the value you enter is constrained by your service quotas for Maximum concurrent jobs, per on-demand queue and Maximum concurrent jobs, per account. For reserved queues, specify the number of jobs you can process concurrently in your reservation plan instead."', args=[d.arg(name='concurrentJobs', type=d.T.number)]),
      withConcurrentJobs(concurrentJobs): { spec+: { initProvider+: { concurrentJobs: concurrentJobs } } },
      '#withDescription':: d.fn(help='"A description of the queue"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withPricingPlan':: d.fn(help='"Specifies whether the pricing plan for the queue is on-demand or reserved. Valid values are ON_DEMAND or RESERVED. Default to ON_DEMAND."', args=[d.arg(name='pricingPlan', type=d.T.string)]),
      withPricingPlan(pricingPlan): { spec+: { initProvider+: { pricingPlan: pricingPlan } } },
      '#withReservationPlanSettings':: d.fn(help='"A detail pricing plan of the  reserved queue. See below."', args=[d.arg(name='reservationPlanSettings', type=d.T.array)]),
      withReservationPlanSettings(reservationPlanSettings): { spec+: { initProvider+: { reservationPlanSettings: if std.isArray(v=reservationPlanSettings) then reservationPlanSettings else [reservationPlanSettings] } } },
      '#withReservationPlanSettingsMixin':: d.fn(help='"A detail pricing plan of the  reserved queue. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reservationPlanSettings', type=d.T.array)]),
      withReservationPlanSettingsMixin(reservationPlanSettings): { spec+: { initProvider+: { reservationPlanSettings+: if std.isArray(v=reservationPlanSettings) then reservationPlanSettings else [reservationPlanSettings] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
