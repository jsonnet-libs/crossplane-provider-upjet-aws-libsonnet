{
  ...
  '#':: d.pkg(name='originAccessIdentity', url='', help='"OriginAccessIdentity is the Schema for the OriginAccessIdentitys API. Provides a CloudFront origin access identity."'),
  ...
  '#new':: d.fn(help='new returns an instance of OriginAccessIdentity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OriginAccessIdentitySpec defines the desired state of OriginAccessIdentity"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withComment':: d.fn(help='"An optional comment for the origin access identity."', args=[d.arg(name='comment', type=d.T.string)]),
