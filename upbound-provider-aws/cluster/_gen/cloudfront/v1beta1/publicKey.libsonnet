{
  ...
  '#':: d.pkg(name='publicKey', url='', help='"PublicKey is the Schema for the PublicKeys API. Provides a CloudFront Public Key which you add to CloudFront to use with features like field-level encryption."'),
  ...
  '#new':: d.fn(help='new returns an instance of PublicKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PublicKeySpec defines the desired state of PublicKey"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#encodedKeySecretRef':: d.obj(help='"The encoded public key that you want to add to CloudFront to use with features like field-level encryption."'),
      encodedKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { encodedKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { encodedKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { encodedKeySecretRef+: { namespace: namespace } } } },
      },
      '#withComment':: d.fn(help='"An optional comment about the public key."', args=[d.arg(name='comment', type=d.T.string)]),
      withComment(comment): { spec+: { forProvider+: { comment: comment } } },
      '#withName':: d.fn(help='"The name for the public key."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      encodedKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { encodedKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { encodedKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { encodedKeySecretRef+: { namespace: namespace } } } },
      },
      '#withComment':: d.fn(help='"An optional comment about the public key."', args=[d.arg(name='comment', type=d.T.string)]),
