{
  ...
  '#':: d.pkg(name='originAccessControl', url='', help='"OriginAccessControl is the Schema for the OriginAccessControls API."'),
  ...
  '#new':: d.fn(help='new returns an instance of OriginAccessControl', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OriginAccessControlSpec defines the desired state of OriginAccessControl"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"The description of the Origin Access Control."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"A name that identifies the Origin Access Control."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withOriginAccessControlOriginType':: d.fn(help='"The type of origin that this Origin Access Control is for. Valid values are lambda, mediapackagev2, mediastore, and s3."', args=[d.arg(name='originAccessControlOriginType', type=d.T.string)]),
      withOriginAccessControlOriginType(originAccessControlOriginType): { spec+: { forProvider+: { originAccessControlOriginType: originAccessControlOriginType } } },
      '#withSigningBehavior':: d.fn(help='"Specifies which requests CloudFront signs. Specify always for the most common use case. Allowed values: always, never, and no-override."', args=[d.arg(name='signingBehavior', type=d.T.string)]),
      withSigningBehavior(signingBehavior): { spec+: { forProvider+: { signingBehavior: signingBehavior } } },
      '#withSigningProtocol':: d.fn(help='"Determines how CloudFront signs (authenticates) requests. The only valid value is sigv4."', args=[d.arg(name='signingProtocol', type=d.T.string)]),
      withSigningProtocol(signingProtocol): { spec+: { forProvider+: { signingProtocol: signingProtocol } } },
    },
    ...
    initProvider: {
      ...
      '#withOriginAccessControlOriginType':: d.fn(help='"The type of origin that this Origin Access Control is for. Valid values are lambda, mediapackagev2, mediastore, and s3."', args=[d.arg(name='originAccessControlOriginType', type=d.T.string)]),
      withOriginAccessControlOriginType(originAccessControlOriginType): { spec+: { initProvider+: { originAccessControlOriginType: originAccessControlOriginType } } },
      '#withSigningBehavior':: d.fn(help='"Specifies which requests CloudFront signs. Specify always for the most common use case. Allowed values: always, never, and no-override."', args=[d.arg(name='signingBehavior', type=d.T.string)]),
      withSigningBehavior(signingBehavior): { spec+: { initProvider+: { signingBehavior: signingBehavior } } },
      '#withSigningProtocol':: d.fn(help='"Determines how CloudFront signs (authenticates) requests. The only valid value is sigv4."', args=[d.arg(name='signingProtocol', type=d.T.string)]),
      withSigningProtocol(signingProtocol): { spec+: { initProvider+: { signingProtocol: signingProtocol } } },
    },
