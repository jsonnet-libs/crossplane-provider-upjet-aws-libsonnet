{
  ...
  '#':: d.pkg(name='connection', url='', help='"Connection is the Schema for the Connections API. Provides a CodeStar Connection"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withHostArn':: d.fn(help='"The Amazon Resource Name (ARN) of the host associated with the connection. Conflicts with provider_type"', args=[d.arg(name='hostArn', type=d.T.string)]),
      withHostArn(hostArn): { spec+: { forProvider+: { hostArn: hostArn } } },
      '#withName':: d.fn(help='"The name of the connection to be created. The name must be unique in the calling AWS account. Changing name will create a new resource."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withProviderType':: d.fn(help='"The name of the external provider where your third-party code repository is configured. Valid values are Bitbucket, GitHub, GitHubEnterpriseServer, GitLab or GitLabSelfManaged. Changing provider_type will create a new resource. Conflicts with host_arn"', args=[d.arg(name='providerType', type=d.T.string)]),
    ...
    initProvider: {
      '#withHostArn':: d.fn(help='"The Amazon Resource Name (ARN) of the host associated with the connection. Conflicts with provider_type"', args=[d.arg(name='hostArn', type=d.T.string)]),
      withHostArn(hostArn): { spec+: { initProvider+: { hostArn: hostArn } } },
      '#withName':: d.fn(help='"The name of the connection to be created. The name must be unique in the calling AWS account. Changing name will create a new resource."', args=[d.arg(name='name', type=d.T.string)]),
