{
  ...
  '#':: d.pkg(name='instance', url='', help='"Instance is the Schema for the Instances API. Manages a Lightsail Instance."'),
  ...
  spec: {
    ...
    forProvider: {
      '#addOn':: d.obj(help='"Add-on configuration for the instance. See below."'),
      addOn: {
        '#withSnapshotTime':: d.fn(help='"Daily time when an automatic snapshot will be created. Must be in HH:00 format, and in an hourly increment and specified in Coordinated Universal Time (UTC). The snapshot will be automatically created between the time specified and up to 45 minutes after."', args=[d.arg(name='snapshotTime', type=d.T.string)]),
        withSnapshotTime(snapshotTime): { snapshotTime: snapshotTime },
        '#withType':: d.fn(help='"Add-on type. There is currently only one valid type AutoSnapshot."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withAddOn':: d.fn(help='"Add-on configuration for the instance. See below."', args=[d.arg(name='addOn', type=d.T.array)]),
      withAddOn(addOn): { spec+: { forProvider+: { addOn: if std.isArray(v=addOn) then addOn else [addOn] } } },
      '#withAddOnMixin':: d.fn(help='"Add-on configuration for the instance. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addOn', type=d.T.array)]),
      withAddOnMixin(addOn): { spec+: { forProvider+: { addOn+: if std.isArray(v=addOn) then addOn else [addOn] } } },
      '#withAvailabilityZone':: d.fn(help='"Availability Zone in which to create your instance. A list of available zones can be obtained using the AWS CLI command: aws lightsail get-regions --include-availability-zones."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      withAvailabilityZone(availabilityZone): { spec+: { forProvider+: { availabilityZone: availabilityZone } } },
      '#withBlueprintId':: d.fn(help='"ID for a virtual private server image. A list of available blueprint IDs can be obtained using the AWS CLI command: aws lightsail get-blueprints."', args=[d.arg(name='blueprintId', type=d.T.string)]),
      withBlueprintId(blueprintId): { spec+: { forProvider+: { blueprintId: blueprintId } } },
      '#withBundleId':: d.fn(help='"Bundle of specification information. A list of available bundle IDs can be obtained using the AWS CLI command: aws lightsail get-bundles."', args=[d.arg(name='bundleId', type=d.T.string)]),
      withBundleId(bundleId): { spec+: { forProvider+: { bundleId: bundleId } } },
      '#withIpAddressType':: d.fn(help='"IP address type of the Lightsail Instance. Valid values: dualstack, ipv4, ipv6. Default: dualstack."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
      withIpAddressType(ipAddressType): { spec+: { forProvider+: { ipAddressType: ipAddressType } } },
      '#withKeyPairName':: d.fn(help='"Name of your key pair. Created in the Lightsail console (cannot use aws_key_pair at this time)."', args=[d.arg(name='keyPairName', type=d.T.string)]),
      withKeyPairName(keyPairName): { spec+: { forProvider+: { keyPairName: keyPairName } } },
      ...
      '#withUserData':: d.fn(help='"Single lined launch script as a string to configure server with additional user data."', args=[d.arg(name='userData', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAddOn':: d.fn(help='"Add-on configuration for the instance. See below."', args=[d.arg(name='addOn', type=d.T.array)]),
      withAddOn(addOn): { spec+: { initProvider+: { addOn: if std.isArray(v=addOn) then addOn else [addOn] } } },
      '#withAddOnMixin':: d.fn(help='"Add-on configuration for the instance. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addOn', type=d.T.array)]),
      withAddOnMixin(addOn): { spec+: { initProvider+: { addOn+: if std.isArray(v=addOn) then addOn else [addOn] } } },
      '#withAvailabilityZone':: d.fn(help='"Availability Zone in which to create your instance. A list of available zones can be obtained using the AWS CLI command: aws lightsail get-regions --include-availability-zones."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      withAvailabilityZone(availabilityZone): { spec+: { initProvider+: { availabilityZone: availabilityZone } } },
      '#withBlueprintId':: d.fn(help='"ID for a virtual private server image. A list of available blueprint IDs can be obtained using the AWS CLI command: aws lightsail get-blueprints."', args=[d.arg(name='blueprintId', type=d.T.string)]),
      withBlueprintId(blueprintId): { spec+: { initProvider+: { blueprintId: blueprintId } } },
      '#withBundleId':: d.fn(help='"Bundle of specification information. A list of available bundle IDs can be obtained using the AWS CLI command: aws lightsail get-bundles."', args=[d.arg(name='bundleId', type=d.T.string)]),
      withBundleId(bundleId): { spec+: { initProvider+: { bundleId: bundleId } } },
      '#withIpAddressType':: d.fn(help='"IP address type of the Lightsail Instance. Valid values: dualstack, ipv4, ipv6. Default: dualstack."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
      withIpAddressType(ipAddressType): { spec+: { initProvider+: { ipAddressType: ipAddressType } } },
      '#withKeyPairName':: d.fn(help='"Name of your key pair. Created in the Lightsail console (cannot use aws_key_pair at this time)."', args=[d.arg(name='keyPairName', type=d.T.string)]),
      withKeyPairName(keyPairName): { spec+: { initProvider+: { keyPairName: keyPairName } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
