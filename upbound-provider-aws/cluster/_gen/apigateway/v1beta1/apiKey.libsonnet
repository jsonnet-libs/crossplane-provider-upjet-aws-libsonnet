{
  ...
  '#':: d.pkg(name='apiKey', url='', help='"APIKey is the Schema for the APIKeys API. Provides an API Gateway API Key."'),
  ...
  '#new':: d.fn(help='new returns an instance of APIKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APIKeySpec defines the desired state of APIKey"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#valueSecretRef':: d.obj(help='"Value of the API key. If specified, the value must be an alphanumeric string between 20 and 128 characters. If not specified, it will be automatically generated by AWS on creation."'),
      valueSecretRef: {
      ...
      '#withCustomerId':: d.fn(help='"An Amazon Web Services Marketplace customer identifier, when integrating with the Amazon Web Services SaaS Marketplace."', args=[d.arg(name='customerId', type=d.T.string)]),
      withCustomerId(customerId): { spec+: { forProvider+: { customerId: customerId } } },
      '#withDescription':: d.fn(help='"API key description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEnabled':: d.fn(help='"Whether the API key can be used by callers. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withName':: d.fn(help='"Name of the API key."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withCustomerId':: d.fn(help='"An Amazon Web Services Marketplace customer identifier, when integrating with the Amazon Web Services SaaS Marketplace."', args=[d.arg(name='customerId', type=d.T.string)]),
      withCustomerId(customerId): { spec+: { initProvider+: { customerId: customerId } } },
      '#withDescription':: d.fn(help='"API key description."', args=[d.arg(name='description', type=d.T.string)]),
