{
  ...
  '#':: d.pkg(name='securityConfig', url='', help='"SecurityConfig is the Schema for the SecurityConfigs API."'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityConfigSpec defines the desired state of SecurityConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#samlOptions':: d.obj(help='"Configuration block for SAML options."'),
      samlOptions: {
        '#withGroupAttribute':: d.fn(help='"Group attribute for this SAML integration.\\nGroup attribute for this SAML integration."', args=[d.arg(name='groupAttribute', type=d.T.string)]),
        withGroupAttribute(groupAttribute): { spec+: { forProvider+: { samlOptions+: { groupAttribute: groupAttribute } } } },
        '#withMetadata':: d.fn(help='"The XML IdP metadata file generated from your identity provider.\\nThe XML IdP metadata file generated from your identity provider."', args=[d.arg(name='metadata', type=d.T.string)]),
        withMetadata(metadata): { spec+: { forProvider+: { samlOptions+: { metadata: metadata } } } },
        '#withSessionTimeout':: d.fn(help='"Session timeout, in minutes. Minimum is 5 minutes and maximum is 720 minutes (12 hours). Default is 60 minutes.\\nSession timeout, in minutes. Minimum is 5 minutes and maximum is 720 minutes (12 hours). Default is 60 minutes."', args=[d.arg(name='sessionTimeout', type=d.T.number)]),
        withSessionTimeout(sessionTimeout): { spec+: { forProvider+: { samlOptions+: { sessionTimeout: sessionTimeout } } } },
        '#withUserAttribute':: d.fn(help='"User attribute for this SAML integration.\\nUser attribute for this SAML integration."', args=[d.arg(name='userAttribute', type=d.T.string)]),
        withUserAttribute(userAttribute): { spec+: { forProvider+: { samlOptions+: { userAttribute: userAttribute } } } },
      },
      '#withDescription':: d.fn(help='"Description of the security configuration.\\nDescription of the security configuration."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of configuration. Must be saml.\\nType of configuration. Must be `saml`."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      samlOptions: {
        '#withGroupAttribute':: d.fn(help='"Group attribute for this SAML integration.\\nGroup attribute for this SAML integration."', args=[d.arg(name='groupAttribute', type=d.T.string)]),
        withGroupAttribute(groupAttribute): { spec+: { initProvider+: { samlOptions+: { groupAttribute: groupAttribute } } } },
        '#withMetadata':: d.fn(help='"The XML IdP metadata file generated from your identity provider.\\nThe XML IdP metadata file generated from your identity provider."', args=[d.arg(name='metadata', type=d.T.string)]),
        withMetadata(metadata): { spec+: { initProvider+: { samlOptions+: { metadata: metadata } } } },
        '#withSessionTimeout':: d.fn(help='"Session timeout, in minutes. Minimum is 5 minutes and maximum is 720 minutes (12 hours). Default is 60 minutes.\\nSession timeout, in minutes. Minimum is 5 minutes and maximum is 720 minutes (12 hours). Default is 60 minutes."', args=[d.arg(name='sessionTimeout', type=d.T.number)]),
        withSessionTimeout(sessionTimeout): { spec+: { initProvider+: { samlOptions+: { sessionTimeout: sessionTimeout } } } },
        '#withUserAttribute':: d.fn(help='"User attribute for this SAML integration.\\nUser attribute for this SAML integration."', args=[d.arg(name='userAttribute', type=d.T.string)]),
        withUserAttribute(userAttribute): { spec+: { initProvider+: { samlOptions+: { userAttribute: userAttribute } } } },
      },
      '#withDescription':: d.fn(help='"Description of the security configuration.\\nDescription of the security configuration."', args=[d.arg(name='description', type=d.T.string)]),
