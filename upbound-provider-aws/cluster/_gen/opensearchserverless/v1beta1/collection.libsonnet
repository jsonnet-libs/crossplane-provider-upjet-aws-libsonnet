{
  ...
  '#':: d.pkg(name='collection', url='', help='"Collection is the Schema for the Collections API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Collection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CollectionSpec defines the desired state of Collection"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the collection.\\nDescription of the collection."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name of the collection.\\nName of the collection."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withStandbyReplicas':: d.fn(help='"Indicates whether standby replicas should be used for a collection. One of ENABLED or DISABLED. Defaults to ENABLED.\\nIndicates whether standby replicas should be used for a collection. One of `ENABLED` or `DISABLED`. Defaults to `ENABLED`."', args=[d.arg(name='standbyReplicas', type=d.T.string)]),
      withStandbyReplicas(standbyReplicas): { spec+: { forProvider+: { standbyReplicas: standbyReplicas } } },
      ...
      '#withType':: d.fn(help='"Type of collection. One of SEARCH, TIMESERIES, or VECTORSEARCH. Defaults to TIMESERIES.\\nType of collection. One of `SEARCH`, `TIMESERIES`, or `VECTORSEARCH`. Defaults to `TIMESERIES`."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withStandbyReplicas':: d.fn(help='"Indicates whether standby replicas should be used for a collection. One of ENABLED or DISABLED. Defaults to ENABLED.\\nIndicates whether standby replicas should be used for a collection. One of `ENABLED` or `DISABLED`. Defaults to `ENABLED`."', args=[d.arg(name='standbyReplicas', type=d.T.string)]),
      withStandbyReplicas(standbyReplicas): { spec+: { initProvider+: { standbyReplicas: standbyReplicas } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
