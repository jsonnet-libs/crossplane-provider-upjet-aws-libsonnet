{
  ...
  '#':: d.pkg(name='gateway', url='', help='"Gateway is the Schema for the Gateways API. Provides a Direct Connect Gateway."'),
  ...
  '#new':: d.fn(help='new returns an instance of Gateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GatewaySpec defines the desired state of Gateway"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAmazonSideAsn':: d.fn(help='"The ASN to be configured on the Amazon side of the connection. The ASN must be in the private range of 64,512 to 65,534 or 4,200,000,000 to 4,294,967,294."', args=[d.arg(name='amazonSideAsn', type=d.T.string)]),
