{
  ...
  '#':: d.pkg(name='mesh', url='', help='"Mesh is the Schema for the Meshs API. Provides an AWS App Mesh service mesh resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Mesh', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MeshSpec defines the desired state of Mesh"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#spec':: d.obj(help='"Service mesh specification to apply."'),
      spec: {
        '#egressFilter':: d.obj(help='"Egress filter rules for the service mesh."'),
        egressFilter: {
          '#withType':: d.fn(help='"Egress filter type. By default, the type is DROP_ALL. Valid values are ALLOW_ALL and DROP_ALL."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        '#serviceDiscovery':: d.obj(help='"The service discovery information for the service mesh."'),
        serviceDiscovery: {
          '#withIpPreference':: d.fn(help='"The IP version to use to control traffic within the mesh. Valid values are IPv6_PREFERRED, IPv4_PREFERRED, IPv4_ONLY, and IPv6_ONLY."', args=[d.arg(name='ipPreference', type=d.T.string)]),
          withIpPreference(ipPreference): { ipPreference: ipPreference },
        },
        '#withEgressFilter':: d.fn(help='"Egress filter rules for the service mesh."', args=[d.arg(name='egressFilter', type=d.T.array)]),
        withEgressFilter(egressFilter): { egressFilter: if std.isArray(v=egressFilter) then egressFilter else [egressFilter] },
        '#withEgressFilterMixin':: d.fn(help='"Egress filter rules for the service mesh."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='egressFilter', type=d.T.array)]),
        withEgressFilterMixin(egressFilter): { egressFilter+: if std.isArray(v=egressFilter) then egressFilter else [egressFilter] },
        '#withServiceDiscovery':: d.fn(help='"The service discovery information for the service mesh."', args=[d.arg(name='serviceDiscovery', type=d.T.array)]),
