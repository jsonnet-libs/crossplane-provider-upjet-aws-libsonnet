{
  ...
  '#':: d.pkg(name='registryPolicy', url='', help='"RegistryPolicy is the Schema for the RegistryPolicys API. Provides an Elastic Container Registry Policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegistryPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegistryPolicySpec defines the desired state of RegistryPolicy"'),
  spec: {
