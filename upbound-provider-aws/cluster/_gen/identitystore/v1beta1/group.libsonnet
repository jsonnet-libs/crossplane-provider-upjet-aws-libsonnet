{
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"A string containing the description of the group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"A string containing the name of the group. This value is commonly displayed when the group is referenced."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withIdentityStoreId':: d.fn(help='"The globally unique identifier for the identity store."', args=[d.arg(name='identityStoreId', type=d.T.string)]),
