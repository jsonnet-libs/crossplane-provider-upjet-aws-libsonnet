{
  ...
  '#':: d.pkg(name='clusterParameterGroup', url='', help='"ClusterParameterGroup is the Schema for the ClusterParameterGroups API. Manages a Neptune Cluster Parameter Group"'),
  ...
  spec: {
    ...
    forProvider: {
      '#parameter':: d.obj(help='"A list of neptune parameters to apply."'),
      parameter: {
        ...
        '#withName':: d.fn(help='"The name of the neptune cluster parameter group."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"The value of the neptune parameter."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withDescription':: d.fn(help='"The description of the neptune cluster parameter group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFamily':: d.fn(help='"The family of the neptune cluster parameter group."', args=[d.arg(name='family', type=d.T.string)]),
      withFamily(family): { spec+: { forProvider+: { family: family } } },
      '#withParameter':: d.fn(help='"A list of neptune parameters to apply."', args=[d.arg(name='parameter', type=d.T.array)]),
      withParameter(parameter): { spec+: { forProvider+: { parameter: if std.isArray(v=parameter) then parameter else [parameter] } } },
      '#withParameterMixin':: d.fn(help='"A list of neptune parameters to apply."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameter', type=d.T.array)]),
