{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withServerSideEncryption':: d.fn(help='"Encrypt at rest options"', args=[d.arg(name='serverSideEncryption', type=d.T.array)]),
