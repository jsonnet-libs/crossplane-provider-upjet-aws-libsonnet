{
  ...
  '#':: d.pkg(name='user', url='', help='"User is the Schema for the Users API. Provides a MemoryDB User."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      authenticationMode: {
        '#passwordsSecretRef':: d.obj(help='"Set of passwords used for authentication if type is set to password. You can create up to two passwords for each user."'),
        passwordsSecretRef: {
        ...
        '#withPasswordsSecretRef':: d.fn(help='"Set of passwords used for authentication if type is set to password. You can create up to two passwords for each user."', args=[d.arg(name='passwordsSecretRef', type=d.T.array)]),
        ...
        '#withPasswordsSecretRefMixin':: d.fn(help='"Set of passwords used for authentication if type is set to password. You can create up to two passwords for each user."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='passwordsSecretRef', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"Specifies the authentication type. Valid values are: password or iam."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withAccessString':: d.fn(help='"Access permissions string used for this user."', args=[d.arg(name='accessString', type=d.T.string)]),
