{
  ...
  '#':: d.pkg(name='maintenanceWindow', url='', help='"MaintenanceWindow is the Schema for the MaintenanceWindows API. Provides an SSM Maintenance Window resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of MaintenanceWindow', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MaintenanceWindowSpec defines the desired state of MaintenanceWindow"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAllowUnassociatedTargets':: d.fn(help='"Whether targets must be registered with the Maintenance Window before tasks can be defined for those targets."', args=[d.arg(name='allowUnassociatedTargets', type=d.T.boolean)]),
      withAllowUnassociatedTargets(allowUnassociatedTargets): { spec+: { forProvider+: { allowUnassociatedTargets: allowUnassociatedTargets } } },
      '#withCutoff':: d.fn(help='"The number of hours before the end of the Maintenance Window that Systems Manager stops scheduling new tasks for execution."', args=[d.arg(name='cutoff', type=d.T.number)]),
      withCutoff(cutoff): { spec+: { forProvider+: { cutoff: cutoff } } },
      '#withDescription':: d.fn(help='"A description for the maintenance window."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDuration':: d.fn(help='"The duration of the Maintenance Window in hours."', args=[d.arg(name='duration', type=d.T.number)]),
      withDuration(duration): { spec+: { forProvider+: { duration: duration } } },
      '#withEnabled':: d.fn(help='"Whether the maintenance window is enabled. Default: true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withEndDate':: d.fn(help='"Timestamp in ISO-8601 extended format when to no longer run the maintenance window."', args=[d.arg(name='endDate', type=d.T.string)]),
      withEndDate(endDate): { spec+: { forProvider+: { endDate: endDate } } },
      '#withName':: d.fn(help='"The name of the maintenance window."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSchedule':: d.fn(help='"The schedule of the Maintenance Window in the form of a cron or rate expression."', args=[d.arg(name='schedule', type=d.T.string)]),
      withSchedule(schedule): { spec+: { forProvider+: { schedule: schedule } } },
      '#withScheduleOffset':: d.fn(help='"The number of days to wait after the date and time specified by a CRON expression before running the maintenance window. Valid range is 1 to 6."', args=[d.arg(name='scheduleOffset', type=d.T.number)]),
      withScheduleOffset(scheduleOffset): { spec+: { forProvider+: { scheduleOffset: scheduleOffset } } },
      '#withScheduleTimezone':: d.fn(help='"Timezone for schedule in Internet Assigned Numbers Authority (IANA) Time Zone Database format. For example: America/Los_Angeles, etc/UTC, or Asia/Seoul."', args=[d.arg(name='scheduleTimezone', type=d.T.string)]),
      withScheduleTimezone(scheduleTimezone): { spec+: { forProvider+: { scheduleTimezone: scheduleTimezone } } },
      '#withStartDate':: d.fn(help='"Timestamp in ISO-8601 extended format when to begin the maintenance window."', args=[d.arg(name='startDate', type=d.T.string)]),
    ...
    initProvider: {
      '#withAllowUnassociatedTargets':: d.fn(help='"Whether targets must be registered with the Maintenance Window before tasks can be defined for those targets."', args=[d.arg(name='allowUnassociatedTargets', type=d.T.boolean)]),
      withAllowUnassociatedTargets(allowUnassociatedTargets): { spec+: { initProvider+: { allowUnassociatedTargets: allowUnassociatedTargets } } },
      '#withCutoff':: d.fn(help='"The number of hours before the end of the Maintenance Window that Systems Manager stops scheduling new tasks for execution."', args=[d.arg(name='cutoff', type=d.T.number)]),
      withCutoff(cutoff): { spec+: { initProvider+: { cutoff: cutoff } } },
      '#withDescription':: d.fn(help='"A description for the maintenance window."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withScheduleOffset':: d.fn(help='"The number of days to wait after the date and time specified by a CRON expression before running the maintenance window. Valid range is 1 to 6."', args=[d.arg(name='scheduleOffset', type=d.T.number)]),
      withScheduleOffset(scheduleOffset): { spec+: { initProvider+: { scheduleOffset: scheduleOffset } } },
      '#withScheduleTimezone':: d.fn(help='"Timezone for schedule in Internet Assigned Numbers Authority (IANA) Time Zone Database format. For example: America/Los_Angeles, etc/UTC, or Asia/Seoul."', args=[d.arg(name='scheduleTimezone', type=d.T.string)]),
      withScheduleTimezone(scheduleTimezone): { spec+: { initProvider+: { scheduleTimezone: scheduleTimezone } } },
      '#withStartDate':: d.fn(help='"Timestamp in ISO-8601 extended format when to begin the maintenance window."', args=[d.arg(name='startDate', type=d.T.string)]),
