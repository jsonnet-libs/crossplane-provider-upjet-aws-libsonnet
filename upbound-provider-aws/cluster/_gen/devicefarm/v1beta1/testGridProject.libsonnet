{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVpcConfig':: d.fn(help='"The VPC security groups and subnets that are attached to a project. See VPC Config below."', args=[d.arg(name='vpcConfig', type=d.T.array)]),
      withVpcConfig(vpcConfig): { spec+: { forProvider+: { vpcConfig: if std.isArray(v=vpcConfig) then vpcConfig else [vpcConfig] } } },
      '#withVpcConfigMixin':: d.fn(help='"The VPC security groups and subnets that are attached to a project. See VPC Config below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vpcConfig', type=d.T.array)]),
