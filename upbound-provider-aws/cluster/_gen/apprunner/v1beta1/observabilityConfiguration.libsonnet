{
  ...
  '#':: d.pkg(name='observabilityConfiguration', url='', help='"ObservabilityConfiguration is the Schema for the ObservabilityConfigurations API. Manages an App Runner Observability Configuration."'),
  ...
  '#new':: d.fn(help='new returns an instance of ObservabilityConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ObservabilityConfigurationSpec defines the desired state of ObservabilityConfiguration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#traceConfiguration':: d.obj(help="\"Configuration of the tracing feature within this observability configuration. If you don't specify it, App Runner doesn't enable tracing. See Trace Configuration below for more details.\""),
      traceConfiguration: {
        '#withVendor':: d.fn(help='"Implementation provider chosen for tracing App Runner services. Valid values: AWSXRAY."', args=[d.arg(name='vendor', type=d.T.string)]),
        withVendor(vendor): { vendor: vendor },
      },
      '#withObservabilityConfigurationName':: d.fn(help='"Name of the observability configuration."', args=[d.arg(name='observabilityConfigurationName', type=d.T.string)]),
      withObservabilityConfigurationName(observabilityConfigurationName): { spec+: { forProvider+: { observabilityConfigurationName: observabilityConfigurationName } } },
      ...
      '#withTraceConfiguration':: d.fn(help="\"Configuration of the tracing feature within this observability configuration. If you don't specify it, App Runner doesn't enable tracing. See Trace Configuration below for more details.\"", args=[d.arg(name='traceConfiguration', type=d.T.array)]),
      withTraceConfiguration(traceConfiguration): { spec+: { forProvider+: { traceConfiguration: if std.isArray(v=traceConfiguration) then traceConfiguration else [traceConfiguration] } } },
      '#withTraceConfigurationMixin':: d.fn(help="\"Configuration of the tracing feature within this observability configuration. If you don't specify it, App Runner doesn't enable tracing. See Trace Configuration below for more details.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='traceConfiguration', type=d.T.array)]),
      withTraceConfigurationMixin(traceConfiguration): { spec+: { forProvider+: { traceConfiguration+: if std.isArray(v=traceConfiguration) then traceConfiguration else [traceConfiguration] } } },
    },
    ...
    initProvider: {
      ...
      '#withObservabilityConfigurationName':: d.fn(help='"Name of the observability configuration."', args=[d.arg(name='observabilityConfigurationName', type=d.T.string)]),
      withObservabilityConfigurationName(observabilityConfigurationName): { spec+: { initProvider+: { observabilityConfigurationName: observabilityConfigurationName } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Key-value map of resource tags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withTraceConfiguration':: d.fn(help="\"Configuration of the tracing feature within this observability configuration. If you don't specify it, App Runner doesn't enable tracing. See Trace Configuration below for more details.\"", args=[d.arg(name='traceConfiguration', type=d.T.array)]),
      withTraceConfiguration(traceConfiguration): { spec+: { initProvider+: { traceConfiguration: if std.isArray(v=traceConfiguration) then traceConfiguration else [traceConfiguration] } } },
      '#withTraceConfigurationMixin':: d.fn(help="\"Configuration of the tracing feature within this observability configuration. If you don't specify it, App Runner doesn't enable tracing. See Trace Configuration below for more details.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='traceConfiguration', type=d.T.array)]),
      withTraceConfigurationMixin(traceConfiguration): { spec+: { initProvider+: { traceConfiguration+: if std.isArray(v=traceConfiguration) then traceConfiguration else [traceConfiguration] } } },
    },
