{
  ...
  '#':: d.pkg(name='deviceFleet', url='', help='"DeviceFleet is the Schema for the DeviceFleets API. Provides a SageMaker AI Device Fleet resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of DeviceFleet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DeviceFleetSpec defines the desired state of DeviceFleet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#outputConfig':: d.obj(help='"Specifies details about the repository. see Output Config details below."'),
      outputConfig: {
        '#withKmsKeyId':: d.fn(help="\"The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt data on the storage volume after compilation job. If you don't provide a KMS key ID, Amazon SageMaker AI uses the default KMS key for Amazon S3 for your role's account.\"", args=[d.arg(name='kmsKeyId', type=d.T.string)]),
        withKmsKeyId(kmsKeyId): { kmsKeyId: kmsKeyId },
        '#withS3OutputLocation':: d.fn(help='"The Amazon Simple Storage (S3) bucker URI."', args=[d.arg(name='s3OutputLocation', type=d.T.string)]),
        withS3OutputLocation(s3OutputLocation): { s3OutputLocation: s3OutputLocation },
      },
      ...
      '#withDescription':: d.fn(help='"A description of the fleet."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEnableIotRoleAlias':: d.fn(help='"Whether to create an AWS IoT Role Alias during device fleet creation. The name of the role alias generated will match this pattern: \\"SageMakerEdge-{DeviceFleetName}\\"."', args=[d.arg(name='enableIotRoleAlias', type=d.T.boolean)]),
      withEnableIotRoleAlias(enableIotRoleAlias): { spec+: { forProvider+: { enableIotRoleAlias: enableIotRoleAlias } } },
      '#withOutputConfig':: d.fn(help='"Specifies details about the repository. see Output Config details below."', args=[d.arg(name='outputConfig', type=d.T.array)]),
      withOutputConfig(outputConfig): { spec+: { forProvider+: { outputConfig: if std.isArray(v=outputConfig) then outputConfig else [outputConfig] } } },
      '#withOutputConfigMixin':: d.fn(help='"Specifies details about the repository. see Output Config details below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='outputConfig', type=d.T.array)]),
      withOutputConfigMixin(outputConfig): { spec+: { forProvider+: { outputConfig+: if std.isArray(v=outputConfig) then outputConfig else [outputConfig] } } },
      ...
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) that has access to AWS Internet of Things (IoT)."', args=[d.arg(name='roleArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withEnableIotRoleAlias':: d.fn(help='"Whether to create an AWS IoT Role Alias during device fleet creation. The name of the role alias generated will match this pattern: \\"SageMakerEdge-{DeviceFleetName}\\"."', args=[d.arg(name='enableIotRoleAlias', type=d.T.boolean)]),
      withEnableIotRoleAlias(enableIotRoleAlias): { spec+: { initProvider+: { enableIotRoleAlias: enableIotRoleAlias } } },
      '#withOutputConfig':: d.fn(help='"Specifies details about the repository. see Output Config details below."', args=[d.arg(name='outputConfig', type=d.T.array)]),
      withOutputConfig(outputConfig): { spec+: { initProvider+: { outputConfig: if std.isArray(v=outputConfig) then outputConfig else [outputConfig] } } },
      '#withOutputConfigMixin':: d.fn(help='"Specifies details about the repository. see Output Config details below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='outputConfig', type=d.T.array)]),
      withOutputConfigMixin(outputConfig): { spec+: { initProvider+: { outputConfig+: if std.isArray(v=outputConfig) then outputConfig else [outputConfig] } } },
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) that has access to AWS Internet of Things (IoT)."', args=[d.arg(name='roleArn', type=d.T.string)]),
