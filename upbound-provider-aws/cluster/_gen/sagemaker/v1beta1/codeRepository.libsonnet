{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withGitConfig':: d.fn(help='"Specifies details about the repository. see Git Config details below."', args=[d.arg(name='gitConfig', type=d.T.array)]),
      withGitConfig(gitConfig): { spec+: { forProvider+: { gitConfig: if std.isArray(v=gitConfig) then gitConfig else [gitConfig] } } },
      '#withGitConfigMixin':: d.fn(help='"Specifies details about the repository. see Git Config details below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gitConfig', type=d.T.array)]),
      withGitConfigMixin(gitConfig): { spec+: { forProvider+: { gitConfig+: if std.isArray(v=gitConfig) then gitConfig else [gitConfig] } } },
    ...
    initProvider: {
      ...
      '#withGitConfig':: d.fn(help='"Specifies details about the repository. see Git Config details below."', args=[d.arg(name='gitConfig', type=d.T.array)]),
      withGitConfig(gitConfig): { spec+: { initProvider+: { gitConfig: if std.isArray(v=gitConfig) then gitConfig else [gitConfig] } } },
      '#withGitConfigMixin':: d.fn(help='"Specifies details about the repository. see Git Config details below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gitConfig', type=d.T.array)]),
      withGitConfigMixin(gitConfig): { spec+: { initProvider+: { gitConfig+: if std.isArray(v=gitConfig) then gitConfig else [gitConfig] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
