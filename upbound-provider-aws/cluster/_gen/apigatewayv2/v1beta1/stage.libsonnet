{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAccessLogSettings':: d.fn(help='"Settings for logging access in this stage.\\nUse the aws_api_gateway_account resource to configure permissions for CloudWatch Logging."', args=[d.arg(name='accessLogSettings', type=d.T.array)]),
      ...
      '#withDefaultRouteSettings':: d.fn(help='"Default route settings for the stage."', args=[d.arg(name='defaultRouteSettings', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withDefaultRouteSettings':: d.fn(help='"Default route settings for the stage."', args=[d.arg(name='defaultRouteSettings', type=d.T.array)]),
      withDefaultRouteSettings(defaultRouteSettings): { spec+: { initProvider+: { defaultRouteSettings: if std.isArray(v=defaultRouteSettings) then defaultRouteSettings else [defaultRouteSettings] } } },
      '#withDefaultRouteSettingsMixin':: d.fn(help='"Default route settings for the stage."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultRouteSettings', type=d.T.array)]),
      withDefaultRouteSettingsMixin(defaultRouteSettings): { spec+: { initProvider+: { defaultRouteSettings+: if std.isArray(v=defaultRouteSettings) then defaultRouteSettings else [defaultRouteSettings] } } },
      '#withDeploymentId':: d.fn(help='"Deployment identifier of the stage. Use the aws_apigatewayv2_deployment resource to configure a deployment."', args=[d.arg(name='deploymentId', type=d.T.string)]),
