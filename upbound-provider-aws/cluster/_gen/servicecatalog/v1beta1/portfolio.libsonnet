{
  ...
  '#':: d.pkg(name='portfolio', url='', help='"Portfolio is the Schema for the Portfolios API. Provides a resource to create a Service Catalog portfolio"'),
  ...
  '#new':: d.fn(help='new returns an instance of Portfolio', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PortfolioSpec defines the desired state of Portfolio"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the portfolio"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of the portfolio."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withProviderName':: d.fn(help='"Name of the person or organization who owns the portfolio."', args=[d.arg(name='providerName', type=d.T.string)]),
