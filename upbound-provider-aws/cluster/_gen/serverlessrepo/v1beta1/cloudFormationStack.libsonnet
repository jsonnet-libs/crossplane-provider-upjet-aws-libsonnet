{
  ...
  '#':: d.pkg(name='cloudFormationStack', url='', help='"CloudFormationStack is the Schema for the CloudFormationStacks API. Deploys an Application CloudFormation Stack from the Serverless Application Repository."'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudFormationStack', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CloudFormationStackSpec defines the desired state of CloudFormationStack"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withApplicationId':: d.fn(help='"The ARN of the application from the Serverless Application Repository."', args=[d.arg(name='applicationId', type=d.T.string)]),
      withApplicationId(applicationId): { spec+: { forProvider+: { applicationId: applicationId } } },
      '#withCapabilities':: d.fn(help='"A list of capabilities. Valid values are CAPABILITY_IAM, CAPABILITY_NAMED_IAM, CAPABILITY_RESOURCE_POLICY, or CAPABILITY_AUTO_EXPAND"', args=[d.arg(name='capabilities', type=d.T.array)]),
      ...
      '#withCapabilitiesMixin':: d.fn(help='"A list of capabilities. Valid values are CAPABILITY_IAM, CAPABILITY_NAMED_IAM, CAPABILITY_RESOURCE_POLICY, or CAPABILITY_AUTO_EXPAND"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='capabilities', type=d.T.array)]),
      ...
      '#withName':: d.fn(help='"The name of the stack to create. The resource deployed in AWS will be prefixed with serverlessrepo-"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSemanticVersion':: d.fn(help='"The version of the application to deploy. If not supplied, deploys the latest version."', args=[d.arg(name='semanticVersion', type=d.T.string)]),
      withSemanticVersion(semanticVersion): { spec+: { forProvider+: { semanticVersion: semanticVersion } } },
    ...
    initProvider: {
      ...
      '#withSemanticVersion':: d.fn(help='"The version of the application to deploy. If not supplied, deploys the latest version."', args=[d.arg(name='semanticVersion', type=d.T.string)]),
      withSemanticVersion(semanticVersion): { spec+: { initProvider+: { semanticVersion: semanticVersion } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
