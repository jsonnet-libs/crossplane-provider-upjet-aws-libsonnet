{
  ...
  '#':: d.pkg(name='policy', url='', help='"Policy is the Schema for the Policys API. Provides a resource to manage an AWS Organizations policy."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withType':: d.fn(help='"The type of policy to create. Valid values are AISERVICES_OPT_OUT_POLICY, BACKUP_POLICY, RESOURCE_CONTROL_POLICY (RCP), SERVICE_CONTROL_POLICY (SCP), and TAG_POLICY. Defaults to SERVICE_CONTROL_POLICY."', args=[d.arg(name='type', type=d.T.string)]),
