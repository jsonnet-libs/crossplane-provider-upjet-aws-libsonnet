{
  ...
  '#':: d.pkg(name='permissionSet', url='', help='"PermissionSet is the Schema for the PermissionSets API. Manages a Single Sign-On (SSO) Permission Set"'),
  ...
  '#new':: d.fn(help='new returns an instance of PermissionSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PermissionSetSpec defines the desired state of PermissionSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"The description of the Permission Set."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name of the Permission Set."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRelayState':: d.fn(help='"The relay state URL used to redirect users within the application during the federation authentication process."', args=[d.arg(name='relayState', type=d.T.string)]),
      withRelayState(relayState): { spec+: { forProvider+: { relayState: relayState } } },
      '#withSessionDuration':: d.fn(help='"The length of time that the application user sessions are valid in the ISO-8601 standard. Default: PT1H."', args=[d.arg(name='sessionDuration', type=d.T.string)]),
      withSessionDuration(sessionDuration): { spec+: { forProvider+: { sessionDuration: sessionDuration } } },
    ...
    initProvider: {
      ...
      '#withInstanceArn':: d.fn(help='"The Amazon Resource Name (ARN) of the SSO Instance under which the operation will be executed."', args=[d.arg(name='instanceArn', type=d.T.string)]),
      withInstanceArn(instanceArn): { spec+: { initProvider+: { instanceArn: instanceArn } } },
      '#withName':: d.fn(help='"The name of the Permission Set."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withRelayState':: d.fn(help='"The relay state URL used to redirect users within the application during the federation authentication process."', args=[d.arg(name='relayState', type=d.T.string)]),
      withRelayState(relayState): { spec+: { initProvider+: { relayState: relayState } } },
      '#withSessionDuration':: d.fn(help='"The length of time that the application user sessions are valid in the ISO-8601 standard. Default: PT1H."', args=[d.arg(name='sessionDuration', type=d.T.string)]),
      withSessionDuration(sessionDuration): { spec+: { initProvider+: { sessionDuration: sessionDuration } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
