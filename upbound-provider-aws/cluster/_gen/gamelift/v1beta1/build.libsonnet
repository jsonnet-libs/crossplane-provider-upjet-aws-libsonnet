{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStorageLocation':: d.fn(help='"Information indicating where your game build files are stored. See below."', args=[d.arg(name='storageLocation', type=d.T.array)]),
      ...
      '#withStorageLocationMixin':: d.fn(help='"Information indicating where your game build files are stored. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='storageLocation', type=d.T.array)]),
