{
  ...
  '#':: d.pkg(name='alias', url='', help='"Alias is the Schema for the Aliass API. Provides a GameLift Alias resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#routingStrategy':: d.obj(help='"Specifies the fleet and/or routing type to use for the alias."'),
      routingStrategy: {
        '#withFleetId':: d.fn(help='"ID of the GameLift Fleet to point the alias to."', args=[d.arg(name='fleetId', type=d.T.string)]),
        withFleetId(fleetId): { fleetId: fleetId },
        '#withMessage':: d.fn(help='"Message text to be used with the TERMINAL routing strategy."', args=[d.arg(name='message', type=d.T.string)]),
        withMessage(message): { message: message },
        '#withType':: d.fn(help='"Type of routing strategyE.g., SIMPLE or TERMINAL"', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"Name of the alias."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRoutingStrategy':: d.fn(help='"Specifies the fleet and/or routing type to use for the alias."', args=[d.arg(name='routingStrategy', type=d.T.array)]),
      withRoutingStrategy(routingStrategy): { spec+: { forProvider+: { routingStrategy: if std.isArray(v=routingStrategy) then routingStrategy else [routingStrategy] } } },
      '#withRoutingStrategyMixin':: d.fn(help='"Specifies the fleet and/or routing type to use for the alias."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='routingStrategy', type=d.T.array)]),
      withRoutingStrategyMixin(routingStrategy): { spec+: { forProvider+: { routingStrategy+: if std.isArray(v=routingStrategy) then routingStrategy else [routingStrategy] } } },
    ...
    initProvider: {
      ...
      '#withRoutingStrategy':: d.fn(help='"Specifies the fleet and/or routing type to use for the alias."', args=[d.arg(name='routingStrategy', type=d.T.array)]),
      withRoutingStrategy(routingStrategy): { spec+: { initProvider+: { routingStrategy: if std.isArray(v=routingStrategy) then routingStrategy else [routingStrategy] } } },
      '#withRoutingStrategyMixin':: d.fn(help='"Specifies the fleet and/or routing type to use for the alias."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='routingStrategy', type=d.T.array)]),
      withRoutingStrategyMixin(routingStrategy): { spec+: { initProvider+: { routingStrategy+: if std.isArray(v=routingStrategy) then routingStrategy else [routingStrategy] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
