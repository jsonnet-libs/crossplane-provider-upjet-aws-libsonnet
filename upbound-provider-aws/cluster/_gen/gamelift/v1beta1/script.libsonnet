{
  ...
  spec: {
    ...
    forProvider: {
      ...
      storageLocation: {
        ...
        keyRef: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { keyRef+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { keyRef+: { policy+: { resolve: resolve } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { keyRef+: { name: name } },
        },
        ...
        keySelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { keySelector+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { keySelector+: { policy+: { resolve: resolve } } },
          },
          '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
          withMatchControllerRef(matchControllerRef): { keySelector+: { matchControllerRef: matchControllerRef } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { keySelector+: { matchLabels: matchLabels } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { keySelector+: { matchLabels+: matchLabels } },
        },
      ...
      '#withStorageLocation':: d.fn(help='"Information indicating where your game script files are stored. See below."', args=[d.arg(name='storageLocation', type=d.T.array)]),
      withStorageLocation(storageLocation): { spec+: { forProvider+: { storageLocation: if std.isArray(v=storageLocation) then storageLocation else [storageLocation] } } },
      '#withStorageLocationMixin':: d.fn(help='"Information indicating where your game script files are stored. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='storageLocation', type=d.T.array)]),
      withStorageLocationMixin(storageLocation): { spec+: { forProvider+: { storageLocation+: if std.isArray(v=storageLocation) then storageLocation else [storageLocation] } } },
    ...
    initProvider: {
      ...
      '#withStorageLocation':: d.fn(help='"Information indicating where your game script files are stored. See below."', args=[d.arg(name='storageLocation', type=d.T.array)]),
      withStorageLocation(storageLocation): { spec+: { initProvider+: { storageLocation: if std.isArray(v=storageLocation) then storageLocation else [storageLocation] } } },
      '#withStorageLocationMixin':: d.fn(help='"Information indicating where your game script files are stored. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='storageLocation', type=d.T.array)]),
      withStorageLocationMixin(storageLocation): { spec+: { initProvider+: { storageLocation+: if std.isArray(v=storageLocation) then storageLocation else [storageLocation] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
