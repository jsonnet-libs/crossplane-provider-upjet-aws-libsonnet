---
permalink: /upbound-provider-aws/cluster/cloudsearch/v1beta1/domain/
---

# cloudsearch.v1beta1.domain
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withEndpointOptions(endpointOptions)`](#fn-specforproviderwithendpointoptions)
    * [`fn withEndpointOptionsMixin(endpointOptions)`](#fn-specforproviderwithendpointoptionsmixin)
    ...
    * [`fn withScalingParameters(scalingParameters)`](#fn-specforproviderwithscalingparameters)
    * [`fn withScalingParametersMixin(scalingParameters)`](#fn-specforproviderwithscalingparametersmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withEndpointOptions(endpointOptions)`](#fn-specinitproviderwithendpointoptions)
    * [`fn withEndpointOptionsMixin(endpointOptions)`](#fn-specinitproviderwithendpointoptionsmixin)
    ...
    * [`fn withScalingParameters(scalingParameters)`](#fn-specinitproviderwithscalingparameters)
    * [`fn withScalingParametersMixin(scalingParameters)`](#fn-specinitproviderwithscalingparametersmixin)
...
### fn spec.forProvider.withEndpointOptions
...
### fn spec.forProvider.withEndpointOptionsMixin

```ts
withEndpointOptionsMixin(endpointOptions)
```
...
### fn spec.forProvider.withScalingParameters

```ts
withScalingParameters(scalingParameters)
```

"Domain scaling parameters. Documented below."

### fn spec.forProvider.withScalingParametersMixin

```ts
withScalingParametersMixin(scalingParameters)
```
...
### fn spec.initProvider.withEndpointOptions
...
### fn spec.initProvider.withEndpointOptionsMixin
...
### fn spec.initProvider.withScalingParameters
...
### fn spec.initProvider.withScalingParametersMixin
