---
permalink: /upbound-provider-aws/cluster/sesv2/v1beta1/emailIdentity/
---

# sesv2.v1beta1.emailIdentity
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withDkimSigningAttributes(dkimSigningAttributes)`](#fn-specforproviderwithdkimsigningattributes)
    * [`fn withDkimSigningAttributesMixin(dkimSigningAttributes)`](#fn-specforproviderwithdkimsigningattributesmixin)
    ...
    * [`obj spec.forProvider.dkimSigningAttributes`](#obj-specforproviderdkimsigningattributes)
      * [`fn withDomainSigningSelector(domainSigningSelector)`](#fn-specforproviderdkimsigningattributeswithdomainsigningselector)
      * [`fn withNextSigningKeyLength(nextSigningKeyLength)`](#fn-specforproviderdkimsigningattributeswithnextsigningkeylength)
      * [`obj spec.forProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef`](#obj-specforproviderdkimsigningattributesdomainsigningprivatekeysecretref)
        * [`fn withKey(key)`](#fn-specforproviderdkimsigningattributesdomainsigningprivatekeysecretrefwithkey)
        * [`fn withName(name)`](#fn-specforproviderdkimsigningattributesdomainsigningprivatekeysecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specforproviderdkimsigningattributesdomainsigningprivatekeysecretrefwithnamespace)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withConfigurationSetName(configurationSetName)`](#fn-specinitproviderwithconfigurationsetname)
    * [`fn withDkimSigningAttributes(dkimSigningAttributes)`](#fn-specinitproviderwithdkimsigningattributes)
    * [`fn withDkimSigningAttributesMixin(dkimSigningAttributes)`](#fn-specinitproviderwithdkimsigningattributesmixin)
    ...
    * [`obj spec.initProvider.dkimSigningAttributes`](#obj-specinitproviderdkimsigningattributes)
      * [`fn withDomainSigningSelector(domainSigningSelector)`](#fn-specinitproviderdkimsigningattributeswithdomainsigningselector)
      * [`fn withNextSigningKeyLength(nextSigningKeyLength)`](#fn-specinitproviderdkimsigningattributeswithnextsigningkeylength)
      * [`obj spec.initProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef`](#obj-specinitproviderdkimsigningattributesdomainsigningprivatekeysecretref)
        * [`fn withKey(key)`](#fn-specinitproviderdkimsigningattributesdomainsigningprivatekeysecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitproviderdkimsigningattributesdomainsigningprivatekeysecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitproviderdkimsigningattributesdomainsigningprivatekeysecretrefwithnamespace)
...
new returns an instance of EmailIdentity
...
### fn spec.forProvider.withDkimSigningAttributes
...
### fn spec.forProvider.withDkimSigningAttributesMixin
...
## obj spec.forProvider.dkimSigningAttributes

"The configuration of the DKIM authentication settings for an email domain identity."

### fn spec.forProvider.dkimSigningAttributes.withDomainSigningSelector

```ts
withDomainSigningSelector(domainSigningSelector)
```

"[Bring Your Own DKIM] A string that's used to identify a public key in the DNS configuration for a domain."

### fn spec.forProvider.dkimSigningAttributes.withNextSigningKeyLength

```ts
withNextSigningKeyLength(nextSigningKeyLength)
```
...
## obj spec.forProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef

"[Bring Your Own DKIM] A private key that's used to generate a DKIM signature. The private key must use 1024 or 2048-bit RSA encryption, and must be encoded using base64 encoding."

### fn spec.forProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef.withKey
...
### fn spec.forProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef.withName
...
### fn spec.forProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef.withNamespace
...
### fn spec.initProvider.withDkimSigningAttributes
...
### fn spec.initProvider.withDkimSigningAttributesMixin
...
## obj spec.initProvider.dkimSigningAttributes

"The configuration of the DKIM authentication settings for an email domain identity."

### fn spec.initProvider.dkimSigningAttributes.withDomainSigningSelector
...
### fn spec.initProvider.dkimSigningAttributes.withNextSigningKeyLength
...
## obj spec.initProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef

"[Bring Your Own DKIM] A private key that's used to generate a DKIM signature. The private key must use 1024 or 2048-bit RSA encryption, and must be encoded using base64 encoding."

### fn spec.initProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef.withKey
...
### fn spec.initProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef.withName
...
### fn spec.initProvider.dkimSigningAttributes.domainSigningPrivateKeySecretRef.withNamespace
