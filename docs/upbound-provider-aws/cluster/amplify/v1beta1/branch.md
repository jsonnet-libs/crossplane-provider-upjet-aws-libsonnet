---
permalink: /upbound-provider-aws/cluster/amplify/v1beta1/branch/
---

# amplify.v1beta1.branch
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withBackendEnvironmentArn(backendEnvironmentArn)`](#fn-specforproviderwithbackendenvironmentarn)
    * [`fn withDescription(description)`](#fn-specforproviderwithdescription)
    * [`fn withDisplayName(displayName)`](#fn-specforproviderwithdisplayname)
    * [`fn withEnableAutoBuild(enableAutoBuild)`](#fn-specforproviderwithenableautobuild)
    * [`fn withEnableBasicAuth(enableBasicAuth)`](#fn-specforproviderwithenablebasicauth)
    * [`fn withEnableNotification(enableNotification)`](#fn-specforproviderwithenablenotification)
    * [`fn withEnablePerformanceMode(enablePerformanceMode)`](#fn-specforproviderwithenableperformancemode)
    * [`fn withEnablePullRequestPreview(enablePullRequestPreview)`](#fn-specforproviderwithenablepullrequestpreview)
    * [`fn withEnableSkewProtection(enableSkewProtection)`](#fn-specforproviderwithenableskewprotection)
    ...
    * [`fn withFramework(framework)`](#fn-specforproviderwithframework)
    * [`fn withPullRequestEnvironmentName(pullRequestEnvironmentName)`](#fn-specforproviderwithpullrequestenvironmentname)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withBackendEnvironmentArn(backendEnvironmentArn)`](#fn-specinitproviderwithbackendenvironmentarn)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withDisplayName(displayName)`](#fn-specinitproviderwithdisplayname)
    * [`fn withEnableAutoBuild(enableAutoBuild)`](#fn-specinitproviderwithenableautobuild)
    * [`fn withEnableBasicAuth(enableBasicAuth)`](#fn-specinitproviderwithenablebasicauth)
    * [`fn withEnableNotification(enableNotification)`](#fn-specinitproviderwithenablenotification)
    * [`fn withEnablePerformanceMode(enablePerformanceMode)`](#fn-specinitproviderwithenableperformancemode)
    * [`fn withEnablePullRequestPreview(enablePullRequestPreview)`](#fn-specinitproviderwithenablepullrequestpreview)
    * [`fn withEnableSkewProtection(enableSkewProtection)`](#fn-specinitproviderwithenableskewprotection)
    ...
    * [`fn withFramework(framework)`](#fn-specinitproviderwithframework)
    * [`fn withPullRequestEnvironmentName(pullRequestEnvironmentName)`](#fn-specinitproviderwithpullrequestenvironmentname)
    ...
    * [`obj spec.initProvider.basicAuthCredentialsSecretRef`](#obj-specinitproviderbasicauthcredentialssecretref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitproviderbasicauthcredentialssecretrefwithnamespace)
...
new returns an instance of Branch
...
### fn spec.forProvider.withBackendEnvironmentArn

```ts
withBackendEnvironmentArn(backendEnvironmentArn)
```
...
### fn spec.forProvider.withEnableAutoBuild
...
### fn spec.forProvider.withEnableNotification

```ts
withEnableNotification(enableNotification)
```

"Enables notifications for the branch."

### fn spec.forProvider.withEnablePerformanceMode
...
### fn spec.forProvider.withEnablePullRequestPreview
...
### fn spec.forProvider.withEnableSkewProtection

```ts
withEnableSkewProtection(enableSkewProtection)
```
...
### fn spec.forProvider.withFramework
...
### fn spec.forProvider.withPullRequestEnvironmentName
...
### fn spec.initProvider.withBackendEnvironmentArn
...
### fn spec.initProvider.withEnableAutoBuild
...
### fn spec.initProvider.withEnableNotification
...
### fn spec.initProvider.withEnablePerformanceMode
...
### fn spec.initProvider.withEnablePullRequestPreview
...
### fn spec.initProvider.withEnableSkewProtection
...
### fn spec.initProvider.withFramework
...
### fn spec.initProvider.withPullRequestEnvironmentName
...
### fn spec.initProvider.basicAuthCredentialsSecretRef.withNamespace
