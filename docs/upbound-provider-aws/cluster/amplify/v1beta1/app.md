---
permalink: /upbound-provider-aws/cluster/amplify/v1beta1/app/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withCacheConfig(cacheConfig)`](#fn-specforproviderwithcacheconfig)
    * [`fn withCacheConfigMixin(cacheConfig)`](#fn-specforproviderwithcacheconfigmixin)
    ...
    * [`fn withJobConfig(jobConfig)`](#fn-specforproviderwithjobconfig)
    * [`fn withJobConfigMixin(jobConfig)`](#fn-specforproviderwithjobconfigmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAutoBranchCreationConfig(autoBranchCreationConfig)`](#fn-specinitproviderwithautobranchcreationconfig)
    * [`fn withAutoBranchCreationConfigMixin(autoBranchCreationConfig)`](#fn-specinitproviderwithautobranchcreationconfigmixin)
    ...
    * [`fn withCacheConfig(cacheConfig)`](#fn-specinitproviderwithcacheconfig)
    * [`fn withCacheConfigMixin(cacheConfig)`](#fn-specinitproviderwithcacheconfigmixin)
    ...
    * [`fn withJobConfig(jobConfig)`](#fn-specinitproviderwithjobconfig)
    * [`fn withJobConfigMixin(jobConfig)`](#fn-specinitproviderwithjobconfigmixin)
    ...
    * [`obj spec.initProvider.accessTokenSecretRef`](#obj-specinitprovideraccesstokensecretref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitprovideraccesstokensecretrefwithnamespace)
    * [`obj spec.initProvider.autoBranchCreationConfig`](#obj-specinitproviderautobranchcreationconfig)
      ...
      * [`obj spec.initProvider.autoBranchCreationConfig.basicAuthCredentialsSecretRef`](#obj-specinitproviderautobranchcreationconfigbasicauthcredentialssecretref)
        ...
        * [`fn withNamespace(namespace)`](#fn-specinitproviderautobranchcreationconfigbasicauthcredentialssecretrefwithnamespace)
    ...
    * [`obj spec.initProvider.oauthTokenSecretRef`](#obj-specinitprovideroauthtokensecretref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitprovideroauthtokensecretrefwithnamespace)
...
### fn spec.forProvider.withCacheConfig
...
### fn spec.forProvider.withCacheConfigMixin

```ts
withCacheConfigMixin(cacheConfig)
```
...
### fn spec.forProvider.withJobConfig
...
### fn spec.forProvider.withJobConfigMixin

```ts
withJobConfigMixin(jobConfig)
```
...
### fn spec.initProvider.withAutoBranchCreationConfig
...
### fn spec.initProvider.withAutoBranchCreationConfigMixin
...
### fn spec.initProvider.withCacheConfig
...
### fn spec.initProvider.withCacheConfigMixin
...
### fn spec.initProvider.withJobConfig
...
### fn spec.initProvider.withJobConfigMixin
...
### fn spec.initProvider.accessTokenSecretRef.withNamespace
...
### fn spec.initProvider.autoBranchCreationConfig.basicAuthCredentialsSecretRef.withNamespace
...
### fn spec.initProvider.oauthTokenSecretRef.withNamespace
