---
permalink: /upbound-provider-aws/cluster/keyspaces/v1beta1/table/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withClientSideTimestamps(clientSideTimestamps)`](#fn-specforproviderwithclientsidetimestamps)
    * [`fn withClientSideTimestampsMixin(clientSideTimestamps)`](#fn-specforproviderwithclientsidetimestampsmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withCapacitySpecification(capacitySpecification)`](#fn-specinitproviderwithcapacityspecification)
    * [`fn withCapacitySpecificationMixin(capacitySpecification)`](#fn-specinitproviderwithcapacityspecificationmixin)
    * [`fn withClientSideTimestamps(clientSideTimestamps)`](#fn-specinitproviderwithclientsidetimestamps)
    * [`fn withClientSideTimestampsMixin(clientSideTimestamps)`](#fn-specinitproviderwithclientsidetimestampsmixin)
    * [`fn withComment(comment)`](#fn-specinitproviderwithcomment)
    * [`fn withCommentMixin(comment)`](#fn-specinitproviderwithcommentmixin)
    * [`fn withDefaultTimeToLive(defaultTimeToLive)`](#fn-specinitproviderwithdefaulttimetolive)
    * [`fn withEncryptionSpecification(encryptionSpecification)`](#fn-specinitproviderwithencryptionspecification)
    * [`fn withEncryptionSpecificationMixin(encryptionSpecification)`](#fn-specinitproviderwithencryptionspecificationmixin)
    ...
    * [`fn withSchemaDefinitionMixin(schemaDefinition)`](#fn-specinitproviderwithschemadefinitionmixin)
...
### fn spec.forProvider.withClientSideTimestamps

```ts
withClientSideTimestamps(clientSideTimestamps)
```

"Enables client-side timestamps for the table. By default, the setting is disabled."

### fn spec.forProvider.withClientSideTimestampsMixin

```ts
withClientSideTimestampsMixin(clientSideTimestamps)
```
...
### fn spec.initProvider.withCapacitySpecification
...
### fn spec.initProvider.withCapacitySpecificationMixin
...
### fn spec.initProvider.withClientSideTimestamps
...
### fn spec.initProvider.withClientSideTimestampsMixin
...
### fn spec.initProvider.withCommentMixin
...
### fn spec.initProvider.withEncryptionSpecification
...
### fn spec.initProvider.withEncryptionSpecificationMixin
...
### fn spec.initProvider.withSchemaDefinitionMixin
