---
permalink: /upbound-provider-aws/cluster/lambda/v1beta1/alias/
---

# lambda.v1beta1.alias
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withRoutingConfig(routingConfig)`](#fn-specforproviderwithroutingconfig)
    * [`fn withRoutingConfigMixin(routingConfig)`](#fn-specforproviderwithroutingconfigmixin)
    ...
    * [`obj spec.forProvider.routingConfig`](#obj-specforproviderroutingconfig)
      * [`fn withAdditionalVersionWeights(additionalVersionWeights)`](#fn-specforproviderroutingconfigwithadditionalversionweights)
      * [`fn withAdditionalVersionWeightsMixin(additionalVersionWeights)`](#fn-specforproviderroutingconfigwithadditionalversionweightsmixin)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withFunctionVersion(functionVersion)`](#fn-specinitproviderwithfunctionversion)
    * [`fn withRoutingConfig(routingConfig)`](#fn-specinitproviderwithroutingconfig)
    * [`fn withRoutingConfigMixin(routingConfig)`](#fn-specinitproviderwithroutingconfigmixin)
    * [`obj spec.initProvider.routingConfig`](#obj-specinitproviderroutingconfig)
      * [`fn withAdditionalVersionWeights(additionalVersionWeights)`](#fn-specinitproviderroutingconfigwithadditionalversionweights)
      * [`fn withAdditionalVersionWeightsMixin(additionalVersionWeights)`](#fn-specinitproviderroutingconfigwithadditionalversionweightsmixin)
...
### fn spec.forProvider.withRoutingConfig
...
### fn spec.forProvider.withRoutingConfigMixin
...
## obj spec.forProvider.routingConfig

"Lambda alias' route configuration settings. See below."

### fn spec.forProvider.routingConfig.withAdditionalVersionWeights

```ts
withAdditionalVersionWeights(additionalVersionWeights)
```

"Map that defines the proportion of events that should be sent to different versions of a Lambda function."

### fn spec.forProvider.routingConfig.withAdditionalVersionWeightsMixin

```ts
withAdditionalVersionWeightsMixin(additionalVersionWeights)
```
...
### fn spec.initProvider.withRoutingConfig
...
### fn spec.initProvider.withRoutingConfigMixin
...
## obj spec.initProvider.routingConfig

"Lambda alias' route configuration settings. See below."

### fn spec.initProvider.routingConfig.withAdditionalVersionWeights
...
### fn spec.initProvider.routingConfig.withAdditionalVersionWeightsMixin
