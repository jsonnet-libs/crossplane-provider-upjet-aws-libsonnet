---
permalink: /upbound-provider-aws/cluster/cloudcontrol/v1beta1/resource/
---

# cloudcontrol.v1beta1.resource
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withTypeName(typeName)`](#fn-specforproviderwithtypename)
    * [`fn withTypeVersionId(typeVersionId)`](#fn-specforproviderwithtypeversionid)
    ...
    * [`obj spec.forProvider.schemaSecretRef`](#obj-specforproviderschemasecretref)
      * [`fn withKey(key)`](#fn-specforproviderschemasecretrefwithkey)
      * [`fn withName(name)`](#fn-specforproviderschemasecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderschemasecretrefwithnamespace)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withTypeName(typeName)`](#fn-specinitproviderwithtypename)
    * [`fn withTypeVersionId(typeVersionId)`](#fn-specinitproviderwithtypeversionid)
    ...
    * [`obj spec.initProvider.schemaSecretRef`](#obj-specinitproviderschemasecretref)
      * [`fn withKey(key)`](#fn-specinitproviderschemasecretrefwithkey)
      * [`fn withName(name)`](#fn-specinitproviderschemasecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderschemasecretrefwithnamespace)
...
### fn spec.forProvider.withTypeName
...
### fn spec.forProvider.withTypeVersionId

```ts
withTypeVersionId(typeVersionId)
```
...
## obj spec.forProvider.schemaSecretRef
...
### fn spec.forProvider.schemaSecretRef.withKey
...
### fn spec.forProvider.schemaSecretRef.withName
...
### fn spec.forProvider.schemaSecretRef.withNamespace
...
### fn spec.initProvider.withTypeName
...
### fn spec.initProvider.withTypeVersionId
...
## obj spec.initProvider.schemaSecretRef

"JSON string of the CloudFormation resource type schema which is used for plan time validation where possible. Automatically fetched if not provided. In large scale environments with multiple resources using the same type_name, it is recommended to fetch the schema once via the aws_cloudformation_type data source and use this argument to reduce DescribeType API operation throttling. This value is marked sensitive only to prevent large plan differences from showing."

### fn spec.initProvider.schemaSecretRef.withKey
...
### fn spec.initProvider.schemaSecretRef.withName
...
### fn spec.initProvider.schemaSecretRef.withNamespace
