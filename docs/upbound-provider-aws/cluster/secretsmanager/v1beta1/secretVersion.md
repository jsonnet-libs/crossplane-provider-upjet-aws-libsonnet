---
permalink: /upbound-provider-aws/cluster/secretsmanager/v1beta1/secretVersion/
---

# secretsmanager.v1beta1.secretVersion
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withSecretStringWoVersion(secretStringWoVersion)`](#fn-specforproviderwithsecretstringwoversion)
    * [`fn withVersionStages(versionStages)`](#fn-specforproviderwithversionstages)
    * [`fn withVersionStagesMixin(versionStages)`](#fn-specforproviderwithversionstagesmixin)
    * [`obj spec.forProvider.secretBinarySecretRef`](#obj-specforprovidersecretbinarysecretref)
      * [`fn withKey(key)`](#fn-specforprovidersecretbinarysecretrefwithkey)
      * [`fn withName(name)`](#fn-specforprovidersecretbinarysecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidersecretbinarysecretrefwithnamespace)
    ...
    * [`obj spec.forProvider.secretStringSecretRef`](#obj-specforprovidersecretstringsecretref)
      * [`fn withKey(key)`](#fn-specforprovidersecretstringsecretrefwithkey)
      * [`fn withName(name)`](#fn-specforprovidersecretstringsecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidersecretstringsecretrefwithnamespace)
    * [`obj spec.forProvider.secretStringWoSecretRef`](#obj-specforprovidersecretstringwosecretref)
      * [`fn withKey(key)`](#fn-specforprovidersecretstringwosecretrefwithkey)
      * [`fn withName(name)`](#fn-specforprovidersecretstringwosecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidersecretstringwosecretrefwithnamespace)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withSecretId(secretId)`](#fn-specinitproviderwithsecretid)
    * [`fn withSecretStringWoVersion(secretStringWoVersion)`](#fn-specinitproviderwithsecretstringwoversion)
    * [`fn withVersionStages(versionStages)`](#fn-specinitproviderwithversionstages)
    * [`fn withVersionStagesMixin(versionStages)`](#fn-specinitproviderwithversionstagesmixin)
    * [`obj spec.initProvider.secretBinarySecretRef`](#obj-specinitprovidersecretbinarysecretref)
      * [`fn withKey(key)`](#fn-specinitprovidersecretbinarysecretrefwithkey)
      * [`fn withName(name)`](#fn-specinitprovidersecretbinarysecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersecretbinarysecretrefwithnamespace)
    ...
    * [`obj spec.initProvider.secretStringSecretRef`](#obj-specinitprovidersecretstringsecretref)
      * [`fn withKey(key)`](#fn-specinitprovidersecretstringsecretrefwithkey)
      * [`fn withName(name)`](#fn-specinitprovidersecretstringsecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersecretstringsecretrefwithnamespace)
    * [`obj spec.initProvider.secretStringWoSecretRef`](#obj-specinitprovidersecretstringwosecretref)
      * [`fn withKey(key)`](#fn-specinitprovidersecretstringwosecretrefwithkey)
      * [`fn withName(name)`](#fn-specinitprovidersecretstringwosecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersecretstringwosecretrefwithnamespace)
...
new returns an instance of SecretVersion
...
### fn spec.forProvider.withSecretStringWoVersion

```ts
withSecretStringWoVersion(secretStringWoVersion)
```
...
### fn spec.forProvider.withVersionStages

```ts
withVersionStages(versionStages)
```

"Specifies a list of staging labels that are attached to this version of the secret. A staging label must be unique to a single version of the secret. If you specify a staging label that's already associated with a different version of the same secret then that staging label is automatically removed from the other version and attached to this version. If you do not specify a value, then AWS Secrets Manager automatically moves the staging label AWSCURRENT to this new version on creation."

### fn spec.forProvider.withVersionStagesMixin

```ts
withVersionStagesMixin(versionStages)
```
...
## obj spec.forProvider.secretBinarySecretRef
...
### fn spec.forProvider.secretBinarySecretRef.withKey
...
### fn spec.forProvider.secretBinarySecretRef.withName
...
### fn spec.forProvider.secretBinarySecretRef.withNamespace
...
## obj spec.forProvider.secretStringSecretRef
...
### fn spec.forProvider.secretStringSecretRef.withKey
...
### fn spec.forProvider.secretStringSecretRef.withName
...
### fn spec.forProvider.secretStringSecretRef.withNamespace
...
## obj spec.forProvider.secretStringWoSecretRef
...
### fn spec.forProvider.secretStringWoSecretRef.withKey
...
### fn spec.forProvider.secretStringWoSecretRef.withName
...
### fn spec.forProvider.secretStringWoSecretRef.withNamespace
...
### fn spec.initProvider.withSecretStringWoVersion
...
### fn spec.initProvider.withVersionStages
...
### fn spec.initProvider.withVersionStagesMixin
...
## obj spec.initProvider.secretBinarySecretRef

"Specifies binary data that you want to encrypt and store in this version of the secret. This is required if secret_string or secret_string_wo is not set. Needs to be encoded to base64."

### fn spec.initProvider.secretBinarySecretRef.withKey
...
### fn spec.initProvider.secretBinarySecretRef.withName
...
### fn spec.initProvider.secretBinarySecretRef.withNamespace
...
## obj spec.initProvider.secretStringSecretRef

"Specifies text data that you want to encrypt and store in this version of the secret. This is required if secret_binary or secret_string_wo is not set."

### fn spec.initProvider.secretStringSecretRef.withKey
...
### fn spec.initProvider.secretStringSecretRef.withName
...
### fn spec.initProvider.secretStringSecretRef.withNamespace
...
## obj spec.initProvider.secretStringWoSecretRef

"Specifies text data that you want to encrypt and store in this version of the secret. This is required if secret_binary or secret_string is not set."

### fn spec.initProvider.secretStringWoSecretRef.withKey
...
### fn spec.initProvider.secretStringWoSecretRef.withName
...
### fn spec.initProvider.secretStringWoSecretRef.withNamespace
