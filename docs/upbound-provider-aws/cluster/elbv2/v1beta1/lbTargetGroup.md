---
permalink: /upbound-provider-aws/cluster/elbv2/v1beta1/lbTargetGroup/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withTargetGroupHealth(targetGroupHealth)`](#fn-specforproviderwithtargetgrouphealth)
    * [`fn withTargetGroupHealthMixin(targetGroupHealth)`](#fn-specforproviderwithtargetgrouphealthmixin)
    ...
    * [`obj spec.forProvider.targetGroupHealth`](#obj-specforprovidertargetgrouphealth)
      * [`fn withDnsFailover(dnsFailover)`](#fn-specforprovidertargetgrouphealthwithdnsfailover)
      * [`fn withDnsFailoverMixin(dnsFailover)`](#fn-specforprovidertargetgrouphealthwithdnsfailovermixin)
      * [`fn withUnhealthyStateRouting(unhealthyStateRouting)`](#fn-specforprovidertargetgrouphealthwithunhealthystaterouting)
      * [`fn withUnhealthyStateRoutingMixin(unhealthyStateRouting)`](#fn-specforprovidertargetgrouphealthwithunhealthystateroutingmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withTargetGroupHealth(targetGroupHealth)`](#fn-specinitproviderwithtargetgrouphealth)
    * [`fn withTargetGroupHealthMixin(targetGroupHealth)`](#fn-specinitproviderwithtargetgrouphealthmixin)
    ...
    * [`obj spec.initProvider.targetGroupHealth`](#obj-specinitprovidertargetgrouphealth)
      * [`fn withDnsFailover(dnsFailover)`](#fn-specinitprovidertargetgrouphealthwithdnsfailover)
      * [`fn withDnsFailoverMixin(dnsFailover)`](#fn-specinitprovidertargetgrouphealthwithdnsfailovermixin)
      * [`fn withUnhealthyStateRouting(unhealthyStateRouting)`](#fn-specinitprovidertargetgrouphealthwithunhealthystaterouting)
      * [`fn withUnhealthyStateRoutingMixin(unhealthyStateRouting)`](#fn-specinitprovidertargetgrouphealthwithunhealthystateroutingmixin)
...
### fn spec.forProvider.withTargetGroupHealth

```ts
withTargetGroupHealth(targetGroupHealth)
```

"Target health requirements block. See target_group_health for more information."

### fn spec.forProvider.withTargetGroupHealthMixin

```ts
withTargetGroupHealthMixin(targetGroupHealth)
```
...
### fn spec.forProvider.targetGroupHealth.withDnsFailover

```ts
withDnsFailover(dnsFailover)
```

"Block to configure DNS Failover requirements. See DNS Failover below for details on attributes."

### fn spec.forProvider.targetGroupHealth.withDnsFailoverMixin

```ts
withDnsFailoverMixin(dnsFailover)
```
...
### fn spec.forProvider.targetGroupHealth.withUnhealthyStateRouting

```ts
withUnhealthyStateRouting(unhealthyStateRouting)
```

"Block to configure Unhealthy State Routing requirements. See Unhealthy State Routing below for details on attributes."

### fn spec.forProvider.targetGroupHealth.withUnhealthyStateRoutingMixin

```ts
withUnhealthyStateRoutingMixin(unhealthyStateRouting)
```
...
### fn spec.initProvider.withTargetGroupHealth
...
### fn spec.initProvider.withTargetGroupHealthMixin
...
### fn spec.initProvider.targetGroupHealth.withDnsFailover
...
### fn spec.initProvider.targetGroupHealth.withDnsFailoverMixin
...
### fn spec.initProvider.targetGroupHealth.withUnhealthyStateRouting
...
### fn spec.initProvider.targetGroupHealth.withUnhealthyStateRoutingMixin
