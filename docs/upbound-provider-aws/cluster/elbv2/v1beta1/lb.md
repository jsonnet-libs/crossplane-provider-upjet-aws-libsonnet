---
permalink: /upbound-provider-aws/cluster/elbv2/v1beta1/lb/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withIpamPools(ipamPools)`](#fn-specforproviderwithipampools)
    * [`fn withIpamPoolsMixin(ipamPools)`](#fn-specforproviderwithipampoolsmixin)
    * [`fn withLoadBalancerType(loadBalancerType)`](#fn-specforproviderwithloadbalancertype)
    * [`fn withMinimumLoadBalancerCapacity(minimumLoadBalancerCapacity)`](#fn-specforproviderwithminimumloadbalancercapacity)
    * [`fn withMinimumLoadBalancerCapacityMixin(minimumLoadBalancerCapacity)`](#fn-specforproviderwithminimumloadbalancercapacitymixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withIpamPools(ipamPools)`](#fn-specinitproviderwithipampools)
    * [`fn withIpamPoolsMixin(ipamPools)`](#fn-specinitproviderwithipampoolsmixin)
    * [`fn withLoadBalancerType(loadBalancerType)`](#fn-specinitproviderwithloadbalancertype)
    * [`fn withMinimumLoadBalancerCapacity(minimumLoadBalancerCapacity)`](#fn-specinitproviderwithminimumloadbalancercapacity)
    * [`fn withMinimumLoadBalancerCapacityMixin(minimumLoadBalancerCapacity)`](#fn-specinitproviderwithminimumloadbalancercapacitymixin)
...
### fn spec.forProvider.withIpamPools

```ts
withIpamPools(ipamPools)
```
...
### fn spec.forProvider.withIpamPoolsMixin

```ts
withIpamPoolsMixin(ipamPools)
```
...
### fn spec.forProvider.withMinimumLoadBalancerCapacity
...
### fn spec.forProvider.withMinimumLoadBalancerCapacityMixin

```ts
withMinimumLoadBalancerCapacityMixin(minimumLoadBalancerCapacity)
```
...
### fn spec.initProvider.withIpamPools
...
### fn spec.initProvider.withIpamPoolsMixin
...
### fn spec.initProvider.withMinimumLoadBalancerCapacity
...
### fn spec.initProvider.withMinimumLoadBalancerCapacityMixin
