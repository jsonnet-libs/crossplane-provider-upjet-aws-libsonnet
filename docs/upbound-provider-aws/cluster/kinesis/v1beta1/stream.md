---
permalink: /upbound-provider-aws/cluster/kinesis/v1beta1/stream/
---

# kinesis.v1beta1.stream
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withEnforceConsumerDeletion(enforceConsumerDeletion)`](#fn-specforproviderwithenforceconsumerdeletion)
    ...
    * [`fn withShardLevelMetrics(shardLevelMetrics)`](#fn-specforproviderwithshardlevelmetrics)
    * [`fn withShardLevelMetricsMixin(shardLevelMetrics)`](#fn-specforproviderwithshardlevelmetricsmixin)
    * [`fn withStreamModeDetails(streamModeDetails)`](#fn-specforproviderwithstreammodedetails)
    * [`fn withStreamModeDetailsMixin(streamModeDetails)`](#fn-specforproviderwithstreammodedetailsmixin)
    ...
    * [`obj spec.forProvider.streamModeDetails`](#obj-specforproviderstreammodedetails)
      * [`fn withStreamMode(streamMode)`](#fn-specforproviderstreammodedetailswithstreammode)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withEncryptionType(encryptionType)`](#fn-specinitproviderwithencryptiontype)
    * [`fn withEnforceConsumerDeletion(enforceConsumerDeletion)`](#fn-specinitproviderwithenforceconsumerdeletion)
    ...
    * [`fn withShardLevelMetrics(shardLevelMetrics)`](#fn-specinitproviderwithshardlevelmetrics)
    * [`fn withShardLevelMetricsMixin(shardLevelMetrics)`](#fn-specinitproviderwithshardlevelmetricsmixin)
    * [`fn withStreamModeDetails(streamModeDetails)`](#fn-specinitproviderwithstreammodedetails)
    * [`fn withStreamModeDetailsMixin(streamModeDetails)`](#fn-specinitproviderwithstreammodedetailsmixin)
    ...
    * [`obj spec.initProvider.streamModeDetails`](#obj-specinitproviderstreammodedetails)
      * [`fn withStreamMode(streamMode)`](#fn-specinitproviderstreammodedetailswithstreammode)
...
### fn spec.forProvider.withEnforceConsumerDeletion

```ts
withEnforceConsumerDeletion(enforceConsumerDeletion)
```
...
### fn spec.forProvider.withShardLevelMetrics

```ts
withShardLevelMetrics(shardLevelMetrics)
```
...
### fn spec.forProvider.withShardLevelMetricsMixin

```ts
withShardLevelMetricsMixin(shardLevelMetrics)
```
...
### fn spec.forProvider.withStreamModeDetails
...
### fn spec.forProvider.withStreamModeDetailsMixin

```ts
withStreamModeDetailsMixin(streamModeDetails)
```
...
## obj spec.forProvider.streamModeDetails

"Indicates the capacity mode of the data stream. Detailed below."

### fn spec.forProvider.streamModeDetails.withStreamMode
...
### fn spec.initProvider.withEnforceConsumerDeletion
...
### fn spec.initProvider.withShardLevelMetrics
...
### fn spec.initProvider.withShardLevelMetricsMixin
...
### fn spec.initProvider.withStreamModeDetails
...
### fn spec.initProvider.withStreamModeDetailsMixin
...
## obj spec.initProvider.streamModeDetails

"Indicates the capacity mode of the data stream. Detailed below."

### fn spec.initProvider.streamModeDetails.withStreamMode
