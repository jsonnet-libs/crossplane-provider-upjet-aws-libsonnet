---
permalink: /upbound-provider-aws/cluster/ec2/v1beta1/vpcPeeringConnectionAccepter/
---

# ec2.v1beta1.vpcPeeringConnectionAccepter
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAccepter(accepter)`](#fn-specforproviderwithaccepter)
    * [`fn withAccepterMixin(accepter)`](#fn-specforproviderwithacceptermixin)
    * [`fn withAutoAccept(autoAccept)`](#fn-specforproviderwithautoaccept)
    * [`fn withRegion(region)`](#fn-specforproviderwithregion)
    * [`fn withRequester(requester)`](#fn-specforproviderwithrequester)
    * [`fn withRequesterMixin(requester)`](#fn-specforproviderwithrequestermixin)
    * [`fn withTags(tags)`](#fn-specforproviderwithtags)
    * [`fn withTagsMixin(tags)`](#fn-specforproviderwithtagsmixin)
    * [`fn withVpcPeeringConnectionId(vpcPeeringConnectionId)`](#fn-specforproviderwithvpcpeeringconnectionid)
    * [`obj spec.forProvider.accepter`](#obj-specforprovideraccepter)
      * [`fn withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution)`](#fn-specforprovideraccepterwithallowremotevpcdnsresolution)
    * [`obj spec.forProvider.requester`](#obj-specforproviderrequester)
      * [`fn withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution)`](#fn-specforproviderrequesterwithallowremotevpcdnsresolution)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAccepter(accepter)`](#fn-specinitproviderwithaccepter)
    * [`fn withAccepterMixin(accepter)`](#fn-specinitproviderwithacceptermixin)
    * [`fn withAutoAccept(autoAccept)`](#fn-specinitproviderwithautoaccept)
    * [`fn withRequester(requester)`](#fn-specinitproviderwithrequester)
    * [`fn withRequesterMixin(requester)`](#fn-specinitproviderwithrequestermixin)
    * [`fn withTags(tags)`](#fn-specinitproviderwithtags)
    * [`fn withTagsMixin(tags)`](#fn-specinitproviderwithtagsmixin)
    * [`fn withVpcPeeringConnectionId(vpcPeeringConnectionId)`](#fn-specinitproviderwithvpcpeeringconnectionid)
    * [`obj spec.initProvider.accepter`](#obj-specinitprovideraccepter)
      * [`fn withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution)`](#fn-specinitprovideraccepterwithallowremotevpcdnsresolution)
    * [`obj spec.initProvider.requester`](#obj-specinitproviderrequester)
      * [`fn withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution)`](#fn-specinitproviderrequesterwithallowremotevpcdnsresolution)
...
new returns an instance of VPCPeeringConnectionAccepter
...
### fn spec.forProvider.withAccepter

```ts
withAccepter(accepter)
```

"A configuration block that describes [VPC Peering Connection]\n(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC."

### fn spec.forProvider.withAccepterMixin

```ts
withAccepterMixin(accepter)
```
...
### fn spec.forProvider.withRequester
...
### fn spec.forProvider.withRequesterMixin

```ts
withRequesterMixin(requester)
```
...
## obj spec.forProvider.accepter

"A configuration block that describes [VPC Peering Connection]\n(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC."

### fn spec.forProvider.accepter.withAllowRemoteVpcDnsResolution

```ts
withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution)
```

"Indicates whether a local VPC can resolve public DNS hostnames to\nprivate IP addresses when queried from instances in a peer VPC."

## obj spec.forProvider.requester

"A configuration block that describes [VPC Peering Connection]\n(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the requester VPC."

### fn spec.forProvider.requester.withAllowRemoteVpcDnsResolution
...
### fn spec.initProvider.withAccepter
...
### fn spec.initProvider.withAccepterMixin
...
### fn spec.initProvider.withRequester
...
### fn spec.initProvider.withRequesterMixin
...
## obj spec.initProvider.accepter

"A configuration block that describes [VPC Peering Connection]\n(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC."

### fn spec.initProvider.accepter.withAllowRemoteVpcDnsResolution
...
## obj spec.initProvider.requester

"A configuration block that describes [VPC Peering Connection]\n(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the requester VPC."

### fn spec.initProvider.requester.withAllowRemoteVpcDnsResolution
