---
permalink: /upbound-provider-aws/cluster/kendra/v1beta1/experience/
---

# kendra.v1beta1.experience
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.configuration`](#obj-specforproviderconfiguration)
      * [`fn withContentSourceConfiguration(contentSourceConfiguration)`](#fn-specforproviderconfigurationwithcontentsourceconfiguration)
      * [`fn withContentSourceConfigurationMixin(contentSourceConfiguration)`](#fn-specforproviderconfigurationwithcontentsourceconfigurationmixin)
      * [`fn withUserIdentityConfiguration(userIdentityConfiguration)`](#fn-specforproviderconfigurationwithuseridentityconfiguration)
      * [`fn withUserIdentityConfigurationMixin(userIdentityConfiguration)`](#fn-specforproviderconfigurationwithuseridentityconfigurationmixin)
      * [`obj spec.forProvider.configuration.contentSourceConfiguration`](#obj-specforproviderconfigurationcontentsourceconfiguration)
        * [`fn withDataSourceIds(dataSourceIds)`](#fn-specforproviderconfigurationcontentsourceconfigurationwithdatasourceids)
        * [`fn withDataSourceIdsMixin(dataSourceIds)`](#fn-specforproviderconfigurationcontentsourceconfigurationwithdatasourceidsmixin)
        * [`fn withDirectPutContent(directPutContent)`](#fn-specforproviderconfigurationcontentsourceconfigurationwithdirectputcontent)
        * [`fn withFaqIds(faqIds)`](#fn-specforproviderconfigurationcontentsourceconfigurationwithfaqids)
        * [`fn withFaqIdsMixin(faqIds)`](#fn-specforproviderconfigurationcontentsourceconfigurationwithfaqidsmixin)
      * [`obj spec.forProvider.configuration.userIdentityConfiguration`](#obj-specforproviderconfigurationuseridentityconfiguration)
        * [`fn withIdentityAttributeName(identityAttributeName)`](#fn-specforproviderconfigurationuseridentityconfigurationwithidentityattributename)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.configuration`](#obj-specinitproviderconfiguration)
      * [`fn withContentSourceConfiguration(contentSourceConfiguration)`](#fn-specinitproviderconfigurationwithcontentsourceconfiguration)
      * [`fn withContentSourceConfigurationMixin(contentSourceConfiguration)`](#fn-specinitproviderconfigurationwithcontentsourceconfigurationmixin)
      * [`fn withUserIdentityConfiguration(userIdentityConfiguration)`](#fn-specinitproviderconfigurationwithuseridentityconfiguration)
      * [`fn withUserIdentityConfigurationMixin(userIdentityConfiguration)`](#fn-specinitproviderconfigurationwithuseridentityconfigurationmixin)
      * [`obj spec.initProvider.configuration.contentSourceConfiguration`](#obj-specinitproviderconfigurationcontentsourceconfiguration)
        * [`fn withDataSourceIds(dataSourceIds)`](#fn-specinitproviderconfigurationcontentsourceconfigurationwithdatasourceids)
        * [`fn withDataSourceIdsMixin(dataSourceIds)`](#fn-specinitproviderconfigurationcontentsourceconfigurationwithdatasourceidsmixin)
        * [`fn withDirectPutContent(directPutContent)`](#fn-specinitproviderconfigurationcontentsourceconfigurationwithdirectputcontent)
        * [`fn withFaqIds(faqIds)`](#fn-specinitproviderconfigurationcontentsourceconfigurationwithfaqids)
        * [`fn withFaqIdsMixin(faqIds)`](#fn-specinitproviderconfigurationcontentsourceconfigurationwithfaqidsmixin)
      * [`obj spec.initProvider.configuration.userIdentityConfiguration`](#obj-specinitproviderconfigurationuseridentityconfiguration)
        * [`fn withIdentityAttributeName(identityAttributeName)`](#fn-specinitproviderconfigurationuseridentityconfigurationwithidentityattributename)
...
new returns an instance of Experience
...
### fn spec.forProvider.configuration.withContentSourceConfiguration

```ts
withContentSourceConfiguration(contentSourceConfiguration)
```
...
### fn spec.forProvider.configuration.withContentSourceConfigurationMixin

```ts
withContentSourceConfigurationMixin(contentSourceConfiguration)
```
...
### fn spec.forProvider.configuration.withUserIdentityConfiguration

```ts
withUserIdentityConfiguration(userIdentityConfiguration)
```

"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."

### fn spec.forProvider.configuration.withUserIdentityConfigurationMixin

```ts
withUserIdentityConfigurationMixin(userIdentityConfiguration)
```
...
## obj spec.forProvider.configuration.contentSourceConfiguration

"The identifiers of your data sources and FAQs. Or, you can specify that you want to use documents indexed via the BatchPutDocument API. Detailed below."

### fn spec.forProvider.configuration.contentSourceConfiguration.withDataSourceIds

```ts
withDataSourceIds(dataSourceIds)
```

"The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items."

### fn spec.forProvider.configuration.contentSourceConfiguration.withDataSourceIdsMixin

```ts
withDataSourceIdsMixin(dataSourceIds)
```
...
### fn spec.forProvider.configuration.contentSourceConfiguration.withDirectPutContent

```ts
withDirectPutContent(directPutContent)
```

"Whether to use documents you indexed directly using the BatchPutDocument API. Defaults to false."

### fn spec.forProvider.configuration.contentSourceConfiguration.withFaqIds
...
### fn spec.forProvider.configuration.contentSourceConfiguration.withFaqIdsMixin

```ts
withFaqIdsMixin(faqIds)
```
...
## obj spec.forProvider.configuration.userIdentityConfiguration

"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."

### fn spec.forProvider.configuration.userIdentityConfiguration.withIdentityAttributeName

```ts
withIdentityAttributeName(identityAttributeName)
```
...
### fn spec.initProvider.configuration.withContentSourceConfiguration
...
### fn spec.initProvider.configuration.withContentSourceConfigurationMixin
...
### fn spec.initProvider.configuration.withUserIdentityConfiguration
...
### fn spec.initProvider.configuration.withUserIdentityConfigurationMixin
...
## obj spec.initProvider.configuration.contentSourceConfiguration

"The identifiers of your data sources and FAQs. Or, you can specify that you want to use documents indexed via the BatchPutDocument API. Detailed below."

### fn spec.initProvider.configuration.contentSourceConfiguration.withDataSourceIds
...
### fn spec.initProvider.configuration.contentSourceConfiguration.withDataSourceIdsMixin
...
### fn spec.initProvider.configuration.contentSourceConfiguration.withDirectPutContent
...
### fn spec.initProvider.configuration.contentSourceConfiguration.withFaqIds
...
### fn spec.initProvider.configuration.contentSourceConfiguration.withFaqIdsMixin
...
## obj spec.initProvider.configuration.userIdentityConfiguration

"The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below."

### fn spec.initProvider.configuration.userIdentityConfiguration.withIdentityAttributeName
