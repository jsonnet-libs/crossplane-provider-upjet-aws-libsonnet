---
permalink: /upbound-provider-aws/cluster/cloudwatchevents/v1beta1/target/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAppsyncTarget(appsyncTarget)`](#fn-specforproviderwithappsynctarget)
    * [`fn withAppsyncTargetMixin(appsyncTarget)`](#fn-specforproviderwithappsynctargetmixin)
    ...
    * [`fn withSagemakerPipelineTarget(sagemakerPipelineTarget)`](#fn-specforproviderwithsagemakerpipelinetarget)
    * [`fn withSagemakerPipelineTargetMixin(sagemakerPipelineTarget)`](#fn-specforproviderwithsagemakerpipelinetargetmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAppsyncTarget(appsyncTarget)`](#fn-specinitproviderwithappsynctarget)
    * [`fn withAppsyncTargetMixin(appsyncTarget)`](#fn-specinitproviderwithappsynctargetmixin)
    * [`fn withArn(arn)`](#fn-specinitproviderwitharn)
    * [`fn withBatchTarget(batchTarget)`](#fn-specinitproviderwithbatchtarget)
    * [`fn withBatchTargetMixin(batchTarget)`](#fn-specinitproviderwithbatchtargetmixin)
    ...
    * [`fn withEcsTarget(ecsTarget)`](#fn-specinitproviderwithecstarget)
    * [`fn withEcsTargetMixin(ecsTarget)`](#fn-specinitproviderwithecstargetmixin)
    ...
    * [`fn withHttpTarget(httpTarget)`](#fn-specinitproviderwithhttptarget)
    * [`fn withHttpTargetMixin(httpTarget)`](#fn-specinitproviderwithhttptargetmixin)
    * [`fn withInput(input)`](#fn-specinitproviderwithinput)
    * [`fn withInputPath(inputPath)`](#fn-specinitproviderwithinputpath)
    * [`fn withInputTransformer(inputTransformer)`](#fn-specinitproviderwithinputtransformer)
    * [`fn withInputTransformerMixin(inputTransformer)`](#fn-specinitproviderwithinputtransformermixin)
    * [`fn withKinesisTarget(kinesisTarget)`](#fn-specinitproviderwithkinesistarget)
    * [`fn withKinesisTargetMixin(kinesisTarget)`](#fn-specinitproviderwithkinesistargetmixin)
    * [`fn withRedshiftTarget(redshiftTarget)`](#fn-specinitproviderwithredshifttarget)
    * [`fn withRedshiftTargetMixin(redshiftTarget)`](#fn-specinitproviderwithredshifttargetmixin)
    ...
    * [`fn withSagemakerPipelineTarget(sagemakerPipelineTarget)`](#fn-specinitproviderwithsagemakerpipelinetarget)
    * [`fn withSagemakerPipelineTargetMixin(sagemakerPipelineTarget)`](#fn-specinitproviderwithsagemakerpipelinetargetmixin)
    * [`fn withSqsTarget(sqsTarget)`](#fn-specinitproviderwithsqstarget)
    * [`fn withSqsTargetMixin(sqsTarget)`](#fn-specinitproviderwithsqstargetmixin)
    ...
    * [`obj spec.initProvider.ecsTarget`](#obj-specinitproviderecstarget)
      ...
      * [`fn withNetworkConfiguration(networkConfiguration)`](#fn-specinitproviderecstargetwithnetworkconfiguration)
      * [`fn withNetworkConfigurationMixin(networkConfiguration)`](#fn-specinitproviderecstargetwithnetworkconfigurationmixin)
...
### fn spec.forProvider.withAppsyncTarget

```ts
withAppsyncTarget(appsyncTarget)
```
...
### fn spec.forProvider.withAppsyncTargetMixin

```ts
withAppsyncTargetMixin(appsyncTarget)
```
...
### fn spec.forProvider.withSagemakerPipelineTarget

```ts
withSagemakerPipelineTarget(sagemakerPipelineTarget)
```
...
### fn spec.forProvider.withSagemakerPipelineTargetMixin

```ts
withSagemakerPipelineTargetMixin(sagemakerPipelineTarget)
```
...
### fn spec.initProvider.withAppsyncTarget
...
### fn spec.initProvider.withAppsyncTargetMixin
...
### fn spec.initProvider.withBatchTarget
...
### fn spec.initProvider.withBatchTargetMixin
...
### fn spec.initProvider.withEcsTarget
...
### fn spec.initProvider.withEcsTargetMixin
...
### fn spec.initProvider.withInputTransformer
...
### fn spec.initProvider.withInputTransformerMixin
...
### fn spec.initProvider.withKinesisTarget
...
### fn spec.initProvider.withKinesisTargetMixin
...
### fn spec.initProvider.withRedshiftTarget
...
### fn spec.initProvider.withRedshiftTargetMixin
...
### fn spec.initProvider.withSagemakerPipelineTarget
...
### fn spec.initProvider.withSagemakerPipelineTargetMixin
...
### fn spec.initProvider.withSqsTarget
...
### fn spec.initProvider.withSqsTargetMixin
...
### fn spec.initProvider.ecsTarget.withNetworkConfiguration
...
### fn spec.initProvider.ecsTarget.withNetworkConfigurationMixin
