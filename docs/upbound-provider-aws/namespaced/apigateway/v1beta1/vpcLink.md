---
permalink: /upbound-provider-aws/namespaced/apigateway/v1beta1/vpcLink/
---

# apigateway.v1beta1.vpcLink
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withTargetArnRefs(targetArnRefs)`](#fn-specforproviderwithtargetarnrefs)
    * [`fn withTargetArnRefsMixin(targetArnRefs)`](#fn-specforproviderwithtargetarnrefsmixin)
    * [`fn withTargetArns(targetArns)`](#fn-specforproviderwithtargetarns)
    * [`fn withTargetArnsMixin(targetArns)`](#fn-specforproviderwithtargetarnsmixin)
    * [`obj spec.forProvider.targetArnRefs`](#obj-specforprovidertargetarnrefs)
      * [`fn withName(name)`](#fn-specforprovidertargetarnrefswithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidertargetarnrefswithnamespace)
      * [`obj spec.forProvider.targetArnRefs.policy`](#obj-specforprovidertargetarnrefspolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidertargetarnrefspolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidertargetarnrefspolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withTargetArnRefs(targetArnRefs)`](#fn-specinitproviderwithtargetarnrefs)
    * [`fn withTargetArnRefsMixin(targetArnRefs)`](#fn-specinitproviderwithtargetarnrefsmixin)
    * [`fn withTargetArns(targetArns)`](#fn-specinitproviderwithtargetarns)
    * [`fn withTargetArnsMixin(targetArns)`](#fn-specinitproviderwithtargetarnsmixin)
    * [`obj spec.initProvider.targetArnRefs`](#obj-specinitprovidertargetarnrefs)
      * [`fn withName(name)`](#fn-specinitprovidertargetarnrefswithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidertargetarnrefswithnamespace)
      * [`obj spec.initProvider.targetArnRefs.policy`](#obj-specinitprovidertargetarnrefspolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidertargetarnrefspolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidertargetarnrefspolicywithresolve)
...
new returns an instance of VPCLink
...
### fn spec.forProvider.withTargetArnRefs

```ts
withTargetArnRefs(targetArnRefs)
```

"References to LB in elbv2 to populate targetArns."

### fn spec.forProvider.withTargetArnRefsMixin

```ts
withTargetArnRefsMixin(targetArnRefs)
```
...
### fn spec.forProvider.withTargetArns
...
### fn spec.forProvider.withTargetArnsMixin
...
## obj spec.forProvider.targetArnRefs

"References to LB in elbv2 to populate targetArns."

### fn spec.forProvider.targetArnRefs.withName
...
### fn spec.forProvider.targetArnRefs.withNamespace
...
## obj spec.forProvider.targetArnRefs.policy

"Policies for referencing."

### fn spec.forProvider.targetArnRefs.policy.withResolution
...
### fn spec.forProvider.targetArnRefs.policy.withResolve
...
### fn spec.initProvider.withTargetArnRefs
...
### fn spec.initProvider.withTargetArnRefsMixin
...
### fn spec.initProvider.withTargetArns
...
### fn spec.initProvider.withTargetArnsMixin
...
## obj spec.initProvider.targetArnRefs

"References to LB in elbv2 to populate targetArns."

### fn spec.initProvider.targetArnRefs.withName
...
### fn spec.initProvider.targetArnRefs.withNamespace
...
## obj spec.initProvider.targetArnRefs.policy

"Policies for referencing."

### fn spec.initProvider.targetArnRefs.policy.withResolution
...
### fn spec.initProvider.targetArnRefs.policy.withResolve
