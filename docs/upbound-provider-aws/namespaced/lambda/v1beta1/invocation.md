---
permalink: /upbound-provider-aws/namespaced/lambda/v1beta1/invocation/
---

# lambda.v1beta1.invocation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withLifecycleScope(lifecycleScope)`](#fn-specforproviderwithlifecyclescope)
    * [`fn withQualifier(qualifier)`](#fn-specforproviderwithqualifier)
    * [`fn withRegion(region)`](#fn-specforproviderwithregion)
    * [`fn withTerraformKey(terraformKey)`](#fn-specforproviderwithterraformkey)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withLifecycleScope(lifecycleScope)`](#fn-specinitproviderwithlifecyclescope)
    * [`fn withQualifier(qualifier)`](#fn-specinitproviderwithqualifier)
    * [`fn withTerraformKey(terraformKey)`](#fn-specinitproviderwithterraformkey)
...
new returns an instance of Invocation
...
### fn spec.forProvider.withLifecycleScope

```ts
withLifecycleScope(lifecycleScope)
```
...
### fn spec.forProvider.withTerraformKey

```ts
withTerraformKey(terraformKey)
```
...
### fn spec.initProvider.withLifecycleScope
...
### fn spec.initProvider.withTerraformKey
