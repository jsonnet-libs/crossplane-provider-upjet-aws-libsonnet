---
permalink: /upbound-provider-aws/namespaced/elasticbeanstalk/v1beta1/applicationVersion/
---

# elasticbeanstalk.v1beta1.applicationVersion
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withProcess(process)`](#fn-specforproviderwithprocess)
    ...
    * [`obj spec.forProvider.keyRef`](#obj-specforproviderkeyref)
      * [`fn withName(name)`](#fn-specforproviderkeyrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderkeyrefwithnamespace)
      * [`obj spec.forProvider.keyRef.policy`](#obj-specforproviderkeyrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderkeyrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderkeyrefpolicywithresolve)
    * [`obj spec.forProvider.keySelector`](#obj-specforproviderkeyselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderkeyselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderkeyselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderkeyselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforproviderkeyselectorwithnamespace)
      * [`obj spec.forProvider.keySelector.policy`](#obj-specforproviderkeyselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderkeyselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderkeyselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withProcess(process)`](#fn-specinitproviderwithprocess)
    ...
    * [`obj spec.initProvider.keyRef`](#obj-specinitproviderkeyref)
      * [`fn withName(name)`](#fn-specinitproviderkeyrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderkeyrefwithnamespace)
      * [`obj spec.initProvider.keyRef.policy`](#obj-specinitproviderkeyrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderkeyrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderkeyrefpolicywithresolve)
    * [`obj spec.initProvider.keySelector`](#obj-specinitproviderkeyselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderkeyselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderkeyselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderkeyselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderkeyselectorwithnamespace)
      * [`obj spec.initProvider.keySelector.policy`](#obj-specinitproviderkeyselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderkeyselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderkeyselectorpolicywithresolve)
...
new returns an instance of ApplicationVersion
...
### fn spec.forProvider.withProcess
...
## obj spec.forProvider.keyRef

"Reference to a Object in s3 to populate key."

### fn spec.forProvider.keyRef.withName
...
### fn spec.forProvider.keyRef.withNamespace
...
## obj spec.forProvider.keyRef.policy

"Policies for referencing."

### fn spec.forProvider.keyRef.policy.withResolution
...
### fn spec.forProvider.keyRef.policy.withResolve
...
## obj spec.forProvider.keySelector

"Selector for a Object in s3 to populate key."

### fn spec.forProvider.keySelector.withMatchControllerRef
...
### fn spec.forProvider.keySelector.withMatchLabels
...
### fn spec.forProvider.keySelector.withMatchLabelsMixin
...
### fn spec.forProvider.keySelector.withNamespace
...
## obj spec.forProvider.keySelector.policy

"Policies for selection."

### fn spec.forProvider.keySelector.policy.withResolution
...
### fn spec.forProvider.keySelector.policy.withResolve
...
### fn spec.initProvider.withProcess
...
## obj spec.initProvider.keyRef

"Reference to a Object in s3 to populate key."

### fn spec.initProvider.keyRef.withName
...
### fn spec.initProvider.keyRef.withNamespace
...
## obj spec.initProvider.keyRef.policy

"Policies for referencing."

### fn spec.initProvider.keyRef.policy.withResolution
...
### fn spec.initProvider.keyRef.policy.withResolve
...
## obj spec.initProvider.keySelector

"Selector for a Object in s3 to populate key."

### fn spec.initProvider.keySelector.withMatchControllerRef
...
### fn spec.initProvider.keySelector.withMatchLabels
...
### fn spec.initProvider.keySelector.withMatchLabelsMixin
...
### fn spec.initProvider.keySelector.withNamespace
...
## obj spec.initProvider.keySelector.policy

"Policies for selection."

### fn spec.initProvider.keySelector.policy.withResolution
...
### fn spec.initProvider.keySelector.policy.withResolve
