---
permalink: /upbound-provider-aws/namespaced/appautoscaling/v1beta1/target/
---

# appautoscaling.v1beta1.target
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.suspendedState`](#obj-specforprovidersuspendedstate)
      * [`fn withDynamicScalingInSuspended(dynamicScalingInSuspended)`](#fn-specforprovidersuspendedstatewithdynamicscalinginsuspended)
      * [`fn withDynamicScalingOutSuspended(dynamicScalingOutSuspended)`](#fn-specforprovidersuspendedstatewithdynamicscalingoutsuspended)
      * [`fn withScheduledScalingSuspended(scheduledScalingSuspended)`](#fn-specforprovidersuspendedstatewithscheduledscalingsuspended)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.suspendedState`](#obj-specinitprovidersuspendedstate)
      * [`fn withDynamicScalingInSuspended(dynamicScalingInSuspended)`](#fn-specinitprovidersuspendedstatewithdynamicscalinginsuspended)
      * [`fn withDynamicScalingOutSuspended(dynamicScalingOutSuspended)`](#fn-specinitprovidersuspendedstatewithdynamicscalingoutsuspended)
      * [`fn withScheduledScalingSuspended(scheduledScalingSuspended)`](#fn-specinitprovidersuspendedstatewithscheduledscalingsuspended)
...
## obj spec.forProvider.suspendedState

"Specifies whether the scaling activities for a scalable target are in a suspended state."

### fn spec.forProvider.suspendedState.withDynamicScalingInSuspended

```ts
withDynamicScalingInSuspended(dynamicScalingInSuspended)
```

"Whether scale in by a target tracking scaling policy or a step scaling policy is suspended. Default is false."

### fn spec.forProvider.suspendedState.withDynamicScalingOutSuspended

```ts
withDynamicScalingOutSuspended(dynamicScalingOutSuspended)
```

"Whether scale out by a target tracking scaling policy or a step scaling policy is suspended. Default is false."

### fn spec.forProvider.suspendedState.withScheduledScalingSuspended

```ts
withScheduledScalingSuspended(scheduledScalingSuspended)
```
...
## obj spec.initProvider.suspendedState

"Specifies whether the scaling activities for a scalable target are in a suspended state."

### fn spec.initProvider.suspendedState.withDynamicScalingInSuspended
...
### fn spec.initProvider.suspendedState.withDynamicScalingOutSuspended
...
### fn spec.initProvider.suspendedState.withScheduledScalingSuspended
