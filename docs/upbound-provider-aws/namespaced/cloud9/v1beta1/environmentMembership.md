---
permalink: /upbound-provider-aws/namespaced/cloud9/v1beta1/environmentMembership/
---

# cloud9.v1beta1.environmentMembership
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withUserArn(userArn)`](#fn-specforproviderwithuserarn)
    ...
    * [`obj spec.forProvider.userArnRef`](#obj-specforprovideruserarnref)
      * [`fn withName(name)`](#fn-specforprovideruserarnrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovideruserarnrefwithnamespace)
      * [`obj spec.forProvider.userArnRef.policy`](#obj-specforprovideruserarnrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovideruserarnrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovideruserarnrefpolicywithresolve)
    * [`obj spec.forProvider.userArnSelector`](#obj-specforprovideruserarnselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovideruserarnselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovideruserarnselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovideruserarnselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforprovideruserarnselectorwithnamespace)
      * [`obj spec.forProvider.userArnSelector.policy`](#obj-specforprovideruserarnselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovideruserarnselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovideruserarnselectorpolicywithresolve)
...
new returns an instance of EnvironmentMembership
...
### fn spec.forProvider.withUserArn
...
## obj spec.forProvider.userArnRef

"Reference to a User in iam to populate userArn."

### fn spec.forProvider.userArnRef.withName
...
### fn spec.forProvider.userArnRef.withNamespace
...
## obj spec.forProvider.userArnRef.policy

"Policies for referencing."

### fn spec.forProvider.userArnRef.policy.withResolution
...
### fn spec.forProvider.userArnRef.policy.withResolve
...
## obj spec.forProvider.userArnSelector

"Selector for a User in iam to populate userArn."

### fn spec.forProvider.userArnSelector.withMatchControllerRef
...
### fn spec.forProvider.userArnSelector.withMatchLabels
...
### fn spec.forProvider.userArnSelector.withMatchLabelsMixin
...
### fn spec.forProvider.userArnSelector.withNamespace
...
## obj spec.forProvider.userArnSelector.policy

"Policies for selection."

### fn spec.forProvider.userArnSelector.policy.withResolution
...
### fn spec.forProvider.userArnSelector.policy.withResolve
