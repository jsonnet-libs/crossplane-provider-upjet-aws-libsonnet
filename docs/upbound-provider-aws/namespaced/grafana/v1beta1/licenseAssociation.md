---
permalink: /upbound-provider-aws/namespaced/grafana/v1beta1/licenseAssociation/
---

# grafana.v1beta1.licenseAssociation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withGrafanaToken(grafanaToken)`](#fn-specforproviderwithgrafanatoken)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withGrafanaToken(grafanaToken)`](#fn-specinitproviderwithgrafanatoken)
...
new returns an instance of LicenseAssociation
...
### fn spec.forProvider.withGrafanaToken

```ts
withGrafanaToken(grafanaToken)
```
...
### fn spec.initProvider.withGrafanaToken
