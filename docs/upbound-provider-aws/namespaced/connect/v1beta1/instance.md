---
permalink: /upbound-provider-aws/namespaced/connect/v1beta1/instance/
---

# connect.v1beta1.instance
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAutoResolveBestVoicesEnabled(autoResolveBestVoicesEnabled)`](#fn-specforproviderwithautoresolvebestvoicesenabled)
    * [`fn withContactFlowLogsEnabled(contactFlowLogsEnabled)`](#fn-specforproviderwithcontactflowlogsenabled)
    * [`fn withContactLensEnabled(contactLensEnabled)`](#fn-specforproviderwithcontactlensenabled)
    * [`fn withDirectoryId(directoryId)`](#fn-specforproviderwithdirectoryid)
    * [`fn withEarlyMediaEnabled(earlyMediaEnabled)`](#fn-specforproviderwithearlymediaenabled)
    * [`fn withIdentityManagementType(identityManagementType)`](#fn-specforproviderwithidentitymanagementtype)
    * [`fn withInboundCallsEnabled(inboundCallsEnabled)`](#fn-specforproviderwithinboundcallsenabled)
    * [`fn withInstanceAlias(instanceAlias)`](#fn-specforproviderwithinstancealias)
    * [`fn withMultiPartyConferenceEnabled(multiPartyConferenceEnabled)`](#fn-specforproviderwithmultipartyconferenceenabled)
    * [`fn withOutboundCallsEnabled(outboundCallsEnabled)`](#fn-specforproviderwithoutboundcallsenabled)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAutoResolveBestVoicesEnabled(autoResolveBestVoicesEnabled)`](#fn-specinitproviderwithautoresolvebestvoicesenabled)
    * [`fn withContactFlowLogsEnabled(contactFlowLogsEnabled)`](#fn-specinitproviderwithcontactflowlogsenabled)
    * [`fn withContactLensEnabled(contactLensEnabled)`](#fn-specinitproviderwithcontactlensenabled)
    * [`fn withDirectoryId(directoryId)`](#fn-specinitproviderwithdirectoryid)
    * [`fn withEarlyMediaEnabled(earlyMediaEnabled)`](#fn-specinitproviderwithearlymediaenabled)
    * [`fn withIdentityManagementType(identityManagementType)`](#fn-specinitproviderwithidentitymanagementtype)
    * [`fn withInboundCallsEnabled(inboundCallsEnabled)`](#fn-specinitproviderwithinboundcallsenabled)
    * [`fn withInstanceAlias(instanceAlias)`](#fn-specinitproviderwithinstancealias)
    * [`fn withMultiPartyConferenceEnabled(multiPartyConferenceEnabled)`](#fn-specinitproviderwithmultipartyconferenceenabled)
    * [`fn withOutboundCallsEnabled(outboundCallsEnabled)`](#fn-specinitproviderwithoutboundcallsenabled)
...
### fn spec.forProvider.withAutoResolveBestVoicesEnabled

```ts
withAutoResolveBestVoicesEnabled(autoResolveBestVoicesEnabled)
```

"Specifies whether auto resolve best voices is enabled. Defaults to true."

### fn spec.forProvider.withContactFlowLogsEnabled

```ts
withContactFlowLogsEnabled(contactFlowLogsEnabled)
```

"Specifies whether contact flow logs are enabled. Defaults to false."

### fn spec.forProvider.withContactLensEnabled

```ts
withContactLensEnabled(contactLensEnabled)
```
...
### fn spec.forProvider.withEarlyMediaEnabled

```ts
withEarlyMediaEnabled(earlyMediaEnabled)
```

"Specifies whether early media for outbound calls is enabled . Defaults to true if outbound calls is enabled."

### fn spec.forProvider.withIdentityManagementType

```ts
withIdentityManagementType(identityManagementType)
```

"Specifies the identity management type attached to the instance. Allowed Values are: SAML, CONNECT_MANAGED, EXISTING_DIRECTORY."

### fn spec.forProvider.withInboundCallsEnabled

```ts
withInboundCallsEnabled(inboundCallsEnabled)
```

"Specifies whether inbound calls are enabled."

### fn spec.forProvider.withInstanceAlias
...
### fn spec.forProvider.withMultiPartyConferenceEnabled

```ts
withMultiPartyConferenceEnabled(multiPartyConferenceEnabled)
```

"Specifies whether multi-party calls/conference is enabled. Defaults to false."

### fn spec.forProvider.withOutboundCallsEnabled

```ts
withOutboundCallsEnabled(outboundCallsEnabled)
```
...
### fn spec.initProvider.withAutoResolveBestVoicesEnabled
...
### fn spec.initProvider.withContactFlowLogsEnabled
...
### fn spec.initProvider.withContactLensEnabled
...
### fn spec.initProvider.withEarlyMediaEnabled
...
### fn spec.initProvider.withIdentityManagementType
...
### fn spec.initProvider.withInboundCallsEnabled
...
### fn spec.initProvider.withInstanceAlias
...
### fn spec.initProvider.withMultiPartyConferenceEnabled
...
### fn spec.initProvider.withOutboundCallsEnabled
