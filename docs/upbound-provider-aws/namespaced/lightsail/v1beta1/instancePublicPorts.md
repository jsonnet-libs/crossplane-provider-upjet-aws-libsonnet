---
permalink: /upbound-provider-aws/namespaced/lightsail/v1beta1/instancePublicPorts/
---

# lightsail.v1beta1.instancePublicPorts
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPortInfo(portInfo)`](#fn-specforproviderwithportinfo)
    * [`fn withPortInfoMixin(portInfo)`](#fn-specforproviderwithportinfomixin)
    ...
    * [`obj spec.forProvider.portInfo`](#obj-specforproviderportinfo)
      * [`fn withCidrListAliases(cidrListAliases)`](#fn-specforproviderportinfowithcidrlistaliases)
      * [`fn withCidrListAliasesMixin(cidrListAliases)`](#fn-specforproviderportinfowithcidrlistaliasesmixin)
      * [`fn withCidrs(cidrs)`](#fn-specforproviderportinfowithcidrs)
      * [`fn withCidrsMixin(cidrs)`](#fn-specforproviderportinfowithcidrsmixin)
      * [`fn withFromPort(fromPort)`](#fn-specforproviderportinfowithfromport)
      * [`fn withIpv6Cidrs(ipv6Cidrs)`](#fn-specforproviderportinfowithipv6cidrs)
      * [`fn withIpv6CidrsMixin(ipv6Cidrs)`](#fn-specforproviderportinfowithipv6cidrsmixin)
      * [`fn withProtocol(protocol)`](#fn-specforproviderportinfowithprotocol)
      * [`fn withToPort(toPort)`](#fn-specforproviderportinfowithtoport)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withInstanceName(instanceName)`](#fn-specinitproviderwithinstancename)
    * [`fn withPortInfo(portInfo)`](#fn-specinitproviderwithportinfo)
    * [`fn withPortInfoMixin(portInfo)`](#fn-specinitproviderwithportinfomixin)
    ...
    * [`obj spec.initProvider.portInfo`](#obj-specinitproviderportinfo)
      * [`fn withCidrListAliases(cidrListAliases)`](#fn-specinitproviderportinfowithcidrlistaliases)
      * [`fn withCidrListAliasesMixin(cidrListAliases)`](#fn-specinitproviderportinfowithcidrlistaliasesmixin)
      * [`fn withCidrs(cidrs)`](#fn-specinitproviderportinfowithcidrs)
      * [`fn withCidrsMixin(cidrs)`](#fn-specinitproviderportinfowithcidrsmixin)
      * [`fn withFromPort(fromPort)`](#fn-specinitproviderportinfowithfromport)
      * [`fn withIpv6Cidrs(ipv6Cidrs)`](#fn-specinitproviderportinfowithipv6cidrs)
      * [`fn withIpv6CidrsMixin(ipv6Cidrs)`](#fn-specinitproviderportinfowithipv6cidrsmixin)
      * [`fn withProtocol(protocol)`](#fn-specinitproviderportinfowithprotocol)
      * [`fn withToPort(toPort)`](#fn-specinitproviderportinfowithtoport)
...
new returns an instance of InstancePublicPorts
...
### fn spec.forProvider.withPortInfo
...
### fn spec.forProvider.withPortInfoMixin

```ts
withPortInfoMixin(portInfo)
```
...
## obj spec.forProvider.portInfo

"Descriptor of the ports to open for the specified instance. AWS closes all currently open ports that are not included in this argument. See port_info Block for details."

### fn spec.forProvider.portInfo.withCidrListAliases

```ts
withCidrListAliases(cidrListAliases)
```

"Set of CIDR aliases that define access for a preconfigured range of IP addresses."

### fn spec.forProvider.portInfo.withCidrListAliasesMixin

```ts
withCidrListAliasesMixin(cidrListAliases)
```
...
### fn spec.forProvider.portInfo.withCidrs
...
### fn spec.forProvider.portInfo.withCidrsMixin
...
### fn spec.forProvider.portInfo.withFromPort

```ts
withFromPort(fromPort)
```

"First port in a range of open ports on an instance. See PortInfo for details."

### fn spec.forProvider.portInfo.withIpv6Cidrs

```ts
withIpv6Cidrs(ipv6Cidrs)
```
...
### fn spec.forProvider.portInfo.withIpv6CidrsMixin

```ts
withIpv6CidrsMixin(ipv6Cidrs)
```
...
### fn spec.forProvider.portInfo.withProtocol

```ts
withProtocol(protocol)
```

"IP protocol name. Valid values: tcp, all, udp, icmp, icmpv6. See PortInfo for details."

### fn spec.forProvider.portInfo.withToPort

```ts
withToPort(toPort)
```

"Last port in a range of open ports on an instance. See PortInfo for details."
...
### fn spec.initProvider.withPortInfo
...
### fn spec.initProvider.withPortInfoMixin
...
## obj spec.initProvider.portInfo

"Descriptor of the ports to open for the specified instance. AWS closes all currently open ports that are not included in this argument. See port_info Block for details."

### fn spec.initProvider.portInfo.withCidrListAliases
...
### fn spec.initProvider.portInfo.withCidrListAliasesMixin
...
### fn spec.initProvider.portInfo.withCidrs
...
### fn spec.initProvider.portInfo.withCidrsMixin
...
### fn spec.initProvider.portInfo.withFromPort
...
### fn spec.initProvider.portInfo.withIpv6Cidrs
...
### fn spec.initProvider.portInfo.withIpv6CidrsMixin
...
### fn spec.initProvider.portInfo.withProtocol
...
### fn spec.initProvider.portInfo.withToPort
