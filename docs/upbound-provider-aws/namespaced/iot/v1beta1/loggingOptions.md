---
permalink: /upbound-provider-aws/namespaced/iot/v1beta1/loggingOptions/
---

# iot.v1beta1.loggingOptions
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withDefaultLogLevel(defaultLogLevel)`](#fn-specforproviderwithdefaultloglevel)
    * [`fn withDisableAllLogs(disableAllLogs)`](#fn-specforproviderwithdisablealllogs)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withDefaultLogLevel(defaultLogLevel)`](#fn-specinitproviderwithdefaultloglevel)
    * [`fn withDisableAllLogs(disableAllLogs)`](#fn-specinitproviderwithdisablealllogs)
...
new returns an instance of LoggingOptions
...
### fn spec.forProvider.withDefaultLogLevel

```ts
withDefaultLogLevel(defaultLogLevel)
```

"The default logging level. Valid Values: \"DEBUG\", \"INFO\", \"ERROR\", \"WARN\", \"DISABLED\"."

### fn spec.forProvider.withDisableAllLogs

```ts
withDisableAllLogs(disableAllLogs)
```
...
### fn spec.initProvider.withDefaultLogLevel
...
### fn spec.initProvider.withDisableAllLogs
