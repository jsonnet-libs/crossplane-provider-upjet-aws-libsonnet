---
permalink: /upbound-provider-aws/namespaced/apigatewayv2/v1beta1/apiMapping/
---

# apigatewayv2.v1beta1.apiMapping
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withApiMappingKey(apiMappingKey)`](#fn-specforproviderwithapimappingkey)
    ...
    * [`obj spec.forProvider.stageRef`](#obj-specforproviderstageref)
      * [`fn withName(name)`](#fn-specforproviderstagerefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderstagerefwithnamespace)
      * [`obj spec.forProvider.stageRef.policy`](#obj-specforproviderstagerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderstagerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderstagerefpolicywithresolve)
    * [`obj spec.forProvider.stageSelector`](#obj-specforproviderstageselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderstageselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderstageselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderstageselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforproviderstageselectorwithnamespace)
      * [`obj spec.forProvider.stageSelector.policy`](#obj-specforproviderstageselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderstageselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderstageselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withApiId(apiId)`](#fn-specinitproviderwithapiid)
    * [`fn withApiMappingKey(apiMappingKey)`](#fn-specinitproviderwithapimappingkey)
    ...
    * [`obj spec.initProvider.stageRef`](#obj-specinitproviderstageref)
      * [`fn withName(name)`](#fn-specinitproviderstagerefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderstagerefwithnamespace)
      * [`obj spec.initProvider.stageRef.policy`](#obj-specinitproviderstagerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderstagerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderstagerefpolicywithresolve)
    * [`obj spec.initProvider.stageSelector`](#obj-specinitproviderstageselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderstageselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderstageselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderstageselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderstageselectorwithnamespace)
      * [`obj spec.initProvider.stageSelector.policy`](#obj-specinitproviderstageselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderstageselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderstageselectorpolicywithresolve)
...
new returns an instance of APIMapping
...
### fn spec.forProvider.withApiMappingKey
...
## obj spec.forProvider.stageRef

"Reference to a Stage in apigatewayv2 to populate stage."

### fn spec.forProvider.stageRef.withName
...
### fn spec.forProvider.stageRef.withNamespace
...
## obj spec.forProvider.stageRef.policy

"Policies for referencing."

### fn spec.forProvider.stageRef.policy.withResolution
...
### fn spec.forProvider.stageRef.policy.withResolve
...
## obj spec.forProvider.stageSelector

"Selector for a Stage in apigatewayv2 to populate stage."

### fn spec.forProvider.stageSelector.withMatchControllerRef
...
### fn spec.forProvider.stageSelector.withMatchLabels
...
### fn spec.forProvider.stageSelector.withMatchLabelsMixin
...
### fn spec.forProvider.stageSelector.withNamespace
...
## obj spec.forProvider.stageSelector.policy

"Policies for selection."

### fn spec.forProvider.stageSelector.policy.withResolution
...
### fn spec.forProvider.stageSelector.policy.withResolve
...
### fn spec.initProvider.withApiMappingKey
...
## obj spec.initProvider.stageRef

"Reference to a Stage in apigatewayv2 to populate stage."

### fn spec.initProvider.stageRef.withName
...
### fn spec.initProvider.stageRef.withNamespace
...
## obj spec.initProvider.stageRef.policy

"Policies for referencing."

### fn spec.initProvider.stageRef.policy.withResolution
...
### fn spec.initProvider.stageRef.policy.withResolve
...
## obj spec.initProvider.stageSelector

"Selector for a Stage in apigatewayv2 to populate stage."

### fn spec.initProvider.stageSelector.withMatchControllerRef
...
### fn spec.initProvider.stageSelector.withMatchLabels
...
### fn spec.initProvider.stageSelector.withMatchLabelsMixin
...
### fn spec.initProvider.stageSelector.withNamespace
...
## obj spec.initProvider.stageSelector.policy

"Policies for selection."

### fn spec.initProvider.stageSelector.policy.withResolution
...
### fn spec.initProvider.stageSelector.policy.withResolve
