---
permalink: /upbound-provider-aws/namespaced/appstream/v1beta1/fleetStackAssociation/
---

# appstream.v1beta1.fleetStackAssociation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withFleetName(fleetName)`](#fn-specforproviderwithfleetname)
    * [`fn withRegion(region)`](#fn-specforproviderwithregion)
    * [`fn withStackName(stackName)`](#fn-specforproviderwithstackname)
    * [`obj spec.forProvider.fleetNameRef`](#obj-specforproviderfleetnameref)
      * [`fn withName(name)`](#fn-specforproviderfleetnamerefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderfleetnamerefwithnamespace)
      * [`obj spec.forProvider.fleetNameRef.policy`](#obj-specforproviderfleetnamerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderfleetnamerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderfleetnamerefpolicywithresolve)
    * [`obj spec.forProvider.fleetNameSelector`](#obj-specforproviderfleetnameselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderfleetnameselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderfleetnameselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderfleetnameselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforproviderfleetnameselectorwithnamespace)
      * [`obj spec.forProvider.fleetNameSelector.policy`](#obj-specforproviderfleetnameselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderfleetnameselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderfleetnameselectorpolicywithresolve)
...
new returns an instance of FleetStackAssociation
...
### fn spec.forProvider.withFleetName
...
## obj spec.forProvider.fleetNameRef

"Reference to a Fleet in appstream to populate fleetName."

### fn spec.forProvider.fleetNameRef.withName
...
### fn spec.forProvider.fleetNameRef.withNamespace
...
## obj spec.forProvider.fleetNameRef.policy

"Policies for referencing."

### fn spec.forProvider.fleetNameRef.policy.withResolution
...
### fn spec.forProvider.fleetNameRef.policy.withResolve
...
## obj spec.forProvider.fleetNameSelector

"Selector for a Fleet in appstream to populate fleetName."

### fn spec.forProvider.fleetNameSelector.withMatchControllerRef
...
### fn spec.forProvider.fleetNameSelector.withMatchLabels
...
### fn spec.forProvider.fleetNameSelector.withMatchLabelsMixin
...
### fn spec.forProvider.fleetNameSelector.withNamespace
...
## obj spec.forProvider.fleetNameSelector.policy

"Policies for selection."

### fn spec.forProvider.fleetNameSelector.policy.withResolution
...
### fn spec.forProvider.fleetNameSelector.policy.withResolve
