---
permalink: /upbound-provider-aws/namespaced/chime/v1beta1/voiceConnectorLogging/
---

# chime.v1beta1.voiceConnectorLogging
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withEnableMediaMetricLogs(enableMediaMetricLogs)`](#fn-specforproviderwithenablemediametriclogs)
    * [`fn withEnableSipLogs(enableSipLogs)`](#fn-specforproviderwithenablesiplogs)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withEnableMediaMetricLogs(enableMediaMetricLogs)`](#fn-specinitproviderwithenablemediametriclogs)
    * [`fn withEnableSipLogs(enableSipLogs)`](#fn-specinitproviderwithenablesiplogs)
...
new returns an instance of VoiceConnectorLogging
...
### fn spec.forProvider.withEnableMediaMetricLogs

```ts
withEnableMediaMetricLogs(enableMediaMetricLogs)
```

"When true, enables logging of detailed media metrics for Voice Connectors to Amazon CloudWatch logs."

### fn spec.forProvider.withEnableSipLogs

```ts
withEnableSipLogs(enableSipLogs)
```
...
### fn spec.initProvider.withEnableMediaMetricLogs
...
### fn spec.initProvider.withEnableSipLogs
