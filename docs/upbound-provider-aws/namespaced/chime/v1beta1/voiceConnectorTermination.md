---
permalink: /upbound-provider-aws/namespaced/chime/v1beta1/voiceConnectorTermination/
---

# chime.v1beta1.voiceConnectorTermination
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withCallingRegions(callingRegions)`](#fn-specforproviderwithcallingregions)
    * [`fn withCallingRegionsMixin(callingRegions)`](#fn-specforproviderwithcallingregionsmixin)
    * [`fn withCidrAllowList(cidrAllowList)`](#fn-specforproviderwithcidrallowlist)
    * [`fn withCidrAllowListMixin(cidrAllowList)`](#fn-specforproviderwithcidrallowlistmixin)
    * [`fn withCpsLimit(cpsLimit)`](#fn-specforproviderwithcpslimit)
    * [`fn withDefaultPhoneNumber(defaultPhoneNumber)`](#fn-specforproviderwithdefaultphonenumber)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withCallingRegions(callingRegions)`](#fn-specinitproviderwithcallingregions)
    * [`fn withCallingRegionsMixin(callingRegions)`](#fn-specinitproviderwithcallingregionsmixin)
    * [`fn withCidrAllowList(cidrAllowList)`](#fn-specinitproviderwithcidrallowlist)
    * [`fn withCidrAllowListMixin(cidrAllowList)`](#fn-specinitproviderwithcidrallowlistmixin)
    * [`fn withCpsLimit(cpsLimit)`](#fn-specinitproviderwithcpslimit)
    * [`fn withDefaultPhoneNumber(defaultPhoneNumber)`](#fn-specinitproviderwithdefaultphonenumber)
...
new returns an instance of VoiceConnectorTermination
...
### fn spec.forProvider.withCallingRegions

```ts
withCallingRegions(callingRegions)
```

"The countries to which calls are allowed, in ISO 3166-1 alpha-2 format."

### fn spec.forProvider.withCallingRegionsMixin

```ts
withCallingRegionsMixin(callingRegions)
```
...
### fn spec.forProvider.withCidrAllowList
...
### fn spec.forProvider.withCidrAllowListMixin
...
### fn spec.forProvider.withCpsLimit

```ts
withCpsLimit(cpsLimit)
```

"The limit on calls per second. Max value based on account service quota. Default value of 1."

### fn spec.forProvider.withDefaultPhoneNumber

```ts
withDefaultPhoneNumber(defaultPhoneNumber)
```
...
### fn spec.initProvider.withCallingRegions
...
### fn spec.initProvider.withCallingRegionsMixin
...
### fn spec.initProvider.withCidrAllowList
...
### fn spec.initProvider.withCidrAllowListMixin
...
### fn spec.initProvider.withCpsLimit
...
### fn spec.initProvider.withDefaultPhoneNumber
