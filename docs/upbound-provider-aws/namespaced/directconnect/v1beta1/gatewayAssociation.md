---
permalink: /upbound-provider-aws/namespaced/directconnect/v1beta1/gatewayAssociation/
---

# directconnect.v1beta1.gatewayAssociation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withAssociatedGatewayOwnerAccountId(associatedGatewayOwnerAccountId)`](#fn-specforproviderwithassociatedgatewayowneraccountid)
    * [`fn withDxGatewayId(dxGatewayId)`](#fn-specforproviderwithdxgatewayid)
    * [`fn withProposalId(proposalId)`](#fn-specforproviderwithproposalid)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withAssociatedGatewayOwnerAccountId(associatedGatewayOwnerAccountId)`](#fn-specinitproviderwithassociatedgatewayowneraccountid)
    * [`fn withDxGatewayId(dxGatewayId)`](#fn-specinitproviderwithdxgatewayid)
    * [`fn withProposalId(proposalId)`](#fn-specinitproviderwithproposalid)
...
new returns an instance of GatewayAssociation
...
### fn spec.forProvider.withAssociatedGatewayOwnerAccountId

```ts
withAssociatedGatewayOwnerAccountId(associatedGatewayOwnerAccountId)
```
...
### fn spec.forProvider.withProposalId
...
### fn spec.initProvider.withAssociatedGatewayOwnerAccountId
...
### fn spec.initProvider.withProposalId
