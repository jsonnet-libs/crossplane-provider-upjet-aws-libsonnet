---
permalink: /upbound-provider-aws/namespaced/cloudformation/v1beta1/stack/
---

# cloudformation.v1beta1.stack
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withDisableRollback(disableRollback)`](#fn-specforproviderwithdisablerollback)
    ...
    * [`fn withOnFailure(onFailure)`](#fn-specforproviderwithonfailure)
    ...
    * [`fn withPolicyBody(policyBody)`](#fn-specforproviderwithpolicybody)
    * [`fn withPolicyUrl(policyUrl)`](#fn-specforproviderwithpolicyurl)
    ...
    * [`fn withTimeoutInMinutes(timeoutInMinutes)`](#fn-specforproviderwithtimeoutinminutes)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withDisableRollback(disableRollback)`](#fn-specinitproviderwithdisablerollback)
    * [`fn withIamRoleArn(iamRoleArn)`](#fn-specinitproviderwithiamrolearn)
    * [`fn withNotificationArns(notificationArns)`](#fn-specinitproviderwithnotificationarns)
    * [`fn withNotificationArnsMixin(notificationArns)`](#fn-specinitproviderwithnotificationarnsmixin)
    * [`fn withOnFailure(onFailure)`](#fn-specinitproviderwithonfailure)
    ...
    * [`fn withPolicyBody(policyBody)`](#fn-specinitproviderwithpolicybody)
    * [`fn withPolicyUrl(policyUrl)`](#fn-specinitproviderwithpolicyurl)
    ...
    * [`fn withTimeoutInMinutes(timeoutInMinutes)`](#fn-specinitproviderwithtimeoutinminutes)
...
### fn spec.forProvider.withDisableRollback
...
### fn spec.forProvider.withOnFailure
...
### fn spec.forProvider.withPolicyBody

```ts
withPolicyBody(policyBody)
```

"Structure containing the stack policy body.\nConflicts w/ policy_url."

### fn spec.forProvider.withPolicyUrl

```ts
withPolicyUrl(policyUrl)
```
...
### fn spec.forProvider.withTimeoutInMinutes
...
### fn spec.initProvider.withDisableRollback
...
### fn spec.initProvider.withNotificationArns
...
### fn spec.initProvider.withNotificationArnsMixin
...
### fn spec.initProvider.withOnFailure
...
### fn spec.initProvider.withPolicyBody
...
### fn spec.initProvider.withPolicyUrl
...
### fn spec.initProvider.withTimeoutInMinutes
