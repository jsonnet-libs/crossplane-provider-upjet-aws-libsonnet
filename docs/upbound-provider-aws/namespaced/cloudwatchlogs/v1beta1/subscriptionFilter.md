---
permalink: /upbound-provider-aws/namespaced/cloudwatchlogs/v1beta1/subscriptionFilter/
---

# cloudwatchlogs.v1beta1.subscriptionFilter
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withFilterPattern(filterPattern)`](#fn-specforproviderwithfilterpattern)
    * [`fn withLogGroupName(logGroupName)`](#fn-specforproviderwithloggroupname)
    * [`fn withName(name)`](#fn-specforproviderwithname)
    * [`fn withRegion(region)`](#fn-specforproviderwithregion)
    * [`fn withRoleArn(roleArn)`](#fn-specforproviderwithrolearn)
    * [`obj spec.forProvider.destinationArnRef`](#obj-specforproviderdestinationarnref)
      * [`fn withName(name)`](#fn-specforproviderdestinationarnrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderdestinationarnrefwithnamespace)
      * [`obj spec.forProvider.destinationArnRef.policy`](#obj-specforproviderdestinationarnrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderdestinationarnrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderdestinationarnrefpolicywithresolve)
    * [`obj spec.forProvider.destinationArnSelector`](#obj-specforproviderdestinationarnselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderdestinationarnselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderdestinationarnselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderdestinationarnselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforproviderdestinationarnselectorwithnamespace)
      * [`obj spec.forProvider.destinationArnSelector.policy`](#obj-specforproviderdestinationarnselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderdestinationarnselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderdestinationarnselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withFilterPattern(filterPattern)`](#fn-specinitproviderwithfilterpattern)
    ...
    * [`obj spec.initProvider.destinationArnRef`](#obj-specinitproviderdestinationarnref)
      * [`fn withName(name)`](#fn-specinitproviderdestinationarnrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderdestinationarnrefwithnamespace)
      * [`obj spec.initProvider.destinationArnRef.policy`](#obj-specinitproviderdestinationarnrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderdestinationarnrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderdestinationarnrefpolicywithresolve)
    * [`obj spec.initProvider.destinationArnSelector`](#obj-specinitproviderdestinationarnselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderdestinationarnselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderdestinationarnselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderdestinationarnselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderdestinationarnselectorwithnamespace)
      * [`obj spec.initProvider.destinationArnSelector.policy`](#obj-specinitproviderdestinationarnselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderdestinationarnselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderdestinationarnselectorpolicywithresolve)
...
new returns an instance of SubscriptionFilter
...
### fn spec.forProvider.withFilterPattern
...
## obj spec.forProvider.destinationArnRef

"Reference to a Stream in kinesis to populate destinationArn."

### fn spec.forProvider.destinationArnRef.withName
...
### fn spec.forProvider.destinationArnRef.withNamespace
...
## obj spec.forProvider.destinationArnRef.policy

"Policies for referencing."

### fn spec.forProvider.destinationArnRef.policy.withResolution
...
### fn spec.forProvider.destinationArnRef.policy.withResolve
...
## obj spec.forProvider.destinationArnSelector

"Selector for a Stream in kinesis to populate destinationArn."

### fn spec.forProvider.destinationArnSelector.withMatchControllerRef
...
### fn spec.forProvider.destinationArnSelector.withMatchLabels
...
### fn spec.forProvider.destinationArnSelector.withMatchLabelsMixin
...
### fn spec.forProvider.destinationArnSelector.withNamespace
...
## obj spec.forProvider.destinationArnSelector.policy

"Policies for selection."

### fn spec.forProvider.destinationArnSelector.policy.withResolution
...
### fn spec.forProvider.destinationArnSelector.policy.withResolve
...
### fn spec.initProvider.withFilterPattern
...
## obj spec.initProvider.destinationArnRef

"Reference to a Stream in kinesis to populate destinationArn."

### fn spec.initProvider.destinationArnRef.withName
...
### fn spec.initProvider.destinationArnRef.withNamespace
...
## obj spec.initProvider.destinationArnRef.policy

"Policies for referencing."

### fn spec.initProvider.destinationArnRef.policy.withResolution
...
### fn spec.initProvider.destinationArnRef.policy.withResolve
...
## obj spec.initProvider.destinationArnSelector

"Selector for a Stream in kinesis to populate destinationArn."

### fn spec.initProvider.destinationArnSelector.withMatchControllerRef
...
### fn spec.initProvider.destinationArnSelector.withMatchLabels
...
### fn spec.initProvider.destinationArnSelector.withMatchLabelsMixin
...
### fn spec.initProvider.destinationArnSelector.withNamespace
...
## obj spec.initProvider.destinationArnSelector.policy

"Policies for selection."

### fn spec.initProvider.destinationArnSelector.policy.withResolution
...
### fn spec.initProvider.destinationArnSelector.policy.withResolve
