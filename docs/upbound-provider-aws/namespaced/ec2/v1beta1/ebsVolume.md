---
permalink: /upbound-provider-aws/namespaced/ec2/v1beta1/ebsVolume/
---

# ec2.v1beta1.ebsVolume
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withFinalSnapshot(finalSnapshot)`](#fn-specforproviderwithfinalsnapshot)
    ...
    * [`fn withVolumeInitializationRate(volumeInitializationRate)`](#fn-specforproviderwithvolumeinitializationrate)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withFinalSnapshot(finalSnapshot)`](#fn-specinitproviderwithfinalsnapshot)
    * [`fn withIops(iops)`](#fn-specinitproviderwithiops)
    * [`fn withKmsKeyId(kmsKeyId)`](#fn-specinitproviderwithkmskeyid)
    * [`fn withMultiAttachEnabled(multiAttachEnabled)`](#fn-specinitproviderwithmultiattachenabled)
    ...
    * [`fn withVolumeInitializationRate(volumeInitializationRate)`](#fn-specinitproviderwithvolumeinitializationrate)
...
new returns an instance of EBSVolume
...
### fn spec.forProvider.withFinalSnapshot

```ts
withFinalSnapshot(finalSnapshot)
```
...
### fn spec.forProvider.withVolumeInitializationRate
...
### fn spec.initProvider.withFinalSnapshot
...
### fn spec.initProvider.withMultiAttachEnabled
...
### fn spec.initProvider.withVolumeInitializationRate
