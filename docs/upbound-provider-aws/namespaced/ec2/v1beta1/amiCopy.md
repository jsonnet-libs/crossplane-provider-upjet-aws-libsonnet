---
permalink: /upbound-provider-aws/namespaced/ec2/v1beta1/amiCopy/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withDestinationOutpostArn(destinationOutpostArn)`](#fn-specforproviderwithdestinationoutpostarn)
    ...
    * [`fn withSourceAmiId(sourceAmiId)`](#fn-specforproviderwithsourceamiid)
    * [`fn withSourceAmiRegion(sourceAmiRegion)`](#fn-specforproviderwithsourceamiregion)
    ...
    * [`obj spec.forProvider.sourceAmiIdRef`](#obj-specforprovidersourceamiidref)
      * [`fn withName(name)`](#fn-specforprovidersourceamiidrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidersourceamiidrefwithnamespace)
      * [`obj spec.forProvider.sourceAmiIdRef.policy`](#obj-specforprovidersourceamiidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidersourceamiidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidersourceamiidrefpolicywithresolve)
    * [`obj spec.forProvider.sourceAmiIdSelector`](#obj-specforprovidersourceamiidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidersourceamiidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidersourceamiidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidersourceamiidselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforprovidersourceamiidselectorwithnamespace)
      * [`obj spec.forProvider.sourceAmiIdSelector.policy`](#obj-specforprovidersourceamiidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidersourceamiidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidersourceamiidselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withDeprecationTime(deprecationTime)`](#fn-specinitproviderwithdeprecationtime)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withDestinationOutpostArn(destinationOutpostArn)`](#fn-specinitproviderwithdestinationoutpostarn)
    ...
    * [`fn withSourceAmiId(sourceAmiId)`](#fn-specinitproviderwithsourceamiid)
    * [`fn withSourceAmiRegion(sourceAmiRegion)`](#fn-specinitproviderwithsourceamiregion)
    ...
    * [`obj spec.initProvider.sourceAmiIdRef`](#obj-specinitprovidersourceamiidref)
      * [`fn withName(name)`](#fn-specinitprovidersourceamiidrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersourceamiidrefwithnamespace)
      * [`obj spec.initProvider.sourceAmiIdRef.policy`](#obj-specinitprovidersourceamiidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidersourceamiidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidersourceamiidrefpolicywithresolve)
    * [`obj spec.initProvider.sourceAmiIdSelector`](#obj-specinitprovidersourceamiidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidersourceamiidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidersourceamiidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidersourceamiidselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersourceamiidselectorwithnamespace)
      * [`obj spec.initProvider.sourceAmiIdSelector.policy`](#obj-specinitprovidersourceamiidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidersourceamiidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidersourceamiidselectorpolicywithresolve)
...
new returns an instance of AMICopy
...
### fn spec.forProvider.withDestinationOutpostArn

```ts
withDestinationOutpostArn(destinationOutpostArn)
```
...
### fn spec.forProvider.withSourceAmiId

```ts
withSourceAmiId(sourceAmiId)
```

"Id of the AMI to copy. This id must be valid in the region\ngiven by source_ami_region."

### fn spec.forProvider.withSourceAmiRegion

```ts
withSourceAmiRegion(sourceAmiRegion)
```
...
## obj spec.forProvider.sourceAmiIdRef

"Reference to a AMI in ec2 to populate sourceAmiId."

### fn spec.forProvider.sourceAmiIdRef.withName
...
### fn spec.forProvider.sourceAmiIdRef.withNamespace
...
## obj spec.forProvider.sourceAmiIdRef.policy

"Policies for referencing."

### fn spec.forProvider.sourceAmiIdRef.policy.withResolution
...
### fn spec.forProvider.sourceAmiIdRef.policy.withResolve
...
## obj spec.forProvider.sourceAmiIdSelector

"Selector for a AMI in ec2 to populate sourceAmiId."

### fn spec.forProvider.sourceAmiIdSelector.withMatchControllerRef
...
### fn spec.forProvider.sourceAmiIdSelector.withMatchLabels
...
### fn spec.forProvider.sourceAmiIdSelector.withMatchLabelsMixin
...
### fn spec.forProvider.sourceAmiIdSelector.withNamespace
...
## obj spec.forProvider.sourceAmiIdSelector.policy

"Policies for selection."

### fn spec.forProvider.sourceAmiIdSelector.policy.withResolution
...
### fn spec.forProvider.sourceAmiIdSelector.policy.withResolve
...
### fn spec.initProvider.withDestinationOutpostArn
...
### fn spec.initProvider.withSourceAmiId
...
### fn spec.initProvider.withSourceAmiRegion
...
## obj spec.initProvider.sourceAmiIdRef

"Reference to a AMI in ec2 to populate sourceAmiId."

### fn spec.initProvider.sourceAmiIdRef.withName
...
### fn spec.initProvider.sourceAmiIdRef.withNamespace
...
## obj spec.initProvider.sourceAmiIdRef.policy

"Policies for referencing."

### fn spec.initProvider.sourceAmiIdRef.policy.withResolution
...
### fn spec.initProvider.sourceAmiIdRef.policy.withResolve
...
## obj spec.initProvider.sourceAmiIdSelector

"Selector for a AMI in ec2 to populate sourceAmiId."

### fn spec.initProvider.sourceAmiIdSelector.withMatchControllerRef
...
### fn spec.initProvider.sourceAmiIdSelector.withMatchLabels
...
### fn spec.initProvider.sourceAmiIdSelector.withMatchLabelsMixin
...
### fn spec.initProvider.sourceAmiIdSelector.withNamespace
...
## obj spec.initProvider.sourceAmiIdSelector.policy

"Policies for selection."

### fn spec.initProvider.sourceAmiIdSelector.policy.withResolution
...
### fn spec.initProvider.sourceAmiIdSelector.policy.withResolve
