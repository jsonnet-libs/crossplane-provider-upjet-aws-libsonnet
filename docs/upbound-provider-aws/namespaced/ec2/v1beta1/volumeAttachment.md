---
permalink: /upbound-provider-aws/namespaced/ec2/v1beta1/volumeAttachment/
---

# ec2.v1beta1.volumeAttachment
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withDeviceName(deviceName)`](#fn-specforproviderwithdevicename)
    * [`fn withForceDetach(forceDetach)`](#fn-specforproviderwithforcedetach)
    ...
    * [`fn withStopInstanceBeforeDetaching(stopInstanceBeforeDetaching)`](#fn-specforproviderwithstopinstancebeforedetaching)
    * [`fn withVolumeId(volumeId)`](#fn-specforproviderwithvolumeid)
    ...
    * [`obj spec.forProvider.volumeIdRef`](#obj-specforprovidervolumeidref)
      * [`fn withName(name)`](#fn-specforprovidervolumeidrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidervolumeidrefwithnamespace)
      * [`obj spec.forProvider.volumeIdRef.policy`](#obj-specforprovidervolumeidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidervolumeidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidervolumeidrefpolicywithresolve)
    * [`obj spec.forProvider.volumeIdSelector`](#obj-specforprovidervolumeidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidervolumeidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidervolumeidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidervolumeidselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforprovidervolumeidselectorwithnamespace)
      * [`obj spec.forProvider.volumeIdSelector.policy`](#obj-specforprovidervolumeidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidervolumeidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidervolumeidselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withDeviceName(deviceName)`](#fn-specinitproviderwithdevicename)
    * [`fn withForceDetach(forceDetach)`](#fn-specinitproviderwithforcedetach)
    ...
    * [`fn withStopInstanceBeforeDetaching(stopInstanceBeforeDetaching)`](#fn-specinitproviderwithstopinstancebeforedetaching)
    * [`fn withVolumeId(volumeId)`](#fn-specinitproviderwithvolumeid)
    ...
    * [`obj spec.initProvider.volumeIdRef`](#obj-specinitprovidervolumeidref)
      * [`fn withName(name)`](#fn-specinitprovidervolumeidrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidervolumeidrefwithnamespace)
      * [`obj spec.initProvider.volumeIdRef.policy`](#obj-specinitprovidervolumeidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidervolumeidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidervolumeidrefpolicywithresolve)
    * [`obj spec.initProvider.volumeIdSelector`](#obj-specinitprovidervolumeidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidervolumeidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidervolumeidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidervolumeidselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidervolumeidselectorwithnamespace)
      * [`obj spec.initProvider.volumeIdSelector.policy`](#obj-specinitprovidervolumeidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidervolumeidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidervolumeidselectorpolicywithresolve)
...
### fn spec.forProvider.withDeviceName
...
### fn spec.forProvider.withForceDetach
...
### fn spec.forProvider.withStopInstanceBeforeDetaching

```ts
withStopInstanceBeforeDetaching(stopInstanceBeforeDetaching)
```

"Set this to true to ensure that the target instance is stopped\nbefore trying to detach the volume. Stops the instance, if it is not already stopped."

### fn spec.forProvider.withVolumeId
...
## obj spec.forProvider.volumeIdRef

"Reference to a EBSVolume in ec2 to populate volumeId."

### fn spec.forProvider.volumeIdRef.withName
...
### fn spec.forProvider.volumeIdRef.withNamespace
...
## obj spec.forProvider.volumeIdRef.policy

"Policies for referencing."

### fn spec.forProvider.volumeIdRef.policy.withResolution
...
### fn spec.forProvider.volumeIdRef.policy.withResolve
...
## obj spec.forProvider.volumeIdSelector

"Selector for a EBSVolume in ec2 to populate volumeId."

### fn spec.forProvider.volumeIdSelector.withMatchControllerRef
...
### fn spec.forProvider.volumeIdSelector.withMatchLabels
...
### fn spec.forProvider.volumeIdSelector.withMatchLabelsMixin
...
### fn spec.forProvider.volumeIdSelector.withNamespace
...
## obj spec.forProvider.volumeIdSelector.policy

"Policies for selection."

### fn spec.forProvider.volumeIdSelector.policy.withResolution
...
### fn spec.forProvider.volumeIdSelector.policy.withResolve
...
### fn spec.initProvider.withDeviceName
...
### fn spec.initProvider.withForceDetach
...
### fn spec.initProvider.withStopInstanceBeforeDetaching
...
### fn spec.initProvider.withVolumeId
...
## obj spec.initProvider.volumeIdRef

"Reference to a EBSVolume in ec2 to populate volumeId."

### fn spec.initProvider.volumeIdRef.withName
...
### fn spec.initProvider.volumeIdRef.withNamespace
...
## obj spec.initProvider.volumeIdRef.policy

"Policies for referencing."

### fn spec.initProvider.volumeIdRef.policy.withResolution
...
### fn spec.initProvider.volumeIdRef.policy.withResolve
...
## obj spec.initProvider.volumeIdSelector

"Selector for a EBSVolume in ec2 to populate volumeId."

### fn spec.initProvider.volumeIdSelector.withMatchControllerRef
...
### fn spec.initProvider.volumeIdSelector.withMatchLabels
...
### fn spec.initProvider.volumeIdSelector.withMatchLabelsMixin
...
### fn spec.initProvider.volumeIdSelector.withNamespace
...
## obj spec.initProvider.volumeIdSelector.policy

"Policies for selection."

### fn spec.initProvider.volumeIdSelector.policy.withResolution
...
### fn spec.initProvider.volumeIdSelector.policy.withResolve
