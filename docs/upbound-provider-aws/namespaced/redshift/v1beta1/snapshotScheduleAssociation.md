---
permalink: /upbound-provider-aws/namespaced/redshift/v1beta1/snapshotScheduleAssociation/
---

# redshift.v1beta1.snapshotScheduleAssociation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withScheduleIdentifier(scheduleIdentifier)`](#fn-specforproviderwithscheduleidentifier)
    ...
    * [`obj spec.forProvider.scheduleIdentifierRef`](#obj-specforproviderscheduleidentifierref)
      * [`fn withName(name)`](#fn-specforproviderscheduleidentifierrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderscheduleidentifierrefwithnamespace)
      * [`obj spec.forProvider.scheduleIdentifierRef.policy`](#obj-specforproviderscheduleidentifierrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderscheduleidentifierrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderscheduleidentifierrefpolicywithresolve)
    * [`obj spec.forProvider.scheduleIdentifierSelector`](#obj-specforproviderscheduleidentifierselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderscheduleidentifierselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderscheduleidentifierselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderscheduleidentifierselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specforproviderscheduleidentifierselectorwithnamespace)
      * [`obj spec.forProvider.scheduleIdentifierSelector.policy`](#obj-specforproviderscheduleidentifierselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderscheduleidentifierselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderscheduleidentifierselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withClusterIdentifier(clusterIdentifier)`](#fn-specinitproviderwithclusteridentifier)
    * [`fn withScheduleIdentifier(scheduleIdentifier)`](#fn-specinitproviderwithscheduleidentifier)
    ...
    * [`obj spec.initProvider.scheduleIdentifierRef`](#obj-specinitproviderscheduleidentifierref)
      * [`fn withName(name)`](#fn-specinitproviderscheduleidentifierrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderscheduleidentifierrefwithnamespace)
      * [`obj spec.initProvider.scheduleIdentifierRef.policy`](#obj-specinitproviderscheduleidentifierrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderscheduleidentifierrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderscheduleidentifierrefpolicywithresolve)
    * [`obj spec.initProvider.scheduleIdentifierSelector`](#obj-specinitproviderscheduleidentifierselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderscheduleidentifierselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderscheduleidentifierselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderscheduleidentifierselectorwithmatchlabelsmixin)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderscheduleidentifierselectorwithnamespace)
      * [`obj spec.initProvider.scheduleIdentifierSelector.policy`](#obj-specinitproviderscheduleidentifierselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderscheduleidentifierselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderscheduleidentifierselectorpolicywithresolve)
...
new returns an instance of SnapshotScheduleAssociation
...
### fn spec.forProvider.withScheduleIdentifier

```ts
withScheduleIdentifier(scheduleIdentifier)
```
...
## obj spec.forProvider.scheduleIdentifierRef

"Reference to a SnapshotSchedule in redshift to populate scheduleIdentifier."

### fn spec.forProvider.scheduleIdentifierRef.withName
...
### fn spec.forProvider.scheduleIdentifierRef.withNamespace
...
## obj spec.forProvider.scheduleIdentifierRef.policy

"Policies for referencing."

### fn spec.forProvider.scheduleIdentifierRef.policy.withResolution
...
### fn spec.forProvider.scheduleIdentifierRef.policy.withResolve
...
## obj spec.forProvider.scheduleIdentifierSelector

"Selector for a SnapshotSchedule in redshift to populate scheduleIdentifier."

### fn spec.forProvider.scheduleIdentifierSelector.withMatchControllerRef
...
### fn spec.forProvider.scheduleIdentifierSelector.withMatchLabels
...
### fn spec.forProvider.scheduleIdentifierSelector.withMatchLabelsMixin
...
### fn spec.forProvider.scheduleIdentifierSelector.withNamespace
...
## obj spec.forProvider.scheduleIdentifierSelector.policy

"Policies for selection."

### fn spec.forProvider.scheduleIdentifierSelector.policy.withResolution
...
### fn spec.forProvider.scheduleIdentifierSelector.policy.withResolve
...
### fn spec.initProvider.withScheduleIdentifier
...
## obj spec.initProvider.scheduleIdentifierRef

"Reference to a SnapshotSchedule in redshift to populate scheduleIdentifier."

### fn spec.initProvider.scheduleIdentifierRef.withName
...
### fn spec.initProvider.scheduleIdentifierRef.withNamespace
...
## obj spec.initProvider.scheduleIdentifierRef.policy

"Policies for referencing."

### fn spec.initProvider.scheduleIdentifierRef.policy.withResolution
...
### fn spec.initProvider.scheduleIdentifierRef.policy.withResolve
...
## obj spec.initProvider.scheduleIdentifierSelector

"Selector for a SnapshotSchedule in redshift to populate scheduleIdentifier."

### fn spec.initProvider.scheduleIdentifierSelector.withMatchControllerRef
...
### fn spec.initProvider.scheduleIdentifierSelector.withMatchLabels
...
### fn spec.initProvider.scheduleIdentifierSelector.withMatchLabelsMixin
...
### fn spec.initProvider.scheduleIdentifierSelector.withNamespace
...
## obj spec.initProvider.scheduleIdentifierSelector.policy

"Policies for selection."

### fn spec.initProvider.scheduleIdentifierSelector.policy.withResolution
...
### fn spec.initProvider.scheduleIdentifierSelector.policy.withResolve
