---
permalink: /upbound-provider-aws/namespaced/glue/v1beta1/
---
...
* [catalogTableOptimizer](catalogTableOptimizer.md)
* [classifier](classifier.md)
* [connection](connection.md)
* [crawler](crawler.md)
* [dataCatalogEncryptionSettings](dataCatalogEncryptionSettings.md)
* [job](job.md)
