---
permalink: /upbound-provider-aws/namespaced/iam/v1beta1/userLoginProfile/
---

# iam.v1beta1.userLoginProfile
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withPasswordLength(passwordLength)`](#fn-specforproviderwithpasswordlength)
    * [`fn withPasswordResetRequired(passwordResetRequired)`](#fn-specforproviderwithpasswordresetrequired)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withPasswordLength(passwordLength)`](#fn-specinitproviderwithpasswordlength)
    * [`fn withPasswordResetRequired(passwordResetRequired)`](#fn-specinitproviderwithpasswordresetrequired)
    * [`fn withPgpKey(pgpKey)`](#fn-specinitproviderwithpgpkey)
...
new returns an instance of UserLoginProfile
...
### fn spec.forProvider.withPasswordLength
...
### fn spec.forProvider.withPasswordResetRequired

```ts
withPasswordResetRequired(passwordResetRequired)
```

"Whether the user should be forced to reset the generated password on resource creation. Only applies on resource creation."

### fn spec.forProvider.withPgpKey
...
### fn spec.initProvider.withPasswordLength
...
### fn spec.initProvider.withPasswordResetRequired
...
### fn spec.initProvider.withPgpKey
