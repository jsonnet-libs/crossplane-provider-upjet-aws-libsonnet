---
permalink: /upbound-provider-aws/namespaced/iam/v1beta1/userGroupMembership/
---

# iam.v1beta1.userGroupMembership
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withGroupRefs(groupRefs)`](#fn-specforproviderwithgrouprefs)
    * [`fn withGroupRefsMixin(groupRefs)`](#fn-specforproviderwithgrouprefsmixin)
    ...
    * [`obj spec.forProvider.groupRefs`](#obj-specforprovidergrouprefs)
      * [`fn withName(name)`](#fn-specforprovidergrouprefswithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidergrouprefswithnamespace)
      * [`obj spec.forProvider.groupRefs.policy`](#obj-specforprovidergrouprefspolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidergrouprefspolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidergrouprefspolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withGroupRefs(groupRefs)`](#fn-specinitproviderwithgrouprefs)
    * [`fn withGroupRefsMixin(groupRefs)`](#fn-specinitproviderwithgrouprefsmixin)
    ...
    * [`obj spec.initProvider.groupRefs`](#obj-specinitprovidergrouprefs)
      * [`fn withName(name)`](#fn-specinitprovidergrouprefswithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidergrouprefswithnamespace)
      * [`obj spec.initProvider.groupRefs.policy`](#obj-specinitprovidergrouprefspolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidergrouprefspolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidergrouprefspolicywithresolve)
...
new returns an instance of UserGroupMembership
...
### fn spec.forProvider.withGroupRefs

```ts
withGroupRefs(groupRefs)
```

"References to Group in iam to populate groups."

### fn spec.forProvider.withGroupRefsMixin

```ts
withGroupRefsMixin(groupRefs)
```
...
## obj spec.forProvider.groupRefs

"References to Group in iam to populate groups."

### fn spec.forProvider.groupRefs.withName
...
### fn spec.forProvider.groupRefs.withNamespace
...
## obj spec.forProvider.groupRefs.policy

"Policies for referencing."

### fn spec.forProvider.groupRefs.policy.withResolution
...
### fn spec.forProvider.groupRefs.policy.withResolve
...
### fn spec.initProvider.withGroupRefs
...
### fn spec.initProvider.withGroupRefsMixin
...
## obj spec.initProvider.groupRefs

"References to Group in iam to populate groups."

### fn spec.initProvider.groupRefs.withName
...
### fn spec.initProvider.groupRefs.withNamespace
...
## obj spec.initProvider.groupRefs.policy

"Policies for referencing."

### fn spec.initProvider.groupRefs.policy.withResolution
...
### fn spec.initProvider.groupRefs.policy.withResolve
