---
permalink: /upbound-provider-aws/namespaced/acm/v1beta1/certificateValidation/
---

# acm.v1beta1.certificateValidation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withValidationRecordFqdns(validationRecordFqdns)`](#fn-specforproviderwithvalidationrecordfqdns)
    * [`fn withValidationRecordFqdnsMixin(validationRecordFqdns)`](#fn-specforproviderwithvalidationrecordfqdnsmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withValidationRecordFqdns(validationRecordFqdns)`](#fn-specinitproviderwithvalidationrecordfqdns)
    * [`fn withValidationRecordFqdnsMixin(validationRecordFqdns)`](#fn-specinitproviderwithvalidationrecordfqdnsmixin)
...
new returns an instance of CertificateValidation
...
### fn spec.forProvider.withValidationRecordFqdns

```ts
withValidationRecordFqdns(validationRecordFqdns)
```

"List of FQDNs that implement the validation. Only valid for DNS validation method ACM certificates. If this is set, the resource can implement additional sanity checks and has an explicit dependency on the resource that is implementing the validation"

### fn spec.forProvider.withValidationRecordFqdnsMixin

```ts
withValidationRecordFqdnsMixin(validationRecordFqdns)
```
...
### fn spec.initProvider.withValidationRecordFqdns
...
### fn spec.initProvider.withValidationRecordFqdnsMixin
